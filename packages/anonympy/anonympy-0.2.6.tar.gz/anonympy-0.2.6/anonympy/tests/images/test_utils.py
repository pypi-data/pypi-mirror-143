...
def test_find_middle(rectangle):
    ...
    assert output == expected, "`find_middle` returned unexpected value for the following arguments: `x=2, y=7, w=8, h=1`"
...
def test_find_radius(rectangle):
    ...
    assert output == expected, "`find_radius` returned unexpected value for the following arguments: `x=2, y=7, w=8, h=1`"
