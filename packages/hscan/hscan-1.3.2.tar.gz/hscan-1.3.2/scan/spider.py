...
class Spider(object):
    ...
    async def on_success(self, mongo_db=None, collection=None, spider_id=None, count=1):
        """
        处理成功计数
        :param collection:
        :param mongo_db:
    ...
    async def on_error(self, e, mongo_conn=None, collection=None, spider_name=None, desc=None, url=None, headers=None):
        """
        处理失败日志记录
        :param collection:
        :param mongo_conn:
