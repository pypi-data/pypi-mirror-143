...
class ExORoleConfigConfig(AppConf):
    ...
    # ExO Builder
    CODE_CERTIFICATION_BUILDER_FOUNDATIONS = 'CBF'
    CODE_CERTIFICATION_BUILDER_BASECAMP = 'CBB'
    CODE_CERTIFICATION_BUILDER_CAMP = 'CBC'
    CODE_CERTIFICATION_BUILDER_SUMMIT = 'CBS'

    # ExO Sherpa
    CODE_CERTIFICATION_SHERPA_TRAINING = 'CST'
    CODE_CERTIFICATION_SHERPA_SHERPA = 'CSS'
    CODE_CERTIFICATION_SHERPA_LEAD = 'CSL'
    CODE_CERTIFICATION_SHERPA_MASTER = 'CSM'

    # ExO Instructor
    CODE_CERTIFICATION_INSTRUCTOR_ADJUNT = 'CIA'
    CODE_CERTIFICATION_INSTRUCTOR_INSTRUCTOR = 'CII'
    CODE_CERTIFICATION_INSTRUCTOR_LEAD = 'CIL'
    CODE_CERTIFICATION_INSTRUCTOR_MASTER = 'CIM'
    ...
    CERTIFICATION_CODE_CHOICES = (
        ...
        (CODE_CERTIFICATION_BUILDER_FOUNDATIONS, 'ExO Builder Foundations'),
