...
def analyze_pytorch_source(model_file_path, model_script_args=[]):
    ...
    if (len(models) < 1):
        ...
        raise ClickException("The provided model file does not contain any models attached with `autumn8.attach_model`.\n"
    ...
    model_file_bytes = autumn8.export_pytorch_model_repr(model, dummy_input, interns, externs, max_search_depth)
