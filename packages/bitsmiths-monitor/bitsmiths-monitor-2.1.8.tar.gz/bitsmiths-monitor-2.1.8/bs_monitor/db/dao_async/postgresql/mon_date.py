# This file was generated by mettle.genes.db.GenPy3 [ver 2.1] on Wed May 12 11:42:34 2021
...
from bs_monitor.db.tables.mon_date import tMonDate
from bs_monitor.db.tables.mon_date_key import tMonDateKey

from .mon_date_lock_one import dMonDateLockOne
from .mon_date_select_one import dMonDateSelectOne
from .mon_date_update import dMonDateUpdate
from .mon_date_insert import dMonDateInsert
from .mon_date_delete_one import dMonDateDeleteOne
...
class dMonDate:
    ...
    async def lock_one_with(self, _rec: tMonDate, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tMonDateKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
        ...
        :return: True if selected, False if not found and _expected is set to False
        """
        with dMonDateLockOne(self._dbcon) as _qry:
            ...
            while _dex >= 0:
                try:
                    ...
                    if not await _qry.fetch():
                        ...
                        raise mettle.lib.xMettle("LockOne failed to return a record (dMonDate)")
                    ...
                    if _dex == 0:
                        raise mettle.lib.xMettle("Could not lock MonDate record after %d attempt(s) at %d mili second intervals!" % (
