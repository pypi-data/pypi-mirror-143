...
from autodidaqt.instrument.spec import AxisSpecification, MockDriver
...
class MockImageDetector(ManagedInstrument):
    ...
    Various utility mocks are available in autodidaqt.mock as well.
