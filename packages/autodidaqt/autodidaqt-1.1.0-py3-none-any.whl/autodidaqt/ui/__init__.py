...
from autodidaqt.ui.lens import Lens
from autodidaqt.widgets import *
...
def layout_dataclass(
    dataclass_cls: type, prefix: Optional[str] = None, submit: Optional[str] = None
) -> QWidget:
    ...
    Args:
        dataclass_cls: The class definition for the field under layout.
        prefix: UI ID prefix. If none is provided, the dataclass name will be used instead.
        submit: An observable used to trigger UI -> data sync.
