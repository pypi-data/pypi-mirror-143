...
class CustomEntitiesApi(object):
    ...
    def upsert_custom_entity(self, entity_type, custom_entity_request, **kwargs):  # noqa: E501
        ...
        :param entity_type: The type of the CustomEntity to be created. An entityType can be created using the \"CreateCustomEntityDefinition\" endpoint for CustomEntityDefinitions. (required)
        :type entity_type: str
