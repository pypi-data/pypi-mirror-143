...
class CustomEntityDefinitionsApi(object):
    ...
    def create_custom_entity_definition(self, custom_entity_definition_request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] CreateCustomEntityDefinition: Define a new custom entityType.  # noqa: E501

        The API will return a Bad Request if the custom entityType already exists.  # noqa: E501
        ...
        :param custom_entity_definition_request: The payload containing the description of the custom entityType. (required)
    ...
    def get_definition(self, entity_type, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetDefinition: Get a custom entityType definition.  # noqa: E501
