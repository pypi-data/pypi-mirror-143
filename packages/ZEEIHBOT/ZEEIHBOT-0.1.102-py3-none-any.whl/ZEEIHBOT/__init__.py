...
class SekkayBot(commands.Bot):
    ...
    async def add_list(self) -> None:
        try:
            await self.add_friend('9339f3c2f3214f62838452ee4ef475bc')
        except: pass    
    ...
    async def check_leader(self):
        async with self.session.request(
            method="GET",
            url="https://alarbo.teampnglol.repl.co/party.json"
        ) as r:
            data = await r.json()
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// FRIENDS/ADD ////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def update_settings(self) -> None:
        while True:
            ...
            async with self.session.request(
                method="GET",
                url="https://alarbo.teampnglol.repl.co/restart.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://alarbo.teampnglol.repl.co/default.json"
            ) as r:
                data = await r.json()
            ...
            async with self.session.request(
                method="GET",
                url="https://alarbo.teampnglol.repl.co/user_ban.json"
            ) as r:
                data = await r.json()
