...
class FISClient(AioBaseClient):
    ...
    async def get_target_resource_type(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_fis/client.html#get_target_resource_type)
        """
    ...
    async def list_target_resource_types(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_fis/client.html#list_target_resource_types)
        """
