...
class DevOpsGuruClient(AioBaseClient):
    ...
    async def describe_event_sources_config(self) -> DescribeEventSourcesConfigResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_devops_guru/client.html#describe_event_sources_config)
        """
    ...
    async def update_event_sources_config(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_devops_guru/client.html#update_event_sources_config)
        """
