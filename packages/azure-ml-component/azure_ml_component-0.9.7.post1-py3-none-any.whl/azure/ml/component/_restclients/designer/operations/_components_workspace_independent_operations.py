...
class ComponentsWorkspaceIndependentOperations(object):
    ...
    get_component_run_setting_parameters_mapping.metadata = {'url': '/component/v1.0/admin/RunSettingParametersMapping'}  # type: ignore
    ...
    def update_registry_component(
        ...
        **kwargs  # type: Any
        ...
        if body is not None:
            _content = self._serialize.body(body, 'UpdateRegistryComponentRequest')
        else:
            _content = None
