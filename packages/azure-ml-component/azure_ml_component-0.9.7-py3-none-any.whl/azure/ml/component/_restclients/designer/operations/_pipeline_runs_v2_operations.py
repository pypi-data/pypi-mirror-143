...
def build_get_pipeline_run_graph_no_status_request(
    ...
    **kwargs  # type: Any
    ...
    graph_datasets_load_mode_enum = kwargs.pop('graph_datasets_load_mode_enum', None)  # type: Optional[Union[str, "_models.GraphDatasetsLoadModeEnum"]]
...
class PipelineRunsV2Operations(object):
    ...
    def get_pipeline_run_graph_no_status(
        ...
        graph_datasets_load_mode_enum=None,  # type: Optional[Union[str, "_models.GraphDatasetsLoadModeEnum"]]
        **kwargs  # type: Any
    ):
        ...
        :type graph_datasets_load_mode_enum: str or ~designer.models.GraphDatasetsLoadModeEnum
    ...
    cancel_pipeline_run.metadata = {'url': '/studioservice/apiv2/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/PipelineRuns/{pipelineRunId}'}  # type: ignore
