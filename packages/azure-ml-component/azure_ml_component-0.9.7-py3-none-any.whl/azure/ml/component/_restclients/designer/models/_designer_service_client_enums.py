...
class Framework(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    ...
    PY_TORCH = "PyTorch"
    TENSOR_FLOW_PARAMETER_SERVER = "TensorFlowParameterServer"
    PYTHON_MPI = "PythonMpi"
    PYTHON_INTEL_MPI = "PythonIntelMpi"
...
class GraphDatasetsLoadModeEnum(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
