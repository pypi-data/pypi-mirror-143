...
def print_info() -> None:
    ...
    """
    print(
        "Type annotations for aiobotocore.Route53RecoveryControlConfig 2.2.0\nVersion:        "
        " 2.2.0\nBuilder version: 7.4.0\nDocs:           "
        " https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_route53_recovery_control_config//\nBoto3"
        " docs:     "
