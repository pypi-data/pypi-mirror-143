...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.MigrationHubStrategyRecommendations 2.2.0 service"
        " generated with mypy-boto3-builder 7.4.1"
    ),
    classifiers=[
    ...
    keywords=(
        "aiobotocore migrationhubstrategy type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
