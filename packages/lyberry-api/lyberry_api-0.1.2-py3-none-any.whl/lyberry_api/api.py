...
class LBRY_Api():
    ...
    def claim_to_object(self, claim):
        ...
        if claim['value_type'] == 'repost':
            if 'reposted_claim' in claim:
                return self.claim_to_object(claim['reposted_claim'])
            else:
    ...
    def lbrynet_search_feed(self, name: str = "", text: str = "", page_size: int = 20):
