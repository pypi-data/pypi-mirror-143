...
[boto3.EC2InstanceConnect 1.21.23](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2-instance-connect.html#EC2InstanceConnect)
...
```python
from mypy_boto3_ec2_instance_connect.literals import (
...
[boto3 docs](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_ec2_instance_connect/)
