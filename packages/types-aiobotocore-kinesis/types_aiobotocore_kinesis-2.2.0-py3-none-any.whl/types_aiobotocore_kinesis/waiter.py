...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_kinesis/waiters.html)
...
class StreamExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_kinesis/waiters.html#streamexistswaiter)
    """
...
class StreamNotExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_kinesis/waiters.html#streamnotexistswaiter)
    """
