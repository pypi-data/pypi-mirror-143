...
class ModelNet40(Dataset):
    def __init__(
        ...
        Args:
            ...
            split: The required split. Available splits are:
                ...
                - "val", the validation split extracted from the full training set.
                - "train_no_val", the training set without the validation split.
            transforms: The list of transforms to apply to pcds. Defaults to [].
        """
        super().__init__()

        assert split in ["train_no_val", "val", "train", "test"]
        self.split = split
    ...
    def get_h5_files_from_split(self, split: str) -> List[str]:
        ...
        """
        files = {
            "train": ["train_no_val.h5", "val.h5"],
            "train_no_val": ["train_no_val.h5"],
            "val": ["val.h5"],
