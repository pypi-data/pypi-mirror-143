...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html)
...
class HealthLakeClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#can_paginate)
        """
    ...
    async def create_fhir_datastore(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#create_fhir_datastore)
        """
    ...
    async def delete_fhir_datastore(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#delete_fhir_datastore)
        """
    ...
    async def describe_fhir_datastore(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#describe_fhir_datastore)
        """
    ...
    async def describe_fhir_export_job(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#describe_fhir_export_job)
        """
    ...
    async def describe_fhir_import_job(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#describe_fhir_import_job)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#generate_presigned_url)
        """
    ...
    async def list_fhir_datastores(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#list_fhir_datastores)
        """
    ...
    async def list_fhir_export_jobs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#list_fhir_export_jobs)
        """
    ...
    async def list_fhir_import_jobs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#list_fhir_import_jobs)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#list_tags_for_resource)
        """
    ...
    async def start_fhir_export_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#start_fhir_export_job)
        """
    ...
    async def start_fhir_import_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#start_fhir_import_job)
        """
    ...
    async def tag_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceARN: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_healthlake/client.html#untag_resource)
        """
