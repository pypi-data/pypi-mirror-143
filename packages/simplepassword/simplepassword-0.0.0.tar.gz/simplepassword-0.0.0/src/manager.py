...
from .password_manager_error import *
...
class PasswordManager:
    def __init__(self, secret_password: str, default_pass_len: int = 32):
        ...
        self._secret_storage: tp.Dict[str, bytes] = {}
    ...
    @staticmethod
    def _hash(obj: tp.Union[str, bytes]) -> str:
    ...
    def generate_password(self, pass_len: tp.Optional[int] = None) -> str:
