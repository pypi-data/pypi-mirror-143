...
# 
#from genie. import 
#from genie..util.schemaengine import Schema, Any, Optional
...
# ===================================
class ShowIpInterfaceVrfAllSchema():
...
# ===================================
class ShowVrfAllInterfaceSchema():
    """Schema for show vrf all interface
    schema = {
        Any():
            {'vrf': str,
...
# ======================================
class ShowInterfaceSwitchportSchema():
    """Schema for show interface switchport
...
# ========================================
class ShowIpv6InterfaceVrfAllSchema():
    """Schema for show ipv6 interface vrf all
...
# =================================
class ShowInterfaceBriefSchema():
    """Schema for show interface brief
...
# ============================================
class ShowIpInterfaceBriefVrfAllSchema():
    """Schema for show ip interface brief vrf all
    schema = {
        'interface': {
            Any(): {
...
# ============================================
class ShowIpInterfaceBriefVrfAll():
    """Parser for show ip interface brief vrf all"""
...
class ShowInterfaceDescriptionSchema():
    """schema for show interface description
...
class ShowInterfaceStatusSchema():
...
# ========================================
class ShowInterfaceCapabilitiesSchema():
    """Schema for show interface capabilities
...
class ShowInterfaceCapabilities():
...
# ========================================
class ShowInterfaceTransceiverSchema():
    """Schema for show interface transceiver
...
class ShowInterfaceTransceiver():
...
# ================================================
class ShowInterfaceTransceiverDetailsSchema():
    """Schema for show interface transceiver details
...
class ShowInterfaceTransceiverDetails():
...
# ========================================
class ShowInterfaceHardwareMapSchema():
    """Schema for show interface hardware-mappings
...
class ShowInterfaceHardwareMap():
    """Parser for show interface hardware-mappings """
