...
class NapariSTPT:
    ...
    def Load(self, text):
        ...
        try:
            ...
            ) + str(self.comboBoxPath.currentText())+'/mos.zarr', consolidated=False)
            print("not trying consolidated")

            #for _t in list(self.ds1):
            #    print(_t.attrs['offsets']['x'])
        ...
        #print(self.ds1['S001'].attrs['raw_meta'])
        #print(json.loads(self.ds1['S001'].attrs['raw_meta'])['zres'])
        ...
        #print(json.loads(self.ds1['S001'].attrs['raw_meta'][0][0]['zres']))
        ...
        if self.old_method:
            ...
            #print(self.ds1['S001'].attrs['thickness'])
            ...
            # print(self.ds1.attrs.keys())
            #print("self.ds1['S001'].attrs['offsets']")
            #print(self.ds1['S001'].attrs['offsets'])
            #print(float(json.loads(self.ds1['S001'].attrs['scale'])["x"]))
            #print(json.loads(self.ds1['S001'].attrs['offset']))
            #print("self.ds1['S002'].attrs")
            #print(self.ds1['S002'].attrs)
            #print("self.ds1.keys()")
            #print(self.ds1.keys()["Coordinates"])
            #print(self.ds1['S001'].attrs['offsets']['x'])
            #print(self.ds1['S001'].attrs['offsets']['y'])
            #print(self.ds1['S002'].attrs['offsets']['x'])
            #print(self.ds1['S002'].attrs['offsets']['y'])
            ...
            for z in range(0, number_of_section):
                ...
                #print(self.ds1[slice_name].attrs['offsets']['x'])
                #print(self.ds1[slice_name].attrs['offsets']['y'])
        ...
        print(f"self.corrected_align_x values length: {len(self.corrected_align_x)}")
        print(f"self.corrected_align_y values length: {len(self.corrected_align_y)}")
