...
class PGS3CH:
    ...
    def sync_tables(self, tables_to_exclude=None):
        ...
        tables_to_remove = [t for t in tables_ch if t not in tables_pg]
        return tables_to_remove, tables_pg
    ...
    def save_sync_tables(self, client_description, save_table_name, tables_to_exclude):
        ...
        :return:
        """
        tables_to_remove, tables_pg = self.sync_tables(tables_to_exclude=tables_to_exclude)
        new_tables = []
