...
def check_criticality(parent_task, child_task, task_workflow):
    ...
    for current_task in task_workflow:
        ...
        if (parent_task_criticality is not None) and (child_task_criticality is not None):
            ...
            if ((parent_task_criticality == "warning") or (parent_task_criticality == "transparent")) and (child_task_criticality == "critical"):
                print("")
...
"""
    ...
    #for item in tasks_to_process:
        ...
        try:
            ...
            if task_criticality not in ["critical", "warning", "transparent"]:
...
"""
        ...
        output_payload += """
    try:
        ret, account, environment, dag_init_status = initialize(dag_run_id=dag_run_id, firestore_com_id=firestore_com_id)
...
def process(
    ...
    for item in json_payload["workflow"]:
        ...
        try:
            ...
            json_payload["workflow"][index]["task_type"] = task_type
