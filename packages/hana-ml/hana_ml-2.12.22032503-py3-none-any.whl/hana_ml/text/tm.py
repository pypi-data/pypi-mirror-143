...
def tf_analysis(data, lang=None):
    ...
    lang : str, optional
        Specify the language type. HANA cloud instance currently supports 'EN' and 'DE'. If None, it will do the auto detection.
...
def text_classification(pred_data, ref_data=None, k_nearest_neighbours=None, thread_ratio=None, lang=None, index_name=None, created_index=None):
    """
