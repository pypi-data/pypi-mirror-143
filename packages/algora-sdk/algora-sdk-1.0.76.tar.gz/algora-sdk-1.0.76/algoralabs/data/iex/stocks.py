from algoralabs.data.iex.utils import __base_request
...
@data_request
def historical_prices(symbol: str, **kwargs):
    """
    ...
    return __base_request(f"time-series/HISTORICAL_PRICES/{symbol}", **params)


@data_request
def news(symbol: str, **kwargs):
    """
