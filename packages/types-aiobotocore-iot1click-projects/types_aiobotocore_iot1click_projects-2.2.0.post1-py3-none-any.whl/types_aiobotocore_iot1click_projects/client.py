...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html)
...
class IoT1ClickProjectsClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#exceptions)
        """
    ...
    async def associate_device_with_placement(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#associate_device_with_placement)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#can_paginate)
        """
    ...
    async def create_placement(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#create_placement)
        """
    ...
    async def create_project(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#create_project)
        """

    async def delete_placement(self, *, placementName: str, projectName: str) -> Dict[str, Any]:
        """
        Deletes a placement.
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#delete_placement)
        """

    async def delete_project(self, *, projectName: str) -> Dict[str, Any]:
        """
        Deletes a project.
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#delete_project)
        """
    ...
    async def describe_placement(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#describe_placement)
        """
    ...
    async def describe_project(self, *, projectName: str) -> DescribeProjectResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#describe_project)
        """
    ...
    async def disassociate_device_from_placement(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#disassociate_device_from_placement)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#generate_presigned_url)
        """
    ...
    async def get_devices_in_placement(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#get_devices_in_placement)
        """
    ...
    async def list_placements(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#list_placements)
        """
    ...
    async def list_projects(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#list_projects)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#list_tags_for_resource)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#untag_resource)
        """
    ...
    async def update_placement(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#update_placement)
        """
    ...
    async def update_project(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#update_project)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_placements"]) -> ListPlacementsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_projects/client.html#get_paginator)
        """
