...
def get_provider_info():
    return {
        ...
        'additional-dependencies': ['pypsrp>=0.8.0'],
        'integrations': [
            {
        ...
        'operators': [
            {
                'integration-name': 'Windows PowerShell Remoting Protocol',
                'python-modules': ['airflow.providers.microsoft.psrp.operators.psrp'],
            }
        ],
        'hooks': [
            {
                'integration-name': 'Windows PowerShell Remoting Protocol',
                'python-modules': ['airflow.providers.microsoft.psrp.hooks.psrp'],
            }
        ],
    }
