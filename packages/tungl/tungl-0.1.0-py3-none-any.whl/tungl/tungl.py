...
#-------------------------------------------------------------------------------
def debug(msg: str, file: str = '', line: int = 0):	log(Level.DEBUG, msg, file, line)
def error(msg: str, file: str = '', line: int = 0):	log(Level.ERROR, msg, file, line)
def info (msg: str, file: str = '', line: int = 0):	log(Level.INFO,  msg, file, line)
def trace(msg: str, file: str = '', line: int = 0):	log(Level.TRACE, msg, file, line)
def warn (msg: str, file: str = '', line: int = 0):	log(Level.WARN,  msg, file, line)
