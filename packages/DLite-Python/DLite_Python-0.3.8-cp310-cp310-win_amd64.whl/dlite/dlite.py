...
class Property(object):
    ...
    def __init__(self, name: "char const *", type: "char const *", dims: "obj_t *"=None, unit: "char const *"=None, description: "char const *"=None):
        r"""
        __init__(self, name, type, dims=None, unit=None, description=None) -> Property
        Creates a new property.
        ...
        """
        _dlite.Property_swiginit(self, _dlite.new_Property(name, type, dims, unit, description))
...
class Instance(object):
    ...
    def __init__(self, metaid: "char const *"=None, dims: "int *"=None, id: "char const *"=None, url: "char const *"=None, storage: "Storage"=None, driver: "char const *"=None, location: "char const *"=None, options: "char const *"=None, uri: "char const *"=None, jsoninput: "char const *"=None, dimensions: "Dimension"=None, properties: "Property"=None, description: "char const *"=None):
        r"""
        __init__(self, metaid=None, dims=None, id=None, url=None, storage=None, driver=None, location=None, options=None, uri=None, jsoninput=None, dimensions=None, properties=None, description=None) -> Instance
        Returns a new instance.
        ...
        """
        _dlite.Instance_swiginit(self, _dlite.new_Instance(metaid, dims, id, url, storage, driver, location, options, uri, jsoninput, dimensions, properties, description))
    ...
    def tojson(self, indent: "int"=0, flags: "int"=0) -> "char *":
        r"""tojson(self, indent=0, flags=0) -> char *"""
        return _dlite.Instance_tojson(self, indent, flags)
...
def _collection_add_relation(coll: "_Collection", s: "char const *", p: "char const *", o: "char const *") -> "int":
    r"""_collection_add_relation(coll, s, p, o) -> int"""
    return _dlite._collection_add_relation(coll, s, p, o)

def _collection_remove_relations(coll: "_Collection", s: "char const *", p: "char const *", o: "char const *") -> "int":
    r"""_collection_remove_relations(coll, s, p, o) -> int"""
    return _dlite._collection_remove_relations(coll, s, p, o)

def _collection_find_first(coll: "_Collection", s: "char const *", p: "char const *", o: "char const *") -> "struct _Triple const *":
    r"""_collection_find_first(coll, s, p, o) -> Relation"""
    return _dlite._collection_find_first(coll, s, p, o)
...
class _CollectionIter(object):
    ...
    def __init__(self, *args, **kwargs):
        r"""
        __init__(self, inst, s=None, p=None, o=None, rettype='T') -> _CollectionIter
