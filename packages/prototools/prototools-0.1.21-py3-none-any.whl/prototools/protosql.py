...
class ProtoSqlite:
    ...
    """
    __slots__ = "name", "conn", "cursor", "lang"

    def __init__(self, name: str = None, lang: str = None) -> None:
        self.conn = None
        self.cursor = None
    ...
    def get_last(self, table: str, index=None, value=None) -> list:
        try:
    ...
    def _delete(self, table: str, columns: str):
        try:
    ...
    def update(self, table:str, columns: str, condition: str):
        try:
    ...
    def update_(self, table: str, columns: str, condition: str):
        try:
