...
@validate_authentication_token
def ros_completeness(identifier, verbose=False):
    """
    ...
    :rtype: dict
    """
    url = settings.API_URL + f"ros/{identifier}/completness/"
    ...
    if verbose:
        ...
        selected_info = {
            "completeness": content.get("completness"),
            "completeness_calculated_on": content.get("completness_calculated_on"),
