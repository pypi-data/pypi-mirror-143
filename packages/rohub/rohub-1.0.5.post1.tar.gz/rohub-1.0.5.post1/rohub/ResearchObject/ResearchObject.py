...
class ResearchObject(object):
    ...
    def load_full_metadata(self):
        ...
        self.completeness = self.full_metadata_response_content.get("completness")
        self.completeness_calculated_on = self.full_metadata_response_content.get("completness_calculated_on")
        self.completeness_check_report = self.full_metadata_response_content.get("completness_check_report")
    ...
    def completeness(self, verbose=False):
        """
        ...
        :rtype: dict
        """
        return rohub.ros_completeness(identifier=self.identifier, verbose=verbose)
    ...
    def enrich(self):
        ...
        .. warning::
            The enrichment process can take a while, we recommend waiting few minutes
            and then check a job status manually by running a command that was prompted.
