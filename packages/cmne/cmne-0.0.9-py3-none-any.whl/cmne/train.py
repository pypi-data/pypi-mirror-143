...
def train(
    ...
    os.system('mkdir ' + settings.result_path() + 'Results/Models')
    os.system('mkdir ' + settings.result_path() + 'Results/Training')
    os.system('mkdir ' + settings.result_path() + 'Results/img')
