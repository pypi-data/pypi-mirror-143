...
class Settings(object):
    ...
    # Constructor
    ###############################################################################################
    def __init__(self, result_path='/workspace/results/', data_path='/workspace/data/', 
        ...
        # CMNE
        if not os.path.isdir(self._result_path + 'cmne'):
            os.mkdir(self._result_path + 'cmne') 
        self._results_cmne_path = self._result_path + 'cmne'

        if not os.path.isdir(self._result_path + 'cmne/models'):
            os.mkdir(self._result_path + 'cmne/models')
        self._results_models_path = self._result_path + 'cmne/models'

        if not os.path.isdir(self._result_path + 'cmne/logs'):
            os.mkdir(self._result_path + 'cmne/logs')
        self._results_logs_path = self._result_path + 'cmne/logs'
        self._tb_log_dir = self._result_path + 'cmne/logs'

        if not os.path.isdir(self._result_path + 'cmne/training'):
            os.mkdir(self._result_path + 'cmne/training')
        self._results_training_path = self._result_path + 'cmne/training'

        if not os.path.isdir(self._result_path + 'cmne/img'):
            os.mkdir(self._result_path + 'cmne/img')
        self._results_img_path = self._result_path + 'cmne/img'
            
        # source_estimation
        if not os.path.isdir(self._result_path + 'source_estimation'):    
            os.mkdir(self._result_path + 'source_estimation')
        self._results_stc_path = self._result_path + 'source_estimation'
