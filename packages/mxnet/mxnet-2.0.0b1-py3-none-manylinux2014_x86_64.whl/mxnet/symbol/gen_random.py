...
def binomial(n=_Null, p=_Null, shape=_Null, ctx=_Null, dtype=_Null, name=None, attr=None, out=None, **kwargs):
    r"""Draw random samples from a binomial distribution.
    ...
    *n* (number of experiments) and *p* (success probability in each experiment).
    ...
    Defined in ../src/operator/random/sample_op.cc:L166
...
def exponential(lam=_Null, shape=_Null, ctx=_Null, dtype=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/sample_op.cc:L138
...
def exponential_like(data=None, lam=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/sample_op.cc:L263
...
def gamma(alpha=_Null, beta=_Null, shape=_Null, ctx=_Null, dtype=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/sample_op.cc:L126
...
def gamma_like(data=None, alpha=_Null, beta=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/sample_op.cc:L251
...
def generalized_negative_binomial(mu=_Null, alpha=_Null, shape=_Null, ctx=_Null, dtype=_Null, name=None, attr=None, out=None, **kwargs):
...
def generalized_negative_binomial_like(data=None, mu=_Null, alpha=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    *mu* (mean) and *alpha* (dispersion). *alpha* is defined as *1/k* where *k* is the failure limit of the
    ...
    Defined in ../src/operator/random/sample_op.cc:L307
...
def negative_binomial(k=_Null, p=_Null, shape=_Null, ctx=_Null, dtype=_Null, name=None, attr=None, out=None, **kwargs):
...
def negative_binomial_like(data=None, k=_Null, p=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    *k* (limit of unsuccessful experiments) and *p* (failure probability in each experiment).
    ...
    Defined in ../src/operator/random/sample_op.cc:L290
...
def normal_like(data=None, loc=_Null, scale=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/sample_op.cc:L239
...
def pdf_dirichlet(sample=None, alpha=None, is_log=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/pdf_op.cc:L360
...
def pdf_exponential(sample=None, lam=None, is_log=_Null, name=None, attr=None, out=None, **kwargs):
    r"""Computes the value of the PDF of *sample* of
    ...
    Defined in ../src/operator/random/pdf_op.cc:L334
...
def pdf_gamma(sample=None, alpha=None, beta=None, is_log=_Null, name=None, attr=None, out=None, **kwargs):
    r"""Computes the value of the PDF of *sample* of
    ...
    *alpha* and *beta* must have the same shape, which must match the leftmost subshape
    ...
    Defined in ../src/operator/random/pdf_op.cc:L328
...
def pdf_generalized_negative_binomial(sample=None, mu=None, alpha=None, is_log=_Null, name=None, attr=None, out=None, **kwargs):
    r"""Computes the value of the PDF of *sample* of
    ...
    *mu* and *alpha* must have the same shape, which must match the leftmost subshape
    ...
    Defined in ../src/operator/random/pdf_op.cc:L354
...
def pdf_negative_binomial(sample=None, k=None, p=None, is_log=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    *k* and *p* must have the same shape, which must match the leftmost subshape
    ...
    Defined in ../src/operator/random/pdf_op.cc:L347
...
def pdf_normal(sample=None, mu=None, sigma=None, is_log=_Null, name=None, attr=None, out=None, **kwargs):
    r"""Computes the value of the PDF of *sample* of
    ...
    *mu* and *sigma* must have the same shape, which must match the leftmost subshape
    ...
    Defined in ../src/operator/random/pdf_op.cc:L321
...
def pdf_poisson(sample=None, lam=None, is_log=_Null, name=None, attr=None, out=None, **kwargs):
    r"""Computes the value of the PDF of *sample* of
    ...
    Defined in ../src/operator/random/pdf_op.cc:L340
...
def pdf_uniform(sample=None, low=None, high=None, is_log=_Null, name=None, attr=None, out=None, **kwargs):
    r"""Computes the value of the PDF of *sample* of
...
def poisson(lam=_Null, shape=_Null, ctx=_Null, dtype=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/sample_op.cc:L152
...
def poisson_like(data=None, lam=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/sample_op.cc:L276
...
def randint(low=_Null, high=_Null, shape=_Null, ctx=_Null, dtype=_Null, name=None, attr=None, out=None, **kwargs):
...
def uniform(low=_Null, high=_Null, shape=_Null, ctx=_Null, dtype=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/sample_op.cc:L97
...
def uniform_like(data=None, low=_Null, high=_Null, name=None, attr=None, out=None, **kwargs):
    ...
    Defined in ../src/operator/random/sample_op.cc:L226
