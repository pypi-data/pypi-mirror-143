...
setup(
    ...
    install_requires = [],
    entry_points = {
        'console_scripts': ['twc_square=twc_square:get_rules'],
        'console_scripts': ['twc_square=twc_square:get_owl_el_list'],
        'console_scripts': ['twc_square=twc_square:get_owl_ql_list'],
        'console_scripts': ['twc_square=twc_square:get_owl_rl_list'],
        'console_scripts': ['twc_square=twc_square:get_owl_dl_list'],
    },
    classifiers=[
