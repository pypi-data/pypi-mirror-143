            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i593 in range(_size589):
                        _elem594 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.path.append(_elem594)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class deleteStorageGroups_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i600 in range(_size596):
                        _elem601 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.storageGroup.append(_elem601)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.storageGroup is not None:
            ...
            for iter602 in self.storageGroup:
