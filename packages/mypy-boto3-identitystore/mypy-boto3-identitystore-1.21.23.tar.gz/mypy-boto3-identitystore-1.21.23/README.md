...
[boto3.IdentityStore 1.21.23](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/identitystore.html#IdentityStore)
...
def check_value(value: IdentityStoreServiceName) -> bool:
    ...
```
...
[boto3 docs](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_identitystore/)
