...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/paginators.html)
...
class ListPermissionsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/paginators.html#listpermissionspaginator)
    """
...
class ListWorkspacesPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/paginators.html#listworkspacespaginator)
    """
