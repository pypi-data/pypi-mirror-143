...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html)
...
class ManagedGrafanaClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#exceptions)
        """
    ...
    async def associate_license(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#associate_license)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#can_paginate)
        """
    ...
    async def create_workspace(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#create_workspace)
        """
    ...
    async def delete_workspace(self, *, workspaceId: str) -> DeleteWorkspaceResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#delete_workspace)
        """
    ...
    async def describe_workspace(self, *, workspaceId: str) -> DescribeWorkspaceResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#describe_workspace)
        """
    ...
    async def describe_workspace_authentication(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#describe_workspace_authentication)
        """
    ...
    async def disassociate_license(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#disassociate_license)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#generate_presigned_url)
        """
    ...
    async def list_permissions(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#list_permissions)
        """
    ...
    async def list_workspaces(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#list_workspaces)
        """
    ...
    async def update_permissions(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#update_permissions)
        """
    ...
    async def update_workspace(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#update_workspace)
        """
    ...
    async def update_workspace_authentication(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#update_workspace_authentication)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_grafana/client.html#get_paginator)
        """
