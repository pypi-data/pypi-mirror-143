...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudfront/waiters.html)
...
class DistributionDeployedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudfront/waiters.html#distributiondeployedwaiter)
    """
...
class InvalidationCompletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudfront/waiters.html#invalidationcompletedwaiter)
    """
...
class StreamingDistributionDeployedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudfront/waiters.html#streamingdistributiondeployedwaiter)
    """
