...
class EntitySchemaDependencyLink:
    ...
    _type: Union[Unset, EntitySchemaDependencyLinkType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_type() -> Union[Unset, EntitySchemaDependencyLinkType]:
            type = None
            _type = d.pop("type")
        ...
        type = get_type() if "type" in d else cast(Union[Unset, EntitySchemaDependencyLinkType], UNSET)
