...
T = TypeVar("T", bound="CustomEntityUpsert")


@attr.s(auto_attribs=True, repr=False)
class CustomEntityUpsert:
    """  """
    ...
    def __repr__(self):
        ...
        return "CustomEntityUpsert({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_entity_upsert.additional_properties = d
        return custom_entity_upsert
