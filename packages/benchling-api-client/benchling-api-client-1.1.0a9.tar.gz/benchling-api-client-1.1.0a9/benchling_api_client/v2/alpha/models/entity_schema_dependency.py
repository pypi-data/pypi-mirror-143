...
class EntitySchemaDependency:
    ...
    _type: Union[Unset, EntitySchemaDependencyType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_type() -> Union[Unset, EntitySchemaDependencyType]:
            type = None
            _type = d.pop("type")
        ...
        type = get_type() if "type" in d else cast(Union[Unset, EntitySchemaDependencyType], UNSET)
