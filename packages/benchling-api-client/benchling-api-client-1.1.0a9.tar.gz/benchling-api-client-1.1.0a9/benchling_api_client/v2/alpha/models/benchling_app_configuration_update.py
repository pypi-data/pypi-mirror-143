...
T = TypeVar("T", bound="BenchlingAppConfigurationUpdate")


@attr.s(auto_attribs=True, repr=False)
class BenchlingAppConfigurationUpdate:
    """  """
    ...
    def __repr__(self):
        ...
        return "BenchlingAppConfigurationUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
                ...
                def _parse_configuration_item(
                    ...
                    if discriminator_value is not None:
                        ...
                        if discriminator_value == "entity_schema":
                            configuration_item = EntitySchemaDependencyLink.from_dict(data)
        ...
        benchling_app_configuration_update = cls(
            configuration=configuration,
        )

        benchling_app_configuration_update.additional_properties = d
        return benchling_app_configuration_update
