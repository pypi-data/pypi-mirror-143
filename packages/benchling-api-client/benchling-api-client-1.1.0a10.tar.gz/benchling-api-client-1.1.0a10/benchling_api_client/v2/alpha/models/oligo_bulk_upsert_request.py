...
T = TypeVar("T", bound="OligoBulkUpsertRequest")


@attr.s(auto_attribs=True, repr=False)
class OligoBulkUpsertRequest:
    """  """
    ...
    def __repr__(self):
        ...
        return "OligoBulkUpsertRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        oligo_bulk_upsert_request.additional_properties = d
        return oligo_bulk_upsert_request
