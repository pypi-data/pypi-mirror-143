...
from client.main_window_converted import Ui_MainClientWindow
...
class ClientMainWindow(QMainWindow):
    ...
    def set_disabled_input(self):
        self.ui.label_new_message.setText('Для выбора получателя дважды кликните на нём в списке контактов.')
