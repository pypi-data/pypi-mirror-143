...
class IoTWirelessClient(AioBaseClient):
    ...
    async def delete_queued_messages(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotwireless/client.html#delete_queued_messages)
        """
    ...
    async def list_queued_messages(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotwireless/client.html#list_queued_messages)
        """
