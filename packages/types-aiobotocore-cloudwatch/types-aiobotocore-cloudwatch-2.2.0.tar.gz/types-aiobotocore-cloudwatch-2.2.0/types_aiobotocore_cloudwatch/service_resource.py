...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html)
...
class ServiceResourceAlarmsCollection(ResourceCollection):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#serviceresourcealarmscollection)
    """

    async def all(self) -> "ServiceResourceAlarmsCollection":
        """
    ...
    async def limit(self, count: int) -> "ServiceResourceAlarmsCollection":
        """
    ...
    async def page_size(self, count: int) -> "ServiceResourceAlarmsCollection":
        """
    ...
    async def pages(self) -> Iterator[List["Alarm"]]:
        """
    ...
    async def __iter__(self) -> Iterator["Alarm"]:
        """
...
class ServiceResourceMetricsCollection(ResourceCollection):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#serviceresourcemetricscollection)
    """

    async def all(self) -> "ServiceResourceMetricsCollection":
        """
        Get all items from the collection, optionally with a custom page size and item count limit.
    ...
    async def limit(self, count: int) -> "ServiceResourceMetricsCollection":
        """
    ...
    async def page_size(self, count: int) -> "ServiceResourceMetricsCollection":
        """
    ...
    async def pages(self) -> Iterator[List["Metric"]]:
        """
    ...
    async def __iter__(self) -> Iterator["Metric"]:
        """
...
class MetricAlarmsCollection(ResourceCollection):
    async def all(self) -> "MetricAlarmsCollection":
        """
        Get all items from the collection, optionally with a custom page size and item count limit.
        """
    ...
    async def limit(self, count: int) -> "MetricAlarmsCollection":
        """
        Return at most this many Alarms.
        """

    async def page_size(self, count: int) -> "MetricAlarmsCollection":
        """
        Fetch at most this many Alarms per service request.
        """
...
class Alarm(Boto3ServiceResource):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#alarm)
    """
    ...
    async def delete(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#alarmdelete-method)
        """
    ...
    async def describe_history(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#alarmdescribe_history-method)
        """
    ...
    async def disable_actions(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#alarmdisable_actions-method)
        """
    ...
    async def enable_actions(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#alarmenable_actions-method)
        """
    ...
    async def get_available_subresources(self) -> Sequence[str]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#alarmget_available_subresources-method)
        """
    ...
    async def load(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#alarmload-method)
        """
    ...
    async def reload(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#alarmreload-method)
        """
    ...
    async def set_state(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#alarmset_state-method)
        """
...
class Metric(Boto3ServiceResource):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#metric)
    """
    ...
    async def get_available_subresources(self) -> Sequence[str]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#metricget_available_subresources-method)
        """
    ...
    async def get_statistics(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#metricget_statistics-method)
        """
    ...
    async def load(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#metricload-method)
        """
    ...
    async def put_alarm(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#metricput_alarm-method)
        """
    ...
    async def put_data(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#metricput_data-method)
        """
    ...
    async def reload(self) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#metricreload-method)
        """
...
class CloudWatchServiceResource(Boto3ServiceResource):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html)
    """
    ...
    async def Alarm(self, name: str) -> _Alarm:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudwatch.html#CloudWatch.ServiceResource.Alarm)
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#cloudwatchserviceresourcealarm-method)
        """
    ...
    async def Metric(self, namespace: str, name: str) -> _Metric:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudwatch.html#CloudWatch.ServiceResource.Metric)
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#cloudwatchserviceresourcemetric-method)
        """
    ...
    async def get_available_subresources(self) -> Sequence[str]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/service_resource.html#cloudwatchserviceresourceget_available_subresources-method)
        """
