...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/paginators.html)
...
class DescribeAlarmHistoryPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/paginators.html#describealarmhistorypaginator)
    """
...
class DescribeAlarmsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/paginators.html#describealarmspaginator)
    """
...
class GetMetricDataPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/paginators.html#getmetricdatapaginator)
    """
...
class ListDashboardsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/paginators.html#listdashboardspaginator)
    """
...
class ListMetricsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudwatch/paginators.html#listmetricspaginator)
    """
