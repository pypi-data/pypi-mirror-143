...
html_theme_options = {
    "footer_icons": [
        {
            "name": "Codeberg",
            "url": "https://codeberg.org/meadow/pypergraph",
            "html": codeberg_icon_white_svg,
            "class": "only-dark",
        },
        {
            "name": "Codeberg",
            "url": "https://codeberg.org/meadow/pypergraph",
            "html": codeberg_icon_blue_svg,
            "class": "only-light",
        },
    ],
}
