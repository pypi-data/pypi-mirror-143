...
class KinesisClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_kinesis/client.html#exceptions)
        """

    def add_tags_to_stream(self, *, StreamName: str, Tags: Mapping[str, str]) -> None:
        """
    ...
    def remove_tags_from_stream(self, *, StreamName: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def get_paginator(self, operation_name: Literal["describe_stream"]) -> DescribeStreamPaginator:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_kinesis/client.html#get_paginator)
        """
    ...
    def get_waiter(self, waiter_name: Literal["stream_exists"]) -> StreamExistsWaiter:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_kinesis/client.html#get_waiter)
        """
