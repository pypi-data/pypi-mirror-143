...
def get_provider_info():
    return {
        ...
        'operators': [
            {'integration-name': 'Plexus', 'python-modules': ['airflow.providers.plexus.operators.job']}
        ],
        'hooks': [
            {'integration-name': 'Plexus', 'python-modules': ['airflow.providers.plexus.hooks.plexus']}
        ],
    }
