...
class OpsWorksClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_opsworks/client.html#exceptions)
        """

    def assign_instance(self, *, InstanceId: str, LayerIds: Sequence[str]) -> None:
        """
    ...
    def update_volume(self, *, VolumeId: str, Name: str = ..., MountPoint: str = ...) -> None:
        """
    ...
    def get_paginator(
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_opsworks/client.html#get_paginator)
        """
    ...
    def get_waiter(self, waiter_name: Literal["app_exists"]) -> AppExistsWaiter:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_opsworks/client.html#get_waiter)
        """
