...
def main():
    ...
    if len(sys.argv) > 2 and sys.argv[1] == 'run':
        try:
            app = BioLibApp(uri=sys.argv[2], is_run_from_cli=True)
        ...
        parser_lfs_push.add_argument('--chunk-size', type=check_positive, default=50, required=False,
        ...
        if args.command == 'push':
            ...
            push_application(args.app_uri, args.path, app_version_to_copy_images_from=args.copy_images_from_version)
