...
from biolib.biolib_api_client import JobState, Job
...
class BioLibApp:
    ...
    def __init__(self, uri: str, is_run_from_cli=False):
        ...
        self._is_run_from_cli = is_run_from_cli
    ...
    def cli(self, args=None, stdin=None, files=None):
        ...
        try:
            module_output = run_job(job, module_input_serialized, self._is_run_from_cli)
            try:
