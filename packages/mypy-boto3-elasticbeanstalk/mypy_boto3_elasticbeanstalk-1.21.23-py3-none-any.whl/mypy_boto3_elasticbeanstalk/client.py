...
class ElasticBeanstalkClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_elasticbeanstalk/client.html#exceptions)
        """
    ...
    def rebuild_environment(self, *, EnvironmentId: str = ..., EnvironmentName: str = ...) -> None:
        """
    ...
    def restart_app_server(self, *, EnvironmentId: str = ..., EnvironmentName: str = ...) -> None:
        """
    ...
    def get_paginator(
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_elasticbeanstalk/client.html#get_paginator)
        """
    ...
    def get_waiter(self, waiter_name: Literal["environment_exists"]) -> EnvironmentExistsWaiter:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_elasticbeanstalk/client.html#get_waiter)
        """
