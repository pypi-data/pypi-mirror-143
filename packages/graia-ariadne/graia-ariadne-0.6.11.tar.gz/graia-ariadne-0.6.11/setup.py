...
extras_require = \
{'alconna': ['arclet-alconna-graia>=0.0.4,<0.0.5'],
 'full': ['arclet-alconna-graia>=0.0.4,<0.0.5',
          'graia-scheduler>=0.0.6,<0.0.7',
          'graia-saya>=0.0,<0.1',
          'fastapi>=0.74.1,<0.75.0',
          'uvicorn[standard]>=0.17.5,<0.18.0',
          'prompt-toolkit>=3.0.24,<4.0.0'],
 'graia': ['graia-scheduler>=0.0.6,<0.0.7', 'graia-saya>=0.0,<0.1'],
 'server': ['fastapi>=0.74.1,<0.75.0', 'uvicorn[standard]>=0.17.5,<0.18.0'],
 'standard': ['arclet-alconna-graia>=0.0.4,<0.0.5',
              'graia-scheduler>=0.0.6,<0.0.7',
              'graia-saya>=0.0,<0.1',
              'prompt-toolkit>=3.0.24,<4.0.0']}
