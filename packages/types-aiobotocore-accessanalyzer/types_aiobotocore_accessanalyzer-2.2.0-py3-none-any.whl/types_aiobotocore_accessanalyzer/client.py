...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html)
...
class AccessAnalyzerClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#exceptions)
        """
    ...
    async def apply_archive_rule(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#apply_archive_rule)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#can_paginate)
        """
    ...
    async def cancel_policy_generation(self, *, jobId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#cancel_policy_generation)
        """
    ...
    async def create_access_preview(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#create_access_preview)
        """
    ...
    async def create_analyzer(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#create_analyzer)
        """
    ...
    async def create_archive_rule(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#create_archive_rule)
        """

    async def delete_analyzer(self, *, analyzerName: str, clientToken: str = ...) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#delete_analyzer)
        """
    ...
    async def delete_archive_rule(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#delete_archive_rule)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#generate_presigned_url)
        """
    ...
    async def get_access_preview(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#get_access_preview)
        """
    ...
    async def get_analyzed_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#get_analyzed_resource)
        """
    ...
    async def get_analyzer(self, *, analyzerName: str) -> GetAnalyzerResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#get_analyzer)
        """
    ...
    async def get_archive_rule(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#get_archive_rule)
        """
    ...
    async def get_finding(self, *, analyzerArn: str, id: str) -> GetFindingResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#get_finding)
        """
    ...
    async def get_generated_policy(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#get_generated_policy)
        """
    ...
    async def list_access_preview_findings(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#list_access_preview_findings)
        """

    async def list_access_previews(
        self, *, analyzerArn: str, maxResults: int = ..., nextToken: str = ...
    ) -> ListAccessPreviewsResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#list_access_previews)
        """
    ...
    async def list_analyzed_resources(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#list_analyzed_resources)
        """

    async def list_analyzers(
        self, *, maxResults: int = ..., nextToken: str = ..., type: TypeType = ...
    ) -> ListAnalyzersResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#list_analyzers)
        """

    async def list_archive_rules(
        self, *, analyzerName: str, maxResults: int = ..., nextToken: str = ...
    ) -> ListArchiveRulesResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#list_archive_rules)
        """
    ...
    async def list_findings(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#list_findings)
        """

    async def list_policy_generations(
        self, *, maxResults: int = ..., nextToken: str = ..., principalArn: str = ...
    ) -> ListPolicyGenerationsResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#list_policy_generations)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#list_tags_for_resource)
        """
    ...
    async def start_policy_generation(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#start_policy_generation)
        """

    async def start_resource_scan(self, *, analyzerArn: str, resourceArn: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#start_resource_scan)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#untag_resource)
        """
    ...
    async def update_archive_rule(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#update_archive_rule)
        """
    ...
    async def update_findings(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#update_findings)
        """
    ...
    async def validate_policy(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#validate_policy)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_accessanalyzer/client.html#get_paginator)
        """
