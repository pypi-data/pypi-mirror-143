...
class QBluetooth(Shiboken.Object):
    ...
    @overload
    @staticmethod
    def qt_getEnumMetaObject(arg__1:PySide6.QtBluetooth.QBluetooth.AttAccessConstraint) -> PySide6.QtCore.QMetaObject: ...
    @overload
    @staticmethod
    def qt_getEnumMetaObject(arg__1:PySide6.QtBluetooth.QBluetooth.Security) -> PySide6.QtCore.QMetaObject: ...
    @overload
    @staticmethod
    def qt_getEnumName(arg__1:PySide6.QtBluetooth.QBluetooth.AttAccessConstraint) -> bytes: ...
    @overload
    @staticmethod
...
class QBluetoothDeviceInfo(Shiboken.Object):
    ...
    @overload
    def __init__(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid], name:str, classOfDevice:int) -> None: ...
    ...
    def setDeviceUuid(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid]) -> None: ...
...
class QBluetoothServer(PySide6.QtCore.QObject):
    ...
    @overload
    def listen(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid], serviceName:str=...) -> PySide6.QtBluetooth.QBluetoothServiceInfo: ...
...
class QBluetoothServiceDiscoveryAgent(PySide6.QtCore.QObject):
    ...
    @overload
    def setUuidFilter(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid]) -> None: ...
    @overload
...
class QBluetoothServiceInfo(Shiboken.Object):
    ...
    @overload
    def setAttribute(self, attributeId:int, value:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid]) -> None: ...
    ...
    def setServiceUuid(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid]) -> None: ...
...
class QBluetoothSocket(PySide6.QtCore.QIODevice):
    ...
    @overload
    def connectToService(self, address:PySide6.QtBluetooth.QBluetoothAddress, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid], openMode:PySide6.QtCore.QIODeviceBase.OpenMode=...) -> None: ...
    @overload
...
class QBluetoothUuid(PySide6.QtCore.QUuid):
    ...
    def __init__(self, uuid:int) -> None: ...
    @overload
    def __init__(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid]) -> None: ...
...
class QLowEnergyCharacteristic(Shiboken.Object):
    ...
    def descriptor(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid]) -> PySide6.QtBluetooth.QLowEnergyDescriptor: ...
...
class QLowEnergyCharacteristicData(Shiboken.Object):
    ...
    def setUuid(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid]) -> None: ...
...
class QLowEnergyController(PySide6.QtCore.QObject):
    ...
    def createServiceObject(self, service:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid], parent:Optional[PySide6.QtCore.QObject]=...) -> PySide6.QtBluetooth.QLowEnergyService: ...
...
class QLowEnergyDescriptorData(Shiboken.Object):
    ...
    @overload
    def __init__(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid], value:Union[PySide6.QtCore.QByteArray, bytes]) -> None: ...
...
class QLowEnergyService(PySide6.QtCore.QObject):
    ...
    def characteristic(self, uuid:Union[PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, PySide6.QtCore.QUuid]) -> PySide6.QtBluetooth.QLowEnergyCharacteristic: ...
