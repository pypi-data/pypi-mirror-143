...
// Converter indices
enum : int {
    SBK_QTMULTIMEDIA_QLIST_QMEDIATIMERANGE_INTERVAL_IDX      = 0, // QList<QMediaTimeRange::Interval >
    SBK_QTMULTIMEDIA_QLIST_QMEDIAMETADATA_KEY_IDX            = 1, // QList<QMediaMetaData::Key >
    SBK_QTMULTIMEDIA_QHASH_QMEDIAMETADATA_KEY_QVARIANT_IDX   = 2, // QHash<QMediaMetaData::Key,QVariant >
    SBK_QTMULTIMEDIA_QLIST_QMEDIAFORMAT_AUDIOCODEC_IDX       = 3, // QList<QMediaFormat::AudioCodec >
    SBK_QTMULTIMEDIA_QLIST_QMEDIAFORMAT_FILEFORMAT_IDX       = 4, // QList<QMediaFormat::FileFormat >
    SBK_QTMULTIMEDIA_QLIST_QMEDIAFORMAT_VIDEOCODEC_IDX       = 5, // QList<QMediaFormat::VideoCodec >
    SBK_QTMULTIMEDIA_QLIST_QSIZE_IDX                         = 6, // QList<QSize >
    SBK_QTMULTIMEDIA_QLIST_QCAMERAFORMAT_IDX                 = 7, // QList<QCameraFormat >
    SBK_QTMULTIMEDIA_QLIST_QAUDIOFORMAT_SAMPLEFORMAT_IDX     = 8, // QList<QAudioFormat::SampleFormat >
    SBK_QTMULTIMEDIA_QLIST_QOBJECTPTR_IDX                    = 9, // QList<QObject* >
    SBK_QTMULTIMEDIA_QLIST_QBYTEARRAY_IDX                    = 10, // QList<QByteArray >
