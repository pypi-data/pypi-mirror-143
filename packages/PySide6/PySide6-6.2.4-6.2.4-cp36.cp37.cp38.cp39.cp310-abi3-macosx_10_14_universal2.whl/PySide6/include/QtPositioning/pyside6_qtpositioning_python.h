...
// Converter indices
enum : int {
    SBK_QTPOSITIONING_QLIST_QGEOCOORDINATE_IDX               = 0, // QList<QGeoCoordinate >
    SBK_QTPOSITIONING_QMAP_QSTRING_QVARIANT_IDX              = 1, // QMap<QString,QVariant >
    SBK_QTPOSITIONING_QLIST_QVARIANT_IDX                     = 2, // QList<QVariant >
    SBK_QTPOSITIONING_QLIST_QOBJECTPTR_IDX                   = 3, // QList<QObject* >
    SBK_QTPOSITIONING_QLIST_QBYTEARRAY_IDX                   = 4, // QList<QByteArray >
    SBK_QTPOSITIONING_QLIST_QGEOSATELLITEINFO_IDX            = 5, // QList<QGeoSatelliteInfo >
    SBK_QTPOSITIONING_QLIST_QGEOAREAMONITORINFO_IDX          = 6, // QList<QGeoAreaMonitorInfo >
