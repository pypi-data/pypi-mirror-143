...
// Converter indices
enum : int {
    SBK_QT3DINPUT_QLIST_QT3DCORE_QENTITYPTR_IDX              = 0, // QList<Qt3DCore::QEntity* >
    SBK_QT3DINPUT_QLIST_QOBJECTPTR_IDX                       = 1, // QList<QObject* >
    SBK_QT3DINPUT_QLIST_QBYTEARRAY_IDX                       = 2, // QList<QByteArray >
    SBK_QT3DINPUT_QLIST_QT3DINPUT_QACTIONPTR_IDX             = 3, // QList<Qt3DInput::QAction* >
    SBK_QT3DINPUT_QLIST_QT3DINPUT_QAXISPTR_IDX               = 4, // QList<Qt3DInput::QAxis* >
    SBK_QT3DINPUT_QLIST_INT_IDX                              = 5, // QList<int >
