...
// Converter indices
enum : int {
    SBK_QTQUICK3D_QLIST_QQUICK3DOBJECTPTR_IDX                = 0, // QList<QQuick3DObject* >
    SBK_QTQUICK3D_QLIST_QOBJECTPTR_IDX                       = 1, // QList<QObject* >
    SBK_QTQUICK3D_QLIST_QBYTEARRAY_IDX                       = 2, // QList<QByteArray >
