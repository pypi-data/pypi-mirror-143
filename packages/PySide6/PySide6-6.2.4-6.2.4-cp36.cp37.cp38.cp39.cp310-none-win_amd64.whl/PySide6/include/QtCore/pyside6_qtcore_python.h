...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 420,
    ...
    SBK_QFUTUREINTERFACEBASE_STATE_IDX                       = 145,
    SBK_QFUTUREINTERFACEBASE_IDX                             = 144,
    SBK_QGENERICARGUMENT_IDX                                 = 146,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 147,
    SBK_QIODEVICE_IDX                                        = 148,
    SBK_QIODEVICEBASE_OPENMODEFLAG_IDX                       = 150,
    SBK_QFLAGS_QIODEVICEBASE_OPENMODEFLAG_IDX                = 105,
    SBK_QIODEVICEBASE_IDX                                    = 149,
    ...
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 158,
    SBK_QJSONDOCUMENT_IDX                                    = 157,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 160,
    SBK_QJSONPARSEERROR_IDX                                  = 159,
    SBK_QJSONVALUE_TYPE_IDX                                  = 162,
    SBK_QJSONVALUE_IDX                                       = 161,
    SBK_QKEYCOMBINATION_IDX                                  = 163,
    SBK_QLIBRARY_LOADHINT_IDX                                = 165,
    SBK_QFLAGS_QLIBRARY_LOADHINT_IDX                         = 107,
    SBK_QLIBRARY_IDX                                         = 164,
    SBK_QLIBRARYINFO_LIBRARYPATH_IDX                         = 167,
    SBK_QLIBRARYINFO_IDX                                     = 166,
    SBK_QLINE_IDX                                            = 168,
    SBK_QLINEF_INTERSECTIONTYPE_IDX                          = 170,
    SBK_QLINEF_IDX                                           = 169,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 176,
    SBK_QLOCALE_SCRIPT_IDX                                   = 423,
    SBK_QLOCALE_COUNTRY_IDX                                  = 172,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 177,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 175,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 178,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 109,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 174,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 421,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 173,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 108,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 422,
    SBK_QLOCALE_IDX                                          = 171,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 180,
    SBK_QLOCKFILE_IDX                                        = 179,
    SBK_QMARGINS_IDX                                         = 181,
    SBK_QMARGINSF_IDX                                        = 182,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 183,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 184,
    SBK_QMETACLASSINFO_IDX                                   = 185,
    SBK_QMETAENUM_IDX                                        = 186,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 188,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 189,
    SBK_QMETAMETHOD_IDX                                      = 187,
    SBK_QMETAOBJECT_CALL_IDX                                 = 191,
    SBK_QMETAOBJECT_IDX                                      = 190,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 192,
    SBK_QMETAPROPERTY_IDX                                    = 193,
    SBK_QMETATYPE_TYPE_IDX                                   = 195,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 196,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 110,
    SBK_QMETATYPE_IDX                                        = 194,
    SBK_QMIMEDATA_IDX                                        = 197,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 199,
    SBK_QMIMEDATABASE_IDX                                    = 198,
    SBK_QMIMETYPE_IDX                                        = 200,
    SBK_QMODELINDEX_IDX                                      = 201,
    SBK_QMODELROLEDATA_IDX                                   = 202,
    SBK_QMUTEX_IDX                                           = 203,
    SBK_QOBJECT_IDX                                          = 204,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 206,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 205,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 207,
    SBK_QPAUSEANIMATION_IDX                                  = 208,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 209,
    SBK_QPLUGINLOADER_IDX                                    = 210,
    SBK_QPOINT_IDX                                           = 211,
    SBK_QPOINTF_IDX                                          = 212,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 218,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 219,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 216,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 217,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 215,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 214,
    SBK_QPROCESS_IDX                                         = 213,
    SBK_QPROCESSENVIRONMENT_IDX                              = 220,
    SBK_QPROPERTYANIMATION_IDX                               = 221,
    SBK_QRANDOMGENERATOR_IDX                                 = 222,
    SBK_QRANDOMGENERATOR64_IDX                               = 223,
    SBK_QREADLOCKER_IDX                                      = 224,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 226,
    SBK_QREADWRITELOCK_IDX                                   = 225,
    SBK_QRECT_IDX                                            = 227,
    SBK_QRECTF_IDX                                           = 228,
    SBK_QRECURSIVEMUTEX_IDX                                  = 229,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 233,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 112,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 232,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 231,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 111,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 234,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 113,
    SBK_QREGULAREXPRESSION_IDX                               = 230,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 235,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 236,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 238,
    SBK_QRESOURCE_IDX                                        = 237,
    SBK_QRUNNABLE_IDX                                        = 239,
    SBK_QSAVEFILE_IDX                                        = 240,
    SBK_QSEMAPHORE_IDX                                       = 241,
    SBK_QSEMAPHORERELEASER_IDX                               = 242,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 243,
    SBK_QSETTINGS_STATUS_IDX                                 = 247,
    SBK_QSETTINGS_FORMAT_IDX                                 = 245,
    SBK_QSETTINGS_SCOPE_IDX                                  = 246,
    SBK_QSETTINGS_IDX                                        = 244,
    SBK_QSHAREDMEMORY_ACCESSMODE_IDX                         = 249,
    SBK_QSHAREDMEMORY_SHAREDMEMORYERROR_IDX                  = 250,
    SBK_QSHAREDMEMORY_IDX                                    = 248,
    SBK_QSIGNALBLOCKER_IDX                                   = 251,
    SBK_QSIGNALMAPPER_IDX                                    = 252,
    SBK_QSIZE_IDX                                            = 253,
    SBK_QSIZEF_IDX                                           = 254,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 255,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 257,
    SBK_QSOCKETNOTIFIER_IDX                                  = 256,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 258,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 261,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 260,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 114,
    SBK_QSTANDARDPATHS_IDX                                   = 259,
    SBK_QSTORAGEINFO_IDX                                     = 262,
    SBK_QSTRINGCONVERTER_ENCODING_IDX                        = 264,
    SBK_QSTRINGCONVERTER_IDX                                 = 263,
    SBK_QSTRINGCONVERTERBASE_FLAG_IDX                        = 266,
    SBK_QFLAGS_QSTRINGCONVERTERBASE_FLAG_IDX                 = 115,
    SBK_QSTRINGCONVERTERBASE_IDX                             = 265,
    SBK_QSTRINGCONVERTERBASE_STATE_IDX                       = 267,
    SBK_QSTRINGDECODER_IDX                                   = 268,
    SBK_QSTRINGENCODER_IDX                                   = 269,
    SBK_QSTRINGLISTMODEL_IDX                                 = 270,
    SBK_QSYSINFO_SIZES_IDX                                   = 273,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 272,
    SBK_QSYSINFO_IDX                                         = 271,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 275,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 276,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 274,
    SBK_QTEMPORARYDIR_IDX                                    = 277,
    SBK_QTEMPORARYFILE_IDX                                   = 278,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 281,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 280,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 116,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 279,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 285,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 283,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 286,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 284,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 117,
    SBK_QTEXTSTREAM_IDX                                      = 282,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 287,
    SBK_QTHREAD_PRIORITY_IDX                                 = 289,
    SBK_QTHREAD_IDX                                          = 288,
    SBK_QTHREADPOOL_IDX                                      = 290,
    SBK_QTIME_IDX                                            = 291,
    SBK_QTIMELINE_STATE_IDX                                  = 294,
    SBK_QTIMELINE_DIRECTION_IDX                              = 293,
    SBK_QTIMELINE_IDX                                        = 292,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 298,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 296,
    SBK_QTIMEZONE_IDX                                        = 295,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 297,
    SBK_QTIMER_IDX                                           = 299,
    SBK_QTIMEREVENT_IDX                                      = 300,
    SBK_QTRANSLATOR_IDX                                      = 301,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 302,
    SBK_QURL_PARSINGMODE_IDX                                 = 305,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 306,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 304,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 118,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 307,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 120,
    SBK_QURL_IDX                                             = 303,
    SBK_QURLQUERY_IDX                                        = 308,
    SBK_QUUID_VARIANT_IDX                                    = 311,
    SBK_QUUID_VERSION_IDX                                    = 312,
    SBK_QUUID_STRINGFORMAT_IDX                               = 310,
    SBK_QUUID_IDX                                            = 309,
    SBK_QVARIANTANIMATION_IDX                                = 313,
    SBK_QVERSIONNUMBER_IDX                                   = 314,
    SBK_QWAITCONDITION_IDX                                   = 315,
    SBK_QWINEVENTNOTIFIER_IDX                                = 316,
    SBK_QWRITELOCKER_IDX                                     = 317,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 318,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 319,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 320,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 321,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 322,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 323,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 327,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 326,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 325,
    SBK_QXMLSTREAMREADER_IDX                                 = 324,
    SBK_QXMLSTREAMWRITER_IDX                                 = 328,
    SBK_QT_GLOBALCOLOR_IDX                                   = 363,
    SBK_QT_MOUSEBUTTON_IDX                                   = 379,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 134,
    SBK_QT_ORIENTATION_IDX                                   = 384,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 136,
    SBK_QT_FOCUSPOLICY_IDX                                   = 358,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 397,
    SBK_QT_SORTORDER_IDX                                     = 395,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 396,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 138,
    SBK_QT_TILERULE_IDX                                      = 402,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 330,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 121,
    SBK_QT_TEXTFLAG_IDX                                      = 399,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 398,
    SBK_QT_WHITESPACEMODE_IDX                                = 411,
    SBK_QT_HITTESTACCURACY_IDX                               = 365,
    SBK_QT_WINDOWTYPE_IDX                                    = 416,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 143,
    SBK_QT_WINDOWSTATE_IDX                                   = 415,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 142,
    SBK_QT_APPLICATIONSTATE_IDX                              = 333,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 122,
    SBK_QT_SCREENORIENTATION_IDX                             = 389,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 137,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 412,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 332,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 366,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 128,
    SBK_QT_BGMODE_IDX                                        = 337,
    SBK_QT_KEY_IDX                                           = 373,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 374,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 132,
    SBK_QT_MODIFIER_IDX                                      = 378,
    SBK_QT_ARROWTYPE_IDX                                     = 334,
    SBK_QT_PENSTYLE_IDX                                      = 387,
    SBK_QT_PENCAPSTYLE_IDX                                   = 385,
    SBK_QT_PENJOINSTYLE_IDX                                  = 386,
    SBK_QT_BRUSHSTYLE_IDX                                    = 338,
    SBK_QT_SIZEMODE_IDX                                      = 394,
    SBK_QT_UIEFFECT_IDX                                      = 410,
    SBK_QT_CURSORSHAPE_IDX                                   = 347,
    SBK_QT_TEXTFORMAT_IDX                                    = 400,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 335,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 350,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 123,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 351,
    SBK_QT_TOOLBARAREA_IDX                                   = 405,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 140,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 406,
    SBK_QT_DATEFORMAT_IDX                                    = 348,
    SBK_QT_TIMESPEC_IDX                                      = 403,
    SBK_QT_DAYOFWEEK_IDX                                     = 349,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 390,
    SBK_QT_CASESENSITIVITY_IDX                               = 339,
    SBK_QT_CORNER_IDX                                        = 346,
    SBK_QT_EDGE_IDX                                          = 353,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 125,
    SBK_QT_CONNECTIONTYPE_IDX                                = 343,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 392,
    SBK_QT_FILLRULE_IDX                                      = 356,
    SBK_QT_MASKMODE_IDX                                      = 376,
    SBK_QT_CLIPOPERATION_IDX                                 = 342,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 371,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 372,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 409,
    SBK_QT_AXIS_IDX                                          = 336,
    SBK_QT_FOCUSREASON_IDX                                   = 359,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 344,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 368,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 130,
    SBK_QT_INPUTMETHODHINT_IDX                               = 367,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 129,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 354,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 407,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 375,
    SBK_QT_ANCHORPOINT_IDX                                   = 331,
    SBK_QT_FINDCHILDOPTION_IDX                               = 357,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 126,
    SBK_QT_DROPACTION_IDX                                    = 352,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 124,
    SBK_QT_CHECKSTATE_IDX                                    = 340,
    SBK_QT_ITEMDATAROLE_IDX                                  = 369,
    SBK_QT_ITEMFLAG_IDX                                      = 370,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 131,
    SBK_QT_MATCHFLAG_IDX                                     = 377,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 133,
    SBK_QT_WINDOWMODALITY_IDX                                = 414,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 401,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 139,
    SBK_QT_EVENTPRIORITY_IDX                                 = 355,
    SBK_QT_SIZEHINT_IDX                                      = 393,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 413,
    SBK_QT_COORDINATESYSTEM_IDX                              = 345,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 408,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 141,
    SBK_QT_GESTURESTATE_IDX                                  = 361,
    SBK_QT_GESTURETYPE_IDX                                   = 362,
    SBK_QT_GESTUREFLAG_IDX                                   = 360,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 127,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 382,
    SBK_QT_NAVIGATIONMODE_IDX                                = 383,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 424,
    SBK_QT_TIMERTYPE_IDX                                     = 404,
    SBK_QT_SCROLLPHASE_IDX                                   = 391,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 381,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 380,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 135,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 341,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 364,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 388,
    SBK_QtCoreQT_IDX                                         = 329,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 418,
    SBK_QCBORKNOWNTAGS_IDX                                   = 31,
    SBK_QCBORSIMPLETYPE_IDX                                  = 34,
    SBK_QCBORTAG_IDX                                         = 41,
    SBK_QTMSGTYPE_IDX                                        = 419,
    SBK_QtCore_IDX_COUNT                                     = 425
};
...
enum : int {
    ...
    SBK_QPTRDIFF_IDX                                         = 12,
    SBK_QUINTPTR_IDX                                         = 13,
    SBK_QTCORE_QLIST_QXMLSTREAMNAMESPACEDECLARATION_IDX      = 14, // QList<QXmlStreamNamespaceDeclaration >
    SBK_QTCORE_QLIST_QXMLSTREAMENTITYDECLARATION_IDX         = 15, // QList<QXmlStreamEntityDeclaration >
    SBK_QTCORE_QLIST_QXMLSTREAMNOTATIONDECLARATION_IDX       = 16, // QList<QXmlStreamNotationDeclaration >
    SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                 = 17, // QList<QXmlStreamAttribute >
    SBK_QTCORE_QLIST_INT_IDX                                 = 18, // QList<int >
    ...
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 29, // QList<QItemSelectionRange >
    SBK_QTCORE_QLIST_QOBJECTPTR_IDX                          = 30, // QList<QObject* >
    SBK_QTCORE_QLIST_QURL_IDX                                = 31, // QList<QUrl >
    SBK_QTCORE_QLIST_QPOINTF_IDX                             = 32, // QList<QPointF >
