...
// Converter indices
enum : int {
    SBK_QTPRINTSUPPORT_QLIST_QPRINTERINFO_IDX                = 0, // QList<QPrinterInfo >
    SBK_QTPRINTSUPPORT_QLIST_QPRINTER_COLORMODE_IDX          = 1, // QList<QPrinter::ColorMode >
    SBK_QTPRINTSUPPORT_QLIST_QPRINTER_DUPLEXMODE_IDX         = 2, // QList<QPrinter::DuplexMode >
    SBK_QTPRINTSUPPORT_QLIST_QPAGESIZE_IDX                   = 3, // QList<QPageSize >
    SBK_QTPRINTSUPPORT_QLIST_INT_IDX                         = 4, // QList<int >
