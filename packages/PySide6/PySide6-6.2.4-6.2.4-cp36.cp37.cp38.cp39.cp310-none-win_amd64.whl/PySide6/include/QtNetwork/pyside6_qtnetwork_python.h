...
enum : int {
    ...
    SBK_QNETWORKREQUEST_TRANSFERTIMEOUTCONSTANT_IDX          = 82,
    SBK_QNETWORKREQUEST_IDX                                  = 75,
    SBK_QOCSPRESPONSE_IDX                                    = 84,
    SBK_QtNetworkQPASSWORDDIGESTOR_IDX                       = 86,
    SBK_QSSL_KEYTYPE_IDX                                     = 94,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 91,
    SBK_QSSL_KEYALGORITHM_IDX                                = 93,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 90,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 96,
    SBK_QSSL_SSLOPTION_IDX                                   = 95,
    SBK_QFLAGS_QSSL_SSLOPTION_IDX                            = 31,
    SBK_QSSL_ALERTLEVEL_IDX                                  = 88,
    SBK_QSSL_ALERTTYPE_IDX                                   = 89,
    SBK_QSSL_IMPLEMENTEDCLASS_IDX                            = 92,
    SBK_QSSL_SUPPORTEDFEATURE_IDX                            = 97,
    SBK_QtNetworkQSSL_IDX                                    = 87,
    SBK_QSSLCERTIFICATE_SUBJECTINFO_IDX                      = 100,
    SBK_QSSLCERTIFICATE_PATTERNSYNTAX_IDX                    = 99,
    SBK_QSSLCERTIFICATE_IDX                                  = 98,
    SBK_QSSLCERTIFICATEEXTENSION_IDX                         = 101,
    SBK_QSSLCIPHER_IDX                                       = 102,
    SBK_QSSLCONFIGURATION_NEXTPROTOCOLNEGOTIATIONSTATUS_IDX  = 104,
    SBK_QSSLCONFIGURATION_IDX                                = 103,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_ERROR_IDX                = 106,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_IDX                      = 105,
    SBK_QSSLELLIPTICCURVE_IDX                                = 107,
    SBK_QSSLERROR_SSLERROR_IDX                               = 109,
    SBK_QSSLERROR_IDX                                        = 108,
    SBK_QSSLKEY_IDX                                          = 110,
    SBK_QSSLPRESHAREDKEYAUTHENTICATOR_IDX                    = 111,
    SBK_QSSLSOCKET_SSLMODE_IDX                               = 114,
    SBK_QSSLSOCKET_PEERVERIFYMODE_IDX                        = 113,
    SBK_QSSLSOCKET_IDX                                       = 112,
    SBK_QTCPSERVER_IDX                                       = 115,
    SBK_QTCPSOCKET_IDX                                       = 116,
    SBK_QUDPSOCKET_IDX                                       = 117,
    SBK_QDTLSERROR_IDX                                       = 21,
    SBK_QOCSPCERTIFICATESTATUS_IDX                           = 83,
    SBK_QOCSPREVOCATIONREASON_IDX                            = 85,
    SBK_QtNetwork_IDX_COUNT                                  = 118
};
