...
// Converter indices
enum : int {
    SBK_QTSQL_QLIST_QVARIANT_IDX                             = 0, // QList<QVariant >
    SBK_QTSQL_QLIST_INT_IDX                                  = 1, // QList<int >
    ...
    SBK_QTSQL_QHASH_INT_QBYTEARRAY_IDX                       = 5, // QHash<int,QByteArray >
    SBK_QTSQL_QLIST_QSTRING_IDX                              = 6, // QList<QString >
    SBK_QTSQL_QMAP_QSTRING_QVARIANT_IDX                      = 7, // QMap<QString,QVariant >
    SBK_QtSql_CONVERTERS_IDX_COUNT                           = 8
};
