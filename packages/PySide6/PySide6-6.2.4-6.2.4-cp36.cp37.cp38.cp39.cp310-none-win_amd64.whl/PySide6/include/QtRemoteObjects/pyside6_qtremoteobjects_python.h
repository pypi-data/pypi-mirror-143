...
// Converter indices
enum : int {
    SBK_QTREMOTEOBJECTS_QLIST_QOBJECTPTR_IDX                 = 0, // QList<QObject* >
    SBK_QTREMOTEOBJECTS_QLIST_QBYTEARRAY_IDX                 = 1, // QList<QByteArray >
    ...
    SBK_QTREMOTEOBJECTS_QLIST_INT_IDX                        = 5, // QList<int >
    SBK_QTREMOTEOBJECTS_QMAP_INT_QVARIANT_IDX                = 6, // QMap<int,QVariant >
    SBK_QTREMOTEOBJECTS_QLIST_QPERSISTENTMODELINDEX_IDX      = 7, // QList<QPersistentModelIndex >
