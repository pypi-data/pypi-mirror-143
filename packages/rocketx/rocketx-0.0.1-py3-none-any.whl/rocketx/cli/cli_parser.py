...
from rocketx.utils.model_loading import import_string
from rocketx.utils.helpers import partition
...
ARG_YUQUE_API_TOKEN = Arg(
    ('-t', '--token',),
    help=(
        "Your yuque api key, this parameter must be provided if you never configure YuQueAssistant/yuque.cfg."
        "We recommend your to configure api key in YuQueAssistant/yuque.cfg."
    ),
    type=str,
)
...
YUQUE_COMMANDS = (
    ActionCommand(
        ...
        func=lazy_load_command('rocketx.cli.commands.yuque.init'),
        args=(),
    ),
    ActionCommand(
        name='like',
        ...
        func=lazy_load_command('rocketx.cli.commands.yuque.like'),
    ...
    ActionCommand(
        ...
        func=lazy_load_command('rocketx.cli.commands.yuque.follow'),
    ...
    ActionCommand(
        ...
        func=lazy_load_command('rocketx.cli.commands.yuque.unfollow'),
        args=(ARG_YUQUE_SELF_USER, ARG_YUQUE_SELF_PASSWORD),
    ),
    ActionCommand(
        name='comment',
        ...
        func=lazy_load_command('rocketx.cli.commands.yuque.comment'),
        args=(ARG_YUQUE_API_TOKEN, ARG_YUQUE_SELF_USER, ARG_YUQUE_SELF_PASSWORD, ARG_YUQUE_NUM),
    ),
    ActionCommand(
        name='note',
        ...
        func=lazy_load_command('rocketx.cli.commands.yuque.note'),
        args=(ARG_YUQUE_SELF_USER, ARG_YUQUE_SELF_PASSWORD, ARG_YUQUE_NUM),
    ),
    ActionCommand(
        name='search-users',
        help='Search YuQue users',
        func=lazy_load_command('rocketx.cli.commands.yuque.search_users'),
        args=(ARG_YUQUE_SELF_USER, ARG_YUQUE_SELF_PASSWORD, ARG_YUQUE_NUM),
    ),
    ActionCommand(
        name='search-docs',
        help='Search documents of YuQue users',
        func=lazy_load_command('rocketx.cli.commands.yuque.search_docs'),
        args=(ARG_YUQUE_API_TOKEN, ARG_YUQUE_NUM),
    ),
)

rocket_commands: List[CLICommand] = [
    GroupCommand(
        name='yuque',
...
ALL_COMMANDS_DICT: Dict[str, CLICommand] = {sp.name: sp for sp in rocket_commands}


class RocketHelpFormatter(argparse.HelpFormatter):
    """
...
def get_parser(yuque_parser: bool = False) -> argparse.ArgumentParser:
    ...
    parser = DefaultHelpParser(prog="rocket", formatter_class=RocketHelpFormatter)
