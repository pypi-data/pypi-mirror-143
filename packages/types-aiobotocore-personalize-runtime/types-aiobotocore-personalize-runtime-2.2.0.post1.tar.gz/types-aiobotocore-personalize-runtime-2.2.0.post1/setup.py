...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.PersonalizeRuntime 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore personalize-runtime type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
