...
`%df` returns a human readable string in GB. Input is the path to the disk/partition. Default is '~/'.
...
class DfMagics(Magics):
    ...
    @magic_arguments.argument('-p', '--path', default='~/', help='Sets the path to the partition to check')
