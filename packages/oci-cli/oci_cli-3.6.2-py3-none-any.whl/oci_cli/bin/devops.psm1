...
function GetOciSubcommands_devops() {
    $ociSubcommands = @{
        ...
        'devops connection' = 'create-github-connection create-gitlab-connection delete get list update-github-connection update-gitlab-connection'
        ...
        'devops repository' = 'create delete delete-ref get get-commit get-commit-diff get-file-diff get-mirror-record get-object get-object-content get-ref get-repository-archive-content get-repository-file-lines list list-authors list-commit-diffs list-commits list-mirror-records list-refs mirror put-repository-ref-branch-details put-repository-ref-tag-details update'
        'devops repository-path-summary' = 'list-paths'
        'devops trigger' = 'create-devops-code-repo-trigger create-github-trigger create-gitlab-trigger delete get list update-devops-code-repo-trigger update-github-trigger update-gitlab-trigger'
...
function GetOciCommandsToLongParams_devops() {
    $ociCommandsToLongParams = @{
        ...
        'devops build-pipeline-stage create-build-stage' = 'build-pipeline-id build-source-collection build-spec-file defined-tags description display-name freeform-tags from-json help image max-wait-seconds primary-build-source stage-execution-timeout-in-seconds stage-predecessor-collection wait-for-state wait-interval-seconds'
        ...
        'devops build-pipeline-stage update-build-stage' = 'build-source-collection build-spec-file defined-tags description display-name force freeform-tags from-json help if-match image max-wait-seconds primary-build-source stage-execution-timeout-in-seconds stage-id stage-predecessor-collection wait-for-state wait-interval-seconds'
        ...
        'devops trigger create-github-trigger' = 'actions defined-tags description display-name freeform-tags from-json help max-wait-seconds project-id wait-for-state wait-interval-seconds'
        'devops trigger create-gitlab-trigger' = 'actions defined-tags description display-name freeform-tags from-json help max-wait-seconds project-id wait-for-state wait-interval-seconds'
        ...
        'devops trigger update-github-trigger' = 'actions defined-tags description display-name force freeform-tags from-json help if-match max-wait-seconds trigger-id wait-for-state wait-interval-seconds'
        'devops trigger update-gitlab-trigger' = 'actions defined-tags description display-name force freeform-tags from-json help if-match max-wait-seconds trigger-id wait-for-state wait-interval-seconds'
