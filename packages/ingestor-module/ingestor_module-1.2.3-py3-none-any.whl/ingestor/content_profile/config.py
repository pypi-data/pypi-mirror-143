from ingestor.common.constants import CONTENT_ID, YEAR, DURATION_MINUTE, TITLE, STATUS, IS_GEO_BLOCK, IS_FREE, \
    IS_ORIGINAL, IS_BRANDED, IS_EXCLUSIVE, SYNOPSIS, SYNOPSIS_EN, START_DATE, END_DATE, MODIFIED_ON, TYPE, RATING
