...
class AwesomeList(
    ...
    '''(experimental) Awesome List project.
    ...
    def __init__(
        ...
        *,
        ...
        dotnet: typing.Optional[projen.cdk.JsiiDotNetTarget] = None,
        exclude_typescript: typing.Optional[typing.Sequence[builtins.str]] = None,
        publish_to_go: typing.Optional[projen.cdk.JsiiGoTarget] = None,
        publish_to_maven: typing.Optional[projen.cdk.JsiiJavaTarget] = None,
        publish_to_nuget: typing.Optional[projen.cdk.JsiiDotNetTarget] = None,
        publish_to_pypi: typing.Optional[projen.cdk.JsiiPythonTarget] = None,
        python: typing.Optional[projen.cdk.JsiiPythonTarget] = None,
        ...
        '''
        :param contact_email: (experimental) What e-mail address to list for the Code of Conduct Point of Contact. Default: - ``project.authorAddress``
...
@jsii.data_type(
    ...
    jsii_struct_bases=[projen.cdk.JsiiProjectOptions],
    name_mapping={
        "name": "name",
        "logging": "logging",
        "outdir": "outdir",
...
class AwesomeListProjectOptions(projen.cdk.JsiiProjectOptions):
    def __init__(
        self,
        *,
        name: builtins.str,
        ...
        '''(experimental) Configurable knobs for Awesome Lists.
        ...
        if isinstance(dotnet, dict):
            dotnet = projen.cdk.JsiiDotNetTarget(**dotnet)
        if isinstance(publish_to_go, dict):
            publish_to_go = projen.cdk.JsiiGoTarget(**publish_to_go)
        if isinstance(publish_to_maven, dict):
            publish_to_maven = projen.cdk.JsiiJavaTarget(**publish_to_maven)
        if isinstance(publish_to_nuget, dict):
            publish_to_nuget = projen.cdk.JsiiDotNetTarget(**publish_to_nuget)
        if isinstance(publish_to_pypi, dict):
            publish_to_pypi = projen.cdk.JsiiPythonTarget(**publish_to_pypi)
        if isinstance(python, dict):
            python = projen.cdk.JsiiPythonTarget(**python)
    ...
    @builtins.property
    def dotnet(self) -> typing.Optional[projen.cdk.JsiiDotNetTarget]:
        '''
        ...
        return typing.cast(typing.Optional[projen.cdk.JsiiDotNetTarget], result)
    ...
    @builtins.property
    def publish_to_go(self) -> typing.Optional[projen.cdk.JsiiGoTarget]:
        ...
        return typing.cast(typing.Optional[projen.cdk.JsiiGoTarget], result)

    @builtins.property
    def publish_to_maven(self) -> typing.Optional[projen.cdk.JsiiJavaTarget]:
        ...
        return typing.cast(typing.Optional[projen.cdk.JsiiJavaTarget], result)

    @builtins.property
    def publish_to_nuget(self) -> typing.Optional[projen.cdk.JsiiDotNetTarget]:
    ...
    @builtins.property
    def publish_to_pypi(self) -> typing.Optional[projen.cdk.JsiiPythonTarget]:
        ...
        return typing.cast(typing.Optional[projen.cdk.JsiiPythonTarget], result)

    @builtins.property
    def python(self) -> typing.Optional[projen.cdk.JsiiPythonTarget]:
        '''
    ...
    def contact_email(self) -> typing.Optional[builtins.str]:
        '''(experimental) What e-mail address to list for the Code of Conduct Point of Contact.
