...
class KinesisAnalyticsV2Client(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_kinesisanalyticsv2/client.html#exceptions)
        """
    ...
    def stop_application(self, *, ApplicationName: str, Force: bool = ...) -> Dict[str, Any]:
        """
    ...
    def get_paginator(
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_kinesisanalyticsv2/client.html#get_paginator)
        """
