...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html)
...
class PinpointSMSVoiceClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#can_paginate)
        """
    ...
    async def create_configuration_set(self, *, ConfigurationSetName: str = ...) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#create_configuration_set)
        """
    ...
    async def create_configuration_set_event_destination(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#create_configuration_set_event_destination)
        """
    ...
    async def delete_configuration_set(self, *, ConfigurationSetName: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#delete_configuration_set)
        """
    ...
    async def delete_configuration_set_event_destination(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#delete_configuration_set_event_destination)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#generate_presigned_url)
        """
    ...
    async def get_configuration_set_event_destinations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#get_configuration_set_event_destinations)
        """
    ...
    async def list_configuration_sets(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#list_configuration_sets)
        """
    ...
    async def send_voice_message(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#send_voice_message)
        """
    ...
    async def update_configuration_set_event_destination(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sms_voice/client.html#update_configuration_set_event_destination)
        """
