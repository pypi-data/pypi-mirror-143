...
setup(
    ...
    description=(
        "Type annotations for boto3.CloudFormation 1.21.23 service generated with"
    ...
    keywords="boto3 cloudformation type-annotations boto3-stubs mypy typeshed autocomplete",
