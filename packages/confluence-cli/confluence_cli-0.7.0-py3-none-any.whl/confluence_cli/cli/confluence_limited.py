...
def limit_rate(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if last_access_time != 0.0 and t < MIN_TIME_BETWEEN_CALLS:
            ...
            logger.debug(f"RateBrake: Time since las Confluence API access:  {tick - last_access_time} s : "
...
@base_methods_decorator(deco=limit_rate, regex=r"(post|put|delete|get)", base_class=ConfluenceWrapper)
