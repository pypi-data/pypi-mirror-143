...
class ClientLoop(object):
    ...
    def request_url(self, url, **kwargs):
        ...
        def default_error_predict(result):
            ...
            click.echo("content-Type:{}".format(content_type))
    ...
    def read_serve_list(self, dir):
        ...
        click.echo("dir: [{}],serve, status_code:{} text:{}".format(
            dir, res.status_code, res.text))
        click.echo("dir:[{}],serve, res:  cost:{}".format(
    ...
    def loop(self):
        while 1:
            ...
            click.echo("download cost {}".format(round(end-start, 2)).center(80, " "))
            click.echo("="*80)
            click.echo("sleep {}, {}".format(
