...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html)
...
class STSClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#exceptions)
        """
    ...
    async def assume_role(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#assume_role)
        """
    ...
    async def assume_role_with_saml(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#assume_role_with_saml)
        """
    ...
    async def assume_role_with_web_identity(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#assume_role_with_web_identity)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#can_paginate)
        """
    ...
    async def decode_authorization_message(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#decode_authorization_message)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#generate_presigned_url)
        """
    ...
    async def get_access_key_info(self, *, AccessKeyId: str) -> GetAccessKeyInfoResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#get_access_key_info)
        """
    ...
    async def get_caller_identity(self) -> GetCallerIdentityResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#get_caller_identity)
        """
    ...
    async def get_federation_token(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#get_federation_token)
        """
    ...
    async def get_session_token(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sts/client.html#get_session_token)
        """
