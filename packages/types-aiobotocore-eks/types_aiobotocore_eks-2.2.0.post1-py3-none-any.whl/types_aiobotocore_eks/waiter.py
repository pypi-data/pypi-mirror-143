...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_eks/waiters.html)
...
class AddonActiveWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_eks/waiters.html#addonactivewaiter)
    """
...
class AddonDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_eks/waiters.html#addondeletedwaiter)
    """
...
class ClusterActiveWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_eks/waiters.html#clusteractivewaiter)
    """
...
class ClusterDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_eks/waiters.html#clusterdeletedwaiter)
    """
...
class FargateProfileActiveWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_eks/waiters.html#fargateprofileactivewaiter)
    """
...
class FargateProfileDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_eks/waiters.html#fargateprofiledeletedwaiter)
    """
...
class NodegroupActiveWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_eks/waiters.html#nodegroupactivewaiter)
    """
...
class NodegroupDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_eks/waiters.html#nodegroupdeletedwaiter)
    """
