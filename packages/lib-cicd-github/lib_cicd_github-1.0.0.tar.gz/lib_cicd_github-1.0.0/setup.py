...
long_description = "CI/CD (Continuous Integration / Continuous Delivery) - utils for github actions"
...
setup_kwargs["name"] = "lib_cicd_github"
setup_kwargs["version"] = "v1.0.0"
setup_kwargs["url"] = "https://github.com/bitranox/lib_cicd_github"
setup_kwargs["packages"] = find_packages()
setup_kwargs["package_data"] = {"lib_cicd_github": ["py.typed", "*.pyi", "__init__.pyi"]}
setup_kwargs["description"] = "CI/CD (Continuous Integration / Continuous Delivery) - utils for github actions"
...
setup_kwargs["entry_points"] = {"console_scripts": ["lib_cicd_github = lib_cicd_github.lib_cicd_github_cli:cli_main"]}
