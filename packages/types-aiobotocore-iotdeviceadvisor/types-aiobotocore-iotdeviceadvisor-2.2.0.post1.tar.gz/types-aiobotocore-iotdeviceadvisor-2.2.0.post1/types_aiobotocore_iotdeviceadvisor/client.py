...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html)
...
class IoTDeviceAdvisorClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#can_paginate)
        """
    ...
    async def create_suite_definition(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#create_suite_definition)
        """

    async def delete_suite_definition(self, *, suiteDefinitionId: str) -> Dict[str, Any]:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#delete_suite_definition)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#generate_presigned_url)
        """
    ...
    async def get_endpoint(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#get_endpoint)
        """
    ...
    async def get_suite_definition(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#get_suite_definition)
        """
    ...
    async def get_suite_run(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#get_suite_run)
        """
    ...
    async def get_suite_run_report(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#get_suite_run_report)
        """
    ...
    async def list_suite_definitions(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#list_suite_definitions)
        """
    ...
    async def list_suite_runs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#list_suite_runs)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#list_tags_for_resource)
        """
    ...
    async def start_suite_run(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#start_suite_run)
        """

    async def stop_suite_run(self, *, suiteDefinitionId: str, suiteRunId: str) -> Dict[str, Any]:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#stop_suite_run)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#untag_resource)
        """
    ...
    async def update_suite_definition(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iotdeviceadvisor/client.html#update_suite_definition)
        """
