...
@company.command()
@click.option("--ticker", "-k", type=TickerParamType(), required=True, help="Ticker or company name.")
def details(ticker: str) -> None:
    """Get details for a given company.

    Examples:

    `i8 company details MSFT`

    `i8 company details microsoft`
    """
    template = """
# {0}
- Ticker: {1}
- Exchange: {2}
- Sector: {3}
- [https://www.investoreight.com/](https://www.investoreight.com/)
"""
    console = Console()
