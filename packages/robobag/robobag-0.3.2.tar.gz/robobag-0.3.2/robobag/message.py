    ...
    def _to_hive_schema(self, pa_schema):
        def to_hive_type(t):
            if pa.types.is_boolean(t):
                ...
                return "SMALLINT"  # uint8 unsupported in spark, upgrade to int16
            elif pa.types.is_uint16(t):
                return "INT"  # uint16 unsupported in spark, upgrade to int32
            elif pa.types.is_uint32(t):
                return "BIGINT"  # uint32 unsupported in spark, upgrade to int64
