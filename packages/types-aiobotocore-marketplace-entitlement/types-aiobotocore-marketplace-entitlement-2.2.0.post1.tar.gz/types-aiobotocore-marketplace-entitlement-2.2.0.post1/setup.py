...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.MarketplaceEntitlementService 2.2.0 service generated"
        " with mypy-boto3-builder 7.4.1"
    ),
    classifiers=[
    ...
    keywords=(
        "aiobotocore marketplace-entitlement type-annotations boto3-stubs mypy typeshed"
        " autocomplete"
    ),
