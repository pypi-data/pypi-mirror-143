...
def print_info() -> None:
    ...
    """
    print(
        "Type annotations for aiobotocore.MarketplaceEntitlementService 2.2.0\nVersion:        "
        " 2.2.0\nBuilder version: 7.4.0\nDocs:           "
        " https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_entitlement//\nBoto3"
        " docs:     "
