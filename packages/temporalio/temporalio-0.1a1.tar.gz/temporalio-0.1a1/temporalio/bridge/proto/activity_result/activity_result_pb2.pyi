...
class ActivityExecutionResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cancelled",b"cancelled","completed",b"completed","failed",b"failed","status",b"status","will_complete_async",b"will_complete_async"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cancelled",b"cancelled","completed",b"completed","failed",b"failed","status",b"status","will_complete_async",b"will_complete_async"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["status",b"status"]) -> typing.Optional[typing_extensions.Literal["completed","failed","cancelled","will_complete_async"]]: ...
...
class ActivityResolution(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["backoff",b"backoff","cancelled",b"cancelled","completed",b"completed","failed",b"failed","status",b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["backoff",b"backoff","cancelled",b"cancelled","completed",b"completed","failed",b"failed","status",b"status"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["status",b"status"]) -> typing.Optional[typing_extensions.Literal["completed","failed","cancelled","backoff"]]: ...
...
class DoBackoff(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["backoff_duration",b"backoff_duration","original_schedule_time",b"original_schedule_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attempt",b"attempt","backoff_duration",b"backoff_duration","original_schedule_time",b"original_schedule_time"]) -> None: ...
