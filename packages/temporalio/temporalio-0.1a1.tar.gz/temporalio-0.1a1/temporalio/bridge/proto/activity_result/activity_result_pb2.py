...
ActivityExecutionResult = _reflection.GeneratedProtocolMessageType('ActivityExecutionResult', (_message.Message,), {
...
ActivityResolution = _reflection.GeneratedProtocolMessageType('ActivityResolution', (_message.Message,), {
...
WillCompleteAsync = _reflection.GeneratedProtocolMessageType('WillCompleteAsync', (_message.Message,), {
...
DoBackoff = _reflection.GeneratedProtocolMessageType('DoBackoff', (_message.Message,), {
