...
class RegisterNamespaceRequest(google.protobuf.message.Message):
    ...
    @property
    def clusters(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.replication.v1.message_pb2.ClusterReplicationConfig]: ...
    ...
    def __init__(self,
        *,
        ...
        clusters: typing.Optional[typing.Iterable[temporalio.api.replication.v1.message_pb2.ClusterReplicationConfig]] = ...,
        active_cluster_name: typing.Text = ...,
...
class ListNamespacesResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def namespaces(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DescribeNamespaceResponse]: ...
    next_page_token: builtins.bytes
    def __init__(self,
        *,
        namespaces: typing.Optional[typing.Iterable[global___DescribeNamespaceResponse]] = ...,
        next_page_token: builtins.bytes = ...,
        ) -> None: ...
...
class DescribeNamespaceResponse(google.protobuf.message.Message):
    ...
    IS_GLOBAL_NAMESPACE_FIELD_NUMBER: builtins.int
    @property
    def namespace_info(self) -> temporalio.api.namespace.v1.message_pb2.NamespaceInfo: ...
    @property
    def config(self) -> temporalio.api.namespace.v1.message_pb2.NamespaceConfig: ...
    @property
    def replication_config(self) -> temporalio.api.replication.v1.message_pb2.NamespaceReplicationConfig: ...
    failover_version: builtins.int
    is_global_namespace: builtins.bool
    def __init__(self,
        *,
        namespace_info: typing.Optional[temporalio.api.namespace.v1.message_pb2.NamespaceInfo] = ...,
        config: typing.Optional[temporalio.api.namespace.v1.message_pb2.NamespaceConfig] = ...,
        replication_config: typing.Optional[temporalio.api.replication.v1.message_pb2.NamespaceReplicationConfig] = ...,
        failover_version: builtins.int = ...,
        is_global_namespace: builtins.bool = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["config",b"config","namespace_info",b"namespace_info","replication_config",b"replication_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["config",b"config","failover_version",b"failover_version","is_global_namespace",b"is_global_namespace","namespace_info",b"namespace_info","replication_config",b"replication_config"]) -> None: ...
...
class UpdateNamespaceRequest(google.protobuf.message.Message):
    ...
    namespace: typing.Text
    @property
    def update_info(self) -> temporalio.api.namespace.v1.message_pb2.UpdateNamespaceInfo: ...
    @property
    def config(self) -> temporalio.api.namespace.v1.message_pb2.NamespaceConfig: ...
    @property
    def replication_config(self) -> temporalio.api.replication.v1.message_pb2.NamespaceReplicationConfig: ...
    ...
    def __init__(self,
        *,
        namespace: typing.Text = ...,
        update_info: typing.Optional[temporalio.api.namespace.v1.message_pb2.UpdateNamespaceInfo] = ...,
        config: typing.Optional[temporalio.api.namespace.v1.message_pb2.NamespaceConfig] = ...,
        replication_config: typing.Optional[temporalio.api.replication.v1.message_pb2.NamespaceReplicationConfig] = ...,
        security_token: typing.Text = ...,
        delete_bad_binary: typing.Text = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["config",b"config","replication_config",b"replication_config","update_info",b"update_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["config",b"config","delete_bad_binary",b"delete_bad_binary","namespace",b"namespace","promote_namespace",b"promote_namespace","replication_config",b"replication_config","security_token",b"security_token","update_info",b"update_info"]) -> None: ...
...
class DeprecateNamespaceRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace",b"namespace","security_token",b"security_token"]) -> None: ...
...
class StartWorkflowExecutionRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        namespace: typing.Text = ...,
        workflow_id: typing.Text = ...,
        workflow_type: typing.Optional[temporalio.api.common.v1.message_pb2.WorkflowType] = ...,
        task_queue: typing.Optional[temporalio.api.taskqueue.v1.message_pb2.TaskQueue] = ...,
        input: typing.Optional[temporalio.api.common.v1.message_pb2.Payloads] = ...,
        workflow_execution_timeout: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        workflow_run_timeout: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        workflow_task_timeout: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        identity: typing.Text = ...,
        request_id: typing.Text = ...,
        workflow_id_reuse_policy: temporalio.api.enums.v1.workflow_pb2.WorkflowIdReusePolicy.ValueType = ...,
        retry_policy: typing.Optional[temporalio.api.common.v1.message_pb2.RetryPolicy] = ...,
        cron_schedule: typing.Text = ...,
        memo: typing.Optional[temporalio.api.common.v1.message_pb2.Memo] = ...,
        search_attributes: typing.Optional[temporalio.api.common.v1.message_pb2.SearchAttributes] = ...,
        header: typing.Optional[temporalio.api.common.v1.message_pb2.Header] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["header",b"header","input",b"input","memo",b"memo","retry_policy",b"retry_policy","search_attributes",b"search_attributes","task_queue",b"task_queue","workflow_execution_timeout",b"workflow_execution_timeout","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cron_schedule",b"cron_schedule","header",b"header","identity",b"identity","input",b"input","memo",b"memo","namespace",b"namespace","request_id",b"request_id","retry_policy",b"retry_policy","search_attributes",b"search_attributes","task_queue",b"task_queue","workflow_execution_timeout",b"workflow_execution_timeout","workflow_id",b"workflow_id","workflow_id_reuse_policy",b"workflow_id_reuse_policy","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> None: ...
...
class GetWorkflowExecutionHistoryRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        namespace: typing.Text = ...,
        execution: typing.Optional[temporalio.api.common.v1.message_pb2.WorkflowExecution] = ...,
        maximum_page_size: builtins.int = ...,
        next_page_token: builtins.bytes = ...,
        wait_new_event: builtins.bool = ...,
        history_event_filter_type: temporalio.api.enums.v1.workflow_pb2.HistoryEventFilterType.ValueType = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["execution",b"execution","history_event_filter_type",b"history_event_filter_type","maximum_page_size",b"maximum_page_size","namespace",b"namespace","next_page_token",b"next_page_token","skip_archival",b"skip_archival","wait_new_event",b"wait_new_event"]) -> None: ...
...
class GetWorkflowExecutionHistoryResponse(google.protobuf.message.Message):
    ...
    @property
    def raw_history(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.common.v1.message_pb2.DataBlob]:
    ...
    def __init__(self,
        *,
        ...
        raw_history: typing.Optional[typing.Iterable[temporalio.api.common.v1.message_pb2.DataBlob]] = ...,
        next_page_token: builtins.bytes = ...,
        archived: builtins.bool = ...,
        ) -> None: ...
...
class PollWorkflowTaskQueueRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["task_queue",b"task_queue"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["binary_checksum",b"binary_checksum","identity",b"identity","namespace",b"namespace","task_queue",b"task_queue"]) -> None: ...
...
class PollWorkflowTaskQueueResponse(google.protobuf.message.Message):
    ...
    class QueriesEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key: typing.Text = ...,
            value: typing.Optional[temporalio.api.query.v1.message_pb2.WorkflowQuery] = ...,
            ) -> None: ...
    ...
    def query(self) -> temporalio.api.query.v1.message_pb2.WorkflowQuery:
        ...
        pass
    @property
    def workflow_execution_task_queue(self) -> temporalio.api.taskqueue.v1.message_pb2.TaskQueue:
    ...
    def started_time(self) -> google.protobuf.timestamp_pb2.Timestamp:
        ...
        pass
    @property
    def queries(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, temporalio.api.query.v1.message_pb2.WorkflowQuery]:
    ...
    def __init__(self,
        *,
        task_token: builtins.bytes = ...,
        workflow_execution: typing.Optional[temporalio.api.common.v1.message_pb2.WorkflowExecution] = ...,
        workflow_type: typing.Optional[temporalio.api.common.v1.message_pb2.WorkflowType] = ...,
        previous_started_event_id: builtins.int = ...,
        started_event_id: builtins.int = ...,
        attempt: builtins.int = ...,
        ...
        workflow_execution_task_queue: typing.Optional[temporalio.api.taskqueue.v1.message_pb2.TaskQueue] = ...,
        ...
        queries: typing.Optional[typing.Mapping[typing.Text, temporalio.api.query.v1.message_pb2.WorkflowQuery]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["history",b"history","query",b"query","scheduled_time",b"scheduled_time","started_time",b"started_time","workflow_execution",b"workflow_execution","workflow_execution_task_queue",b"workflow_execution_task_queue","workflow_type",b"workflow_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attempt",b"attempt","backlog_count_hint",b"backlog_count_hint","history",b"history","next_page_token",b"next_page_token","previous_started_event_id",b"previous_started_event_id","queries",b"queries","query",b"query","scheduled_time",b"scheduled_time","started_event_id",b"started_event_id","started_time",b"started_time","task_token",b"task_token","workflow_execution",b"workflow_execution","workflow_execution_task_queue",b"workflow_execution_task_queue","workflow_type",b"workflow_type"]) -> None: ...
...
class RespondWorkflowTaskCompletedRequest(google.protobuf.message.Message):
    ...
    class QueryResultsEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key: typing.Text = ...,
            value: typing.Optional[temporalio.api.query.v1.message_pb2.WorkflowQueryResult] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    @property
    def commands(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.command.v1.message_pb2.Command]:
    ...
    @property
    def sticky_attributes(self) -> temporalio.api.taskqueue.v1.message_pb2.StickyExecutionAttributes:
    ...
    @property
    def query_results(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, temporalio.api.query.v1.message_pb2.WorkflowQueryResult]:
    ...
    def __init__(self,
        *,
        task_token: builtins.bytes = ...,
        commands: typing.Optional[typing.Iterable[temporalio.api.command.v1.message_pb2.Command]] = ...,
        identity: typing.Text = ...,
        sticky_attributes: typing.Optional[temporalio.api.taskqueue.v1.message_pb2.StickyExecutionAttributes] = ...,
        return_new_workflow_task: builtins.bool = ...,
        force_create_new_workflow_task: builtins.bool = ...,
        binary_checksum: typing.Text = ...,
        query_results: typing.Optional[typing.Mapping[typing.Text, temporalio.api.query.v1.message_pb2.WorkflowQueryResult]] = ...,
        namespace: typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["sticky_attributes",b"sticky_attributes"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["binary_checksum",b"binary_checksum","commands",b"commands","force_create_new_workflow_task",b"force_create_new_workflow_task","identity",b"identity","namespace",b"namespace","query_results",b"query_results","return_new_workflow_task",b"return_new_workflow_task","sticky_attributes",b"sticky_attributes","task_token",b"task_token"]) -> None: ...
...
class RespondWorkflowTaskCompletedResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_task",b"workflow_task"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["workflow_task",b"workflow_task"]) -> None: ...
...
class RespondWorkflowTaskFailedRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["binary_checksum",b"binary_checksum","cause",b"cause","failure",b"failure","identity",b"identity","namespace",b"namespace","task_token",b"task_token"]) -> None: ...
...
class PollActivityTaskQueueRequest(google.protobuf.message.Message):
    ...
    @property
    def task_queue_metadata(self) -> temporalio.api.taskqueue.v1.message_pb2.TaskQueueMetadata: ...
    def __init__(self,
        *,
        namespace: typing.Text = ...,
        task_queue: typing.Optional[temporalio.api.taskqueue.v1.message_pb2.TaskQueue] = ...,
        identity: typing.Text = ...,
        task_queue_metadata: typing.Optional[temporalio.api.taskqueue.v1.message_pb2.TaskQueueMetadata] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["task_queue",b"task_queue","task_queue_metadata",b"task_queue_metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["identity",b"identity","namespace",b"namespace","task_queue",b"task_queue","task_queue_metadata",b"task_queue_metadata"]) -> None: ...
...
class PollActivityTaskQueueResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        workflow_type: typing.Optional[temporalio.api.common.v1.message_pb2.WorkflowType] = ...,
        workflow_execution: typing.Optional[temporalio.api.common.v1.message_pb2.WorkflowExecution] = ...,
        activity_type: typing.Optional[temporalio.api.common.v1.message_pb2.ActivityType] = ...,
        activity_id: typing.Text = ...,
        header: typing.Optional[temporalio.api.common.v1.message_pb2.Header] = ...,
        input: typing.Optional[temporalio.api.common.v1.message_pb2.Payloads] = ...,
        heartbeat_details: typing.Optional[temporalio.api.common.v1.message_pb2.Payloads] = ...,
        scheduled_time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        current_attempt_scheduled_time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        started_time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        attempt: builtins.int = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["activity_type",b"activity_type","current_attempt_scheduled_time",b"current_attempt_scheduled_time","header",b"header","heartbeat_details",b"heartbeat_details","heartbeat_timeout",b"heartbeat_timeout","input",b"input","retry_policy",b"retry_policy","schedule_to_close_timeout",b"schedule_to_close_timeout","scheduled_time",b"scheduled_time","start_to_close_timeout",b"start_to_close_timeout","started_time",b"started_time","workflow_execution",b"workflow_execution","workflow_type",b"workflow_type"]) -> builtins.bool: ...
...
class RecordActivityTaskHeartbeatRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["details",b"details","identity",b"identity","namespace",b"namespace","task_token",b"task_token"]) -> None: ...
...
class RecordActivityTaskHeartbeatByIdRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["details",b"details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id",b"activity_id","details",b"details","identity",b"identity","namespace",b"namespace","run_id",b"run_id","workflow_id",b"workflow_id"]) -> None: ...
...
class RespondActivityTaskCompletedRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity",b"identity","namespace",b"namespace","result",b"result","task_token",b"task_token"]) -> None: ...
...
class RespondActivityTaskCompletedByIdRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["result",b"result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id",b"activity_id","identity",b"identity","namespace",b"namespace","result",b"result","run_id",b"run_id","workflow_id",b"workflow_id"]) -> None: ...
...
class RespondActivityTaskFailedRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure",b"failure"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failure",b"failure","identity",b"identity","namespace",b"namespace","task_token",b"task_token"]) -> None: ...
...
class RespondActivityTaskFailedByIdRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure",b"failure"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id",b"activity_id","failure",b"failure","identity",b"identity","namespace",b"namespace","run_id",b"run_id","workflow_id",b"workflow_id"]) -> None: ...
...
class RequestCancelWorkflowExecutionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["first_execution_run_id",b"first_execution_run_id","identity",b"identity","namespace",b"namespace","request_id",b"request_id","workflow_execution",b"workflow_execution"]) -> None: ...
...
class SignalWorkflowExecutionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["header",b"header","input",b"input","workflow_execution",b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["control",b"control","header",b"header","identity",b"identity","input",b"input","namespace",b"namespace","request_id",b"request_id","signal_name",b"signal_name","workflow_execution",b"workflow_execution"]) -> None: ...
...
class SignalWithStartWorkflowExecutionRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        workflow_id_reuse_policy: temporalio.api.enums.v1.workflow_pb2.WorkflowIdReusePolicy.ValueType = ...,
        signal_name: typing.Text = ...,
        signal_input: typing.Optional[temporalio.api.common.v1.message_pb2.Payloads] = ...,
        control: typing.Text = ...,
        retry_policy: typing.Optional[temporalio.api.common.v1.message_pb2.RetryPolicy] = ...,
        cron_schedule: typing.Text = ...,
        memo: typing.Optional[temporalio.api.common.v1.message_pb2.Memo] = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["header",b"header","input",b"input","memo",b"memo","retry_policy",b"retry_policy","search_attributes",b"search_attributes","signal_input",b"signal_input","task_queue",b"task_queue","workflow_execution_timeout",b"workflow_execution_timeout","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["control",b"control","cron_schedule",b"cron_schedule","header",b"header","identity",b"identity","input",b"input","memo",b"memo","namespace",b"namespace","request_id",b"request_id","retry_policy",b"retry_policy","search_attributes",b"search_attributes","signal_input",b"signal_input","signal_name",b"signal_name","task_queue",b"task_queue","workflow_execution_timeout",b"workflow_execution_timeout","workflow_id",b"workflow_id","workflow_id_reuse_policy",b"workflow_id_reuse_policy","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> None: ...
...
class ResetWorkflowExecutionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution",b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace",b"namespace","reason",b"reason","request_id",b"request_id","reset_reapply_type",b"reset_reapply_type","workflow_execution",b"workflow_execution","workflow_task_finish_event_id",b"workflow_task_finish_event_id"]) -> None: ...
...
class TerminateWorkflowExecutionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["details",b"details","first_execution_run_id",b"first_execution_run_id","identity",b"identity","namespace",b"namespace","reason",b"reason","workflow_execution",b"workflow_execution"]) -> None: ...
...
class ListOpenWorkflowExecutionsRequest(google.protobuf.message.Message):
    ...
    next_page_token: builtins.bytes
    @property
    def start_time_filter(self) -> temporalio.api.filter.v1.message_pb2.StartTimeFilter: ...
    @property
    def execution_filter(self) -> temporalio.api.filter.v1.message_pb2.WorkflowExecutionFilter: ...
    @property
    def type_filter(self) -> temporalio.api.filter.v1.message_pb2.WorkflowTypeFilter: ...
    def __init__(self,
        *,
        namespace: typing.Text = ...,
        maximum_page_size: builtins.int = ...,
        next_page_token: builtins.bytes = ...,
        start_time_filter: typing.Optional[temporalio.api.filter.v1.message_pb2.StartTimeFilter] = ...,
        execution_filter: typing.Optional[temporalio.api.filter.v1.message_pb2.WorkflowExecutionFilter] = ...,
        type_filter: typing.Optional[temporalio.api.filter.v1.message_pb2.WorkflowTypeFilter] = ...,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["execution_filter",b"execution_filter","filters",b"filters","maximum_page_size",b"maximum_page_size","namespace",b"namespace","next_page_token",b"next_page_token","start_time_filter",b"start_time_filter","type_filter",b"type_filter"]) -> None: ...
...
class ListOpenWorkflowExecutionsResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def executions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.workflow.v1.message_pb2.WorkflowExecutionInfo]: ...
    next_page_token: builtins.bytes
    def __init__(self,
        *,
        executions: typing.Optional[typing.Iterable[temporalio.api.workflow.v1.message_pb2.WorkflowExecutionInfo]] = ...,
        next_page_token: builtins.bytes = ...,
        ) -> None: ...
...
class ListClosedWorkflowExecutionsRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        execution_filter: typing.Optional[temporalio.api.filter.v1.message_pb2.WorkflowExecutionFilter] = ...,
        type_filter: typing.Optional[temporalio.api.filter.v1.message_pb2.WorkflowTypeFilter] = ...,
        status_filter: typing.Optional[temporalio.api.filter.v1.message_pb2.StatusFilter] = ...,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["execution_filter",b"execution_filter","filters",b"filters","maximum_page_size",b"maximum_page_size","namespace",b"namespace","next_page_token",b"next_page_token","start_time_filter",b"start_time_filter","status_filter",b"status_filter","type_filter",b"type_filter"]) -> None: ...
...
class ListWorkflowExecutionsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace",b"namespace","next_page_token",b"next_page_token","page_size",b"page_size","query",b"query"]) -> None: ...
...
class CountWorkflowExecutionsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace",b"namespace","query",b"query"]) -> None: ...
...
class GetSearchAttributesResponse(google.protobuf.message.Message):
    ...
    @property
    def keys(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, temporalio.api.enums.v1.common_pb2.IndexedValueType.ValueType]: ...
    def __init__(self,
        *,
        keys: typing.Optional[typing.Mapping[typing.Text, temporalio.api.enums.v1.common_pb2.IndexedValueType.ValueType]] = ...,
        ) -> None: ...
...
class RespondQueryTaskCompletedRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        task_token: builtins.bytes = ...,
        completed_type: temporalio.api.enums.v1.query_pb2.QueryResultType.ValueType = ...,
        query_result: typing.Optional[temporalio.api.common.v1.message_pb2.Payloads] = ...,
        error_message: typing.Text = ...,
        namespace: typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["query_result",b"query_result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["completed_type",b"completed_type","error_message",b"error_message","namespace",b"namespace","query_result",b"query_result","task_token",b"task_token"]) -> None: ...
...
class ResetStickyTaskQueueRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["execution",b"execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["execution",b"execution","namespace",b"namespace"]) -> None: ...
...
class QueryWorkflowRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["execution",b"execution","query",b"query"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["execution",b"execution","namespace",b"namespace","query",b"query","query_reject_condition",b"query_reject_condition"]) -> None: ...
...
class QueryWorkflowResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        query_result: typing.Optional[temporalio.api.common.v1.message_pb2.Payloads] = ...,
        query_rejected: typing.Optional[temporalio.api.query.v1.message_pb2.QueryRejected] = ...,
        ) -> None: ...
...
class DescribeWorkflowExecutionResponse(google.protobuf.message.Message):
    ...
    @property
    def execution_config(self) -> temporalio.api.workflow.v1.message_pb2.WorkflowExecutionConfig: ...
    @property
    def workflow_execution_info(self) -> temporalio.api.workflow.v1.message_pb2.WorkflowExecutionInfo: ...
    @property
    def pending_activities(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.workflow.v1.message_pb2.PendingActivityInfo]: ...
    @property
    def pending_children(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.workflow.v1.message_pb2.PendingChildExecutionInfo]: ...
    @property
    def pending_workflow_task(self) -> temporalio.api.workflow.v1.message_pb2.PendingWorkflowTaskInfo: ...
    def __init__(self,
        *,
        execution_config: typing.Optional[temporalio.api.workflow.v1.message_pb2.WorkflowExecutionConfig] = ...,
        workflow_execution_info: typing.Optional[temporalio.api.workflow.v1.message_pb2.WorkflowExecutionInfo] = ...,
        pending_activities: typing.Optional[typing.Iterable[temporalio.api.workflow.v1.message_pb2.PendingActivityInfo]] = ...,
        pending_children: typing.Optional[typing.Iterable[temporalio.api.workflow.v1.message_pb2.PendingChildExecutionInfo]] = ...,
        pending_workflow_task: typing.Optional[temporalio.api.workflow.v1.message_pb2.PendingWorkflowTaskInfo] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["execution_config",b"execution_config","pending_workflow_task",b"pending_workflow_task","workflow_execution_info",b"workflow_execution_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["execution_config",b"execution_config","pending_activities",b"pending_activities","pending_children",b"pending_children","pending_workflow_task",b"pending_workflow_task","workflow_execution_info",b"workflow_execution_info"]) -> None: ...
...
class DescribeTaskQueueRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["task_queue",b"task_queue"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["include_task_queue_status",b"include_task_queue_status","namespace",b"namespace","task_queue",b"task_queue","task_queue_type",b"task_queue_type"]) -> None: ...
...
class DescribeTaskQueueResponse(google.protobuf.message.Message):
    ...
    @property
    def pollers(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.taskqueue.v1.message_pb2.PollerInfo]: ...
    @property
    def task_queue_status(self) -> temporalio.api.taskqueue.v1.message_pb2.TaskQueueStatus: ...
    def __init__(self,
        *,
        pollers: typing.Optional[typing.Iterable[temporalio.api.taskqueue.v1.message_pb2.PollerInfo]] = ...,
        task_queue_status: typing.Optional[temporalio.api.taskqueue.v1.message_pb2.TaskQueueStatus] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["task_queue_status",b"task_queue_status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["pollers",b"pollers","task_queue_status",b"task_queue_status"]) -> None: ...
...
class GetClusterInfoResponse(google.protobuf.message.Message):
    ...
    @property
    def supported_clients(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, typing.Text]:
    ...
    def __init__(self,
        *,
        supported_clients: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        server_version: typing.Text = ...,
        cluster_id: typing.Text = ...,
        version_info: typing.Optional[temporalio.api.version.v1.message_pb2.VersionInfo] = ...,
        cluster_name: typing.Text = ...,
        history_shard_count: builtins.int = ...,
        persistence_store: typing.Text = ...,
        visibility_store: typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["version_info",b"version_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id",b"cluster_id","cluster_name",b"cluster_name","history_shard_count",b"history_shard_count","persistence_store",b"persistence_store","server_version",b"server_version","supported_clients",b"supported_clients","version_info",b"version_info","visibility_store",b"visibility_store"]) -> None: ...
...
class GetSystemInfoResponse(google.protobuf.message.Message):
    ...
    class Capabilities(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["internal_error_differentiation",b"internal_error_differentiation","signal_and_query_header",b"signal_and_query_header"]) -> None: ...
    ...
    def __init__(self,
        *,
        server_version: typing.Text = ...,
        capabilities: typing.Optional[global___GetSystemInfoResponse.Capabilities] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["capabilities",b"capabilities"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["capabilities",b"capabilities","server_version",b"server_version"]) -> None: ...
...
class ListTaskQueuePartitionsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["task_queue",b"task_queue"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace",b"namespace","task_queue",b"task_queue"]) -> None: ...
...
class ListTaskQueuePartitionsResponse(google.protobuf.message.Message):
    ...
    @property
    def activity_task_queue_partitions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.taskqueue.v1.message_pb2.TaskQueuePartitionMetadata]: ...
    @property
    def workflow_task_queue_partitions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.taskqueue.v1.message_pb2.TaskQueuePartitionMetadata]: ...
    def __init__(self,
        *,
        activity_task_queue_partitions: typing.Optional[typing.Iterable[temporalio.api.taskqueue.v1.message_pb2.TaskQueuePartitionMetadata]] = ...,
        workflow_task_queue_partitions: typing.Optional[typing.Iterable[temporalio.api.taskqueue.v1.message_pb2.TaskQueuePartitionMetadata]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_task_queue_partitions",b"activity_task_queue_partitions","workflow_task_queue_partitions",b"workflow_task_queue_partitions"]) -> None: ...
