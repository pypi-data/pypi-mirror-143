...
class ApplicationFailureInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["details",b"details","non_retryable",b"non_retryable","type",b"type"]) -> None: ...
...
class TimeoutFailureInfo(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        timeout_type: temporalio.api.enums.v1.workflow_pb2.TimeoutType.ValueType = ...,
        last_heartbeat_details: typing.Optional[temporalio.api.common.v1.message_pb2.Payloads] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["last_heartbeat_details",b"last_heartbeat_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["last_heartbeat_details",b"last_heartbeat_details","timeout_type",b"timeout_type"]) -> None: ...
...
class ServerFailureInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["non_retryable",b"non_retryable"]) -> None: ...
...
class ResetWorkflowFailureInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["last_heartbeat_details",b"last_heartbeat_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["last_heartbeat_details",b"last_heartbeat_details"]) -> None: ...
...
class ActivityFailureInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["activity_type",b"activity_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id",b"activity_id","activity_type",b"activity_type","identity",b"identity","retry_state",b"retry_state","scheduled_event_id",b"scheduled_event_id","started_event_id",b"started_event_id"]) -> None: ...
...
class Failure(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        application_failure_info: typing.Optional[global___ApplicationFailureInfo] = ...,
        ...
        reset_workflow_failure_info: typing.Optional[global___ResetWorkflowFailureInfo] = ...,
        activity_failure_info: typing.Optional[global___ActivityFailureInfo] = ...,
        child_workflow_execution_failure_info: typing.Optional[global___ChildWorkflowExecutionFailureInfo] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["activity_failure_info",b"activity_failure_info","application_failure_info",b"application_failure_info","canceled_failure_info",b"canceled_failure_info","cause",b"cause","child_workflow_execution_failure_info",b"child_workflow_execution_failure_info","failure_info",b"failure_info","reset_workflow_failure_info",b"reset_workflow_failure_info","server_failure_info",b"server_failure_info","terminated_failure_info",b"terminated_failure_info","timeout_failure_info",b"timeout_failure_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_failure_info",b"activity_failure_info","application_failure_info",b"application_failure_info","canceled_failure_info",b"canceled_failure_info","cause",b"cause","child_workflow_execution_failure_info",b"child_workflow_execution_failure_info","failure_info",b"failure_info","message",b"message","reset_workflow_failure_info",b"reset_workflow_failure_info","server_failure_info",b"server_failure_info","source",b"source","stack_trace",b"stack_trace","terminated_failure_info",b"terminated_failure_info","timeout_failure_info",b"timeout_failure_info"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["failure_info",b"failure_info"]) -> typing.Optional[typing_extensions.Literal["application_failure_info","timeout_failure_info","canceled_failure_info","terminated_failure_info","server_failure_info","reset_workflow_failure_info","activity_failure_info","child_workflow_execution_failure_info"]]: ...
