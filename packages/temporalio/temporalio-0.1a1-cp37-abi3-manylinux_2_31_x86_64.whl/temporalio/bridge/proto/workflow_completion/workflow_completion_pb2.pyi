...
class WorkflowActivationCompletion(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failed",b"failed","status",b"status","successful",b"successful"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failed",b"failed","run_id",b"run_id","status",b"status","successful",b"successful"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["status",b"status"]) -> typing.Optional[typing_extensions.Literal["successful","failed"]]: ...
...
class Success(google.protobuf.message.Message):
    ...
    @property
    def commands(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.WorkflowCommand]:
        """A list of commands to send back to the temporal server"""
        pass
    def __init__(self,
        *,
        commands: typing.Optional[typing.Iterable[temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.WorkflowCommand]] = ...,
        ) -> None: ...
