...
class WorkflowExecutionInfo(google.protobuf.message.Message):
    ...
    @property
    def parent_execution(self) -> temporalio.api.common.v1.message_pb2.WorkflowExecution: ...
    @property
    ...
    def __init__(self,
        *,
        ...
        history_length: builtins.int = ...,
        parent_namespace_id: typing.Text = ...,
        parent_execution: typing.Optional[temporalio.api.common.v1.message_pb2.WorkflowExecution] = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["auto_reset_points",b"auto_reset_points","close_time",b"close_time","execution",b"execution","execution_time",b"execution_time","memo",b"memo","parent_execution",b"parent_execution","search_attributes",b"search_attributes","start_time",b"start_time","type",b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["auto_reset_points",b"auto_reset_points","close_time",b"close_time","execution",b"execution","execution_time",b"execution_time","history_length",b"history_length","memo",b"memo","parent_execution",b"parent_execution","parent_namespace_id",b"parent_namespace_id","search_attributes",b"search_attributes","start_time",b"start_time","state_transition_count",b"state_transition_count","status",b"status","task_queue",b"task_queue","type",b"type"]) -> None: ...
...
class WorkflowExecutionConfig(google.protobuf.message.Message):
    ...
    @property
    def default_workflow_task_timeout(self) -> google.protobuf.duration_pb2.Duration: ...
    def __init__(self,
        *,
        ...
        default_workflow_task_timeout: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["default_workflow_task_timeout",b"default_workflow_task_timeout","task_queue",b"task_queue","workflow_execution_timeout",b"workflow_execution_timeout","workflow_run_timeout",b"workflow_run_timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["default_workflow_task_timeout",b"default_workflow_task_timeout","task_queue",b"task_queue","workflow_execution_timeout",b"workflow_execution_timeout","workflow_run_timeout",b"workflow_run_timeout"]) -> None: ...
...
class PendingChildExecutionInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["initiated_id",b"initiated_id","parent_close_policy",b"parent_close_policy","run_id",b"run_id","workflow_id",b"workflow_id","workflow_type_name",b"workflow_type_name"]) -> None: ...
...
class ResetPointInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["binary_checksum",b"binary_checksum","create_time",b"create_time","expire_time",b"expire_time","first_workflow_task_completed_id",b"first_workflow_task_completed_id","resettable",b"resettable","run_id",b"run_id"]) -> None: ...
