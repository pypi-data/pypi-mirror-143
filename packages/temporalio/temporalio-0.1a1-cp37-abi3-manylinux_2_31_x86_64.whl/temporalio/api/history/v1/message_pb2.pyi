...
class WorkflowExecutionStartedEventAttributes(google.protobuf.message.Message):
    ...
    @property
    def parent_workflow_execution(self) -> temporalio.api.common.v1.message_pb2.WorkflowExecution: ...
    ...
    @property
    def prev_auto_reset_points(self) -> temporalio.api.workflow.v1.message_pb2.ResetPoints: ...
    @property
    ...
    def __init__(self,
        *,
        ...
        parent_workflow_namespace: typing.Text = ...,
        parent_workflow_execution: typing.Optional[temporalio.api.common.v1.message_pb2.WorkflowExecution] = ...,
        parent_initiated_event_id: builtins.int = ...,
        ...
        continued_execution_run_id: typing.Text = ...,
        initiator: temporalio.api.enums.v1.workflow_pb2.ContinueAsNewInitiator.ValueType = ...,
        continued_failure: typing.Optional[temporalio.api.failure.v1.message_pb2.Failure] = ...,
        last_completion_result: typing.Optional[temporalio.api.common.v1.message_pb2.Payloads] = ...,
        original_execution_run_id: typing.Text = ...,
        identity: typing.Text = ...,
        first_execution_run_id: typing.Text = ...,
        retry_policy: typing.Optional[temporalio.api.common.v1.message_pb2.RetryPolicy] = ...,
        attempt: builtins.int = ...,
        workflow_execution_expiration_time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        cron_schedule: typing.Text = ...,
        first_workflow_task_backoff: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        ...
        prev_auto_reset_points: typing.Optional[temporalio.api.workflow.v1.message_pb2.ResetPoints] = ...,
        header: typing.Optional[temporalio.api.common.v1.message_pb2.Header] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["continued_failure",b"continued_failure","first_workflow_task_backoff",b"first_workflow_task_backoff","header",b"header","input",b"input","last_completion_result",b"last_completion_result","memo",b"memo","parent_workflow_execution",b"parent_workflow_execution","prev_auto_reset_points",b"prev_auto_reset_points","retry_policy",b"retry_policy","search_attributes",b"search_attributes","task_queue",b"task_queue","workflow_execution_expiration_time",b"workflow_execution_expiration_time","workflow_execution_timeout",b"workflow_execution_timeout","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attempt",b"attempt","continued_execution_run_id",b"continued_execution_run_id","continued_failure",b"continued_failure","cron_schedule",b"cron_schedule","first_execution_run_id",b"first_execution_run_id","first_workflow_task_backoff",b"first_workflow_task_backoff","header",b"header","identity",b"identity","initiator",b"initiator","input",b"input","last_completion_result",b"last_completion_result","memo",b"memo","original_execution_run_id",b"original_execution_run_id","parent_initiated_event_id",b"parent_initiated_event_id","parent_workflow_execution",b"parent_workflow_execution","parent_workflow_namespace",b"parent_workflow_namespace","prev_auto_reset_points",b"prev_auto_reset_points","retry_policy",b"retry_policy","search_attributes",b"search_attributes","task_queue",b"task_queue","workflow_execution_expiration_time",b"workflow_execution_expiration_time","workflow_execution_timeout",b"workflow_execution_timeout","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> None: ...
...
class WorkflowExecutionCompletedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["new_execution_run_id",b"new_execution_run_id","result",b"result","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class WorkflowExecutionFailedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["failure",b"failure","new_execution_run_id",b"new_execution_run_id","retry_state",b"retry_state","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class WorkflowExecutionTimedOutEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["new_execution_run_id",b"new_execution_run_id","retry_state",b"retry_state"]) -> None: ...
...
class WorkflowTaskScheduledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["start_to_close_timeout",b"start_to_close_timeout","task_queue",b"task_queue"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attempt",b"attempt","start_to_close_timeout",b"start_to_close_timeout","task_queue",b"task_queue"]) -> None: ...
...
class WorkflowTaskCompletedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["binary_checksum",b"binary_checksum","identity",b"identity","scheduled_event_id",b"scheduled_event_id","started_event_id",b"started_event_id"]) -> None: ...
...
class WorkflowTaskTimedOutEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["scheduled_event_id",b"scheduled_event_id","started_event_id",b"started_event_id","timeout_type",b"timeout_type"]) -> None: ...
...
class ActivityTaskScheduledEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id",b"activity_id","activity_type",b"activity_type","header",b"header","heartbeat_timeout",b"heartbeat_timeout","input",b"input","namespace",b"namespace","retry_policy",b"retry_policy","schedule_to_close_timeout",b"schedule_to_close_timeout","schedule_to_start_timeout",b"schedule_to_start_timeout","start_to_close_timeout",b"start_to_close_timeout","task_queue",b"task_queue","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class ActivityTaskStartedEventAttributes(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        request_id: typing.Text = ...,
        attempt: builtins.int = ...,
        last_failure: typing.Optional[temporalio.api.failure.v1.message_pb2.Failure] = ...,
        ) -> None: ...
...
class ActivityTaskFailedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure",b"failure"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failure",b"failure","identity",b"identity","retry_state",b"retry_state","scheduled_event_id",b"scheduled_event_id","started_event_id",b"started_event_id"]) -> None: ...
...
class ActivityTaskTimedOutEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure",b"failure"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failure",b"failure","retry_state",b"retry_state","scheduled_event_id",b"scheduled_event_id","started_event_id",b"started_event_id"]) -> None: ...
...
class ActivityTaskCancelRequestedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["scheduled_event_id",b"scheduled_event_id","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class TimerStartedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["start_to_fire_timeout",b"start_to_fire_timeout","timer_id",b"timer_id","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class TimerCanceledEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity",b"identity","started_event_id",b"started_event_id","timer_id",b"timer_id","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class WorkflowExecutionCancelRequestedEventAttributes(google.protobuf.message.Message):
    ...
    @property
    def external_workflow_execution(self) -> temporalio.api.common.v1.message_pb2.WorkflowExecution: ...
    identity: typing.Text
    ...
    def __init__(self,
        *,
        cause: typing.Text = ...,
        external_initiated_event_id: builtins.int = ...,
        external_workflow_execution: typing.Optional[temporalio.api.common.v1.message_pb2.WorkflowExecution] = ...,
        identity: typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["external_workflow_execution",b"external_workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cause",b"cause","external_initiated_event_id",b"external_initiated_event_id","external_workflow_execution",b"external_workflow_execution","identity",b"identity"]) -> None: ...
...
class WorkflowExecutionCanceledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["details",b"details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["details",b"details","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class MarkerRecordedEventAttributes(google.protobuf.message.Message):
    ...
    @property
    def details(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, temporalio.api.common.v1.message_pb2.Payloads]:
    ...
    def __init__(self,
        *,
        marker_name: typing.Text = ...,
        details: typing.Optional[typing.Mapping[typing.Text, temporalio.api.common.v1.message_pb2.Payloads]] = ...,
        workflow_task_completed_event_id: builtins.int = ...,
        header: typing.Optional[temporalio.api.common.v1.message_pb2.Header] = ...,
        failure: typing.Optional[temporalio.api.failure.v1.message_pb2.Failure] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["failure",b"failure","header",b"header"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["details",b"details","failure",b"failure","header",b"header","marker_name",b"marker_name","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class WorkflowExecutionSignaledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["header",b"header","input",b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["header",b"header","identity",b"identity","input",b"input","signal_name",b"signal_name"]) -> None: ...
...
class RequestCancelExternalWorkflowExecutionInitiatedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["child_workflow_only",b"child_workflow_only","control",b"control","namespace",b"namespace","workflow_execution",b"workflow_execution","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class RequestCancelExternalWorkflowExecutionFailedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution",b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cause",b"cause","control",b"control","initiated_event_id",b"initiated_event_id","namespace",b"namespace","workflow_execution",b"workflow_execution","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class ExternalWorkflowExecutionCancelRequestedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution",b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["initiated_event_id",b"initiated_event_id","namespace",b"namespace","workflow_execution",b"workflow_execution"]) -> None: ...
...
class SignalExternalWorkflowExecutionInitiatedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["child_workflow_only",b"child_workflow_only","control",b"control","header",b"header","input",b"input","namespace",b"namespace","signal_name",b"signal_name","workflow_execution",b"workflow_execution","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class ExternalWorkflowExecutionSignaledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution",b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["control",b"control","initiated_event_id",b"initiated_event_id","namespace",b"namespace","workflow_execution",b"workflow_execution"]) -> None: ...
...
class UpsertWorkflowSearchAttributesEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["search_attributes",b"search_attributes","workflow_task_completed_event_id",b"workflow_task_completed_event_id"]) -> None: ...
...
class StartChildWorkflowExecutionInitiatedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["control",b"control","cron_schedule",b"cron_schedule","header",b"header","input",b"input","memo",b"memo","namespace",b"namespace","parent_close_policy",b"parent_close_policy","retry_policy",b"retry_policy","search_attributes",b"search_attributes","task_queue",b"task_queue","workflow_execution_timeout",b"workflow_execution_timeout","workflow_id",b"workflow_id","workflow_id_reuse_policy",b"workflow_id_reuse_policy","workflow_run_timeout",b"workflow_run_timeout","workflow_task_completed_event_id",b"workflow_task_completed_event_id","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> None: ...
...
class StartChildWorkflowExecutionFailedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cause",b"cause","control",b"control","initiated_event_id",b"initiated_event_id","namespace",b"namespace","workflow_id",b"workflow_id","workflow_task_completed_event_id",b"workflow_task_completed_event_id","workflow_type",b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionStartedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["header",b"header","initiated_event_id",b"initiated_event_id","namespace",b"namespace","workflow_execution",b"workflow_execution","workflow_type",b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionCompletedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["initiated_event_id",b"initiated_event_id","namespace",b"namespace","result",b"result","started_event_id",b"started_event_id","workflow_execution",b"workflow_execution","workflow_type",b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionFailedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["failure",b"failure","initiated_event_id",b"initiated_event_id","namespace",b"namespace","retry_state",b"retry_state","started_event_id",b"started_event_id","workflow_execution",b"workflow_execution","workflow_type",b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionCanceledEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["details",b"details","initiated_event_id",b"initiated_event_id","namespace",b"namespace","started_event_id",b"started_event_id","workflow_execution",b"workflow_execution","workflow_type",b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionTimedOutEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["initiated_event_id",b"initiated_event_id","namespace",b"namespace","retry_state",b"retry_state","started_event_id",b"started_event_id","workflow_execution",b"workflow_execution","workflow_type",b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionTerminatedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution",b"workflow_execution","workflow_type",b"workflow_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["initiated_event_id",b"initiated_event_id","namespace",b"namespace","started_event_id",b"started_event_id","workflow_execution",b"workflow_execution","workflow_type",b"workflow_type"]) -> None: ...
...
class HistoryEvent(google.protobuf.message.Message):
    ...
    @property
    def workflow_task_scheduled_event_attributes(self) -> global___WorkflowTaskScheduledEventAttributes: ...
    @property
    def workflow_task_started_event_attributes(self) -> global___WorkflowTaskStartedEventAttributes: ...
    @property
    def workflow_task_completed_event_attributes(self) -> global___WorkflowTaskCompletedEventAttributes: ...
    @property
    def workflow_task_timed_out_event_attributes(self) -> global___WorkflowTaskTimedOutEventAttributes: ...
    @property
    def workflow_task_failed_event_attributes(self) -> global___WorkflowTaskFailedEventAttributes: ...
    @property
    ...
    def __init__(self,
        *,
        ...
        workflow_task_scheduled_event_attributes: typing.Optional[global___WorkflowTaskScheduledEventAttributes] = ...,
        workflow_task_started_event_attributes: typing.Optional[global___WorkflowTaskStartedEventAttributes] = ...,
        workflow_task_completed_event_attributes: typing.Optional[global___WorkflowTaskCompletedEventAttributes] = ...,
        workflow_task_timed_out_event_attributes: typing.Optional[global___WorkflowTaskTimedOutEventAttributes] = ...,
        workflow_task_failed_event_attributes: typing.Optional[global___WorkflowTaskFailedEventAttributes] = ...,
