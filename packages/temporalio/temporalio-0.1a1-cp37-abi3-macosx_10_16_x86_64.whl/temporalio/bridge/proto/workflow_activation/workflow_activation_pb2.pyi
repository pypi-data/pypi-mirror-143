...
class WorkflowActivation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["is_replaying",b"is_replaying","jobs",b"jobs","run_id",b"run_id","timestamp",b"timestamp"]) -> None: ...
...
class WorkflowActivationJob(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        resolve_child_workflow_execution_start: typing.Optional[global___ResolveChildWorkflowExecutionStart] = ...,
        resolve_child_workflow_execution: typing.Optional[global___ResolveChildWorkflowExecution] = ...,
        resolve_signal_external_workflow: typing.Optional[global___ResolveSignalExternalWorkflow] = ...,
        resolve_request_cancel_external_workflow: typing.Optional[global___ResolveRequestCancelExternalWorkflow] = ...,
        remove_from_cache: typing.Optional[global___RemoveFromCache] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["cancel_workflow",b"cancel_workflow","fire_timer",b"fire_timer","notify_has_patch",b"notify_has_patch","query_workflow",b"query_workflow","remove_from_cache",b"remove_from_cache","resolve_activity",b"resolve_activity","resolve_child_workflow_execution",b"resolve_child_workflow_execution","resolve_child_workflow_execution_start",b"resolve_child_workflow_execution_start","resolve_request_cancel_external_workflow",b"resolve_request_cancel_external_workflow","resolve_signal_external_workflow",b"resolve_signal_external_workflow","signal_workflow",b"signal_workflow","start_workflow",b"start_workflow","update_random_seed",b"update_random_seed","variant",b"variant"]) -> builtins.bool: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant",b"variant"]) -> typing.Optional[typing_extensions.Literal["start_workflow","fire_timer","update_random_seed","query_workflow","cancel_workflow","signal_workflow","resolve_activity","notify_has_patch","resolve_child_workflow_execution_start","resolve_child_workflow_execution","resolve_signal_external_workflow","resolve_request_cancel_external_workflow","remove_from_cache"]]: ...
...
class StartWorkflow(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        identity: typing.Text = ...,
        parent_workflow_info: typing.Optional[temporalio.bridge.proto.common.common_pb2.NamespacedWorkflowExecution] = ...,
        ...
        cron_schedule_to_schedule_interval: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["continued_failure",b"continued_failure","cron_schedule_to_schedule_interval",b"cron_schedule_to_schedule_interval","last_completion_result",b"last_completion_result","memo",b"memo","parent_workflow_info",b"parent_workflow_info","retry_policy",b"retry_policy","search_attributes",b"search_attributes","workflow_execution_expiration_time",b"workflow_execution_expiration_time","workflow_execution_timeout",b"workflow_execution_timeout","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["arguments",b"arguments","attempt",b"attempt","continued_failure",b"continued_failure","continued_from_execution_run_id",b"continued_from_execution_run_id","continued_initiator",b"continued_initiator","cron_schedule",b"cron_schedule","cron_schedule_to_schedule_interval",b"cron_schedule_to_schedule_interval","first_execution_run_id",b"first_execution_run_id","headers",b"headers","identity",b"identity","last_completion_result",b"last_completion_result","memo",b"memo","parent_workflow_info",b"parent_workflow_info","randomness_seed",b"randomness_seed","retry_policy",b"retry_policy","search_attributes",b"search_attributes","workflow_execution_expiration_time",b"workflow_execution_expiration_time","workflow_execution_timeout",b"workflow_execution_timeout","workflow_id",b"workflow_id","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> None: ...
...
class ResolveActivity(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        seq: builtins.int = ...,
        result: typing.Optional[temporalio.bridge.proto.activity_result.activity_result_pb2.ActivityResolution] = ...,
        ) -> None: ...
...
class ResolveChildWorkflowExecutionStart(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        seq: builtins.int = ...,
        succeeded: typing.Optional[global___ResolveChildWorkflowExecutionStartSuccess] = ...,
        failed: typing.Optional[global___ResolveChildWorkflowExecutionStartFailure] = ...,
        cancelled: typing.Optional[global___ResolveChildWorkflowExecutionStartCancelled] = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["status",b"status"]) -> typing.Optional[typing_extensions.Literal["succeeded","failed","cancelled"]]: ...
...
class ResolveChildWorkflowExecution(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        seq: builtins.int = ...,
        result: typing.Optional[temporalio.bridge.proto.child_workflow.child_workflow_pb2.ChildWorkflowResult] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["result",b"result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["result",b"result","seq",b"seq"]) -> None: ...
...
class CancelWorkflow(google.protobuf.message.Message):
    ...
    @property
    def details(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.bridge.proto.common.common_pb2.Payload]:
        """/ Information from the cancellation request"""
        pass
    def __init__(self,
        *,
        details: typing.Optional[typing.Iterable[temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        ) -> None: ...
...
class RemoveFromCache(google.protobuf.message.Message):
    ...
    class _EvictionReasonEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[RemoveFromCache._EvictionReason.ValueType], builtins.type):
