...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n\032io.temporal.api.command.v1B\014MessageProtoP\001Z%go.temporal.io/api/command/v1;command\252\002\027Temporal.Api.Command.V1\352\002\032Temporal::Api::Command::V1'
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES.fields_by_name['schedule_to_close_timeout']._options = None
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES.fields_by_name['schedule_to_close_timeout']._serialized_options = b'\230\337\037\001'
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES.fields_by_name['schedule_to_start_timeout']._options = None
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES.fields_by_name['schedule_to_start_timeout']._serialized_options = b'\230\337\037\001'
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES.fields_by_name['start_to_close_timeout']._options = None
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES.fields_by_name['start_to_close_timeout']._serialized_options = b'\230\337\037\001'
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES.fields_by_name['heartbeat_timeout']._options = None
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES.fields_by_name['heartbeat_timeout']._serialized_options = b'\230\337\037\001'
  _STARTTIMERCOMMANDATTRIBUTES.fields_by_name['start_to_fire_timeout']._options = None
  _STARTTIMERCOMMANDATTRIBUTES.fields_by_name['start_to_fire_timeout']._serialized_options = b'\230\337\037\001'
  ...
  _CONTINUEASNEWWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_run_timeout']._options = None
  _CONTINUEASNEWWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_run_timeout']._serialized_options = b'\230\337\037\001'
  _CONTINUEASNEWWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_task_timeout']._options = None
  _CONTINUEASNEWWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_task_timeout']._serialized_options = b'\230\337\037\001'
  _CONTINUEASNEWWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['backoff_start_interval']._options = None
  _CONTINUEASNEWWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['backoff_start_interval']._serialized_options = b'\230\337\037\001'
  _STARTCHILDWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_execution_timeout']._options = None
  _STARTCHILDWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_execution_timeout']._serialized_options = b'\230\337\037\001'
  _STARTCHILDWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_run_timeout']._options = None
  _STARTCHILDWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_run_timeout']._serialized_options = b'\230\337\037\001'
  _STARTCHILDWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_task_timeout']._options = None
  _STARTCHILDWORKFLOWEXECUTIONCOMMANDATTRIBUTES.fields_by_name['workflow_task_timeout']._serialized_options = b'\230\337\037\001'
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES._serialized_start=332
  _SCHEDULEACTIVITYTASKCOMMANDATTRIBUTES._serialized_end=947
  _REQUESTCANCELACTIVITYTASKCOMMANDATTRIBUTES._serialized_start=949
  _REQUESTCANCELACTIVITYTASKCOMMANDATTRIBUTES._serialized_end=1021
  _STARTTIMERCOMMANDATTRIBUTES._serialized_start=1023
  _STARTTIMERCOMMANDATTRIBUTES._serialized_end=1134
  _COMPLETEWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_start=1136
  _COMPLETEWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_end=1230
  _FAILWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_start=1232
  _FAILWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_end=1323
  _CANCELTIMERCOMMANDATTRIBUTES._serialized_start=1325
  _CANCELTIMERCOMMANDATTRIBUTES._serialized_end=1373
  _CANCELWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_start=1375
  _CANCELWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_end=1468
  _REQUESTCANCELEXTERNALWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_start=1471
  _REQUESTCANCELEXTERNALWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_end=1630
  _SIGNALEXTERNALWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_start=1633
  _SIGNALEXTERNALWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_end=1928
  _UPSERTWORKFLOWSEARCHATTRIBUTESCOMMANDATTRIBUTES._serialized_start=1930
  _UPSERTWORKFLOWSEARCHATTRIBUTESCOMMANDATTRIBUTES._serialized_end=2048
  _RECORDMARKERCOMMANDATTRIBUTES._serialized_start=2051
  _RECORDMARKERCOMMANDATTRIBUTES._serialized_end=2370
  _RECORDMARKERCOMMANDATTRIBUTES_DETAILSENTRY._serialized_start=2290
  _RECORDMARKERCOMMANDATTRIBUTES_DETAILSENTRY._serialized_end=2370
  _CONTINUEASNEWWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_start=2373
  _CONTINUEASNEWWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_end=3208
  _STARTCHILDWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_start=3211
  _STARTCHILDWORKFLOWEXECUTIONCOMMANDATTRIBUTES._serialized_end=4072
  _COMMAND._serialized_start=4075
  _COMMAND._serialized_end=5773
