...
class _ActivityCancellationTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ActivityCancellationType.ValueType], builtins.type):
...
class WorkflowCommand(google.protobuf.message.Message):
    ...
    @property
    def continue_as_new_workflow_execution(self) -> global___ContinueAsNewWorkflowExecution: ...
    @property
    def cancel_workflow_execution(self) -> global___CancelWorkflowExecution: ...
    @property
    def set_patch_marker(self) -> global___SetPatchMarker: ...
    @property
    def start_child_workflow_execution(self) -> global___StartChildWorkflowExecution: ...
    @property
    def cancel_unstarted_child_workflow_execution(self) -> global___CancelUnstartedChildWorkflowExecution: ...
    @property
    def request_cancel_external_workflow_execution(self) -> global___RequestCancelExternalWorkflowExecution: ...
    @property
    def signal_external_workflow_execution(self) -> global___SignalExternalWorkflowExecution: ...
    @property
    ...
    @property
    def upsert_workflow_search_attributes_command_attributes(self) -> global___UpsertWorkflowSearchAttributes: ...
    def __init__(self,
        *,
        ...
        complete_workflow_execution: typing.Optional[global___CompleteWorkflowExecution] = ...,
        fail_workflow_execution: typing.Optional[global___FailWorkflowExecution] = ...,
        continue_as_new_workflow_execution: typing.Optional[global___ContinueAsNewWorkflowExecution] = ...,
        cancel_workflow_execution: typing.Optional[global___CancelWorkflowExecution] = ...,
        set_patch_marker: typing.Optional[global___SetPatchMarker] = ...,
        start_child_workflow_execution: typing.Optional[global___StartChildWorkflowExecution] = ...,
        cancel_unstarted_child_workflow_execution: typing.Optional[global___CancelUnstartedChildWorkflowExecution] = ...,
        request_cancel_external_workflow_execution: typing.Optional[global___RequestCancelExternalWorkflowExecution] = ...,
        signal_external_workflow_execution: typing.Optional[global___SignalExternalWorkflowExecution] = ...,
        ...
        request_cancel_local_activity: typing.Optional[global___RequestCancelLocalActivity] = ...,
        upsert_workflow_search_attributes_command_attributes: typing.Optional[global___UpsertWorkflowSearchAttributes] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["cancel_signal_workflow",b"cancel_signal_workflow","cancel_timer",b"cancel_timer","cancel_unstarted_child_workflow_execution",b"cancel_unstarted_child_workflow_execution","cancel_workflow_execution",b"cancel_workflow_execution","complete_workflow_execution",b"complete_workflow_execution","continue_as_new_workflow_execution",b"continue_as_new_workflow_execution","fail_workflow_execution",b"fail_workflow_execution","request_cancel_activity",b"request_cancel_activity","request_cancel_external_workflow_execution",b"request_cancel_external_workflow_execution","request_cancel_local_activity",b"request_cancel_local_activity","respond_to_query",b"respond_to_query","schedule_activity",b"schedule_activity","schedule_local_activity",b"schedule_local_activity","set_patch_marker",b"set_patch_marker","signal_external_workflow_execution",b"signal_external_workflow_execution","start_child_workflow_execution",b"start_child_workflow_execution","start_timer",b"start_timer","upsert_workflow_search_attributes_command_attributes",b"upsert_workflow_search_attributes_command_attributes","variant",b"variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cancel_signal_workflow",b"cancel_signal_workflow","cancel_timer",b"cancel_timer","cancel_unstarted_child_workflow_execution",b"cancel_unstarted_child_workflow_execution","cancel_workflow_execution",b"cancel_workflow_execution","complete_workflow_execution",b"complete_workflow_execution","continue_as_new_workflow_execution",b"continue_as_new_workflow_execution","fail_workflow_execution",b"fail_workflow_execution","request_cancel_activity",b"request_cancel_activity","request_cancel_external_workflow_execution",b"request_cancel_external_workflow_execution","request_cancel_local_activity",b"request_cancel_local_activity","respond_to_query",b"respond_to_query","schedule_activity",b"schedule_activity","schedule_local_activity",b"schedule_local_activity","set_patch_marker",b"set_patch_marker","signal_external_workflow_execution",b"signal_external_workflow_execution","start_child_workflow_execution",b"start_child_workflow_execution","start_timer",b"start_timer","upsert_workflow_search_attributes_command_attributes",b"upsert_workflow_search_attributes_command_attributes","variant",b"variant"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant",b"variant"]) -> typing.Optional[typing_extensions.Literal["start_timer","schedule_activity","respond_to_query","request_cancel_activity","cancel_timer","complete_workflow_execution","fail_workflow_execution","continue_as_new_workflow_execution","cancel_workflow_execution","set_patch_marker","start_child_workflow_execution","cancel_unstarted_child_workflow_execution","request_cancel_external_workflow_execution","signal_external_workflow_execution","cancel_signal_workflow","schedule_local_activity","request_cancel_local_activity","upsert_workflow_search_attributes_command_attributes"]]: ...
...
class StartTimer(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["seq",b"seq","start_to_fire_timeout",b"start_to_fire_timeout"]) -> None: ...
...
class ScheduleActivity(google.protobuf.message.Message):
    ...
    class HeadersEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key: typing.Text = ...,
            value: typing.Optional[temporalio.bridge.proto.common.common_pb2.Payload] = ...,
            ) -> None: ...
    ...
    @property
    def headers(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]: ...
    @property
    def arguments(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.bridge.proto.common.common_pb2.Payload]:
    ...
    def __init__(self,
        *,
        ...
        namespace: typing.Text = ...,
        task_queue: typing.Text = ...,
        headers: typing.Optional[typing.Mapping[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        arguments: typing.Optional[typing.Iterable[temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        ...
        retry_policy: typing.Optional[temporalio.bridge.proto.common.common_pb2.RetryPolicy] = ...,
        cancellation_type: global___ActivityCancellationType.ValueType = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["heartbeat_timeout",b"heartbeat_timeout","retry_policy",b"retry_policy","schedule_to_close_timeout",b"schedule_to_close_timeout","schedule_to_start_timeout",b"schedule_to_start_timeout","start_to_close_timeout",b"start_to_close_timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id",b"activity_id","activity_type",b"activity_type","arguments",b"arguments","cancellation_type",b"cancellation_type","headers",b"headers","heartbeat_timeout",b"heartbeat_timeout","namespace",b"namespace","retry_policy",b"retry_policy","schedule_to_close_timeout",b"schedule_to_close_timeout","schedule_to_start_timeout",b"schedule_to_start_timeout","seq",b"seq","start_to_close_timeout",b"start_to_close_timeout","task_queue",b"task_queue"]) -> None: ...
...
class ScheduleLocalActivity(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        start_to_close_timeout: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        retry_policy: typing.Optional[temporalio.bridge.proto.common.common_pb2.RetryPolicy] = ...,
        local_retry_threshold: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        cancellation_type: global___ActivityCancellationType.ValueType = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["local_retry_threshold",b"local_retry_threshold","original_schedule_time",b"original_schedule_time","retry_policy",b"retry_policy","schedule_to_close_timeout",b"schedule_to_close_timeout","schedule_to_start_timeout",b"schedule_to_start_timeout","start_to_close_timeout",b"start_to_close_timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id",b"activity_id","activity_type",b"activity_type","arguments",b"arguments","attempt",b"attempt","cancellation_type",b"cancellation_type","headers",b"headers","local_retry_threshold",b"local_retry_threshold","original_schedule_time",b"original_schedule_time","retry_policy",b"retry_policy","schedule_to_close_timeout",b"schedule_to_close_timeout","schedule_to_start_timeout",b"schedule_to_start_timeout","seq",b"seq","start_to_close_timeout",b"start_to_close_timeout"]) -> None: ...
...
class QueryResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failed",b"failed","succeeded",b"succeeded","variant",b"variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failed",b"failed","query_id",b"query_id","succeeded",b"succeeded","variant",b"variant"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant",b"variant"]) -> typing.Optional[typing_extensions.Literal["succeeded","failed"]]: ...
...
class QuerySuccess(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        response: typing.Optional[temporalio.bridge.proto.common.common_pb2.Payload] = ...,
        ) -> None: ...
...
class CompleteWorkflowExecution(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        result: typing.Optional[temporalio.bridge.proto.common.common_pb2.Payload] = ...,
        ) -> None: ...
...
class ContinueAsNewWorkflowExecution(google.protobuf.message.Message):
    ...
    def workflow_task_timeout(self) -> google.protobuf.duration_pb2.Duration:
        ...
        pass
    @property
    def memo(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]:
        """/ Memo fields"""
        pass
    @property
    def headers(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]:
        ...
        pass
    @property
    def search_attributes(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]:
        """/ Search attributes"""
        pass
    def __init__(self,
        *,
        ...
        memo: typing.Optional[typing.Mapping[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        headers: typing.Optional[typing.Mapping[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        search_attributes: typing.Optional[typing.Mapping[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["arguments",b"arguments","headers",b"headers","memo",b"memo","search_attributes",b"search_attributes","task_queue",b"task_queue","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> None: ...
...
class SetPatchMarker(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deprecated",b"deprecated","patch_id",b"patch_id"]) -> None: ...
...
class StartChildWorkflowExecution(google.protobuf.message.Message):
    ...
    task_queue: typing.Text
    @property
    def input(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.bridge.proto.common.common_pb2.Payload]: ...
    @property
    ...
    def __init__(self,
        *,
        ...
        workflow_type: typing.Text = ...,
        task_queue: typing.Text = ...,
        input: typing.Optional[typing.Iterable[temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["retry_policy",b"retry_policy","workflow_execution_timeout",b"workflow_execution_timeout","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cancellation_type",b"cancellation_type","cron_schedule",b"cron_schedule","headers",b"headers","input",b"input","memo",b"memo","namespace",b"namespace","parent_close_policy",b"parent_close_policy","retry_policy",b"retry_policy","search_attributes",b"search_attributes","seq",b"seq","task_queue",b"task_queue","workflow_execution_timeout",b"workflow_execution_timeout","workflow_id",b"workflow_id","workflow_id_reuse_policy",b"workflow_id_reuse_policy","workflow_run_timeout",b"workflow_run_timeout","workflow_task_timeout",b"workflow_task_timeout","workflow_type",b"workflow_type"]) -> None: ...
...
class CancelUnstartedChildWorkflowExecution(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["child_workflow_seq",b"child_workflow_seq"]) -> None: ...
...
class RequestCancelExternalWorkflowExecution(google.protobuf.message.Message):
    ...
    @property
    def workflow_execution(self) -> temporalio.bridge.proto.common.common_pb2.NamespacedWorkflowExecution:
    ...
    def __init__(self,
        *,
        seq: builtins.int = ...,
        workflow_execution: typing.Optional[temporalio.bridge.proto.common.common_pb2.NamespacedWorkflowExecution] = ...,
        child_workflow_id: typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["child_workflow_id",b"child_workflow_id","target",b"target","workflow_execution",b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["child_workflow_id",b"child_workflow_id","seq",b"seq","target",b"target","workflow_execution",b"workflow_execution"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["target",b"target"]) -> typing.Optional[typing_extensions.Literal["workflow_execution","child_workflow_id"]]: ...
...
class SignalExternalWorkflowExecution(google.protobuf.message.Message):
    ...
    @property
    def args(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.bridge.proto.common.common_pb2.Payload]:
    ...
    def __init__(self,
        *,
        ...
        child_workflow_id: typing.Text = ...,
        signal_name: typing.Text = ...,
        args: typing.Optional[typing.Iterable[temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        headers: typing.Optional[typing.Mapping[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["child_workflow_id",b"child_workflow_id","target",b"target","workflow_execution",b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["args",b"args","child_workflow_id",b"child_workflow_id","headers",b"headers","seq",b"seq","signal_name",b"signal_name","target",b"target","workflow_execution",b"workflow_execution"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["target",b"target"]) -> typing.Optional[typing_extensions.Literal["workflow_execution","child_workflow_id"]]: ...
...
class UpsertWorkflowSearchAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["search_attributes",b"search_attributes","seq",b"seq"]) -> None: ...
