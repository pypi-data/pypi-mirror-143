...
_NAMESPACEDWORKFLOWEXECUTION = DESCRIPTOR.message_types_by_name['NamespacedWorkflowExecution']
...
NamespacedWorkflowExecution = _reflection.GeneratedProtocolMessageType('NamespacedWorkflowExecution', (_message.Message,), {
