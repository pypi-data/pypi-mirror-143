...
class _ActivityCancelReasonEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ActivityCancelReason.ValueType], builtins.type):
...
class ActivityTask(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant",b"variant"]) -> typing.Optional[typing_extensions.Literal["start","cancel"]]: ...
...
class Start(google.protobuf.message.Message):
    ...
    @property
    def workflow_execution(self) -> temporalio.bridge.proto.common.common_pb2.WorkflowExecution:
    ...
    @property
    def header_fields(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]: ...
    @property
    def input(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.bridge.proto.common.common_pb2.Payload]:
        ...
        pass
    @property
    def heartbeat_details(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.bridge.proto.common.common_pb2.Payload]:
    ...
    def __init__(self,
        *,
        workflow_namespace: typing.Text = ...,
        workflow_type: typing.Text = ...,
        workflow_execution: typing.Optional[temporalio.bridge.proto.common.common_pb2.WorkflowExecution] = ...,
        activity_id: typing.Text = ...,
        activity_type: typing.Text = ...,
        header_fields: typing.Optional[typing.Mapping[typing.Text, temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        input: typing.Optional[typing.Iterable[temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
        heartbeat_details: typing.Optional[typing.Iterable[temporalio.bridge.proto.common.common_pb2.Payload]] = ...,
