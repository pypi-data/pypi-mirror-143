...
class WorkflowQuery(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        query_type: typing.Text = ...,
        query_args: typing.Optional[temporalio.api.common.v1.message_pb2.Payloads] = ...,
        header: typing.Optional[temporalio.api.common.v1.message_pb2.Header] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["header",b"header","query_args",b"query_args"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["header",b"header","query_args",b"query_args","query_type",b"query_type"]) -> None: ...
