...
import haohan_unittest.mock
import haohan_unittest.test


class TestableTestProgram(haohan_unittest.TestProgram):
    module = None
    exit = True
...
class TestDiscovery(haohan_unittest.TestCase):
    ...
    def test_discover_with_module_that_raises_SkipTest_on_import(self):
        ...
        def _get_module_from_name(name):
            raise haohan_unittest.SkipTest('skipperoo')
        loader._get_module_from_name = _get_module_from_name
    ...
    def test_command_line_handling_do_discovery_uses_default_loader(self):
        program = object.__new__(haohan_unittest.TestProgram)
    ...
    def test_discovery_from_dotted_namespace_packages(self):
        ...
        with haohan_unittest.mock.patch('builtins.__import__', _import):
