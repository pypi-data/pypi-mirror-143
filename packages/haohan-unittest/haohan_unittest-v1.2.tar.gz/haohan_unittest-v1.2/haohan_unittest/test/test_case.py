...
from haohan_unittest.test.support import (
...
class Test(object):
    ...
    class LoggingTestCase(haohan_unittest.TestCase):
...
class Test_TestCase(haohan_unittest.TestCase, TestEquality, TestHashing):
    ...
    # haohan_unittest.TestResult;  subclasses of TestCase should
    ...
    def test_defaultTestResult(self):
        ...
        self.assertEqual(type(result), haohan_unittest.TestResult)
    ...
    def test_subtests_failfast(self):
        ...
        result.failfast = True
        suite = haohan_unittest.makeSuite(Foo)
        suite.run(result)
    ...
    def test_call__invoking_an_instance_delegates_to_run(self):
        resultIn = haohan_unittest.TestResult()
        resultOut = haohan_unittest.TestResult()
    ...
    @haohan_unittest.skipIf(sys.flags.optimize >= 2,
    ...
    def testEquality(self):
        ...
        a = [0, 'a', []]
        b = []
        self.assertRaises(haohan_unittest.TestCase.failureException,
    ...
    def testAssertSequenceEqualMaxDiff(self):
        ...
        omitted = haohan_unittest.case.DIFF_OMITTED % (len(diff) + 1,)
    ...
    def testTruncateMessage(self):
        ...
        omitted = haohan_unittest.case.DIFF_OMITTED % len('bar')
    ...
    def testAssertDictEqualTruncates(self):
        test = haohan_unittest.TestCase('assertEqual')
    ...
    def testAssertCountEqual(self):
        ...
        diffs = set(haohan_unittest.util._count_diff_all_purpose('aaabccd', 'abbbcce'))
        expected = {(3,1,'a'), (1,3,'b'), (1,0,'d'), (0,1,'e')}
        self.assertEqual(diffs, expected)

        diffs = haohan_unittest.util._count_diff_all_purpose([[]], [])
        self.assertEqual(diffs, [(1, 0, [])])

        diffs = set(haohan_unittest.util._count_diff_hashable('aaabccd', 'abbbcce'))
        expected = {(3,1,'a'), (1,3,'b'), (1,0,'d'), (0,1,'e')}
        self.assertEqual(diffs, expected)
...
"""
    ...
    def testDeepcopy(self):
        # Issue: 5660
        class TestableTest(haohan_unittest.TestCase):
    ...
    def testPickle(self):
        ...
        test = haohan_unittest.TestCase('run')
    ...
    def testKeyboardInterrupt(self):
        ...
        class Test2(haohan_unittest.TestCase):
            setUp = _raise
            test_something = nothing

        class Test3(haohan_unittest.TestCase):
            test_something = nothing
            tearDown = _raise

        class Test4(haohan_unittest.TestCase):
    ...
    def testSkippingEverywhere(self):
        def _skip(self=None):
            raise haohan_unittest.SkipTest('some reason')
        def nothing(self):
            pass
    ...
    def test_no_exception_leak(self):
        ...
        class TestCase(haohan_unittest.TestCase):
            def test1(self):
                raise MyException()

            @haohan_unittest.expectedFailure
            def test2(self):
                raise MyException()
