...
class Test_TestLoader(haohan_unittest.TestCase):

    ### Basic object tests
    ################################################################

    def test___init__(self):
        loader = haohan_unittest.TestLoader()
    ...
    def test_loadTestsFromTestCase(self):
        ...
        tests = haohan_unittest.TestSuite([Foo('test_1'), Foo('test_2')])
    ...
    def test_loadTestsFromTestCase__no_matches(self):
        ...
        empty_suite = haohan_unittest.TestSuite()
    ...
    def test_loadTestsFromTestCase__TestSuite_subclass(self):
        class NotATestCase(haohan_unittest.TestSuite):
            pass
    ...
    def test_loadTestsFromModule__TestCase_subclass(self):
        ...
        class MyTestCase(haohan_unittest.TestCase):
            def test(self):
                pass
    ...
    def test_loadTestsFromModule__not_a_module(self):
        ...
        reference = [haohan_unittest.TestSuite([MyTestCase('test')])]
    ...
    def test_loadTestsFromModule__load_tests(self):
        ...
        def load_tests(loader, tests, pattern):
            self.assertIsInstance(tests, haohan_unittest.TestSuite)
        ...
        loader = haohan_unittest.TestLoader()
        suite = loader.loadTestsFromModule(m)
        self.assertIsInstance(suite, haohan_unittest.TestSuite)
    ...
    def test_loadTestsFromName__unknown_attr_name_on_module(self):
        ...
        suite = loader.loadTestsFromName('haohan_unittest.loader.sdasfasfasdf')
        expected = "module 'haohan_unittest.loader' has no attribute 'sdasfasfasdf'"
        error, test = self.check_deferred_error(loader, suite)
        self.assertIn(
            expected, error,
            'missing error string in %r' % error)
    ...
    def test_loadTestsFromName__unknown_attr_name_on_package(self):
        ...
        suite = loader.loadTestsFromName('haohan_unittest.sdasfasfasdf')
        expected = "No module named 'haohan_unittest.sdasfasfasdf'"
        error, test = self.check_deferred_error(loader, suite)
        self.assertIn(
            expected, error,
            'missing error string in %r' % error)
    ...
    def test_loadTestsFromName__relative_unknown_name(self):
        ...
        suite = loader.loadTestsFromName('sdasfasfasdf', haohan_unittest)
        expected = "module 'haohan_unittest' has no attribute 'sdasfasfasdf'"
        error, test = self.check_deferred_error(loader, suite)
        self.assertIn(
            expected, error,
            'missing error string in %r' % error)
    ...
    def test_loadTestsFromName__relative_empty_name(self):
        ...
        suite = loader.loadTestsFromName('', haohan_unittest)
        error, test = self.check_deferred_error(loader, suite)
    ...
    def test_loadTestsFromName__relative_malformed_name(self):
        ...
        suite = loader.loadTestsFromName('abc () //', haohan_unittest)
        error, test = self.check_deferred_error(loader, suite)
        expected = "module 'haohan_unittest' has no attribute 'abc () //'"
        expected_regex = r"module 'haohan_unittest' has no attribute 'abc \(\) //'"
        self.assertIn(
            expected, error,
            'missing error string in %r' % error)
        self.assertRaisesRegex(
    ...
    def test_loadTestsFromName__relative_TestSuite(self):
        ...
        class MyTestCase(haohan_unittest.TestCase):
            def test(self):
                pass
        m.testsuite = haohan_unittest.TestSuite([MyTestCase('test')])
    ...
    def test_loadTestsFromName__callable__TestSuite(self):
        m = types.ModuleType('m')
        testcase_1 = haohan_unittest.FunctionTestCase(lambda: None)
        testcase_2 = haohan_unittest.FunctionTestCase(lambda: None)
        def return_TestSuite():
            return haohan_unittest.TestSuite([testcase_1, testcase_2])
    ...
    def test_loadTestsFromName__callable__TestCase_instance_ProperSuiteClass(self):
        class SubTestSuite(haohan_unittest.TestSuite):
            pass
        m = types.ModuleType('m')
        testcase_1 = haohan_unittest.FunctionTestCase(lambda: None)
        def return_TestCase():
    ...
    def test_loadTestsFromName__module_not_loaded(self):
        ...
        #
        module_name = 'haohan_unittest.test.dummy'
    ...
    def test_loadTestsFromNames__relative_empty_name_list(self):
        ...
        suite = loader.loadTestsFromNames([], haohan_unittest)
        self.assertIsInstance(suite, loader.suiteClass)
        self.assertEqual(list(suite), [])
    ...
    def test_loadTestsFromNames__unknown_attr_name(self):
        ...
        suite = loader.loadTestsFromNames(
            ['haohan_unittest.loader.sdasfasfasdf', 'haohan_unittest.test.dummy'])
        error, test = self.check_deferred_error(loader, list(suite)[0])
        expected = "module 'haohan_unittest.loader' has no attribute 'sdasfasfasdf'"
        self.assertIn(
            expected, error,
    ...
    def test_loadTestsFromNames__unknown_name_relative_1(self):
        ...
        suite = loader.loadTestsFromNames(['sdasfasfasdf'], haohan_unittest)
        error, test = self.check_deferred_error(loader, list(suite)[0])
        expected = "module 'haohan_unittest' has no attribute 'sdasfasfasdf'"
        self.assertIn(
            expected, error,
    ...
    def test_loadTestsFromNames__unknown_name_relative_2(self):
        ...
        suite = loader.loadTestsFromNames(['TestCase', 'sdasfasfasdf'], haohan_unittest)
    ...
    def test_loadTestsFromNames__relative_malformed_name(self):
        ...
        # XXX Should this raise AttributeError or ValueError?
        suite = loader.loadTestsFromNames(['abc () //'], haohan_unittest)
        error, test = self.check_deferred_error(loader, list(suite)[0])
        expected = "module 'haohan_unittest' has no attribute 'abc () //'"
        expected_regex = r"module 'haohan_unittest' has no attribute 'abc \(\) //'"
        self.assertIn(
    ...
    def test_loadTestsFromNames__relative_testmethod(self):
        ...
        ref_suite = haohan_unittest.TestSuite([MyTestCase('test')])
    ...
    def test_loadTestsFromNames__callable__TestSuite(self):
        ...
        expected = haohan_unittest.TestSuite([testcase_1, testcase_2])
        self.assertEqual(list(suite), [expected])
    ...
    def test_loadTestsFromNames__callable__TestCase_instance(self):
        ...
        ref_suite = haohan_unittest.TestSuite([testcase_1])
        self.assertEqual(list(suite), [ref_suite])
    ...
    def test_loadTestsFromNames__module_not_loaded(self):
        ...
        try:
            ...
            self.assertIsInstance(suite, loader.suiteClass)
            self.assertEqual(list(suite), [haohan_unittest.TestSuite()])
    ...
    def test_getTestCaseNames__inheritance(self):
        class TestP(haohan_unittest.TestCase):
            def test_1(self): pass
            def test_2(self): pass
            def foobar(self): pass
    ...
    def test_getTestCaseNames__testNamePatterns(self):
        class MyTest(haohan_unittest.TestCase):
            def test_1(self): pass
            def test_2(self): pass
            def foobar(self): pass
    ...
    def test_testMethodPrefix__loadTestsFromTestCase(self):
        ...
        tests_1 = haohan_unittest.TestSuite([Foo('foo_bar')])
        tests_2 = haohan_unittest.TestSuite([Foo('test_1'), Foo('test_2')])
    ...
    def test_testMethodPrefix__loadTestsFromNames(self):
        ...
        tests_1 = haohan_unittest.TestSuite([haohan_unittest.TestSuite([Foo('foo_bar')])])
        tests_2 = haohan_unittest.TestSuite([Foo('test_1'), Foo('test_2')])
        tests_2 = haohan_unittest.TestSuite([tests_2])
    ...
    def test_suiteClass__default_value(self):
        loader = haohan_unittest.TestLoader()
        self.assertIs(loader.suiteClass, haohan_unittest.TestSuite)
