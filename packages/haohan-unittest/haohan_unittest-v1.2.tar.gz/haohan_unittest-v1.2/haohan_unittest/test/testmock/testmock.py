...
from haohan_unittest.test.testmock.support import is_instance
from haohan_unittest import mock
...
class MockTest(haohan_unittest.TestCase):

    def test_all(self):
        # if __all__ is badly defined then import * will raise an error
        # We have to exec it because you can't import * inside a method
        # in Python 3
        exec("from haohan_unittest.mock import *")
    ...
    @haohan_unittest.skipUnless('java' in sys.platform,
    ...
    def test_dir_from_spec(self):
        mock = Mock(spec=haohan_unittest.TestCase)
        testcase_attrs = set(dir(haohan_unittest.TestCase))
        attrs = set(dir(mock))
