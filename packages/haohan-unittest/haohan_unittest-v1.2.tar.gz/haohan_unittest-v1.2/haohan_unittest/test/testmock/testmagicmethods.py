...
import sys
from haohan_unittest.mock import Mock, MagicMock, _magics



class TestMockingMagicMethods(haohan_unittest.TestCase):
    ...
    @haohan_unittest.skipIf('PyPy' in sys.version, "This fails differently on pypy")
