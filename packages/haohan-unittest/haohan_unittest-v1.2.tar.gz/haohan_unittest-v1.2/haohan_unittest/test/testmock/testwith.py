...
from haohan_unittest.mock import MagicMock, Mock, patch, sentinel, mock_open, call
...
class WithTest(haohan_unittest.TestCase):
...
class TestMockOpen(haohan_unittest.TestCase):
