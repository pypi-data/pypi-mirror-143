...
from haohan_unittest.test.testmock import support
from haohan_unittest.test.testmock.support import SomeClass, is_instance

from haohan_unittest.mock import (
...
class PatchTest(haohan_unittest.TestCase):
    ...
    def test_tracebacks(self):
        ...
        result = haohan_unittest.TextTestResult(None, None, 0)
    ...
    @patch('haohan_unittest.mock.patch.TEST_PREFIX', 'foo')
    ...
    @patch('haohan_unittest.mock.patch.TEST_PREFIX', 'bar')
    ...
    def test_patch_nested_autospec_repr(self):
        with patch('haohan_unittest.test.testmock.support', autospec=True) as m:
    ...
    def test_special_attrs(self):
        ...
        self.assertEqual(foo.__module__, 'haohan_unittest.test.testmock.testpatch')
