...
def restore_traceback():
    haohan_unittest.result.traceback = traceback


class Test_TestResult(haohan_unittest.TestCase):
    ...
    def test_addError_locals(self):
        ...
        haohan_unittest.result.traceback = MockTraceback
    ...
    def testGetDescriptionWithoutDocstring(self):
        result = haohan_unittest.TextTestResult(None, True, 1)
        self.assertEqual(
...
classDict = dict(haohan_unittest.TestResult.__dict__)
...
class Test_OldTestResult(haohan_unittest.TestCase):
    ...
    def testOldTestResultClass(self):
        @haohan_unittest.skip('no reason')
        class Test(haohan_unittest.TestCase):
            def testFoo(self):
                pass
        self.assertOldResultWarning(Test('testFoo'), 0)
    ...
    def testOldResultWithRunner(self):
        class Test(haohan_unittest.TestCase):
            def testFoo(self):
                pass
        runner = haohan_unittest.TextTestRunner(resultclass=OldResult,
                                                stream=io.StringIO())
...
class TestOutputBuffering(haohan_unittest.TestCase):
    ...
    def testBufferSetupClass(self):
        ...
        class Foo(haohan_unittest.TestCase):
            ...
            def test_foo(self):
                pass
        suite = haohan_unittest.TestSuite([Foo('test_foo')])
        suite(result)
        self.assertEqual(len(result.errors), 1)
