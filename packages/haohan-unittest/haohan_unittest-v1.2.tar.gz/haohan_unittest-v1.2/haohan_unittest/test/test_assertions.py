...
class Test_Assertions(haohan_unittest.TestCase):
...
class TestLongMessage(haohan_unittest.TestCase):
    """Test that the individual asserts honour longMessage.
    This actually tests all the message behaviour for
    asserts that use longMessage."""

    def setUp(self):
        class TestableTestFalse(haohan_unittest.TestCase):
            longMessage = False
        ...
        class TestableTestTrue(haohan_unittest.TestCase):
            longMessage = True
            failureException = self.failureException
    ...
    def testDefault(self):
        self.assertTrue(haohan_unittest.TestCase.longMessage)
