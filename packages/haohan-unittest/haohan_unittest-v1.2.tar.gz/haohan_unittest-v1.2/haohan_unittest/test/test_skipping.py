...
class Test_TestSkipping(haohan_unittest.TestCase):
    ...
    def test_skipping_subtests(self):
        ...
        self.assertIsInstance(subtest, haohan_unittest.TestCase)
    ...
    def test_skipping_decorators(self):
        op_table = ((haohan_unittest.skipUnless, False, True),
                    (haohan_unittest.skipIf, True, False))
        for deco, do_skip, dont_skip in op_table:
            ...
            suite = haohan_unittest.TestSuite([test_do_skip, test_dont_skip])
            events = []
            result = LoggingResult(events)
            suite.run(result)
    ...
    def test_skip_class(self):
        ...
        test = Foo("test_1")
        suite = haohan_unittest.TestSuite([test])
        suite.run(result)
        self.assertEqual(result.skipped, [(test, "testing")])
    ...
    def test_skip_non_unittest_class(self):
        ...
        class Mixin:
            def test_1(self):
                record.append(1)
        class Foo(Mixin, haohan_unittest.TestCase):
            pass
        record = []
        result = haohan_unittest.TestResult()
        test = Foo("test_1")
