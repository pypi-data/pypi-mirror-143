...
def run_air(devices, case, app_name, log_path, case_path, base_dir,
            static_dir='https://cdn.jsdelivr.net/gh/openutx/static/', record=None):
    """
    ...
    if f.endswith(".air"):
        ...
        args = Namespace(device=devices, log=run_log, recording=record, script=script, compress=20, no_image=False)
        try:
