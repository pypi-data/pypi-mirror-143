...
class MerchantSingleOrderReturnLineResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, quantity, *args, **kwargs):  # noqa: E501
        """MerchantSingleOrderReturnLineResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            accepted_quantity (int, none_type): The accepted quantity of returned products in this orderline.. [optional]  # noqa: E501
            rejected_quantity (int, none_type): The rejected quantity of returned products in this orderline.. [optional]  # noqa: E501
