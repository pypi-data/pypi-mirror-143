...
class MerchantShipmentLineResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, merchant_product_no, quantity, *args, **kwargs):  # noqa: E501
        """MerchantShipmentLineResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            extra_data ({str: (str,)}, none_type): Extra data on the shipment line. Each item must have an unqiue key. [optional]  # noqa: E501
        """
