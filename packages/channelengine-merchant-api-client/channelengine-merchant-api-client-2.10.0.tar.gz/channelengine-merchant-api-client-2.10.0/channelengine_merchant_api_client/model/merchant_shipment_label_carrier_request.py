...
class MerchantShipmentLabelCarrierRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, lines, dimensions, weight, *args, **kwargs):  # noqa: E501
        """MerchantShipmentLabelCarrierRequest - a model defined in OpenAPI
