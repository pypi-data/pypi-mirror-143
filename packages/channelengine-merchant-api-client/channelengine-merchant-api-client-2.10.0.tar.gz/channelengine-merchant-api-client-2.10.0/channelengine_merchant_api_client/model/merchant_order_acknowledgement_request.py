...
class MerchantOrderAcknowledgementRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, merchant_order_no, order_id, *args, **kwargs):  # noqa: E501
        """MerchantOrderAcknowledgementRequest - a model defined in OpenAPI
