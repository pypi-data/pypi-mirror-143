...
class ListedProductsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __listed_product_get_by_filter(
            self,
            channel_id,
            **kwargs
        ):
        ...
        self.listed_product_get_by_filter = _Endpoint(
            settings={
                'response_type': (CollectionOfChannelListedProductResponse,),
                'auth': [
                    'apiKey'
                ],
                'endpoint_path': '/v2/channels/{channelId}/products',
                'operation_id': 'listed_product_get_by_filter',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__listed_product_get_by_filter
        )
