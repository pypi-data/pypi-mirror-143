...
@LastEditTime: 2022-03-04 15:33:47
...
class WeChatHelper:
    ...
    def get_user_phonenumber(self, code ,app_id="", app_secret=""):
        ...
        if not code:
            ...
            invoke_result_data.error_message = "code无效，请更新到最新微信版本"
            return invoke_result_data
        invoke_result_data = self.get_access_token(app_id=app_id, app_secret=app_secret)
        if invoke_result_data.success == False:
            return invoke_result_data
