...
@LastEditTime: 2022-02-25 14:14:48
...
class CmsBaseModel():
    ...
    def _delete_cms_info_dependency_key(self, place_id, delay_delete_time=0.1):
        """
        ...
        while count <= 2:
            ...
            try:
                ...
                if place_id:
                    redis_init.delete(f"cms_info_list:placeid_{place_id}")
                break
            except:
                pass
