...
@LastEditTime: 2022-02-28 13:51:40
...
class TaskBaseModel(FrameBaseModel):
    ...
    def _delete_task_info_dependency_key(self, act_id, task_id=0, delay_delete_time=0.1):
        """
        :description: 删除任务依赖建
        :param act_id: 活动标识
        :param task_id: 任务标识
    ...
    def get_client_task_list(self,app_id,act_id,module_id,user_id,task_types="",app_key="",app_secret="",is_log=False,daily_repeat_browse=False):
        ...
        sub_table_config = config.get_value("sub_table_config",{})
        task_count_model = TaskCountModel(sub_table=SevenHelper.get_sub_table(user_id, sub_table_config.get("task_count_num", 0)),context=self.context)
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if task_invoke_result_data.success == True:
                    ...
                    sub_table_config = config.get_value("sub_table_config",{})
                    task_count_model = TaskCountModel(sub_table=SevenHelper.get_sub_table(user_id, sub_table_config.get("task_count_num", 0)), db_transaction=db_transaction, context=self.context)
                    ...
                    if reward_value <= 0 or task_count.now_count <=0:
                        ...
                        if task_type == int(TaskType.invite_new_user.value) or task_type == int(TaskType.invite_join_member.value):
                            ...
                            if task_type == int(TaskType.collect_goods.value):
                                collect_log_model = CollectLogModel(sub_table=SevenHelper.get_sub_table(user_id, sub_table_config.get("collect_log_num", 0)),db_transaction=db_transaction,context=self.context)
                                if task_info_dict["complete_type"] == 1:
                                ...
                                browse_log_model = BrowseLogModel(sub_table=SevenHelper.get_sub_table(user_id, sub_table_config.get("browse_log_num", 0)),db_transaction=db_transaction,context=self.context)
                                if task_info_dict["complete_type"] == 1:
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if task_invoke_result_data.success == True:
                    ...
                    request_queue_name = invoke_result_data.data["request_queue_name"]
                    sub_table_config = config.get_value("sub_table_config",{})
                    task_count_model = TaskCountModel(context=self.context,sub_table=SevenHelper.get_sub_table(user_id, sub_table_config.get("task_count_num", 0)))
    ...
    def process_invite_new_user(self,app_id,act_id,module_id,user_id,login_token,from_user_id,handler_name,check_user_nick=True,check_new_user=True,continue_request_expire=5):
        """
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                sub_table_config = config.get_value("sub_table_config",{})
                invite_log_model = InviteLogModel(context=self.context,sub_table=SevenHelper.get_sub_table(user_id, sub_table_config.get("invite_log_num", 0)))
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if top_base_model.check_is_member("",user_info_dict["user_nick"],access_token,app_key, app_secret) == False:
                    ...
                    from_user_info_dict = user_base_model.get_user_info_dict(app_id,act_id,from_user_id)
                    sub_table_config = config.get_value("sub_table_config",{})
                    invite_sub_table = SevenHelper.get_sub_table(user_id, sub_table_config.get("invite_member_log_num", 0))
    ...
    def process_collect_goods(self,app_id,act_id,module_id,user_id,login_token,goods_id,handler_name,check_user_nick=True,continue_request_expire=5):
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                request_queue_name = invoke_result_data.data["request_queue_name"]
                sub_table_config = config.get_value("sub_table_config",{})
                collect_sub_table = SevenHelper.get_sub_table(user_id, sub_table_config.get("collect_log_num", 0))
    ...
    def process_browse_goods(self,app_id,act_id,module_id,user_id,login_token,goods_id,handler_name,daily_repeat_browse=True,check_user_nick=True,continue_request_expire=5):
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                request_queue_name = invoke_result_data.data["request_queue_name"]
                sub_table_config = config.get_value("sub_table_config",{})
                browse_log_model = BrowseLogModel(context=self.context,sub_table=SevenHelper.get_sub_table(user_id, sub_table_config.get("browse_log_num", 0)))
