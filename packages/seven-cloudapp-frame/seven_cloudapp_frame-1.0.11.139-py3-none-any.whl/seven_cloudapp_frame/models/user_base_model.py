...
class UserBaseModel(FrameBaseModel):
    ...
    def get_user_black_dependency_key(self, act_id, user_id):
        ...
        :last_editors: HuangJianYi
        """
        return f"data_cache:dependency_user_black:{act_id}_{user_id}"

    def _delete_user_black_cache(self, act_id, user_id, delay_delete_time=0.1):
        """
    ...
    def get_user_info_dependency_key(self, act_id, id_md5, open_id=""):
        ...
        """
        if id_md5:
            return f"data_cache:dependency_user_info:actid_{act_id}_idmd5_{id_md5}"
        else:
            return f"data_cache:dependency_user_info:actid_{act_id}_openid_{open_id}"

    def _delete_user_info_cache(self, act_id, id_md5, delay_delete_time=0.1):
        """
