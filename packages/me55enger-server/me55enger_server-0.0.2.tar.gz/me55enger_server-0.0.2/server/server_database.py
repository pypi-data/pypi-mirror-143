...
class ServerStorage:
    ...
    def user_login(self, username, ip_address, port):
        """ The function writes the fact of login to the database. """
    ...
    def user_logout(self, username):
        """ The function fixes the disconnection of the user. """
    ...
    def login_history(self, username=None):
        """
        A function that returns the login history for a user or all users.
        Returns a list of tuples.
        """
        query = self.session.query(
            self.AllUsers.name,
...
if __name__ == '__main__':
    ...
    test_db.user_login('client_1', '192.168.0.3', '7777')
    test_db.user_login('client_2', '192.168.0.4', '8888')
    ...
    test_db.add_contact('test1', 'test7')
