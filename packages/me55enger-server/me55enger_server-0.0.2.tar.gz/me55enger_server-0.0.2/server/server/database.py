...
class ServerStorage:
    """
    Shell for working with the server database.
    It uses a SQLite database, implemented with SQLAlchemy ORM
    and uses a classic approach.
    """
...
if __name__ == '__main__':
    ...
    test_db.user_login('test1', '192.168.0.22', 7777, '')
    test_db.user_login('test2', '192.168.0.33', 8888, '')
