...
sys.path.append('../')
from common.variables import MAX_CONNECTIONS, DESTINATION, ACTION, PRESENCE, TIME, MESSAGE, SENDER, USER, \
    MESSAGE_TEXT, RESPONSE_200, ERROR, EXIT, ACCOUNT_NAME, RESPONSE_400, GET_CONTACTS, RESPONSE_202, LIST_INFO, \
    ADD_CONTACT, REMOVE_CONTACT, USERS_REQUEST, RESPONSE, PUBLIC_KEY_REQUEST, RESPONSE_511, DATA, PUBLIC_KEY, \
    RESPONSE_205
...
class MessageProcessor(threading.Thread):
    ...
    Accepts connections, dictionaries - packages
