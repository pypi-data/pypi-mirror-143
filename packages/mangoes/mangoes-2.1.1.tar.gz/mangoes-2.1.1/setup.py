...
setup(
    ...
    download_url='https://gitlab.inria.fr/magnet/mangoes/repository/2.1.1/archive.tar.gz',
    license='LGPL',
    author='Inria - Magnet',
    author_email='nathalie.vauquier@inria.fr',
    description='Mangoes v2 is a toolbox for constructing and evaluating static or contextual token vector '
