...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ecs/waiters.html)
...
class ServicesInactiveWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ecs/waiters.html#servicesinactivewaiter)
    """
...
class ServicesStableWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ecs/waiters.html#servicesstablewaiter)
    """
...
class TasksRunningWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ecs/waiters.html#tasksrunningwaiter)
    """
...
class TasksStoppedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ecs/waiters.html#tasksstoppedwaiter)
    """
