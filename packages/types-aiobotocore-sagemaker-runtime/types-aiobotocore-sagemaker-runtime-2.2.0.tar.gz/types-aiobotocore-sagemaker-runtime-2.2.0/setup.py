...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.SageMakerRuntime 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore sagemaker-runtime type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
