...
class SQSClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_sqs/client.html#exceptions)
        """
    ...
    def tag_queue(self, *, QueueUrl: str, Tags: Mapping[str, str]) -> None:
        """
    ...
    def untag_queue(self, *, QueueUrl: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def get_paginator(
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_sqs/client.html#get_paginator)
        """
