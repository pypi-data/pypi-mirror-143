...
alpha_dict = {
    ...
    "zz1000": {"衍复鲲鹏三号": "SJM688",
               "九坤日享中证1000指数增强1号": "SCP381",
               "启林广进中证1000指数增强1号": "SSU078",
               "明汯量化中小盘增强1号": "SGG585",
               "星阔上林1号中证1000指数增强": "SQF225"},
    "all_market": {"诚奇睿盈优选尊享1号": "SSU249",
                   "明汯股票精选13号": "SSL078",
                   "星阔山海6号股票优选": "SSE288"},
    "cb": {"悬铃C号": "SEK201",
           "百奕传家一号": "SJS027",
...
if __name__ == '__main__':
    AlphaPerformance('20220128', '20220225', alpha_dict).get_construct_result()