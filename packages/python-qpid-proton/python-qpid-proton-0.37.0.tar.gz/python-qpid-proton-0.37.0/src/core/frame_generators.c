...
/* DL[?HIII] */
bool pn_amqp_encode_inner_DLEQHIIIe(pni_emitter_t* emitter, uint64_t arg0, bool arg1, uint16_t arg2, uint32_t arg3, uint32_t arg4, uint32_t arg5)
{
    pni_compound_context compound = make_compound();
    emit_descriptor(emitter, &compound, arg0);
    for (bool small_encoding = true; ; small_encoding = false) {
...
pn_bytes_t pn_amqp_encode_DLEQHIIIe(pn_buffer_t* buffer, uint64_t arg0, bool arg1, uint16_t arg2, uint32_t arg3, uint32_t arg4, uint32_t arg5)
{
    do {
        pni_emitter_t emitter = make_emitter_from_buffer(buffer);
        if (pn_amqp_encode_inner_DLEQHIIIe(&emitter, arg0, arg1, arg2, arg3, arg4, arg5)) {
            size_buffer_to_emitter(buffer, &emitter);
            continue;
        }
        return make_bytes_from_emitter(emitter);
...
size_t pn_amqp_encode_bytes_DLEQHIIIe(char* bytes, size_t size, uint64_t arg0, bool arg1, uint16_t arg2, uint32_t arg3, uint32_t arg4, uint32_t arg5)
{
    pni_emitter_t emitter = make_emitter_from_bytes((pn_rwbytes_t){.size=size, .start=bytes});
    pn_amqp_encode_inner_DLEQHIIIe(&emitter, arg0, arg1, arg2, arg3, arg4, arg5);
    return make_bytes_from_emitter(emitter).size;
}
