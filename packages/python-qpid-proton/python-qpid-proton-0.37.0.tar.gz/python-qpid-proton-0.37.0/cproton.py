...
PN_RAW_CONNECTION_DRAIN_BUFFERS = _cproton.PN_RAW_CONNECTION_DRAIN_BUFFERS
...
def pn_message_get_id(msg):
    return _cproton.pn_message_get_id(msg)

def pn_message_set_id(msg, id):
    return _cproton.pn_message_set_id(msg, id)
...
def pn_message_get_correlation_id(msg):
    return _cproton.pn_message_get_correlation_id(msg)

def pn_message_set_correlation_id(msg, id):
    return _cproton.pn_message_set_correlation_id(msg, id)
...
def pn_connection_driver_read_buffer_sized(arg1, n):
    return _cproton.pn_connection_driver_read_buffer_sized(arg1, n)
