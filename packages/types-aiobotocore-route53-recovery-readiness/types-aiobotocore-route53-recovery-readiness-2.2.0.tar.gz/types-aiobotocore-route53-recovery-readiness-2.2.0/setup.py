...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.Route53RecoveryReadiness 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore route53-recovery-readiness type-annotations boto3-stubs mypy typeshed"
        " autocomplete"
    ),
