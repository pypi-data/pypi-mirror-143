...
from zvtm.contract.base import StatefulService
from zvtm.contract.zvt_info import RecorderState
from zvtm.utils import pd_is_not_null
from zvtm.utils.time_utils import to_pd_timestamp, TIME_FORMAT_DAY, to_time_str, \
    evaluate_size_from_timestamp, is_in_same_interval, now_pd_timestamp, now_time_str
from zvtm.utils.utils import fill_domain_from_dict
...
class TimeSeriesDataRecorder(EntityEventRecorder):
    ...
    def __init__(self,
        ...
        super().__init__(force_update, sleeping_time, exchanges, entity_ids, code=code, codes=codes, day_data=day_data,
                         entity_filters=entity_filters, ignore_failed=ignore_failed)
