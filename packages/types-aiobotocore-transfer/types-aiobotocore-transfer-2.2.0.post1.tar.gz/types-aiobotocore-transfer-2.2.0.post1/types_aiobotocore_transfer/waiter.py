...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_transfer/waiters.html)
...
class ServerOfflineWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_transfer/waiters.html#serverofflinewaiter)
    """
...
class ServerOnlineWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_transfer/waiters.html#serveronlinewaiter)
    """
