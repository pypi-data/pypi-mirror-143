...
from optimeed.core import Performance_ListDataStruct, SaveableObject, AutosaveStruct, create_unique_dirname, getPath_workspace, printIfShown, SHOW_INFO, SingleObjectSaveLoad, order_lists
...
def evaluate_sensitivities(theSensitivityParameters: SensitivityParameters, numberOfCores=2, studyname="sensitivity", indices_to_evaluate=None):
    """
...
def analyse_sobol_plot_indices(theSensitivityParameters: SensitivityParameters, objectives):
    ...
    def split_labels(label_str, level=1):
