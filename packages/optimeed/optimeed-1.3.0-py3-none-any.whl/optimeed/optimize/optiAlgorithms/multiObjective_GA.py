...
from .platypus.core import Problem, TerminationCondition, nondominated, unique, Archive
...
class MyConvergence:
    ...
    def get_graphs(self, *args, **kwargs):
        return self.conv.get_graphs(*args, **kwargs)
...
class ConvergenceTerminationCondition(TerminationCondition):
    ...
    def shouldTerminate(self, algorithm):
        convergence = algorithm.archive.conv
...
class MultiObjective_GA(AlgorithmInterface, Option_class):
    ...
    def __init__(self):
        ...
        self.kwargs_opti_algorithm = dict()  # Additional kwargs opti_algrithm
    ...
    def initialize(self, initialVectorGuess, listOfOptimizationVariables):
        ...
        kwargs = {"generator": MyGenerator(initialVectorGuess), "convergence": EvolutionaryConvergence()}
        ...
        kwargs.update(self.kwargs_opti_algorithm)
    ...
    def set_kwargs_opti_algorithm(self, thekwargs):
        self.kwargs_opti_algorithm = thekwargs
