...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html)
...
class ImportExportClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#can_paginate)
        """

    async def cancel_job(self, *, JobId: str, APIVersion: str = ...) -> CancelJobOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#cancel_job)
        """
    ...
    async def create_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#create_job)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#generate_presigned_url)
        """
    ...
    async def get_shipping_label(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#get_shipping_label)
        """

    async def get_status(self, *, JobId: str, APIVersion: str = ...) -> GetStatusOutputTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#get_status)
        """
    ...
    async def list_jobs(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#list_jobs)
        """
    ...
    async def update_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#update_job)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_importexport/client.html#get_paginator)
        """
