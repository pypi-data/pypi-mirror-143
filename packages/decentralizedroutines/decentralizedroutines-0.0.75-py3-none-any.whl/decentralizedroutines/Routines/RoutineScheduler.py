...
class RoutineScheduler:
    ...
    def LoadSchedule(self):
        ...
        # create schedule
        schedpath = Path(os.environ['SOURCE_DIRECTORY'])
    ...
    def RunPendingRoutines(self):   
        ...
        if len(urunroutine)>0:
            ...
            for r in urunroutine:
                Logger.log.info('Running routine %s ...' % (r))
                ...
                for i,s in runnow.iterrows():
                    Logger.log.info('Executing process %s ...' % (s['Script']))
                    ...
                    Logger.log.info('Executing process %s DONE!' % (s['Script']))
                
                Logger.log.info('Running routine %s DONE!' % (r))
