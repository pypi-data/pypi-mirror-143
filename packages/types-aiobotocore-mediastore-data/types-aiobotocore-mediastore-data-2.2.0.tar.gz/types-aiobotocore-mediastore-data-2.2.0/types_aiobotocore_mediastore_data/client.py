...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html)
...
class MediaStoreDataClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html#can_paginate)
        """

    async def delete_object(self, *, Path: str) -> Dict[str, Any]:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html#delete_object)
        """

    async def describe_object(self, *, Path: str) -> DescribeObjectResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html#describe_object)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html#generate_presigned_url)
        """

    async def get_object(self, *, Path: str, Range: str = ...) -> GetObjectResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html#get_object)
        """
    ...
    async def list_items(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html#list_items)
        """
    ...
    async def put_object(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html#put_object)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_items"]) -> ListItemsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediastore_data/client.html#get_paginator)
        """
