...
import schedule
import logging
from src.jobs import products_jobs, system_jobs
...
for module in modules:
    if module.job_name != 'internaliza_pedidos_pagos_job':
        schedule_job({
...
# Job para notificar execucao periodica do Oking a cada 2 horas
schedule_job({
