...
SIMPEL_PROJECTS_DEFAULTS: Dict[str, Any] = {
    "WORKORDER_ADMIN": "simpel.simpel_projects.admin.PolymorphicWorkOrderAdmin",
    "TASK_ADMIN": "simpel.simpel_projects.admin.TaskAdmin",
    "DELIVERABLE_ADMIN": "simpel.simpel_projects.admin.DeliverableAdmin",
    "CANCELATION_DELIVERABLE_ADMIN": "simpel.simpel_projects.admin.CancelationDeliverableAdmin",
    "DOCUMENT_DELIVERABLE_ADMIN": "simpel.simpel_projects.admin.DocumentDeliverableAdmin",
    "FINAL_DOCUMENT_ADMIN": "simpel.simpel_projects.admin.FinalDocumentAdmin",
}
...
class AppSettings:
    """
    This module is largely inspired by django-rest-framework settings.
    This module provides the `simpel_projects_settings` object, that is used to access
    app settings, checking for user settings first, then falling
    back to the defaults.
    """
...
simpel_projects_settings = AppSettings(None, SIMPEL_PROJECTS_DEFAULTS, IMPORT_STRINGS)


def reload_simpel_projects_settings(*args, **kwargs):
    setting = kwargs["setting"]
    if setting == "SIMPEL_PROJECTS":
        simpel_projects_settings.reload()


setting_changed.connect(reload_simpel_projects_settings)
