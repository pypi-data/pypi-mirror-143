...
def copy_url(task_id: TaskID, url: str, path: str) -> None:
    ...
    with open(path, "wb") as dest_file:
        ...
        # If the chunk size if too low then time will be lost switching between reads and writes,
        # and the limit of the chunk size is only limited by of what you can store in memory.
        # So the chunk size should be kept to a reasonable number in this case 32768
