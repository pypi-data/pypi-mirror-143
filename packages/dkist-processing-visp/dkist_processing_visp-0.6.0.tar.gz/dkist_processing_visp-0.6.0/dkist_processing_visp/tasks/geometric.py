...
class GeometricCalibration(
    ...
    def run(self) -> None:
        ...
        For each beam.
            ...
            - Gather dark/lamp corrected frames
        ...
        with self.apm_processing_step("Computing and logging quality metrics"):
            no_of_raw_geo_frames: int = self.metadata_count_after_beam_split(
                tags=[
                    VispTag.input(),
                    VispTag.frame(),
    ...
    def basic_corrected_data(self, beam: int, modstate: int) -> np.ndarray:
        """
        Dark/lamp corrected data array for a single beam and modstate.
        ...
        -------
        np.ndarray
            Dark/ lamp corrected data array
        """
