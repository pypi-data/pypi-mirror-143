...
l0_pipeline.add_node(task=SplitBeams, upstreams=VispL0QualityMetrics)
...
l0_pipeline.add_node(task=AddDatasetReceiptAccount, upstreams=[AssembleVispMovie, SubmitQuality])
