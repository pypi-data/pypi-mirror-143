...
setuptools.setup(
    ...
    version='0.0.10',                                # important for updates
    license='MIT',                                  # should match your chosen license
    description='Testing installation of Package',
    author='Antoine Choukroun',
    author_email='antcho1@amu.edu.pl',
   
    install_requires=['numpy', 'pandas', 'photutils', 'matplotlib', 'astropy', 'opencv-python', 'glob2', 'keras', 'tqdm'],                  # list all packages that your package uses
