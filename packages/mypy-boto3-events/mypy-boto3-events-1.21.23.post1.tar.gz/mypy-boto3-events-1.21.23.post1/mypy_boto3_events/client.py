...
class EventBridgeClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_events/client.html#exceptions)
        """
    ...
    def delete_rule(self, *, Name: str, EventBusName: str = ..., Force: bool = ...) -> None:
        """
    ...
    def disable_rule(self, *, Name: str, EventBusName: str = ...) -> None:
        """
    ...
    def enable_rule(self, *, Name: str, EventBusName: str = ...) -> None:
        """
    ...
    def get_paginator(
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_events/client.html#get_paginator)
        """
