...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html)
...
class ACMClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#exceptions)
        """
    ...
    async def add_tags_to_certificate(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#add_tags_to_certificate)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#can_paginate)
        """

    async def delete_certificate(self, *, CertificateArn: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#delete_certificate)
        """
    ...
    async def describe_certificate(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#describe_certificate)
        """
    ...
    async def export_certificate(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#export_certificate)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#generate_presigned_url)
        """
    ...
    async def get_account_configuration(self) -> GetAccountConfigurationResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#get_account_configuration)
        """

    async def get_certificate(self, *, CertificateArn: str) -> GetCertificateResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#get_certificate)
        """
    ...
    async def import_certificate(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#import_certificate)
        """
    ...
    async def list_certificates(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#list_certificates)
        """
    ...
    async def list_tags_for_certificate(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#list_tags_for_certificate)
        """
    ...
    async def put_account_configuration(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#put_account_configuration)
        """
    ...
    async def remove_tags_from_certificate(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#remove_tags_from_certificate)
        """

    async def renew_certificate(self, *, CertificateArn: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#renew_certificate)
        """
    ...
    async def request_certificate(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#request_certificate)
        """
    ...
    async def resend_validation_email(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#resend_validation_email)
        """
    ...
    async def update_certificate_options(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#update_certificate_options)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#get_paginator)
        """
    ...
    def get_waiter(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm/client.html#get_waiter)
        """
