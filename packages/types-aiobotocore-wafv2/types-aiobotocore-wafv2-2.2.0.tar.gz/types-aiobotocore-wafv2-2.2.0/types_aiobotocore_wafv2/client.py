...
class WAFV2Client(AioBaseClient):
    ...
    async def generate_mobile_sdk_release_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_wafv2/client.html#generate_mobile_sdk_release_url)
        """
    ...
    async def get_mobile_sdk_release(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_wafv2/client.html#get_mobile_sdk_release)
        """
    ...
    async def list_mobile_sdk_releases(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_wafv2/client.html#list_mobile_sdk_releases)
        """
