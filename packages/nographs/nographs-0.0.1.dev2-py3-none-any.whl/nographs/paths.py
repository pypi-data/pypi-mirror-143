...
class Paths(ABC):
    """A container that stores the paths ("ways" through a graph) that have
    been generated by one of the traversal algorithms.
    ...
    *Paths* provides methods to access and iterate a path.
    ...
    store two paths that lead to the same vertex.
    ...
    Objects of concrete subclasses of this class are not intended to be
    created by application code. On demand, the library will create Paths
    objects.
    """
    ...
    def append_edge(self, from_vertex: [Vertex], to_vertex_id: Hashable, to_edge: Any):
        ...
        from_vertex and ends with the given vertex (resp. id). In case,
        to_edge provides additional edge data, it is stored in the path,too.
        """

    def __contains__(self, vertex: [Vertex]) -> bool:
        """Returns whether a path for *vertex* exists in the *Paths*
...
class PathsOfUnlabeledEdges(Paths):
    def __init__(self, predecessor: dict, vertex_to_id: Optional[VertexToID]):
        ...
        :param predecessor: The predecessor information of the paths will be
           stored in the given dictionary.
...
class PathsOfLabeledEdges(Paths):
    def __init__(
        ...
        :param predecessor: The predecessor information of the paths will
            be stored in the given dictionary.
