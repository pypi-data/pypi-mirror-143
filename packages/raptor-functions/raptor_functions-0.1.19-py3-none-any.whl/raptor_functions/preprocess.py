...
#     if (exp_name[-2].islower()) or ("Neg" in exp_name) or ("Control" in exp_name):
#         return "Control"
#     else:
#         return "Covid"
...
def get_label(f):   
    ...
    if ("Neg" in exp_name) or ("Control" in exp_name) or ('CONTROL' in exp_name):
        return "Control"
    elif ("Pos" in exp_name) or ("Covid" in exp_name) or ('COVID' in exp_name):
        return "Covid"
