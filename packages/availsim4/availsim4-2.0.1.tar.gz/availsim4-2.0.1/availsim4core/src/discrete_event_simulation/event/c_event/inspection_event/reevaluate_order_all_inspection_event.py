...
class ReevaluateOrderAllInspectionEvent(ComponentCEvent):
    """
    ...
    def __eq__(self, other):
        if not isinstance(self, ReevaluateOrderAllInspectionEvent):
    ...
    def __str__(self):
        return f"ReevaluateOrderAllInspectionEvent:: " \
    ...
    def generate_b_events(self, absolute_simulation_time):
        ...
        return BEventGenerator.get_b_events_inspection(absolute_simulation_time,
                                                       self.context,
                                                       self.component)
