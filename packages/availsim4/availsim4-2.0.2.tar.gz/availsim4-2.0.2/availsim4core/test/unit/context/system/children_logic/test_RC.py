...
class test_RC(unittest.TestCase):
    
    context = Context(None, None, None)
    
    # number_of_running_basic, number_of_failed_basic, number_of_running_compound, number_of_failed_compound
    scenario_1 = [8, 0, 0, 0, "6RC", context,  Status.RUNNING]
    scenario_2 = [6, 2, 0, 0, "6RC", context,  Status.DEGRADED]
    scenario_3 = [4, 4, 0, 0, "6RC", context,  Status.FAILED]
    scenario_4 = [0, 0, 8, 0, "6RC", context,  Status.RUNNING]
    scenario_5 = [0, 0, 6, 2, "6RC", context,  Status.DEGRADED]
    scenario_6 = [0, 0, 4, 4, "6RC", context,  Status.FAILED]
    scenario_7 = [4, 0, 4, 0, "6RC", context,  Status.RUNNING]
    scenario_8 = [3, 1, 4, 0, "6RC", context,  Status.DEGRADED]
    scenario_9 = [2, 2, 2, 2, "6RC", context,  Status.FAILED]
    ...
    def test_runner(self):
        for number_of_running_basic, number_of_failed_basic, \
            ...
            with self.subTest():
                self._evaluate_generic(number_of_running_basic, number_of_failed_basic,
                                       number_of_running_compound, number_of_failed_compound,
                                       logic, context, expected_result)
