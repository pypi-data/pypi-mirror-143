simulink_mapping = [
    ...
    # ('external_input_sizes'      , 'ExtUSize'  , 'Size of block input data for the root system (used when inputs are variable dimensions)'),
    # ('external_outputs'          , 'ExtY'      , 'Block output data for the root system'),
    # ('external_output_sizes'     , 'ExtYSize'  , 'Size of block output data for the root system'),
    ...
    ('const_parameters_with_init', 'ConstInitP', 'Initialization data for constant parameters in the system'),
    ...
    # ('global_TID'                , 'GlobalTID' , 'Used for sample time for states in referenced models'),
    # ('invariant_signals'         , 'Invariant' , 'Invariant signals'),
    # ('n_stages'                  , 'NSTAGES'   , 'Solver macro'),
    # ('object'                    , 'Obj'       , 'Used by ERT C++ code generation to refer to referenced model objects'),
    # ('timing_bridge'             , 'TimingBrdg', 'Timing information stored in different data structures'),
    # ('shared_DSM'                , 'SharedDSM' , 'Shared local data stores, which are Data Store Memory blocks with Share across model instances selected'),
