...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.MarketplaceCommerceAnalytics 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore marketplacecommerceanalytics type-annotations boto3-stubs mypy typeshed"
        " autocomplete"
    ),
