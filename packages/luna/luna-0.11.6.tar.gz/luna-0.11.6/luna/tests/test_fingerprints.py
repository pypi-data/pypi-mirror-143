...
working_path = f"{LUNA_PATH}/luna/tests"

inputs_path = f"{working_path}/inputs"
lig_file = f"{inputs_path}/ligands.mol2"

results_path = f"{working_path}/outputs/test_fingerprints"
...
class FingerprintTest(unittest.TestCase):
    ...
    def test_automatic_ifps_creation(self):
        ...
        self.assertEqual(expected_entries, set([e.to_string() for e in pli_obj.entries]))
        ...
        self.assertTrue(exists(ifp_out1), "File '%s' was not found." % ifp_out1)
    ...
    def test_manual_ifps_creation(self):
        ...
        expected_results = {
            "atm_grps_len": [("protein:ZINC000012442563", 485), ("protein:ZINC000343043015", 422)],
