...
setup(
  ...
  version = '0.14.0',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/mccutcheonlab/trompy/archive/v0.14.0-beta.tar.gz',    # I explain this later on
