...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, headers=None, sock_connect_timeout=None, name=None, sock_read_timeout=None, pulp_last_updated=None, max_retries=None, rate_limit=None, url=None, pulp_href=None, tls_validation=None, total_timeout=None, pulp_labels=None, client_cert=None, download_concurrency=None, ca_cert=None, connect_timeout=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
