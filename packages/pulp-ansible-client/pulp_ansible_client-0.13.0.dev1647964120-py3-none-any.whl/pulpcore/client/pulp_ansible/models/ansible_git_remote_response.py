...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, max_retries=None, pulp_last_updated=None, client_cert=None, proxy_url=None, connect_timeout=None, ca_cert=None, rate_limit=None, download_concurrency=None, headers=None, sock_read_timeout=None, pulp_labels=None, total_timeout=None, sock_connect_timeout=None, url=None, pulp_href=None, tls_validation=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
