...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, headers=None, sock_connect_timeout=None, name=None, sock_read_timeout=None, max_retries=None, rate_limit=None, url=None, tls_validation=None, total_timeout=None, proxy_username=None, pulp_labels=None, proxy_password=None, password=None, client_key=None, client_cert=None, username=None, download_concurrency=None, ca_cert=None, connect_timeout=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
