...
class AnsibleGitRemote(object):
    ...
    def __init__(self, password=None, proxy_username=None, max_retries=None, client_cert=None, client_key=None, proxy_url=None, connect_timeout=None, ca_cert=None, rate_limit=None, download_concurrency=None, headers=None, sock_read_timeout=None, pulp_labels=None, total_timeout=None, sock_connect_timeout=None, url=None, username=None, tls_validation=None, name=None, proxy_password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
