...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html)
...
class CloudHSMV2Client(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#can_paginate)
        """
    ...
    async def copy_backup_to_region(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#copy_backup_to_region)
        """
    ...
    async def create_cluster(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#create_cluster)
        """
    ...
    async def create_hsm(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#create_hsm)
        """

    async def delete_backup(self, *, BackupId: str) -> DeleteBackupResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#delete_backup)
        """

    async def delete_cluster(self, *, ClusterId: str) -> DeleteClusterResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#delete_cluster)
        """
    ...
    async def delete_hsm(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#delete_hsm)
        """
    ...
    async def describe_backups(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#describe_backups)
        """
    ...
    async def describe_clusters(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#describe_clusters)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#generate_presigned_url)
        """
    ...
    async def initialize_cluster(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#initialize_cluster)
        """
    ...
    async def list_tags(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#list_tags)
        """
    ...
    async def modify_backup_attributes(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#modify_backup_attributes)
        """
    ...
    async def modify_cluster(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#modify_cluster)
        """

    async def restore_backup(self, *, BackupId: str) -> RestoreBackupResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#restore_backup)
        """

    async def tag_resource(
        self, *, ResourceId: str, TagList: Sequence["TagTypeDef"]
    ) -> Dict[str, Any]:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#tag_resource)
        """

    async def untag_resource(self, *, ResourceId: str, TagKeyList: Sequence[str]) -> Dict[str, Any]:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#untag_resource)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudhsmv2/client.html#get_paginator)
        """
