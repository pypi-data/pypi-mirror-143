...
class DecoratedServeDeployment(object):
    ...
    def __init__(self, id=None, status=None, name=None, cluster_id=None, job_id=None, creator_id=None, namespace_id=None, created_at=None, finished_at=None, http_route=None, grafana_dashboard_url=None, class_name=None, grafana_dashboard_state=None, version=None, cluster=None, creator=None, namespace=None, num_actors=None, local_vars_configuration=None):  # noqa: E501
    ...
    def namespace_id(self):
        ...
        ID of the Namespace this Deployment is using.  # noqa: E501
    ...
    def num_actors(self, num_actors):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and num_actors is None:  # noqa: E501
            raise ValueError("Invalid value for `num_actors`, must not be `None`")  # noqa: E501
