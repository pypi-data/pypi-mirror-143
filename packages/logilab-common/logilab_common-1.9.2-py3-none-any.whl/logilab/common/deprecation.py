...
def _get_package_name(file_path: str) -> Optional[str]:
    ...
    return _cached_path_to_package.get(file_path)
    ...
    def wrapped(*args, **kwargs):
        send_warning(
            ...
            deprecation_class_kwargs={
                ...
                "version": version,
                "package": _get_package_name(inspect.getfile(new_function)),
            },
            stacklevel=3,
            version=version,
            ...
            if old_argument_name in kwargs:
                send_warning(
                    ...
                    deprecation_class_kwargs={
                        ...
                        "version": version,
                        "package": _get_package_name(inspect.getfile(func)),
                    },
                    stacklevel=3,
                    version=version,
            ...
            send_warning(
                ...
                deprecation_class_kwargs=getattr(
                    ...
                    "__deprecation_warning_class_kwargs__",
                    {
                        ...
                        "package": _get_package_name(inspect.getfile(cls)),
        ...
        def _get_old(self) -> Any:
            send_warning(
                ...
                deprecation_class_kwargs={
                    ...
                    "new_name": new_name,
                    "version": version,
                    "package": _get_package_name(inspect.getfile(self.__class__)),
                },
                stacklevel=3,
                version=version,
    ...
    def callnew(*args, **kwargs):
        ...
        send_warning(
            ...
            deprecation_class_kwargs={
                ...
                "version": version,
                "package": _get_package_name(inspect.getfile(getattr(m, object_name))),
            },
            version=version,
            stacklevel=stacklevel + 1,
...
def class_renamed(
    ...
    if deprecated_warning_kwargs is None:
        class_dict["__deprecation_warning_class_kwargs__"] = {
            ...
            "version": version,
            "package": _get_package_name(inspect.getfile(new_class)),
        }
    else:
