from slbs_runtime.excepthook import ExceptionHandler
from slbs_runtime.excepthook._util import RateLimiter
...
class SentryExceptionHandler(ExceptionHandler):
    ...
    slbs's ApplicationContext performs this call automatically for handlers
    ...
    parameter. You can see its use near the bottom of the following snippet:
        ...
        from slbs_runtime import platform
        from slbs_runtime.application_context import ApplicationContext, \
        ...
        class AppContext(ApplicationContext):
            ...
            def sentry(self):
                ...
                # default, but set to "production" when you do `slbs release`.
