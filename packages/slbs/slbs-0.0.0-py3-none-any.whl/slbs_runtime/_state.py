"""
This INTERNAL module is used to manage slbs_runtime's global state. Having it
here, in one central place, allows slbs's test suite to manipulate the state to
