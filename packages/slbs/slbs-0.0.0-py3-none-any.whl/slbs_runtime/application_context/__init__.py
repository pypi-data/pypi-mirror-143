...
from slbs_runtime import _state, _frozen, _source
from slbs_runtime._resources import ResourceLocator
from slbs_runtime._signal import SignalWakeupHandler
from slbs_runtime.excepthook import _Excepthook, StderrExceptionHandler
from slbs_runtime.platform import is_windows, is_mac
...
def cached_property(getter):
    ...
    information, please consult the Manual:  # TODO replace with wiki
...
class _ApplicationContext:
    """
    The main point of contact between your application and slbs. For information
    on how to use it, please see the Manual:  # TODO replace with wiki
    ...
    def run(self):
        ...
        See eg. slbs's tutorial.  # TODO implement tutorial
        """
    ...
    def exception_handlers(self):
        ...
        occurs. See the documentation of module `slbs_runtime.excepthook` for
        more information.
        """
    ...
    def licensing(self):
        ...
        application. For more information, see:
            https://build-system.fman.io/manual#license-keys  # TODO replace with wiki
        """

        # slbs's licensing implementation incurs a dependency on Python library
        # `rsa`. We don't want to force all users to install this library.
        # So we import slbs_runtime.licensing here, instead of at the top of this
        # file. This lets people who don't use licensing avoid the dependency.
        from slbs_runtime.licensing import _Licensing
