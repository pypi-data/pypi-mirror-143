...
from slbs_runtime._slbs import get_default_profiles, get_core_settings, \
    filter_public_settings
from slbs_runtime._settings import load_settings
...
def default_path(path_str):
    defaults_dir = join(dirname(__file__), pardir, 'slbs', '_defaults')
