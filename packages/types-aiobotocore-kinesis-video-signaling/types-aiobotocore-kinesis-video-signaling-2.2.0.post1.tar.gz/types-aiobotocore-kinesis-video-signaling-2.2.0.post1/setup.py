...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.KinesisVideoSignalingChannels 2.2.0 service generated"
    ...
    keywords=(
        "aiobotocore kinesis-video-signaling type-annotations boto3-stubs mypy typeshed"
        " autocomplete"
    ),
