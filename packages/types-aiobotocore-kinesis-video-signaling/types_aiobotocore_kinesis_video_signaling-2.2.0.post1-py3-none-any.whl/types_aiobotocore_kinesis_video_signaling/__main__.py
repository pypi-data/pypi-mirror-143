...
def print_info() -> None:
    ...
    """
    print(
        "Type annotations for aiobotocore.KinesisVideoSignalingChannels 2.2.0\nVersion:        "
        " 2.2.0.post1\nBuilder version: 7.4.1\nDocs:           "
        " https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_kinesis_video_signaling//\nBoto3"
        " docs:     "
