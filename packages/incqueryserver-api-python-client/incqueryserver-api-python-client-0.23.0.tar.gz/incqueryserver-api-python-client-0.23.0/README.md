...
- API version: placeHolderApiVersion
...
*DemoApi* | [**calculate_element_link**](docs/DemoApi.md#calculate_element_link) | **POST** /demo.provideElementLinks | Calculate internal or external element / model links of a specific element.
*DemoApi* | [**calculate_model_compartment_link**](docs/DemoApi.md#calculate_model_compartment_link) | **POST** /demo.provideCompartmentLinks | Calculate a link that navigates to the model compartment in it&#39;s original modeling tool
*DemoApi* | [**compute_compartment_delta**](docs/DemoApi.md#compute_compartment_delta) | **POST** /demo.computeCompartmentDelta | Describes (an approximation of) the difference between two compartments.
...
*DemoApi* | [**discover_compartments**](docs/DemoApi.md#discover_compartments) | **POST** /demo.listChildrenNodes | Discover compartments in repository structure
...
*DemoApi* | [**register_modeling_tool_endpoint**](docs/DemoApi.md#register_modeling_tool_endpoint) | **POST** /demo.registerModelingToolEndpoint | Register the user-facing endpoint of the modeling tool for a given compartment.
...
*PersistentIndexApi* | [**compute_compartment_delta**](docs/PersistentIndexApi.md#compute_compartment_delta) | **POST** /demo.computeCompartmentDelta | Describes (an approximation of) the difference between two compartments.
...
## Documentation For Models
 ...
 - [CompartmentLink](docs/CompartmentLink.md)
 - [CompartmentLinkRequest](docs/CompartmentLinkRequest.md)
 - [CompartmentLinkResponse](docs/CompartmentLinkResponse.md)
 ...
 - [ComputeCompartmentDeltaRequest](docs/ComputeCompartmentDeltaRequest.md)
 - [ComputeCompartmentDeltaResponse](docs/ComputeCompartmentDeltaResponse.md)
 - [ConfluenceRepositoryStructure](docs/ConfluenceRepositoryStructure.md)
 - [ConfluenceSpaceDescriptor](docs/ConfluenceSpaceDescriptor.md)
 ...
 - [DescriptorWithElementLink](docs/DescriptorWithElementLink.md)
 - [DiscoverCompartmentRequestBody](docs/DiscoverCompartmentRequestBody.md)
 - [DiscoverCompartmentsResponse](docs/DiscoverCompartmentsResponse.md)
 ...
 - [ElementLink](docs/ElementLink.md)
 - [ElementLinkRequest](docs/ElementLinkRequest.md)
 - [ElementLinkResponse](docs/ElementLinkResponse.md)
 - [ElementStoreEntry](docs/ElementStoreEntry.md)
 - [ElementToDiagram](docs/ElementToDiagram.md)
 ...
 - [ExecuteQueryOneOffRequest](docs/ExecuteQueryOneOffRequest.md)
 ...
 - [GetDiagramsRequestBody](docs/GetDiagramsRequestBody.md)
 - [GetDiagramsResponse](docs/GetDiagramsResponse.md)
 ...
 - [RegisterModelingToolEndpoint](docs/RegisterModelingToolEndpoint.md)
 - [RepositoryNode](docs/RepositoryNode.md)
