...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html)
...
class MediaPackageVodClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#can_paginate)
        """
    ...
    async def configure_logs(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#configure_logs)
        """
    ...
    async def create_asset(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#create_asset)
        """
    ...
    async def create_packaging_configuration(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#create_packaging_configuration)
        """
    ...
    async def create_packaging_group(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#create_packaging_group)
        """
    ...
    async def delete_asset(self, *, Id: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#delete_asset)
        """
    ...
    async def delete_packaging_configuration(self, *, Id: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#delete_packaging_configuration)
        """
    ...
    async def delete_packaging_group(self, *, Id: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#delete_packaging_group)
        """
    ...
    async def describe_asset(self, *, Id: str) -> DescribeAssetResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#describe_asset)
        """
    ...
    async def describe_packaging_configuration(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#describe_packaging_configuration)
        """
    ...
    async def describe_packaging_group(self, *, Id: str) -> DescribePackagingGroupResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#describe_packaging_group)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#generate_presigned_url)
        """
    ...
    async def list_assets(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#list_assets)
        """
    ...
    async def list_packaging_configurations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#list_packaging_configurations)
        """
    ...
    async def list_packaging_groups(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#list_packaging_groups)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#list_tags_for_resource)
        """
    ...
    async def tag_resource(self, *, ResourceArn: str, Tags: Mapping[str, str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#untag_resource)
        """
    ...
    async def update_packaging_group(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#update_packaging_group)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_assets"]) -> ListAssetsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage_vod/client.html#get_paginator)
        """
