...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.MigrationHubConfig 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore migrationhub-config type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
