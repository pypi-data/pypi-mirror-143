...
from .const import AUTH_SERVER, MAX_POLLING_RETRY, POLLING_SLEEP_TIME_IN_SEC
...
class AuthServiceClient:
    def __init__(self, host=AUTH_SERVER):
        self.host = host
    ...
    def get_device_code(self, client_id):
        ...
        res = res.json()
        return f"{self.host}/{res['userCode']}", res["userCode"], res["deviceCode"]
