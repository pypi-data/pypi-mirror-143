...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html)
...
class CodeStarconnectionsClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#can_paginate)
        """
    ...
    async def create_connection(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#create_connection)
        """
    ...
    async def create_host(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#create_host)
        """
    ...
    async def delete_connection(self, *, ConnectionArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#delete_connection)
        """
    ...
    async def delete_host(self, *, HostArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#delete_host)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#generate_presigned_url)
        """
    ...
    async def get_connection(self, *, ConnectionArn: str) -> GetConnectionOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#get_connection)
        """
    ...
    async def get_host(self, *, HostArn: str) -> GetHostOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#get_host)
        """
    ...
    async def list_connections(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#list_connections)
        """
    ...
    async def list_hosts(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#list_hosts)
        """
    ...
    async def list_tags_for_resource(self, *, ResourceArn: str) -> ListTagsForResourceOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#list_tags_for_resource)
        """
    ...
    async def tag_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#untag_resource)
        """
    ...
    async def update_host(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar_connections/client.html#update_host)
        """
