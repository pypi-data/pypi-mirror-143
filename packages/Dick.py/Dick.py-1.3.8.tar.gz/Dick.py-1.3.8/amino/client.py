...
class Client(Callbacks, SocketHandler):
    ...
    def login(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/auth/login", headers=self.parse_headers(data=data,deviceId=self.devicee()), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def devicee(self):
        d=requests.get("https://ed-generators.herokuapp.com/device?").text
        return d
