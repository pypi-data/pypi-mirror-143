...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm_pca/waiters.html)
...
class AuditReportCreatedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm_pca/waiters.html#auditreportcreatedwaiter)
    """
...
class CertificateAuthorityCSRCreatedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm_pca/waiters.html#certificateauthoritycsrcreatedwaiter)
    """
...
class CertificateIssuedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_acm_pca/waiters.html#certificateissuedwaiter)
    """
