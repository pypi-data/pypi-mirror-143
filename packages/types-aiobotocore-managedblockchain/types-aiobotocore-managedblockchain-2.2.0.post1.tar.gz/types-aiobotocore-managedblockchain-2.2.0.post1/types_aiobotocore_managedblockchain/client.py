...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html)
...
class ManagedBlockchainClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#can_paginate)
        """
    ...
    async def create_member(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#create_member)
        """
    ...
    async def create_network(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#create_network)
        """
    ...
    async def create_node(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#create_node)
        """
    ...
    async def create_proposal(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#create_proposal)
        """
    ...
    async def delete_member(self, *, NetworkId: str, MemberId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#delete_member)
        """
    ...
    async def delete_node(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#delete_node)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#generate_presigned_url)
        """
    ...
    async def get_member(self, *, NetworkId: str, MemberId: str) -> GetMemberOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#get_member)
        """
    ...
    async def get_network(self, *, NetworkId: str) -> GetNetworkOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#get_network)
        """
    ...
    async def get_node(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#get_node)
        """
    ...
    async def get_proposal(self, *, NetworkId: str, ProposalId: str) -> GetProposalOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#get_proposal)
        """
    ...
    async def list_invitations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#list_invitations)
        """
    ...
    async def list_members(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#list_members)
        """
    ...
    async def list_networks(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#list_networks)
        """
    ...
    async def list_nodes(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#list_nodes)
        """
    ...
    async def list_proposal_votes(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#list_proposal_votes)
        """
    ...
    async def list_proposals(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#list_proposals)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#list_tags_for_resource)
        """
    ...
    async def reject_invitation(self, *, InvitationId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#reject_invitation)
        """
    ...
    async def tag_resource(self, *, ResourceArn: str, Tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#untag_resource)
        """
    ...
    async def update_member(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#update_member)
        """
    ...
    async def update_node(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#update_node)
        """
    ...
    async def vote_on_proposal(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_managedblockchain/client.html#vote_on_proposal)
        """
