...
from SailTestFrame.common.my_logger import MyLogger
from SailTestFrame.configs.global_config import get_config
    ...
    with open(output_folder + os.sep + "report.html", "w") as report_file_handler:
        ...
        if len(failed_cases) > 0:
            ...
            for failed_testcase in failed_cases:
                ...
                report_file_handler.write(
                    "<a title='Click to go to test center' href='https://testcenter.englishtown.com/"
                    "testlink/linkto.php?tprojectPrefix=ET&item=testcase&id=ET-%s'><font color='red'>" %
                ...
                try:
                    ...
                    if len(list(failed_testcase["screenshot_list"])) > 1:
                        report_file_handler.write(
                            "<a title='ReRun_Screenshot' href='%s'> <font color='#F18428'> - "
                            "ReRun_Screenshot</font> </a>" %
