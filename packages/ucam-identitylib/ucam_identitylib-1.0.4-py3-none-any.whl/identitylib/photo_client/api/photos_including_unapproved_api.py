...
class PhotosIncludingUnapprovedApi(object):
    ...
    def v1beta1_photos_list(
        ...
        **kwargs
        ...
        Args:
            identifier (str): PhotoIdentifier to get photos for - in the format `<value>@<scheme>`
    ...
    def v1beta1_photos_retrieve(
        ...
        **kwargs
        ...
        """Get a photo by photo UUID  # noqa: E501
          ...
          # Get Photo  This endpoint returns the details and metadata for a single Photo by Photo UUID. Note that this UUID is the `id` field included on a Photo, not a PhotoIdentifier. To get Photos related to a PhotoIdentifier use the `Get Photo List by PhotoIdentifier` endpoint documented above.  This endpoint will return a `404` status code if a Photo cannot be found by the UUID provided.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
