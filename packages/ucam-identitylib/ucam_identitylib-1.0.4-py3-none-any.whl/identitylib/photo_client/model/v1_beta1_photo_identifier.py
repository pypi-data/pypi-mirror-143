...
class V1Beta1PhotoIdentifier(ModelNormal):
    ...
    def _from_openapi_data(cls, scheme, value, *args, **kwargs):  # noqa: E501
        """V1Beta1PhotoIdentifier - a model defined in OpenAPI

        Args:
            scheme (bool, date, datetime, dict, float, int, list, str, none_type): The identifier's scheme
