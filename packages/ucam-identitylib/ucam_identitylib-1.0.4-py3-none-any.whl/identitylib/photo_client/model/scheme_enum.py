...
class SchemeEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["v1.person.identifiers.cam.ac.uk", "person.v1.student-records.university.identifiers.cam.ac.uk", "person.v1.human-resources.university.identifiers.cam.ac.uk", "photo.v1.legacy-card.university.identifiers.cam.ac.uk", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["v1.person.identifiers.cam.ac.uk", "person.v1.student-records.university.identifiers.cam.ac.uk", "person.v1.human-resources.university.identifiers.cam.ac.uk", "photo.v1.legacy-card.university.identifiers.cam.ac.uk", ]  # noqa: E501
