...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../style/play-in-file.svg'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../style/fastforward-in-file.svg'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const plugin = {
    ...
    activate: (app, manager, settingRegistry, palette) => {
        ...
        const icon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_5__.LabIcon({
            ...
            svgstr: Object(function webpackMissingModule() { var e = new Error("Cannot find module '../style/play-in-file.svg'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
        });
        const icon2 = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_5__.LabIcon({
            ...
            svgstr: Object(function webpackMissingModule() { var e = new Error("Cannot find module '../style/fastforward-in-file.svg'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
        });
...
//# sourceMappingURL=lib_index_js.af2732335f64cbe6f4f7.js.map