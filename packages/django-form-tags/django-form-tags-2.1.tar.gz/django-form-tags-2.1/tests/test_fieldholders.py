    ...
    def test_fieldholder_radio(self):
        ...
        if DJANGO_VERSION >= 4:
            self.assertHTMLEqual(
                ...
                """
                <div class="fieldholder ">
                    <label title="Radio field">Radio field:</label>
                    <div class="fieldwrapper fieldwrapper--choicefield fieldwrapper--radioselect ">
                        <div id="id_radio_field">
                            <div><label for="id_radio_field_0"><input checked="checked" class="" id="id_radio_field_0" name="radio_field" type="radio" value="1"> a</label></div>
                            <div><label for="id_radio_field_1"><input class="" id="id_radio_field_1" name="radio_field" type="radio" value="2"> b</label></div>
                        </div>
                    </div>
                </div>
            """,
