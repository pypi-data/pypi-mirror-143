...
class StatementsCollection(object):
    ...
    def set_dc_offset(self, element, input_reference, offset):
        """
        Update the DC offset of an input to a Quantum Element
        :param element: The quantum element to set the correction to
        :param input_reference: Reference to the desired qe input
        ...
        statement.setDcOffset.qeInputReference = input_reference
    ...
    def wait_for_trigger(self, pulse_to_play, trigger_element, *elements):
        statement = self._body.statements.add()
    ...
    def qrun_block(self):
        statement = self._body.statements.add()
        qrun_statement = statement.qrun
        qrun_statement.SetInParent()
        qrun_statement.loc = _get_loc()
        return qrun_statement
