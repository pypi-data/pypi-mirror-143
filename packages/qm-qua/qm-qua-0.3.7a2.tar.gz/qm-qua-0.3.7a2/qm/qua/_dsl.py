...
class TimeTagging:
    ...
    def analog(self, target, max_time, targetLen=None, element_output=""):
        """
        Performs time tagging. See :ref:`Guides/features:Time Tagging`.
        ...
        :param element_output: the output of a quantum element from which to get ADC results
    ...
    def high_res(self, target, max_time, targetLen=None, element_output=""):
        """
        Performs high resolution time tagging. See :ref:`Guides/features:Time Tagging`.
...
class Counting:
    ...
    def digital(self, target, max_time, element_outputs=""):
        """
        Performs counting from the attached OPD. See :ref:`Guides/features:Time Tagging`.

        :param target: A QUA int which will get the number of pulses detected
        :type target: QUA int
        :param max_time: The time in which pulses are detected (Must be larger than the pulse duration)
        :type max_time: QUA int
        :param element_outputs: the outputs of a quantum element from which to get ADC results
