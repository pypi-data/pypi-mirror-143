...
from rivals_top8_results.draw_recolors import (
    generate_recolor,
    get_latest_file,
    start_headless_driver,
)
...
def draw_top8_columns(
    ...
    for i in range(0, 4):
        ...
        pasteImage(players[i + 4], (players[i].size[0] * i + offset_x * i, players[i].size[1] + offset_y), output)
