...
class Hc:
	"""Hc commands group definition. 2 total commands, 2 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("hc", core, parent)
	...
	def clone(self) -> 'Hc':
		...
		new_group = Hc(self._core, self._cmd_group.parent)
