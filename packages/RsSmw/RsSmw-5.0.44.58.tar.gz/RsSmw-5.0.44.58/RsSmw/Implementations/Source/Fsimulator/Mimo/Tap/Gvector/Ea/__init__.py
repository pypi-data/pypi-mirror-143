...
class Ea:
	"""Ea commands group definition. 2 total commands, 2 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("ea", core, parent)
	...
	def clone(self) -> 'Ea':
		...
		new_group = Ea(self._core, self._cmd_group.parent)
