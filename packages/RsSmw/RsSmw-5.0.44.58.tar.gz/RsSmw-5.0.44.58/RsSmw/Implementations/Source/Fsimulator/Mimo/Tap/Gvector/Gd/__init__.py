...
class Gd:
	"""Gd commands group definition. 2 total commands, 2 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("gd", core, parent)
	...
	def clone(self) -> 'Gd':
		...
		new_group = Gd(self._core, self._cmd_group.parent)
