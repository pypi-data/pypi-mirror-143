...
class Group:
	"""Group commands group definition. 22 total commands, 1 Subgroups, 0 group commands
	...
	@property
	def path(self):
		"""path commands group. 16 Sub-classes, 0 commands."""
	...
	def clone(self) -> 'Group':
		...
		new_group = Group(self._core, self._cmd_group.parent)
