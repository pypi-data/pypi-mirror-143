...
class File:
	...
	def set_data(self, dpd_am_table_data: List[float]) -> None:
		"""SCPI: [SOURce<HW>]:IQ:DPD:SHAPing:TABLe:AMAM:FILE:DATA \n
		Snippet: driver.source.iq.dpd.shaping.table.amam.file.set_data(dpd_am_table_data = [1.1, 2.2, 3.3]) \n
		Defines the predistortion function in a raw data format. See also [:SOURce<hw>]:IQ:DPD:SHAPing:TABLe:AMPM:FILE:NEW. \n
	...
	def set_new(self, ipartd_pi_db_dpd_am_table_data_new_file: List[float]) -> None:
		...
		Snippet: driver.source.iq.dpd.shaping.table.amam.file.set_new(ipartd_pi_db_dpd_am_table_data_new_file = [1.1, 2.2, 3.3]) \n
	...
	def set_select(self, filename: str) -> None:
		"""SCPI: [SOURce<HW>]:IQ:DPD:SHAPing:TABLe:AMAM:FILE:[SELect] \n
		Snippet: driver.source.iq.dpd.shaping.table.amam.file.set_select(filename = '1') \n
		Selects a file with correction values (extension *.dpd_magn (AM/AM) or *.dpd_phase(AM/FM) ). \n
