...
class Fmt2:
	"""Fmt2 commands group definition. 1 total commands, 1 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("fmt2", core, parent)
	...
	def clone(self) -> 'Fmt2':
		...
		new_group = Fmt2(self._core, self._cmd_group.parent)
