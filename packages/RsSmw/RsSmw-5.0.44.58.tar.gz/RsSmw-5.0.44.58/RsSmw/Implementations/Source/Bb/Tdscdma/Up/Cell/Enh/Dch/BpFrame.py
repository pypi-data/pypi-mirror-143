...
class BpFrame:
	...
	def get(self, cell=repcap.Cell.Default) -> str:
		...
		Snippet: value: str = driver.source.bb.tdscdma.up.cell.enh.dch.bpFrame.get(cell = repcap.Cell.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:TDSCdma:UP:CELL{cell_cmd_val}:ENH:DCH:BPFRame?')
