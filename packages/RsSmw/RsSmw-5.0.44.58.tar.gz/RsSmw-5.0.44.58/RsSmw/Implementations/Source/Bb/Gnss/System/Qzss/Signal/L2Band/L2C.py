...
class L2C:
	...
	def get_state(self) -> bool:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SYSTem:QZSS:SIGNal:L2Band:L2C:[STATe] \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:SYSTem:QZSS:SIGNal:L2Band:L2C:STATe?')
	...
	def set_state(self, signal_state: bool) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:SYSTem:QZSS:SIGNal:L2Band:L2C:STATe {param}')
