...
class RvcSequence:
	...
	def set(self, rv_coding_seq: str, userIx=repcap.UserIx.Default, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.user.asPy.downlink.cell.rvcSequence.set(rv_coding_seq = '1', userIx = repcap.UserIx.Default, cellNull = repcap.CellNull.Default) \n
