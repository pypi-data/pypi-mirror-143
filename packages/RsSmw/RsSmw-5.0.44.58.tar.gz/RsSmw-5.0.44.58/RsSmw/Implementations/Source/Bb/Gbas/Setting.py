...
class Setting:
	...
	def get_catalog(self) -> List[str]:
		...
		Queries the files with GBAS settings in the default directory. Listed are files with the file extension *.gbas. Refer to
		'Accessing Files in the Default or Specified Directory' for general information on file handling in the default and
	...
	def set_store(self, filename: str) -> None:
		...
		Saves the current settings into the selected file; the file extensions *.gbas is assigned automatically.
		Refer to 'Accessing Files in the Default or Specified Directory' for general information on file handling in the default
		and specific directories. \n
			:param filename: string
		"""
