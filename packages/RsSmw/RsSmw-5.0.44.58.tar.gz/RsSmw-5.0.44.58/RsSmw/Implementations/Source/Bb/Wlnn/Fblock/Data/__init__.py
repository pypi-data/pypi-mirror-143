...
class Data:
	"""Data commands group definition. 5 total commands, 4 Subgroups, 1 group commands"""
	...
	def fduration(self):
		...
		if not hasattr(self, '_fduration'):
			from .Fduration import Fduration
			self._fduration = Fduration(self._core, self._cmd_group)
