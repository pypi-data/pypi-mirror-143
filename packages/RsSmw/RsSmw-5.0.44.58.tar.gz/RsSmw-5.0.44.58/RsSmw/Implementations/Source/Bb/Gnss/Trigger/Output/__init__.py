...
class Output:
	"""Output commands group definition. 10 total commands, 7 Subgroups, 0 group commands
	...
	@property
	def hpps(self):
		"""hpps commands group. 2 Sub-classes, 0 commands."""
		if not hasattr(self, '_hpps'):
			from .Hpps import Hpps
			self._hpps = Hpps(self._core, self._cmd_group)
		return self._hpps
