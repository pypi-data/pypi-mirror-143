...
class ConType:
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, allocationNull=repcap.AllocationNull.Default, codeword=repcap.Codeword.Default) -> enums.DlContentType:
		...
		Snippet: value: enums.DlContentType = driver.source.bb.eutra.downlink.subf.alloc.cw.conType.get(subframeNull = repcap.SubframeNull.Default, allocationNull = repcap.AllocationNull.Default, codeword = repcap.Codeword.Default) \n
		Queries the type for the selected allocation. PBCH can be configured in subframe 0 only. \n
			...
			:return: con_type: PDSCh| PBCH| PDCCh| PMCH | EPD1| EPD2"""
