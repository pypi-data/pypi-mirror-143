...
class Stslot:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, transmission=repcap.Transmission.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.uplink.ue.niot.trans.stslot.get(userEquipment = repcap.UserEquipment.Default, transmission = repcap.Transmission.Default) \n
