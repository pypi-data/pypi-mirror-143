...
class Ca:
	...
	def get_state(self) -> bool:
		"""SCPI: [SOURce<HW>]:BB:V5G:DL:CA:STATe \n
		Snippet: value: bool = driver.source.bb.v5G.downlink.ca.get_state() \n
		Enables/disables the generation of several component carriers. \n
			:return: ca_global_state: 1| ON| 0| OFF
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:V5G:DL:CA:STATe?')
