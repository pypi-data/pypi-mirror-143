...
class View:
	...
	def get_bis(self) -> bool:
		"""SCPI: [SOURce<HW>]:BB:ONEWeb:UL:VIEW:BIS \n
		Snippet: value: bool = driver.source.bb.oneweb.uplink.view.get_bis() \n
		No command help available \n
			:return: block_info: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:ONEWeb:UL:VIEW:BIS?')
		return Conversions.str_to_bool(response)

	def set_bis(self, block_info: bool) -> None:
		"""SCPI: [SOURce<HW>]:BB:ONEWeb:UL:VIEW:BIS \n
		Snippet: driver.source.bb.oneweb.uplink.view.set_bis(block_info = False) \n
		No command help available \n
			:param block_info: No help available
		"""
		param = Conversions.bool_to_str(block_info)
		self._core.io.write(f'SOURce<HwInstance>:BB:ONEWeb:UL:VIEW:BIS {param}')
