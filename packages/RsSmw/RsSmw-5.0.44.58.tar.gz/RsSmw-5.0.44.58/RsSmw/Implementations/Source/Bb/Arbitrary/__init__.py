...
class Arbitrary:
	"""Arbitrary commands group definition. 159 total commands, 12 Subgroups, 3 group commands"""
	...
	def coupled(self):
		...
		if not hasattr(self, '_coupled'):
			...
			self._coupled = Coupled(self._core, self._cmd_group)
		return self._coupled

	@property
	def ethernet(self):
		"""ethernet commands group. 2 Sub-classes, 2 commands."""
		if not hasattr(self, '_ethernet'):
			from .Ethernet import Ethernet
			self._ethernet = Ethernet(self._core, self._cmd_group)
	...
	def get_mode(self) -> enums.ArbMode:
		...
		No command help available \n
			:return: arb_mode: No help available
		"""
	...
	def set_mode(self, arb_mode: enums.ArbMode) -> None:
		...
		No command help available \n
			:param arb_mode: No help available
		"""
