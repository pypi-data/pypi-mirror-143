...
class Row:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, rowNull=repcap.RowNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:V5G:UL:UE<ST>:APMap:AP100Map:ROW<BBID> \n
		Snippet: value: bool = driver.source.bb.v5G.uplink.ue.apMap.ap100Map.row.get(userEquipment = repcap.UserEquipment.Default, rowNull = repcap.RowNull.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:V5G:UL:UE{userEquipment_cmd_val}:APMap:AP100Map:ROW{rowNull_cmd_val}?')
