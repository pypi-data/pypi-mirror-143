...
class M2T:
	"""M2T commands group definition. 4 total commands, 4 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("m2T", core, parent)
	...
	def clone(self) -> 'M2T':
		...
		new_group = M2T(self._core, self._cmd_group.parent)
