...
class Fnav:
	...
	def e5Advs(self):
		...
		if not hasattr(self, '_e5Advs'):
			from .E5Advs import E5Advs
			self._e5Advs = E5Advs(self._core, self._cmd_group)
		return self._e5Advs
	...
	def e5Ahs(self):
		...
		if not hasattr(self, '_e5Ahs'):
			from .E5Ahs import E5Ahs
			self._e5Ahs = E5Ahs(self._core, self._cmd_group)
		return self._e5Ahs
	...
	def clone(self) -> 'Fnav':
		...
		new_group = Fnav(self._core, self._cmd_group.parent)
