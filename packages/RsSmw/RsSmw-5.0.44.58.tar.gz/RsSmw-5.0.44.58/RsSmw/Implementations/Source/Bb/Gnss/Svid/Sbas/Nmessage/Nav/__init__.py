...
class Nav:
	"""Nav commands group definition. 23 total commands, 2 Subgroups, 0 group commands"""
	...
	def ccorrection(self):
		"""ccorrection commands group. 1 Sub-classes, 0 commands."""
	...
	@property
	def ephemeris(self):
		"""ephemeris commands group. 11 Sub-classes, 0 commands."""
