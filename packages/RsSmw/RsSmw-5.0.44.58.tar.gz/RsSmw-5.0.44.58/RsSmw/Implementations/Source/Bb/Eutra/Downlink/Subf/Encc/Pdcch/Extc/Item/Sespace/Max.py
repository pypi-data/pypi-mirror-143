...
class Max:
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.downlink.subf.encc.pdcch.extc.item.sespace.max.get(subframeNull = repcap.SubframeNull.Default, itemNull = repcap.ItemNull.Default) \n
