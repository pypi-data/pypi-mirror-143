...
class Trigger:
	...
	def set_sl_unit(self, sl_unit: enums.UnitSlB) -> None:
		"""SCPI: [SOURce<HW>]:BB:GBAS:TRIGger:SLUNit \n
		Snippet: driver.source.bb.gbas.trigger.set_sl_unit(sl_unit = enums.UnitSlB.SAMPle) \n
		Sets the units the trigger sequence length is expressed in. \n
	...
	def get_source(self) -> enums.TriggerSourceC:
		...
		Snippet: value: enums.TriggerSourceC = driver.source.bb.gbas.trigger.get_source() \n
	...
	def set_source(self, source: enums.TriggerSourceC) -> None:
		"""SCPI: [SOURce<HW>]:BB:GBAS:TRIGger:SOURce \n
		Snippet: driver.source.bb.gbas.trigger.set_source(source = enums.TriggerSourceC.BBSY) \n
			INTRO_CMD_HELP: Selects the trigger signal source and determines the way the triggering is executed. Provided are: \n
			- Internal triggering by a command (INTernal)
			- External trigger signal via one of the local or global connectors
			Table Header:  \n
