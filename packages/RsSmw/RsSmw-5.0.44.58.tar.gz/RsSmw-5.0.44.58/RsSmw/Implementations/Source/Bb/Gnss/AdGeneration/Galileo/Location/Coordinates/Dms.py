...
class Dms:
	...
	def get_pz(self) -> PzStruct:
		...
		Snippet: value: PzStruct = driver.source.bb.gnss.adGeneration.galileo.location.coordinates.dms.get_pz() \n
		...
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:GALileo:LOCation:COORdinates:DMS:PZ?', self.__class__.PzStruct())
	...
	def set_pz(self, value: PzStruct) -> None:
		...
		"""
		self._core.io.write_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:GALileo:LOCation:COORdinates:DMS:PZ', value)
	...
	def get_wgs(self) -> WgsStruct:
		...
		Snippet: value: WgsStruct = driver.source.bb.gnss.adGeneration.galileo.location.coordinates.dms.get_wgs() \n
		Sets the geographic reference location in degrees, minutes and seconds. \n
			:return: structure: for return value, see the help for WgsStruct structure arguments.
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:GALileo:LOCation:COORdinates:DMS:WGS?', self.__class__.WgsStruct())
	...
	def set_wgs(self, value: WgsStruct) -> None:
		...
		"""
		self._core.io.write_struct('SOURce<HwInstance>:BB:GNSS:ADGeneration:GALileo:LOCation:COORdinates:DMS:WGS', value)
