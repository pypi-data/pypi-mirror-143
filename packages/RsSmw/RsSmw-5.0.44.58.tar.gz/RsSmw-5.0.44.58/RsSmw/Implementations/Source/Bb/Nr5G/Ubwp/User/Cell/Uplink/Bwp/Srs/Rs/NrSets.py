...
class NrSets:
	...
	def set(self, srs_resource_sets: List[int], userNull=repcap.UserNull.Default, cellNull=repcap.CellNull.Default, bwPartNull=repcap.BwPartNull.Default) -> None:
		...
		Snippet: driver.source.bb.nr5G.ubwp.user.cell.uplink.bwp.srs.rs.nrSets.set(srs_resource_sets = [1, 2, 3], userNull = repcap.UserNull.Default, cellNull = repcap.CellNull.Default, bwPartNull = repcap.BwPartNull.Default) \n
