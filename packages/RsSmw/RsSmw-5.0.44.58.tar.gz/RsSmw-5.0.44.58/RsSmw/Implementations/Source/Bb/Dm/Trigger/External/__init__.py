...
class External:
	...
	def get_delay(self) -> float:
		...
		See 'Specifying delay and inhibit values'. \n
			:return: delay: float Range: 0 to depends on the symbol rate, Unit: symbol E.g. 0 to 2147483647 symbols (R&S SMW-B10)
		"""
	...
	def set_delay(self, delay: float) -> None:
		...
		Specifies the trigger delay in symbols. Maximum trigger delay and trigger inhibit values depend on the installed options.
		See 'Specifying delay and inhibit values'. \n
			:param delay: float Range: 0 to depends on the symbol rate, Unit: symbol E.g. 0 to 2147483647 symbols (R&S SMW-B10)
		"""
	...
	def get_inhibit(self) -> int:
		...
		on the installed options. See 'Specifying delay and inhibit values'. \n
			:return: inhibit: integer Range: 0 to 21.47 * (symbol rate) , Unit: symbol E.g. 0 to 2147483647 symbols (R&S SMW-B10)
		"""
	...
	def set_inhibit(self, inhibit: int) -> None:
		...
		Specifies the number of symbols, by which a restart is inhibited. Maximum trigger delay and trigger inhibit values depend
		on the installed options. See 'Specifying delay and inhibit values'. \n
			:param inhibit: integer Range: 0 to 21.47 * (symbol rate) , Unit: symbol E.g. 0 to 2147483647 symbols (R&S SMW-B10)
		"""
