...
class MltfMode:
	...
	def set(self, mu_mimo_ltf_mode: List[str], frameBlock=repcap.FrameBlock.Default, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.wlnn.fblock.user.tfConfig.cinfo.mltfMode.set(mu_mimo_ltf_mode = ['raw1', 'raw2', 'raw3'], frameBlock = repcap.FrameBlock.Default, userIx = repcap.UserIx.Default) \n
