...
class Srs:
	...
	def get_dsfc(self) -> str:
		...
		SRS subframe configuration ([:SOURce<hw>]:BB:EUTRa:UL:REFSig:SRS:CSRS) and the dduplexing mode
	...
	def get_tsfc(self) -> str:
		...
		subframe configuration ([:SOURce<hw>]:BB:EUTRa:UL:REFSig:SRS:CSRS) and the duplexing mode
		([:SOURce<hw>]:BB:EUTRa:DUPLexing) . \n
			:return: tsfc: string
		"""
