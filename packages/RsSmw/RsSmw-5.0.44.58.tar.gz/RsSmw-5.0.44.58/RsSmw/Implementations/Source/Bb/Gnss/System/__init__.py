...
class System:
	"""System commands group definition. 131 total commands, 7 Subgroups, 0 group commands"""
	...
	@property
	def beidou(self):
		"""beidou commands group. 1 Sub-classes, 1 commands."""
	...
	@property
	def galileo(self):
		"""galileo commands group. 1 Sub-classes, 1 commands."""
	...
	@property
	def glonass(self):
		"""glonass commands group. 1 Sub-classes, 1 commands."""
	...
	@property
	def gps(self):
		"""gps commands group. 1 Sub-classes, 1 commands."""
	...
	@property
	def navic(self):
		"""navic commands group. 1 Sub-classes, 1 commands."""
	...
	@property
	def qzss(self):
		"""qzss commands group. 1 Sub-classes, 1 commands."""
	...
	@property
	def sbas(self):
		"""sbas commands group. 5 Sub-classes, 1 commands."""
