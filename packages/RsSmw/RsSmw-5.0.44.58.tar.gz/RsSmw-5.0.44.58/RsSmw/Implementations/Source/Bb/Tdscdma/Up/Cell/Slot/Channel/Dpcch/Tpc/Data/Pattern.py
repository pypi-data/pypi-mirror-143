...
class Pattern:
	...
	def set(self, pattern: List[str], bitcount: int, cell=repcap.Cell.Default, slotNull=repcap.SlotNull.Default, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.up.cell.slot.channel.dpcch.tpc.data.pattern.set(pattern = ['raw1', 'raw2', 'raw3'], bitcount = 1, cell = repcap.Cell.Default, slotNull = repcap.SlotNull.Default, channelNull = repcap.ChannelNull.Default) \n
