...
class L5S:
	...
	def get_state(self) -> bool:
		...
		Snippet: value: bool = driver.source.bb.gnss.system.qzss.signal.l5Band.l5S.get_state() \n
		Enables the corresponding signal from the GNSS system in the corresponding RF band. \n
			:return: signal_state: 1| ON| 0| OFF
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:SYSTem:QZSS:SIGNal:L5Band:L5S:STATe?')
		return Conversions.str_to_bool(response)

	def set_state(self, signal_state: bool) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SYSTem:QZSS:SIGNal:L5Band:L5S:[STATe] \n
		Snippet: driver.source.bb.gnss.system.qzss.signal.l5Band.l5S.set_state(signal_state = False) \n
		Enables the corresponding signal from the GNSS system in the corresponding RF band. \n
			:param signal_state: 1| ON| 0| OFF
		"""
		param = Conversions.bool_to_str(signal_state)
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:SYSTem:QZSS:SIGNal:L5Band:L5S:STATe {param}')
