...
class M1T:
	"""M1T commands group definition. 5 total commands, 5 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("m1T", core, parent)
	...
	def clone(self) -> 'M1T':
		...
		new_group = M1T(self._core, self._cmd_group.parent)
