...
class Pa:
	...
	def set(self, power: enums.PdscPowA, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.user.pa.set(power = enums.PdscPowA._0, userIx = repcap.UserIx.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default) -> enums.PdscPowA:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:PA \n
		Snippet: value: enums.PdscPowA = driver.source.bb.eutra.downlink.user.pa.get(userIx = repcap.UserIx.Default) \n
		Sets PDSCH power factor according to , chapter 5.2. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
