...
class Conversion:
	"""Conversion commands group definition. 27 total commands, 3 Subgroups, 0 group commands"""
	...
	@property
	def galileo(self):
		"""galileo commands group. 4 Sub-classes, 1 commands."""
	...
	@property
	def glonass(self):
		"""glonass commands group. 4 Sub-classes, 1 commands."""
	...
	@property
	def utc(self):
		"""utc commands group. 4 Sub-classes, 1 commands."""
