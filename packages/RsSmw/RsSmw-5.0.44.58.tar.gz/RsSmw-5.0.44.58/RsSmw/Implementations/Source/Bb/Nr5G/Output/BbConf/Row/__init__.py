...
class Row:
	...
	def pbrate(self):
		...
		if not hasattr(self, '_pbrate'):
			from .Pbrate import Pbrate
			self._pbrate = Pbrate(self._core, self._cmd_group)
		return self._pbrate
	...
	def peFile(self):
		...
		if not hasattr(self, '_peFile'):
			...
			self._peFile = PeFile(self._core, self._cmd_group)
		return self._peFile
	...
	def variation(self):
		...
		if not hasattr(self, '_variation'):
			...
			self._variation = Variation(self._core, self._cmd_group)
