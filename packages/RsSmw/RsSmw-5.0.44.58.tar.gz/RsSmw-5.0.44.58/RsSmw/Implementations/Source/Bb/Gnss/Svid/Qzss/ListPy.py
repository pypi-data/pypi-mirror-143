...
class ListPy:
	...
	def get_all(self) -> List[int]:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID:QZSS:LIST:ALL \n
		Snippet: value: List[int] = driver.source.bb.gnss.svid.qzss.listPy.get_all() \n
		...
		"""
		response = self._core.io.query_bin_or_ascii_int_list('SOURce<HwInstance>:BB:GNSS:SVID:QZSS:LIST:ALL?')
		return response

	def get_valid(self) -> List[int]:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID:QZSS:LIST:[VALid] \n
		Snippet: value: List[int] = driver.source.bb.gnss.svid.qzss.listPy.get_valid() \n
		...
		"""
		response = self._core.io.query_bin_or_ascii_int_list('SOURce<HwInstance>:BB:GNSS:SVID:QZSS:LIST:VALid?')
		return response
