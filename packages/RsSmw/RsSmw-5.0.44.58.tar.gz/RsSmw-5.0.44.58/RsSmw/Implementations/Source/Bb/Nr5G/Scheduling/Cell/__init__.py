...
class Cell:
	"""Cell commands group definition. 496 total commands, 2 Subgroups, 0 group commands
	...
	@property
	def nsubframe(self):
		"""nsubframe commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_nsubframe'):
			from .Nsubframe import Nsubframe
			self._nsubframe = Nsubframe(self._core, self._cmd_group)
		return self._nsubframe

	@property
	def subf(self):
		"""subf commands group. 6 Sub-classes, 0 commands."""
