...
class Cosine:
	...
	def get_cofs(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:SIRius:TERRestrial:FILTer:PARameter:COSine:COFS \n
		Snippet: value: float = driver.source.bb.sirius.terrestrial.filterPy.parameter.cosine.get_cofs() \n
	...
	def set_cofs(self, cofs: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:SIRius:TERRestrial:FILTer:PARameter:COSine:COFS \n
		Snippet: driver.source.bb.sirius.terrestrial.filterPy.parameter.cosine.set_cofs(cofs = 1.0) \n
		No command help available \n
	...
	def get_value(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:SIRius:TERRestrial:FILTer:PARameter:COSine \n
		Snippet: value: float = driver.source.bb.sirius.terrestrial.filterPy.parameter.cosine.get_value() \n
		No command help available \n
	...
	def set_value(self, cosine: float) -> None:
		"""SCPI: [SOURce<HW>]:BB:SIRius:TERRestrial:FILTer:PARameter:COSine \n
		Snippet: driver.source.bb.sirius.terrestrial.filterPy.parameter.cosine.set_value(cosine = 1.0) \n
		No command help available \n
