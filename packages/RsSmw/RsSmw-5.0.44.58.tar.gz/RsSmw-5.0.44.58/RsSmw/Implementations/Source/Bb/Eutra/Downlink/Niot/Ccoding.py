...
class Ccoding:
	...
	def get_mspare(self) -> List[str]:
		...
		Snippet: value: List[str] = driver.source.bb.eutra.downlink.niot.ccoding.get_mspare() \n
	...
	def set_mspare(self, mib_spare_bits: List[str]) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:CCODing:MSPare \n
		Snippet: driver.source.bb.eutra.downlink.niot.ccoding.set_mspare(mib_spare_bits = ['raw1', 'raw2', 'raw3']) \n
		Sets the 11 spare bits in the NPBCH transmission. \n
