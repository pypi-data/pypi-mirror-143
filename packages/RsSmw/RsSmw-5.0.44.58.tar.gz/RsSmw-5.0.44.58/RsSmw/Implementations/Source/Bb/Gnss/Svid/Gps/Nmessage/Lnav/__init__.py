...
class Lnav:
	"""Lnav commands group definition. 49 total commands, 2 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("lnav", core, parent)
	...
	def clone(self) -> 'Lnav':
		...
		new_group = Lnav(self._core, self._cmd_group.parent)
