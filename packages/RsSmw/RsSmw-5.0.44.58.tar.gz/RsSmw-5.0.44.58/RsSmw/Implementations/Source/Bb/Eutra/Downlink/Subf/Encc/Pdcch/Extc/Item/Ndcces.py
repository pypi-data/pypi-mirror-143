...
class Ndcces:
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.downlink.subf.encc.pdcch.extc.item.ndcces.get(subframeNull = repcap.SubframeNull.Default, itemNull = repcap.ItemNull.Default) \n
