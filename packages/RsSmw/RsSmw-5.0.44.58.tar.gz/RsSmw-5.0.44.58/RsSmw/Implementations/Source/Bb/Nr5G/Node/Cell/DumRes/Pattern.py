...
class Pattern:
	...
	def set(self, pattern: List[str], bitcount: int, cellNull=repcap.CellNull.Nr0) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CH0>:DUMRes:PATTern \n
		Snippet: driver.source.bb.nr5G.node.cell.dumRes.pattern.set(pattern = ['raw1', 'raw2', 'raw3'], bitcount = 1, cellNull = repcap.CellNull.Nr0) \n
