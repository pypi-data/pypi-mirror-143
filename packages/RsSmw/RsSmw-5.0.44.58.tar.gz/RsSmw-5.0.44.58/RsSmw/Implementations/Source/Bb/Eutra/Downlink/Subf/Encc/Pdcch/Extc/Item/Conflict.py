...
class Conflict:
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> bool:
		...
		Snippet: value: bool = driver.source.bb.eutra.downlink.subf.encc.pdcch.extc.item.conflict.get(subframeNull = repcap.SubframeNull.Default, itemNull = repcap.ItemNull.Default) \n
