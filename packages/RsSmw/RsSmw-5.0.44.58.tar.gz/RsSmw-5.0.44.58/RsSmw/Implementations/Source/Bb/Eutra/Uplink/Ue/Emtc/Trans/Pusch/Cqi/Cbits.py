...
class Cbits:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, transmission=repcap.Transmission.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.uplink.ue.emtc.trans.pusch.cqi.cbits.get(userEquipment = repcap.UserEquipment.Default, transmission = repcap.Transmission.Default) \n
