...
class Output:
	"""Output commands group definition. 6 total commands, 6 Subgroups, 0 group commands
	...
	@property
	def sposition(self):
		"""sposition commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_sposition'):
			from .Sposition import Sposition
			self._sposition = Sposition(self._core, self._cmd_group)
		return self._sposition
