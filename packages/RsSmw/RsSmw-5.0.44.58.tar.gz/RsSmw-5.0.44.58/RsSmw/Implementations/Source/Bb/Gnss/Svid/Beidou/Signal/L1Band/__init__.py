...
class L1Band:
	"""L1Band commands group definition. 19 total commands, 2 Subgroups, 0 group commands"""
	...
	def b1C(self):
		...
		if not hasattr(self, '_b1C'):
			from .B1C import B1C
			self._b1C = B1C(self._core, self._cmd_group)
		return self._b1C
	...
	def b1I(self):
		...
		if not hasattr(self, '_b1I'):
			from .B1I import B1I
			self._b1I = B1I(self._core, self._cmd_group)
		return self._b1I
