...
class B1I:
	...
	def get_state(self) -> bool:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SYSTem:BEIDou:SIGNal:L1Band:B1I:[STATe] \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:SYSTem:BEIDou:SIGNal:L1Band:B1I:STATe?')
	...
	def set_state(self, signal_state: bool) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:SYSTem:BEIDou:SIGNal:L1Band:B1I:STATe {param}')
