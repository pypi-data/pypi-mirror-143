...
class Acceleration:
	...
	def get_ecef(self) -> bool:
		"""SCPI: [SOURce<HW>]:BB:GNSS:LOGGing:CATegory:UMOTion:[CSV]:ACCeleration:ECEF \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:LOGGing:CATegory:UMOTion:CSV:ACCeleration:ECEF?')
	...
	def set_ecef(self, state: bool) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:LOGGing:CATegory:UMOTion:CSV:ACCeleration:ECEF {param}')
