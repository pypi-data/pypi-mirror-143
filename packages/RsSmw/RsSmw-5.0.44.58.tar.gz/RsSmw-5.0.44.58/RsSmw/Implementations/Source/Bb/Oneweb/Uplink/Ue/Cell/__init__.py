...
class Cell:
	"""Cell commands group definition. 49 total commands, 6 Subgroups, 0 group commands
	...
	def eimta(self):
		...
		if not hasattr(self, '_eimta'):
			from .Eimta import Eimta
			self._eimta = Eimta(self._core, self._cmd_group)
		return self._eimta
	...
	@property
	def puach(self):
		"""puach commands group. 5 Sub-classes, 0 commands."""
	...
	@property
	def pusch(self):
		"""pusch commands group. 7 Sub-classes, 0 commands."""
