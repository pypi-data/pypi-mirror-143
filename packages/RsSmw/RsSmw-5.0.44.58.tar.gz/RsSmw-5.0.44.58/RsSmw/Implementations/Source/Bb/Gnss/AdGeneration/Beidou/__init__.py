...
class Beidou:
	"""Beidou commands group definition. 16 total commands, 5 Subgroups, 0 group commands"""
	...
	def toaData(self):
		...
		if not hasattr(self, '_toaData'):
			from .ToaData import ToaData
			self._toaData = ToaData(self._core, self._cmd_group)
