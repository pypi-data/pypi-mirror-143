...
class Row:
	"""Row commands group definition. 1 total commands, 1 Subgroups, 0 group commands
	...
	@property
	def avrl(self):
		"""avrl commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_avrl'):
			from .Avrl import Avrl
			self._avrl = Avrl(self._core, self._cmd_group)
		return self._avrl
