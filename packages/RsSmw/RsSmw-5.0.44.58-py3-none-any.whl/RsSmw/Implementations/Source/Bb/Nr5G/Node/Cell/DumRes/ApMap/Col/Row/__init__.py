...
class Row:
	...
	@property
	def magnidute(self):
		"""magnidute commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_magnidute'):
			from .Magnidute import Magnidute
			self._magnidute = Magnidute(self._core, self._cmd_group)
		return self._magnidute
