...
class Use:
	...
	def set(self, scs_use: bool, cellNull=repcap.CellNull.Nr0) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CH0>:TXBW:S60K:USE \n
		Snippet: driver.source.bb.nr5G.node.cell.txbw.s60K.use.set(scs_use = False, cellNull = repcap.CellNull.Nr0) \n
	...
	def get(self, cellNull=repcap.CellNull.Nr0) -> bool:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CH0>:TXBW:S60K:USE \n
		Snippet: value: bool = driver.source.bb.nr5G.node.cell.txbw.s60K.use.get(cellNull = repcap.CellNull.Nr0) \n
		Enables an SCS in the particular cell. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0
