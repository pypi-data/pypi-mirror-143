...
class State:
	...
	def set(self, prs_state: bool, cellNull=repcap.CellNull.Nr0) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CH0>:PRS:STATe \n
		Snippet: driver.source.bb.nr5G.node.cell.prs.state.set(prs_state = False, cellNull = repcap.CellNull.Nr0) \n
	...
	def get(self, cellNull=repcap.CellNull.Nr0) -> bool:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CH0>:PRS:STATe \n
		Snippet: value: bool = driver.source.bb.nr5G.node.cell.prs.state.get(cellNull = repcap.CellNull.Nr0) \n
		Enables the DL PRS positioning frequency layer for the given carrier cell. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0
