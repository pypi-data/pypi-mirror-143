...
class Sp120K:
	"""Sp120K commands group definition. 2 total commands, 0 Subgroups, 2 group commands"""
	...
	def get_trtsamples(self) -> int:
		"""SCPI: [SOURce<HW>]:BB:NR5G:OUTPut:TDWind:SP120K:TRTSamples \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:NR5G:OUTPut:TDWind:SP120K:TRTSamples?')
		return Conversions.str_to_int(response)

	def get_tr_time(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:NR5G:OUTPut:TDWind:SP120K:TRTime \n
		Snippet: value: float = driver.source.bb.nr5G.output.tdWind.sp120K.get_tr_time() \n
		No command help available \n
			:return: transition_time: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:NR5G:OUTPut:TDWind:SP120K:TRTime?')
	...
	def set_tr_time(self, transition_time: float) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:NR5G:OUTPut:TDWind:SP120K:TRTime {param}')
