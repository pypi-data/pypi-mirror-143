...
class BwPart:
	"""BwPart commands group definition. 468 total commands, 3 Subgroups, 0 group commands
	...
	@property
	def alloc(self):
		"""alloc commands group. 34 Sub-classes, 0 commands."""
	...
	def clone(self) -> 'BwPart':
		...
		new_group = BwPart(self._core, self._cmd_group.parent)
