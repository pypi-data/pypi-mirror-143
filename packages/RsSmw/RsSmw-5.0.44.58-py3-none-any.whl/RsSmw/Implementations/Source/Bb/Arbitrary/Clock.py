...
class Clock:
	...
	def get_value(self) -> float:
		...
		frequency}. This command subsequently changes the clock rate; see data sheet for value range. In the case of an external
		clock source, the clock of the external source must be specified with this command. \n
