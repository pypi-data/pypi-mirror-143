...
class Alloc:
	"""Alloc commands group definition. 56 total commands, 3 Subgroups, 0 group commands
	...
	@property
	def puach(self):
		"""puach commands group. 9 Sub-classes, 0 commands."""
	...
	@property
	def pusch(self):
		"""pusch commands group. 12 Sub-classes, 0 commands."""
