...
class Waveform:
	...
	def set_create(self, filename: str) -> None:
		"""SCPI: [SOURce<HW>]:BB:ONEWeb:WAVeform:CREate \n
		Snippet: driver.source.bb.oneweb.waveform.set_create(filename = '1') \n
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:ONEWeb:WAVeform:CREate {param}')
