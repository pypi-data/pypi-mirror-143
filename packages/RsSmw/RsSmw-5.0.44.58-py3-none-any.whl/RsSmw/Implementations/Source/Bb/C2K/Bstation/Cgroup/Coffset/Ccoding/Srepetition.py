...
class Srepetition:
	"""Srepetition commands group definition. 1 total commands, 0 Subgroups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("srepetition", core, parent)
	...
	def get(self, baseStation=repcap.BaseStation.Default, groupNull=repcap.GroupNull.Default, offset=repcap.Offset.Default) -> int:
		...
		is specific for the selected radio configuration. \n
			...
			:return: srepetition: integer Range: 1 to 16"""
