...
class AnPattern:
	...
	def set(self, an_pattern: str, subframeNull=repcap.SubframeNull.Default, cellNull=repcap.CellNull.Default, antennaPattern=repcap.AntennaPattern.Default) -> None:
		...
		Snippet: driver.source.bb.v5G.downlink.subf.encc.phich.cell.anPattern.set(an_pattern = '1', subframeNull = repcap.SubframeNull.Default, cellNull = repcap.CellNull.Default, antennaPattern = repcap.AntennaPattern.Default) \n
