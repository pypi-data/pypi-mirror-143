...
class Harq:
	...
	@property
	def nbundled(self):
		"""nbundled commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_nbundled'):
			from .Nbundled import Nbundled
			self._nbundled = Nbundled(self._core, self._cmd_group)
		return self._nbundled
