...
class NapUsed:
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, allocationNull=repcap.AllocationNull.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.uplink.subf.alloc.pucch.napUsed.get(subframeNull = repcap.SubframeNull.Default, allocationNull = repcap.AllocationNull.Default) \n
