...
class Duplexing:
	...
	def set(self, dl_duplexmode: enums.DuplexModeExtRange, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.ca.cell.duplexing.set(dl_duplexmode = enums.DuplexModeExtRange.FDD, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> enums.DuplexModeExtRange:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CA:CELL<CH0>:DUPLexing \n
		Snippet: value: enums.DuplexModeExtRange = driver.source.bb.eutra.downlink.ca.cell.duplexing.get(cellNull = repcap.CellNull.Default) \n
		Selects the duplexing mode of the component carriers. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
