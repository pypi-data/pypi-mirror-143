...
class Tb2:
	"""Tb2 commands group definition. 4 total commands, 4 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("tb2", core, parent)
	...
	def rlcCounter(self):
		...
		if not hasattr(self, '_rlcCounter'):
			from .RlcCounter import RlcCounter
			self._rlcCounter = RlcCounter(self._core, self._cmd_group)
	...
	def clone(self) -> 'Tb2':
		...
		new_group = Tb2(self._core, self._cmd_group.parent)
