...
class Mode:
	...
	def set(self, ant_port_map: enums.BfapMapMode, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.user.apm.mode.set(ant_port_map = enums.BfapMapMode.CB, userIx = repcap.UserIx.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default) -> enums.BfapMapMode:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:APM:MODE \n
		Snippet: value: enums.BfapMapMode = driver.source.bb.eutra.downlink.user.apm.mode.get(userIx = repcap.UserIx.Default) \n
		Defines the antenna port mapping method. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
