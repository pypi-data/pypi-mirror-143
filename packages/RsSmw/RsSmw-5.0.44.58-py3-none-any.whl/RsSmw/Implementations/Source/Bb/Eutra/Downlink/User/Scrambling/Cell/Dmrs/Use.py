...
class Use:
	...
	def set(self, use: bool, userIx=repcap.UserIx.Default, cell=repcap.Cell.Default) -> None:
		...
		Defines how the DMRS scrambling sequence is initialized. \n
			:param use: 1| ON| 0| OFF OFF DRMS sequence is generated with the variable nID = NIDcell. ON Used are two variable nID = nIDDMRS,i set with the commands [:SOURcehw]:BB:EUTRa:DL:USERch:SCRambling:CELLst:DMRS:ID1|ID2
	...
	def get(self, userIx=repcap.UserIx.Default, cell=repcap.Cell.Default) -> bool:
		...
		Defines how the DMRS scrambling sequence is initialized. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
			:param cell: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cell')
			:return: use: 1| ON| 0| OFF OFF DRMS sequence is generated with the variable nID = NIDcell. ON Used are two variable nID = nIDDMRS,i set with the commands [:SOURcehw]:BB:EUTRa:DL:USERch:SCRambling:CELLst:DMRS:ID1|ID2"""
		userIx_cmd_val = self._cmd_group.get_repcap_cmd_value(userIx, repcap.UserIx)
		cell_cmd_val = self._cmd_group.get_repcap_cmd_value(cell, repcap.Cell)
