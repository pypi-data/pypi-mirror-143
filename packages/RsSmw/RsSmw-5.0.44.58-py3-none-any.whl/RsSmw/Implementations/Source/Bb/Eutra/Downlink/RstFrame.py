...
class RstFrame:
	...
	def set(self) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.rstFrame.set() \n
	...
	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:RSTFrame \n
		Snippet: driver.source.bb.eutra.downlink.rstFrame.set_with_opc() \n
		Resets all subframe settings of the selected link direction to the default values. \n
		Same as set, but waits for the operation to complete before continuing further. Use the RsSmw.utilities.opc_timeout_set() to set the timeout value. \n
			:param opc_timeout_ms: Maximum time to wait in milliseconds, valid only for this call."""
		self._core.io.write_with_opc(f'SOURce<HwInstance>:BB:EUTRa:DL:RSTFrame', opc_timeout_ms)
