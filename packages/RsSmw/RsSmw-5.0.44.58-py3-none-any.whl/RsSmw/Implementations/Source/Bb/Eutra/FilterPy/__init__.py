...
class FilterPy:
	...
	def get_mode(self) -> enums.FiltOptMode:
		...
		Snippet: value: enums.FiltOptMode = driver.source.bb.eutra.filterPy.get_mode() \n
	...
	def set_mode(self, opt_mode: enums.FiltOptMode) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:FILTer:MODE \n
		Snippet: driver.source.bb.eutra.filterPy.set_mode(opt_mode = enums.FiltOptMode.OFFLine) \n
		Selects an offline or real-time filter mode. \n
