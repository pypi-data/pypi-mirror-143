...
class UeId:
	...
	def set(self, ue_id: int, subframeNull=repcap.SubframeNull.Default, allocationNull=repcap.AllocationNull.Default, codeword=repcap.Codeword.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.downlink.subf.alloc.cw.scrambling.ueId.set(ue_id = 1, subframeNull = repcap.SubframeNull.Default, allocationNull = repcap.AllocationNull.Default, codeword = repcap.Codeword.Default) \n
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, allocationNull=repcap.AllocationNull.Default, codeword=repcap.Codeword.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:[SUBF<ST0>]:ALLoc<CH0>:[CW<USER>]:SCRambling:UEID \n
		Snippet: value: int = driver.source.bb.eutra.downlink.subf.alloc.cw.scrambling.ueId.get(subframeNull = repcap.SubframeNull.Default, allocationNull = repcap.AllocationNull.Default, codeword = repcap.Codeword.Default) \n
		Sets the user equipment identifier (n_RNTI) of the user to which the PDSCH transmission is intended. The UE ID is used to
		calculate the scrambling sequence. \n
			:param subframeNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Subf')
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
