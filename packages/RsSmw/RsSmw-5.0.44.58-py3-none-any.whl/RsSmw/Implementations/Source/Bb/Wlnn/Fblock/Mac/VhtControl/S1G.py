...
class S1G:
	...
	def set(self, s_1_g: List[str], frameBlock=repcap.FrameBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:MAC:VHTControl:S1G \n
		Snippet: driver.source.bb.wlnn.fblock.mac.vhtControl.s1G.set(s_1_g = ['raw1', 'raw2', 'raw3'], frameBlock = repcap.FrameBlock.Default) \n
	...
	def get(self, frameBlock=repcap.FrameBlock.Default) -> List[str]:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:MAC:VHTControl:S1G \n
		Snippet: value: List[str] = driver.source.bb.wlnn.fblock.mac.vhtControl.s1G.get(frameBlock = repcap.FrameBlock.Default) \n
		No command help available \n
			:param frameBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Fblock')
