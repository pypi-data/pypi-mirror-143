...
class Pattern:
	...
	def set(self, pattern: List[str], bitcount: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.ofdm.alloc.pattern.set(pattern = ['raw1', 'raw2', 'raw3'], bitcount = 1, allocationNull = repcap.AllocationNull.Default) \n
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:OFDM:ALLoc{allocationNull_cmd_val}:PATTern {param}'.rstrip())
