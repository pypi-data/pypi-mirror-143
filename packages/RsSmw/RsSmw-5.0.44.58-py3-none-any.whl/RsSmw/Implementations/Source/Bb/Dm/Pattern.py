...
class Pattern:
	...
	def set(self, pattern: List[str], bitcount: int) -> None:
		...
		Snippet: driver.source.bb.dm.pattern.set(pattern = ['raw1', 'raw2', 'raw3'], bitcount = 1) \n
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:DM:PATTern {param}'.rstrip())
	...
	def get(self) -> PatternStruct:
		"""SCPI: [SOURce<HW>]:BB:DM:PATTern \n
		Snippet: value: PatternStruct = driver.source.bb.dm.pattern.get() \n
		Selects the data pattern for the internal data source. \n
			:return: structure: for return value, see the help for PatternStruct structure arguments."""
		return self._core.io.query_struct(f'SOURce<HwInstance>:BB:DM:PATTern?', self.__class__.PatternStruct())
