...
class Shdata:
	...
	def set(self, short_frame_data: List[str], commandBlock=repcap.CommandBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:APGeneric:SHData \n
		Snippet: driver.source.bb.nfc.cblock.apGeneric.shdata.set(short_frame_data = ['raw1', 'raw2', 'raw3'], commandBlock = repcap.CommandBlock.Default) \n
		Sets the data bits of a short frame. \n
			:param short_frame_data: integer
			:param commandBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cblock')
		"""
		param = Conversions.list_to_csv_str(short_frame_data)
	...
	def get(self, commandBlock=repcap.CommandBlock.Default) -> List[str]:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:APGeneric:SHData \n
		Snippet: value: List[str] = driver.source.bb.nfc.cblock.apGeneric.shdata.get(commandBlock = repcap.CommandBlock.Default) \n
		Sets the data bits of a short frame. \n
			:param commandBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cblock')
