...
class Sf1:
	...
	def set(self, sflag_1: List[str], commandBlock=repcap.CommandBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:SF1 \n
		Snippet: driver.source.bb.nfc.cblock.sf1.set(sflag_1 = ['raw1', 'raw2', 'raw3'], commandBlock = repcap.CommandBlock.Default) \n
	...
	def get(self, commandBlock=repcap.CommandBlock.Default) -> List[str]:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:SF1 \n
		Snippet: value: List[str] = driver.source.bb.nfc.cblock.sf1.get(commandBlock = repcap.CommandBlock.Default) \n
		Sets the status flag 1 to specify a Type 3 tag's error condition. A value of 0 signals a successful execution, values
		different from 0 indicate errors. \n
			:param commandBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cblock')
