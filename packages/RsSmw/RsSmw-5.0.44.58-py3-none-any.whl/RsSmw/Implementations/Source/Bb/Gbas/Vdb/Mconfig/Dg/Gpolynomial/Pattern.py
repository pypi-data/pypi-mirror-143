...
class Pattern:
	...
	def set(self, pattern: List[str], bitcount: int, vdbTransmitter=repcap.VdbTransmitter.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GBAS:VDB<CH>:MCONfig:DG:GPOLynomial:PATTern \n
		Snippet: driver.source.bb.gbas.vdb.mconfig.dg.gpolynomial.pattern.set(pattern = ['raw1', 'raw2', 'raw3'], bitcount = 1, vdbTransmitter = repcap.VdbTransmitter.Default) \n
