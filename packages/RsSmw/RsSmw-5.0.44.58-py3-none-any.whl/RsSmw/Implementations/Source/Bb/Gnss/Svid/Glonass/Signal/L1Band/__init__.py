...
class L1Band:
	"""L1Band commands group definition. 20 total commands, 2 Subgroups, 0 group commands"""
	...
	@property
	def l1Cdma(self):
		"""l1Cdma commands group. 4 Sub-classes, 0 commands."""
		if not hasattr(self, '_l1Cdma'):
			from .L1Cdma import L1Cdma
			self._l1Cdma = L1Cdma(self._core, self._cmd_group)
		return self._l1Cdma
