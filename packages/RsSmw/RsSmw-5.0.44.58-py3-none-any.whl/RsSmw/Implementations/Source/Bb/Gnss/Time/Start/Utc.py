...
class Utc:
	...
	def get_date(self) -> DateStruct:
		...
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:GNSS:TIME:STARt:UTC:DATE?', self.__class__.DateStruct())
	...
	def get_offset(self) -> float:
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:TIME:STARt:UTC:OFFSet?')
	...
	def get_time(self) -> TimeStruct:
		...
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:GNSS:TIME:STARt:UTC:TIME?', self.__class__.TimeStruct())
