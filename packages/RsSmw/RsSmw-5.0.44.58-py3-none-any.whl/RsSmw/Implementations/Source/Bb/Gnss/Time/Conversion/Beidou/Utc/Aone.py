...
class Aone:
	...
	def get_unscaled(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:BEIDou:UTC:AONE:UNSCaled \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:TIME:CONVersion:BEIDou:UTC:AONE:UNSCaled?')
	...
	def set_unscaled(self, a_1: float) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:TIME:CONVersion:BEIDou:UTC:AONE:UNSCaled {param}')

	def get_value(self) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:BEIDou:UTC:AONE \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:TIME:CONVersion:BEIDou:UTC:AONE?')
	...
	def set_value(self, aone: int) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:TIME:CONVersion:BEIDou:UTC:AONE {param}')
