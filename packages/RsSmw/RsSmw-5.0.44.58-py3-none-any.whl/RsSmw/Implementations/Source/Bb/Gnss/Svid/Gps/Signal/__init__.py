...
class Signal:
	"""Signal commands group definition. 94 total commands, 3 Subgroups, 0 group commands"""
	...
	@property
	def l1Band(self):
		"""l1Band commands group. 5 Sub-classes, 0 commands."""
	...
	@property
	def l2Band(self):
		"""l2Band commands group. 5 Sub-classes, 0 commands."""
