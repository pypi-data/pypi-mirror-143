...
class Egnos:
	...
	@property
	def add(self):
		"""add commands group. 0 Sub-classes, 2 commands."""
	...
	def get_list_py(self) -> List[str]:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:IMPort:SBAS:EGNOS:LIST \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:SV:IMPort:SBAS:EGNOS:LIST?')
