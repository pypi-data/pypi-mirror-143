...
class Count:
	...
	def set(self, number_of_antenna: enums.NumberA, vehicle=repcap.Vehicle.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:RECeiver:[V<ST>]:ANTenna:COUNt \n
		Snippet: driver.source.bb.gnss.receiver.v.antenna.count.set(number_of_antenna = enums.NumberA._1, vehicle = repcap.Vehicle.Default) \n
	...
	def get(self, vehicle=repcap.Vehicle.Default) -> enums.NumberA:
		"""SCPI: [SOURce<HW>]:BB:GNSS:RECeiver:[V<ST>]:ANTenna:COUNt \n
		Snippet: value: enums.NumberA = driver.source.bb.gnss.receiver.v.antenna.count.get(vehicle = repcap.Vehicle.Default) \n
		Set the numer of anntenas to be simulated. \n
			:param vehicle: optional repeated capability selector. Default value: Nr1 (settable in the interface 'V')
