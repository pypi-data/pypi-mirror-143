...
class Gps:
	...
	def get_state(self) -> bool:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SYSTem:GPS:[STATe] \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:SYSTem:GPS:STATe?')
	...
	def set_state(self, state: bool) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:SYSTem:GPS:STATe {param}')
