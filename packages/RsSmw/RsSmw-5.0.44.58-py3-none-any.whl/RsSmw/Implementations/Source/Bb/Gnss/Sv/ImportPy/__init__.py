...
class ImportPy:
	"""ImportPy commands group definition. 36 total commands, 7 Subgroups, 0 group commands"""
	...
	@property
	def beidou(self):
		"""beidou commands group. 2 Sub-classes, 1 commands."""
	...
	@property
	def galileo(self):
		"""galileo commands group. 2 Sub-classes, 1 commands."""
	...
	@property
	def glonass(self):
		"""glonass commands group. 2 Sub-classes, 1 commands."""
	...
	@property
	def gps(self):
		"""gps commands group. 2 Sub-classes, 1 commands."""
	...
	@property
	def navic(self):
		"""navic commands group. 2 Sub-classes, 1 commands."""
	...
	@property
	def qzss(self):
		"""qzss commands group. 2 Sub-classes, 1 commands."""
