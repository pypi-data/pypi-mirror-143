...
class Aone:
	...
	def get_unscaled(self) -> float:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:NAVic:NMESsage:NAV:TIME:CONVersion:GPS:AONE:UNSCaled \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:SV:NAVic:NMESsage:NAV:TIME:CONVersion:GPS:AONE:UNSCaled?')
	...
	def set_unscaled(self, a_1: float) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:SV:NAVic:NMESsage:NAV:TIME:CONVersion:GPS:AONE:UNSCaled {param}')

	def get_value(self) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:NAVic:NMESsage:NAV:TIME:CONVersion:GPS:AONE \n
		Snippet: value: int = driver.source.bb.gnss.sv.navic.nmessage.nav.time.conversion.gps.aone.get_value() \n
		Sets the A1 parameter. \n
			:return: a_1: integer Range: -4096 to 4095
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:SV:NAVic:NMESsage:NAV:TIME:CONVersion:GPS:AONE?')
	...
	def set_value(self, a_1: int) -> None:
		...
		"""
		param = Conversions.decimal_value_to_str(a_1)
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:SV:NAVic:NMESsage:NAV:TIME:CONVersion:GPS:AONE {param}')
