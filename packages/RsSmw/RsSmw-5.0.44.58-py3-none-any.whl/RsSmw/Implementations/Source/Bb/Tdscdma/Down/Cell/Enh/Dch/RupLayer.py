...
class RupLayer:
	...
	def get(self, cell=repcap.Cell.Default) -> str:
		...
		Snippet: value: str = driver.source.bb.tdscdma.down.cell.enh.dch.rupLayer.get(cell = repcap.Cell.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:TDSCdma:DOWN:CELL{cell_cmd_val}:ENH:DCH:RUPLayer?')
