...
class Hsich:
	"""Hsich commands group definition. 4 total commands, 3 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("hsich", core, parent)
	...
	def anPattern(self):
		...
		if not hasattr(self, '_anPattern'):
			...
			self._anPattern = AnPattern(self._core, self._cmd_group)
	...
	def clone(self) -> 'Hsich':
		...
		new_group = Hsich(self._core, self._cmd_group.parent)
