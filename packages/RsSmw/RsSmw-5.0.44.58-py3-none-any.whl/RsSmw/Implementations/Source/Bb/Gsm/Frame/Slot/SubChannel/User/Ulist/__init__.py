...
class Ulist:
	...
	def delete(self, filename: str, frameIx=repcap.FrameIx.Default, slotNull=repcap.SlotNull.Default, subchannel=repcap.Subchannel.Default, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.gsm.frame.slot.subChannel.user.ulist.delete(filename = '1', frameIx = repcap.FrameIx.Default, slotNull = repcap.SlotNull.Default, subchannel = repcap.Subchannel.Default, userIx = repcap.UserIx.Default) \n
	...
	def load(self, filename: str, frameIx=repcap.FrameIx.Default, slotNull=repcap.SlotNull.Default, subchannel=repcap.Subchannel.Default, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.gsm.frame.slot.subChannel.user.ulist.load(filename = '1', frameIx = repcap.FrameIx.Default, slotNull = repcap.SlotNull.Default, subchannel = repcap.Subchannel.Default, userIx = repcap.UserIx.Default) \n
	...
	def clone(self) -> 'Ulist':
		...
		new_group = Ulist(self._core, self._cmd_group.parent)
