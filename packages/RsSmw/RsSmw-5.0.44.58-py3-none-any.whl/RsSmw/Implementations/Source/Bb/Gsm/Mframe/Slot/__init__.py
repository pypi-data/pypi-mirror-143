...
class Slot:
	...
	@property
	def burstIndex(self):
		"""burstIndex commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_burstIndex'):
			from .BurstIndex import BurstIndex
			self._burstIndex = BurstIndex(self._core, self._cmd_group)
		return self._burstIndex
