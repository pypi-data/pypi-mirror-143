...
class Clock:
	...
	def get_mode(self) -> enums.SatNavClockMode:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SATellite:CLOCk:MODE \n
		Snippet: value: enums.SatNavClockMode = driver.source.bb.sirius.satellite.clock.get_mode() \n
	...
	def set_mode(self, mode: enums.SatNavClockMode) -> None:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SATellite:CLOCk:MODE \n
		Snippet: driver.source.bb.sirius.satellite.clock.set_mode(mode = enums.SatNavClockMode.MSYMbol) \n
		No command help available \n
	...
	def get_multiplier(self) -> int:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SATellite:CLOCk:MULTiplier \n
		Snippet: value: int = driver.source.bb.sirius.satellite.clock.get_multiplier() \n
		No command help available \n
	...
	def set_multiplier(self, multiplier: int) -> None:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SATellite:CLOCk:MULTiplier \n
		Snippet: driver.source.bb.sirius.satellite.clock.set_multiplier(multiplier = 1) \n
		No command help available \n
	...
	def get_source(self) -> enums.ClockSourceC:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SATellite:CLOCk:SOURce \n
		Snippet: value: enums.ClockSourceC = driver.source.bb.sirius.satellite.clock.get_source() \n
		No command help available \n
	...
	def set_source(self, source: enums.ClockSourceC) -> None:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SATellite:CLOCk:SOURce \n
		Snippet: driver.source.bb.sirius.satellite.clock.set_source(source = enums.ClockSourceC.ELCLock) \n
		No command help available \n
