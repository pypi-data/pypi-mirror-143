...
class Ergch:
	"""Ergch commands group definition. 6 total commands, 6 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("ergch", core, parent)
	...
	def clone(self) -> 'Ergch':
		...
		new_group = Ergch(self._core, self._cmd_group.parent)
