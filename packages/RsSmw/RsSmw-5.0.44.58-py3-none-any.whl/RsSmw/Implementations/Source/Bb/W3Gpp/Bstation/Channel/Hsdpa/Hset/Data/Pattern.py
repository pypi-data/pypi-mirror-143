...
class Pattern:
	...
	def set(self, pattern: List[str], bitcount: int, baseStation=repcap.BaseStation.Default, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.bstation.channel.hsdpa.hset.data.pattern.set(pattern = ['raw1', 'raw2', 'raw3'], bitcount = 1, baseStation = repcap.BaseStation.Default, channelNull = repcap.ChannelNull.Default) \n
