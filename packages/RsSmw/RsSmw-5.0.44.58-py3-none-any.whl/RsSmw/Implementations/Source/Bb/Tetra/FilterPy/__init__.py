...
class FilterPy:
	...
	def get_type_py(self) -> enums.DmFilter:
		...
		Snippet: value: enums.DmFilter = driver.source.bb.tetra.filterPy.get_type_py() \n
	...
	def set_type_py(self, type_py: enums.DmFilter) -> None:
		"""SCPI: [SOURce<HW>]:BB:TETRa:FILTer:TYPE \n
		Snippet: driver.source.bb.tetra.filterPy.set_type_py(type_py = enums.DmFilter.APCO25) \n
		Sets the baseband filter. \n
