...
class Ldirection:
	"""Ldirection commands group definition. 1 total commands, 1 Subgroups, 0 group commands
	...
	@property
	def tbType(self):
		"""tbType commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_tbType'):
			from .TbType import TbType
			self._tbType = TbType(self._core, self._cmd_group)
		return self._tbType
