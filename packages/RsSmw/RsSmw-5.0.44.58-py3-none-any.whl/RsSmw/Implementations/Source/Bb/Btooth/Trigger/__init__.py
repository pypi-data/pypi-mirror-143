...
class Trigger:
	...
	# noinspection PyTypeChecker
	def get_sl_unit(self) -> enums.UnitSlBto:
	...
	def set_sl_unit(self, sl_unit: enums.UnitSlBto) -> None:
		"""SCPI: [SOURce<HW>]:BB:BTOoth:TRIGger:SLUNit \n
	...
	def get_source(self) -> enums.TriggerSourceC:
		...
		Snippet: value: enums.TriggerSourceC = driver.source.bb.btooth.trigger.get_source() \n
	...
	def set_source(self, source: enums.TriggerSourceC) -> None:
		"""SCPI: [SOURce<HW>]:BB:BTOoth:TRIGger:SOURce \n
		Snippet: driver.source.bb.btooth.trigger.set_source(source = enums.TriggerSourceC.BBSY) \n
			INTRO_CMD_HELP: Selects the trigger signal source and determines the way the triggering is executed. Provided are: \n
			- Internal triggering by a command (INTernal)
			- External trigger signal via one of the local or global connectors
			Table Header:  \n
