...
class Waveform:
	...
	def set_create(self, filename: str) -> None:
		"""SCPI: [SOURce<HW>]:BB:BTOoth:WAVeform:CREate \n
		Snippet: driver.source.bb.btooth.waveform.set_create(filename = '1') \n
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:BTOoth:WAVeform:CREate {param}')
