...
class AcAssigned:
	...
	def set(self, ac_assigned: List[str], bitcount: int) -> None:
		"""SCPI: [SOURce<HW>]:BB:BTOoth:ECONfiguration:PCONfiguration:ACASsigned \n
		Snippet: driver.source.bb.btooth.econfiguration.pconfiguration.acAssigned.set(ac_assigned = ['raw1', 'raw2', 'raw3'], bitcount = 1) \n
		...
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle.as_open_list('ac_assigned', ac_assigned, DataType.RawStringList, None), ArgSingle('bitcount', bitcount, DataType.Integer))
