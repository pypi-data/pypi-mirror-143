...
class LtKey:
	...
	def set(self, lt_key: List[str], bitcount: int) -> None:
		"""SCPI: [SOURce<HW>]:BB:BTOoth:ECONfiguration:LTKey \n
		Snippet: driver.source.bb.btooth.econfiguration.ltKey.set(lt_key = ['raw1', 'raw2', 'raw3'], bitcount = 1) \n
		...
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle.as_open_list('lt_key', lt_key, DataType.RawStringList, None), ArgSingle('bitcount', bitcount, DataType.Integer))
