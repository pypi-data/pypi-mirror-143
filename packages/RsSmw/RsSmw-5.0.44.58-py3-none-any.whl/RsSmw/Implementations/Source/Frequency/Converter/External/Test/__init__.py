...
class Test:
	...
	@property
	def bbLimit(self):
		"""bbLimit commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_bbLimit'):
			from .BbLimit import BbLimit
			self._bbLimit = BbLimit(self._core, self._cmd_group)
		return self._bbLimit
