...
class Coefficients:
	...
	def set(self, ipart_0: List[float], j_0: float, i_1: float, j_1: float) -> None:
		"""SCPI: [SOURce<HW>]:IQ:DPD:SHAPing:POLYnomial:COEFficients \n
		Snippet: driver.source.iq.dpd.shaping.polynomial.coefficients.set(ipart_0 = [1.1, 2.2, 3.3], j_0 = 1.0, i_1 = 1.0, j_1 = 1.0) \n
		...
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle.as_open_list('ipart_0', ipart_0, DataType.FloatList, None), ArgSingle('j_0', j_0, DataType.Float), ArgSingle('i_1', i_1, DataType.Float), ArgSingle('j_1', j_1, DataType.Float))
	...
	def load(self, filename: str) -> None:
		...
		Snippet: driver.source.iq.dpd.shaping.polynomial.coefficients.load(filename = '1') \n
	...
	def set_store(self, filename: str) -> None:
		...
		Snippet: driver.source.iq.dpd.shaping.polynomial.coefficients.set_store(filename = '1') \n
