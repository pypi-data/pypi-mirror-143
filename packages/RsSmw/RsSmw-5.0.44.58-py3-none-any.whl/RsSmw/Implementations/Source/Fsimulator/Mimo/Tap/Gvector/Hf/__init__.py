...
class Hf:
	"""Hf commands group definition. 2 total commands, 2 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("hf", core, parent)
	...
	def clone(self) -> 'Hf':
		...
		new_group = Hf(self._core, self._cmd_group.parent)
