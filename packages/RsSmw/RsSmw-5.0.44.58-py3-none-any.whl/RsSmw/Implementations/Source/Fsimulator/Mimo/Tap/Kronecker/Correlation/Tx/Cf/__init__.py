...
class Cf:
	"""Cf commands group definition. 4 total commands, 4 Subgroups, 0 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("cf", core, parent)
	...
	def clone(self) -> 'Cf':
		...
		new_group = Cf(self._core, self._cmd_group.parent)
