...
class Clock:
	...
	def get_impedance(self) -> enums.ImpG50G1K:
		...
		Snippet: value: enums.ImpG50G1K = driver.source.inputPy.user.clock.get_impedance() \n
	...
	def set_impedance(self, impedance: enums.ImpG50G1K) -> None:
		"""SCPI: [SOURce]:INPut:USER:CLOCk:IMPedance \n
		Snippet: driver.source.inputPy.user.clock.set_impedance(impedance = enums.ImpG50G1K.G1K) \n
		Selects the input impedance for the external trigger inputs. \n
