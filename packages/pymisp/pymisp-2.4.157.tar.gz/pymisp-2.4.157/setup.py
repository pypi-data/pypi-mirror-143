...
extras_require = \
{'brotli': ['urllib3[brotli]>=1.26.7,<2.0.0'],
 'docs': ['sphinx-autodoc-typehints>=1.12.0,<2.0.0',
          'recommonmark>=0.7.1,<0.8.0'],
 'email': ['extract_msg>=0.30.8,<0.31.0',
           'RTFDE>=0.0.2,<0.0.3',
           'oletools>=0.60,<0.61'],
 'fileobjects': ['python-magic>=0.4.24,<0.5.0',
                 'pydeep2>=0.5,<0.6',
                 'lief>=0.11.5,<0.12.0'],
 'openioc': ['beautifulsoup4>=4.10.0,<5.0.0'],
 'pdfexport': ['reportlab>=3.6.3,<4.0.0'],
 'url': ['pyfaup>=1.2,<2.0', 'chardet>=4.0,<5.0'],
