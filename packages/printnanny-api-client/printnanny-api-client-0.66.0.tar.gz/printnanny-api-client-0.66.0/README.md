...
*OctoprintApi* | [**octoprint_settings_device_update_or_create**](docs/OctoprintApi.md#octoprint_settings_device_update_or_create) | **POST** /api/octoprint/settings/update-or-create/ | 
