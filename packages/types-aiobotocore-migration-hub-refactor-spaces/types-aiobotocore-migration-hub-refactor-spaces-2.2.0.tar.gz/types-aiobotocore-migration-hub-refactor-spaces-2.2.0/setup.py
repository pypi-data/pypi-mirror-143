...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.MigrationHubRefactorSpaces 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore migration-hub-refactor-spaces type-annotations boto3-stubs mypy typeshed"
        " autocomplete"
    ),
