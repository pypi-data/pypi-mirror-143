...
class DriverLEDET:
    ...
    def run_LEDET(self, nameMagnet: str, simsToRun: str):
        '''
        ** Run LEDET model **
        :param nameMagnet: Name of the magnet model to run
        :param simsToRun: Number of the simulation to run
        :return:
        '''
        # Unpack arguments
        ...
        # Run model
        subprocess.call([path_exe, path_folder_LEDET, nameMagnet, simsToRun])
