...
from steam_sdk.plotters.PlotterModel import plot_electrical_order
...
class BuilderLEDET:
    ...
    def __init__(self, path_magnet: Path = None, input_model_data: DataModel = None,
                 input_roxie_data: APIdata = None, input_map2d: str = None,
        ...
        if flag_build:
            ...
            self.loadParametersFromMap2d(path_map2d=self.input_map2d)

            # Load conductor data from DataModel keys
            self.loadConductorData()

            # Calculate electrical order of the half-turns
            self.calcElectricalOrder(flag_plot_all=self.flag_plot_all)
    ...
    def loadParametersFromMap2d(self, path_map2d: Path =None):
        """
    ...
    def calcElectricalOrder(self, flag_plot_all: bool = False):
        """
        ...
        if flag_plot_all:
            plot_electrical_order(self.roxie_data, el_order_half_turns, elPairs_GroupTogether, self.Auxiliary.strandToGroup)
