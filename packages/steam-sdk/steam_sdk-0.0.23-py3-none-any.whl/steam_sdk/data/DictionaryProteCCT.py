def lookupModelDataToProteCCT(key: str, mode='data2protecct'):
    """
        Retrieves the correct ProteCCT parameter name for a DataModel input
    ...
    lookup = {
        ...
        'CoilWindings.CCT_straight.inner_radius_formers': 'innerRadiusFormers',
        ...
        'Options_ProteCCT.geometry_generation_options.numTurnsPerStrandTotal': 'numTurnsPerStrandTotal',
        ...
        'Options_ProteCCT.geometry_generation_options.numRowStrands': 'numRowStrands',
        'Options_ProteCCT.geometry_generation_options.numColumnStrands': 'numColumnStrands',
        ...
        'Options_ProteCCT.geometry_generation_options.windingOrder': 'windingOrder',
