...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codeguru_reviewer/waiters.html)
...
class CodeReviewCompletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codeguru_reviewer/waiters.html#codereviewcompletedwaiter)
    """

    async def wait(self, *, CodeReviewArn: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
...
class RepositoryAssociationSucceededWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codeguru_reviewer/waiters.html#repositoryassociationsucceededwaiter)
    """

    async def wait(self, *, AssociationArn: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
