...
from dbnomics_solr.dbnomics_solr_client import DatasetAlreadyIndexed, DBnomicsSolrClient, format_datetime
...
def index_provider(
    ...
    *,
    ...
    logger.debug("Using indexed_at %r for all the Solr documents", format_datetime(indexed_at))
