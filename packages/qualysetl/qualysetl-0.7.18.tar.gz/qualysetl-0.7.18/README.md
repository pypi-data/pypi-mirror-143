...
#### Alternative First Time Setup Activity on Red Hat 8.5
- Login as "non-root" user that will run qualysetl.
- sudo root authorization required.
- Create your /opt/qetl application directory
- Install python3.9
...
Uninstall qualysetl activity on Ubuntu 20.04.
  - deactivate to exit any current python virtual environment you may be in.
...
Web Application Scanning(WAS) | Apr 2022  | Automate download and transform of WAS Findings 
Tagging Info                  | Jun 2022  | Automate download and transform of Tagging Information
Policy Compliance             | Aug 2022  | Delayed to include PCRS. Automate download and transform of Policy Compliance Posture, Policy, Controls. 
Activity Logs/Sub Info        | Oct 2022  | Automate download and transform of Activity Logs, Subscription Info. 
