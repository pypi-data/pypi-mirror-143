...
setuptools.setup(
    ...
    entry_points={
        "climetlab.datasets": [
            # End-users will use cml.load_dataset("dataset-full-name-climetlab-template", ...)
            # see the tests/ folder for a example.
            "dataset-full-name-climetlab-template= climetlab_plugin_name_climetlab_template.dataset_name_climetlab_template:DatasetNameClimetlabTemplate",  # noqa: E501
            # Other datasets can be included here
            # "plugin-name-climetlab-template-dataset-2= climetlab_plugin_name_climetlab_template.dataset_name_climetlab_template2:DatasetNameClimetlabTemplate2",  # noqa: E501
        ]
