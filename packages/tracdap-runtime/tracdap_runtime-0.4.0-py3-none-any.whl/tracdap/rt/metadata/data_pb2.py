...
_SCHEMADEFINITION = DESCRIPTOR.message_types_by_name['SchemaDefinition']
_PARTKEY = DESCRIPTOR.message_types_by_name['PartKey']
_DATADEFINITION = DESCRIPTOR.message_types_by_name['DataDefinition']
_DATADEFINITION_DELTA = _DATADEFINITION.nested_types_by_name['Delta']
_DATADEFINITION_SNAP = _DATADEFINITION.nested_types_by_name['Snap']
_DATADEFINITION_PART = _DATADEFINITION.nested_types_by_name['Part']
_DATADEFINITION_PARTSENTRY = _DATADEFINITION.nested_types_by_name['PartsEntry']
FieldSchema = _reflection.GeneratedProtocolMessageType('FieldSchema', (_message.Message,), {
  'DESCRIPTOR' : _FIELDSCHEMA,
  '__module__' : 'tracdap.metadata.data_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.FieldSchema)
  })
...
TableSchema = _reflection.GeneratedProtocolMessageType('TableSchema', (_message.Message,), {
  ...
  '__module__' : 'tracdap.metadata.data_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.TableSchema)
  })
...
SchemaDefinition = _reflection.GeneratedProtocolMessageType('SchemaDefinition', (_message.Message,), {
  ...
  '__module__' : 'tracdap.metadata.data_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.SchemaDefinition)
  })
_sym_db.RegisterMessage(SchemaDefinition)

PartKey = _reflection.GeneratedProtocolMessageType('PartKey', (_message.Message,), {
  'DESCRIPTOR' : _PARTKEY,
  '__module__' : 'tracdap.metadata.data_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.PartKey)
  })
_sym_db.RegisterMessage(PartKey)

DataDefinition = _reflection.GeneratedProtocolMessageType('DataDefinition', (_message.Message,), {

  'Delta' : _reflection.GeneratedProtocolMessageType('Delta', (_message.Message,), {
    'DESCRIPTOR' : _DATADEFINITION_DELTA,
    '__module__' : 'tracdap.metadata.data_pb2'
    # @@protoc_insertion_point(class_scope:tracdap.metadata.DataDefinition.Delta)
    })
  ,

  'Snap' : _reflection.GeneratedProtocolMessageType('Snap', (_message.Message,), {
    'DESCRIPTOR' : _DATADEFINITION_SNAP,
    '__module__' : 'tracdap.metadata.data_pb2'
    # @@protoc_insertion_point(class_scope:tracdap.metadata.DataDefinition.Snap)
    })
  ,

  'Part' : _reflection.GeneratedProtocolMessageType('Part', (_message.Message,), {
    'DESCRIPTOR' : _DATADEFINITION_PART,
    '__module__' : 'tracdap.metadata.data_pb2'
    # @@protoc_insertion_point(class_scope:tracdap.metadata.DataDefinition.Part)
    })
  ,

  'PartsEntry' : _reflection.GeneratedProtocolMessageType('PartsEntry', (_message.Message,), {
    'DESCRIPTOR' : _DATADEFINITION_PARTSENTRY,
    '__module__' : 'tracdap.metadata.data_pb2'
    # @@protoc_insertion_point(class_scope:tracdap.metadata.DataDefinition.PartsEntry)
    })
  ,
  'DESCRIPTOR' : _DATADEFINITION,
  '__module__' : 'tracdap.metadata.data_pb2'
  # @@protoc_insertion_point(class_scope:tracdap.metadata.DataDefinition)
  })
_sym_db.RegisterMessage(DataDefinition)
_sym_db.RegisterMessage(DataDefinition.Delta)
_sym_db.RegisterMessage(DataDefinition.Snap)
_sym_db.RegisterMessage(DataDefinition.Part)
_sym_db.RegisterMessage(DataDefinition.PartsEntry)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SCHEMATYPE._serialized_start=1352
  _SCHEMATYPE._serialized_end=1400
  _PARTTYPE._serialized_start=1402
  _PARTTYPE._serialized_end=1465
  ...
  _PARTKEY._serialized_end=777
  _DATADEFINITION._serialized_start=780
  _DATADEFINITION._serialized_end=1350
  _DATADEFINITION_DELTA._serialized_start=1013
  _DATADEFINITION_DELTA._serialized_end=1058
  _DATADEFINITION_SNAP._serialized_start=1060
  _DATADEFINITION_SNAP._serialized_end=1141
  _DATADEFINITION_PART._serialized_start=1143
  _DATADEFINITION_PART._serialized_end=1246
  _DATADEFINITION_PARTSENTRY._serialized_start=1248
  _DATADEFINITION_PARTSENTRY._serialized_end=1331
