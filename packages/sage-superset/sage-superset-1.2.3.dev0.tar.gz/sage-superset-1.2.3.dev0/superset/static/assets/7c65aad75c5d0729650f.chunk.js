...
`,Q=s.iK.div`
  color: ${({theme:e})=>e.colors.grayscale.dark2};
`,F=(0,d.Z)((function({addDangerToast:e,addSuccessToast:t}){const{state:{loading:a,resourceCount:i,resourceCollection:d},fetchData:y}=(0,u.Yi)("query",(0,l.t)("Query history"),e,!1),[Z,w]=(0,r.useState)(),$=(0,s.Fg)(),C=(0,r.useCallback)((t=>{o.Z.get({endpoint:`/api/v1/query/${t}`}).then((({json:e={}})=>{w({...e.result})}),(0,c.v$)((t=>e((0,l.t)("There was an issue previewing the selected query. %s",t)))))}),[e]),S={activeChild:"Query history",...g.Y},k=[{id:x.J.start_time,desc:!0}],z=(0,r.useMemo)((()=>[{Cell:({row:{original:{status:e}}})=>{const t={name:null,label:""};return"success"===e?(t.name=(0,H.tZ)(q.Z.Check,{iconColor:$.colors.success.base}),t.label=(0,l.t)("Success")):"failed"===e||"stopped"===e?(t.name=(0,H.tZ)(q.Z.XSmall,{iconColor:"failed"===e?$.colors.error.base:$.colors.grayscale.base}),t.label=(0,l.t)("Failed")):"running"===e?(t.name=(0,H.tZ)(q.Z.Running,{iconColor:$.colors.primary.base}),t.label=(0,l.t)("Running")):"timed_out"===e?(t.name=(0,H.tZ)(q.Z.Offline,{iconColor:$.colors.grayscale.light1}),t.label=(0,l.t)("Offline")):"scheduled"!==e&&"pending"!==e||(t.name=(0,H.tZ)(q.Z.Queued,{iconColor:$.colors.grayscale.base}),t.label=(0,l.t)("Scheduled")),(0,H.tZ)(b.u,{title:t.label,placement:"bottom"},(0,H.tZ)("span",null,t.name))},accessor:x.J.status,size:"xs",disableSortBy:!0},{accessor:x.J.start_time,Header:(0,l.t)("Time"),size:"xl",Cell:({row:{original:{start_time:e,end_time:t}}})=>{const a=n().utc(e).local().format(v.v2).split(" "),s=(0,H.tZ)(r.Fragment,null,a[0]," ",(0,H.tZ)("br",null),a[1]);return t?(0,H.tZ)(b.u,{title:(0,l.t)("Duration: %s",n()(n().utc(t-e)).format(v.n2)),placement:"bottom"},(0,H.tZ)("span",null,s)):s}},{accessor:x.J.tab_name,Header:(0,l.t)("Tab name"),size:"xl"},{accessor:x.J.database_name,Header:(0,l.t)("Database"),size:"xl"},{accessor:x.J.database,hidden:!0},{accessor:x.J.schema,Header:(0,l.t)("Schema"),size:"xl"},{Cell:({row:{original:{sql_tables:e=[]}}})=>{const t=e.map((e=>e.table)),a=t.length>0?t.shift():"";return t.length?(0,H.tZ)(I,null,(0,H.tZ)("span",null,a),(0,H.tZ)(h.Z,{placement:"right",title:(0,l.t)("TABLES"),trigger:"click",content:(0,H.tZ)(r.Fragment,null,t.map((e=>(0,H.tZ)(Q,{key:e},e))))},(0,H.tZ)("span",{className:"count"},"(+",t.length,")"))):a},accessor:x.J.sql_tables,Header:(0,l.t)("Tables"),size:"xl",disableSortBy:!0},{accessor:x.J.user_first_name,Header:(0,l.t)("User"),size:"xl",Cell:({row:{original:{user:e}}})=>e?`${e.first_name} ${e.last_name}`:""},{accessor:x.J.user,hidden:!0},{accessor:x.J.rows,Header:(0,l.t)("Rows"),size:"md"},{accessor:x.J.sql,Header:(0,l.t)("SQL"),Cell:({row:{original:e,id:t}})=>(0,H.tZ)("div",{tabIndex:0,role:"button",onClick:()=>w(e)},(0,H.tZ)(A,{language:"sql",style:f.Z},(0,c.IB)(e.sql,4)))},{Header:(0,l.t)("Actions"),id:"actions",disableSortBy:!0,Cell:({row:{original:{id:e}}})=>(0,H.tZ)(b.u,{title:(0,l.t)("Open query in SQL Lab"),placement:"bottom"},(0,H.tZ)("a",{href:`/superset/sqllab?queryId=${e}`},(0,H.tZ)(q.Z.Full,{iconColor:$.colors.grayscale.base})))}]),[]),_=(0,r.useMemo)((()=>[{Header:(0,l.t)("Database"),id:"database",input:"select",operator:m.p.relationOneMany,unfilteredLabel:"All",fetchSelects:(0,c.tm)("query","database",(0,c.v$)((t=>e((0,l.t)("An error occurred while fetching database values: %s",t))))),paginate:!0},{Header:(0,l.t)("State"),id:"status",input:"select",operator:m.p.equals,unfilteredLabel:"All",fetchSelects:(0,c.wk)("query","status",(0,c.v$)((t=>e((0,l.t)("An error occurred while fetching schema values: %s",t))))),paginate:!0},{Header:(0,l.t)("User"),id:"user",input:"select",operator:m.p.relationOneMany,unfilteredLabel:"All",fetchSelects:(0,c.tm)("query","user",(0,c.v$)((t=>e((0,l.t)("An error occurred while fetching user values: %s",t))))),paginate:!0},{Header:(0,l.t)("Time range"),id:"start_time",input:"datetime_range",operator:m.p.between},{Header:(0,l.t)("Search by query text"),id:"sql",input:"search",operator:m.p.contains}]),[e]);return(0,H.tZ)(r.Fragment,null,(0,H.tZ)(p.Z,S),Z&&(0,H.tZ)(K,{onHide:()=>w(void 0),query:Z,queries:d,fetchData:C,openInSqlLab:e=>window.location.assign(`/superset/sqllab?queryId=${e}`),show:!0}),(0,H.tZ)(U,{className:"query-history-list-view",columns:z,count:i,data:d,fetchData:y,filters:_,initialSort:k,loading:a,pageSize:25,highlightRowId:null==Z?void 0:Z.id}))}))}}]);