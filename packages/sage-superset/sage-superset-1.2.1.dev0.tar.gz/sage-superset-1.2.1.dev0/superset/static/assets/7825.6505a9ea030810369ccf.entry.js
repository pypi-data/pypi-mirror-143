"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[7825],{5951:(e,t,s)=>{s.d(t,{Z:()=>i});var r=s(14890),a=s(37703),n=s(37355),o=s(72570);const i=(0,a.$j)((({messageToasts:e})=>({toasts:e})),(e=>(0,r.DE)({removeToast:o.RS},e)))(n.Z)},25422:(e,t,s)=>{s.d(t,{Z:()=>c});var r=s(5872),a=s.n(r),n=s(67294),o=s(61988),i=s(58552),l=s(91178),u=s(11965);const c=function({error:e,source:t="dashboard",subtitle:s}){const{extra:r,level:c,message:g}=e,d=["dashboard","explore"].includes(t),R=r&&(0,u.tZ)(n.Fragment,null,(0,u.tZ)("p",null,(0,o.t)("This may be triggered by:"),(0,u.tZ)("br",null),r.issue_codes.map((e=>(0,u.tZ)(i.Z,a()({},e,{key:e.code})))).reduce(((e,t)=>[e,(0,u.tZ)("br",null),t]))),d&&r.owners&&(0,u.tZ)(n.Fragment,null,(0,u.tZ)("br",null),(0,u.tZ)("p",null,(0,o.tn)("Please reach out to the Chart Owner for assistance.","Please reach out to the Chart Owners for assistance.",r.owners.length)),(0,u.tZ)("p",null,(0,o.tn)("Chart Owner: %s","Chart Owners: %s",r.owners.length,r.owners.join(", "))))),Z=r&&r.issue_codes?(0,o.t)("%(message)s\nThis may be triggered by: \n%(issues)s",{message:g,issues:r.issue_codes.map((e=>e.message)).join("\n")}):g;return(0,u.tZ)(l.Z,{title:(0,o.t)("%s Error",r&&r.engine_name||(0,o.t)("DB engine")),subtitle:s,level:c,source:t,copyText:Z,body:R})}},41189:(e,t,s)=>{s.d(t,{Z:()=>o}),s(67294);var r=s(61988),a=s(91178),n=s(11965);const o=function({error:e,source:t="dashboard",subtitle:s}){const{level:o,message:i}=e;return(0,n.tZ)(a.Z,{title:(0,r.t)("Missing dataset"),subtitle:s,level:o,source:t,copyText:i,body:null})}},58552:(e,t,s)=>{s.d(t,{Z:()=>n});var r=s(67294),a=s(11965);function n({code:e,message:t}){return(0,a.tZ)(r.Fragment,null,t," ",(0,a.tZ)("a",{href:`https://superset.apache.org/docs/miscellaneous/issue-codes#issue-${e}`,rel:"noopener noreferrer",target:"_blank"},(0,a.tZ)("i",{className:"fa fa-external-link"})))}},15161:(e,t,s)=>{s.d(t,{Z:()=>c});var r=s(67294),a=s(61988),n=s(39991),o=s.n(n),i=s(58552),l=s(91178),u=s(11965);const c=function({error:e,source:t="sqllab",subtitle:s}){const{extra:n={issue_codes:[]},level:c,message:g}=e,d=(0,a.tn)("This was triggered by:","This may be triggered by:",n.issue_codes.length),R=((e,t)=>{const s={};return e.forEach((e=>{t.forEach((t=>{o()(e,t)<=2&&(s[e]||(s[e]=[]),s[e].push(`"${t}"`))}))})),s})(n.undefined_parameters||[],Object.keys(n.template_parameters||{})),Z=(0,u.tZ)(r.Fragment,null,(0,u.tZ)("p",null,Object.keys(R).length>0&&(0,u.tZ)(r.Fragment,null,(0,u.tZ)("p",null,(0,a.t)("Did you mean:")),(0,u.tZ)("ul",null,Object.entries(R).map((([e,t])=>(0,u.tZ)("li",null,(0,a.tn)('%(suggestion)s instead of "%(undefinedParameter)s?"','%(firstSuggestions)s or %(lastSuggestion)s instead of "%(undefinedParameter)s"?',t.length,{suggestion:t.join(", "),firstSuggestions:t.slice(0,-1).join(", "),lastSuggestion:t[t.length-1],undefinedParameter:e}))))),(0,u.tZ)("br",null)),d,(0,u.tZ)("br",null),n.issue_codes.length>0&&n.issue_codes.map((e=>(0,u.tZ)(i.Z,e))).reduce(((e,t)=>[e,(0,u.tZ)("br",null),t])))),_=`${g}\n${d}\n${n.issue_codes.map((e=>e.message)).join("\n")}`;return(0,u.tZ)(l.Z,{title:(0,a.t)("Parameter error"),subtitle:s,level:c,source:t,copyText:_,body:Z})}},18951:(e,t,s)=>{s.d(t,{Z:()=>l});var r=s(67294),a=s(61988),n=s(58552),o=s(91178),i=s(11965);const l=function({error:e,source:t}){const{extra:s,level:l}=e,u=["dashboard","explore"].includes(t),c=u?(0,a.tn)("We’re having trouble loading this visualization. Queries are set to timeout after %s second.","We’re having trouble loading this visualization. Queries are set to timeout after %s seconds.",s.timeout,s.timeout):(0,a.tn)("We’re having trouble loading these results. Queries are set to timeout after %s second.","We’re having trouble loading these results. Queries are set to timeout after %s seconds.",s.timeout,s.timeout),g=(0,i.tZ)(r.Fragment,null,(0,i.tZ)("p",null,(0,a.t)("This may be triggered by:"),(0,i.tZ)("br",null),s.issue_codes.map((e=>(0,i.tZ)(n.Z,e))).reduce(((e,t)=>[e,(0,i.tZ)("br",null),t]))),u&&s.owners&&(0,i.tZ)(r.Fragment,null,(0,i.tZ)("br",null),(0,i.tZ)("p",null,(0,a.tn)("Please reach out to the Chart Owner for assistance.","Please reach out to the Chart Owners for assistance.",s.owners.length)),(0,i.tZ)("p",null,(0,a.tn)("Chart Owner: %s","Chart Owners: %s",s.owners.length,s.owners.join(", "))))),d=(0,a.t)("%(subtitle)s\nThis may be triggered by:\n %(issue)s",{subtitle:c,issue:s.issue_codes.map((e=>e.message)).join("\n")});return(0,i.tZ)(o.Z,{title:(0,a.t)("Timeout error"),subtitle:c,level:l,source:t,copyText:d,body:g})}},50948:(e,t,s)=>{s.d(t,{Z:()=>R});var r=s(51995),a=s(11965),n=s(94184),o=s.n(n),i=s(13423),l=s(67294),u=s(70163),c=s(8818);const g=r.iK.div`
  display: flex;
