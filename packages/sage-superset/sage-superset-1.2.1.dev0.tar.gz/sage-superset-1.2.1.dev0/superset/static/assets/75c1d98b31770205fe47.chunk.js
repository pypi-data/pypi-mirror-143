"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[5656],{73995:(e,t,a)=>{a.d(t,{Z:()=>v});var n=a(67294),s=a(51995),l=a(31069),i=a(61988),o=a(15926),r=a.n(o),d=a(4715),c=a(37921),u=a(49238),m=a(40277),h=a(14114),p=a(11965);const b=s.iK.div`
...
`,Z=({backend:e,databaseName:t})=>(0,p.tZ)(g,null,(0,p.tZ)(c.Z,{className:"backend"},e),(0,p.tZ)("span",{className:"name",title:t},t));function v({db:e,formMode:t=!1,getDbList:a,handleError:s,isDatabaseSelectEnabled:o=!0,onDbChange:c,onSchemaChange:g,onSchemasLoad:v,readOnly:f=!1,schema:y,sqlLabMode:w=!1}){const[S,x]=(0,n.useState)(!1),[_,C]=(0,n.useState)([]),[k,$]=(0,n.useState)(e?{label:(0,p.tZ)(Z,{backend:e.backend,databaseName:e.database_name}),value:e.id,...e}:void 0),[D,N]=(0,n.useState)(y?{label:y,value:y}:void 0),[T,E]=(0,n.useState)(0),{addSuccessToast:L}=(0,h.e)(),z=(0,n.useMemo)((()=>async(e,n,o)=>{const d=`/api/v1/database/?q=${r().encode({order_columns:"database_name",order_direction:"asc",page:n,page_size:o,...t||!w?{filters:[{col:"database_name",opr:"ct",value:e}]}:{filters:[{col:"database_name",opr:"ct",value:e},{col:"expose_in_sqllab",opr:"eq",value:!0}]}})}`;return l.Z.get({endpoint:d}).then((({json:e})=>{const{result:t}=e;a&&a(t),0===t.length&&s((0,i.t)("It seems you don't have access to any database"));const n=t.map((e=>({label:(0,p.tZ)(Z,{backend:e.backend,databaseName:e.database_name}),value:e.id,id:e.id,database_name:e.database_name,backend:e.backend,allow_multi_schema_metadata_fetch:e.allow_multi_schema_metadata_fetch})));return{data:n,totalCount:n.length}}))}),[t,a,s,w]);function M(e,t){return(0,p.tZ)("div",{className:"section"},(0,p.tZ)("span",{className:"select"},e),(0,p.tZ)("span",{className:"refresh"},t))}return(0,n.useEffect)((()=>{if(k){x(!0);const e=r().encode({force:T>0}),t=`/api/v1/database/${k.value}/schemas/?q=${e}`;l.Z.get({endpoint:t}).then((({json:e})=>{const t=e.result.map((e=>({value:e,label:e,title:e})));v&&v(t),C(t),x(!1),T>0&&L("List refreshed")})).catch((()=>{x(!1),s((0,i.t)("There was an error loading the schemas"))}))}}),[k,v,T]),(0,p.tZ)(b,null,M((0,p.tZ)(d.Ph,{ariaLabel:(0,i.t)("Select database or type database name"),optionFilterProps:["database_name","value"],header:(0,p.tZ)(u.lX,null,(0,i.t)("Database")),lazyLoading:!1,onChange:function(e,t){$(t),N(void 0),c&&c(t),g&&g(void 0)},value:k,placeholder:(0,i.t)("Select database or type database name"),disabled:!o||f,options:z}),null),function(){const e=!t&&!f&&(0,p.tZ)(m.Z,{onClick:()=>E(T+1),tooltipContent:(0,i.t)("Force refresh schema list")});return M((0,p.tZ)(d.Ph,{ariaLabel:(0,i.t)("Select schema or type schema name"),disabled:f,header:(0,p.tZ)(u.lX,null,(0,i.t)("Schema")),labelInValue:!0,lazyLoading:!1,loading:S,name:"select-schema",placeholder:(0,i.t)("Select schema or type schema name"),onChange:e=>function(e){N(e),g&&g(e.value)}(e),options:_,showSearch:!0,value:D}),e)}())}},27989:(e,t,a)=>{a.d(t,{Z:()=>h});var n=a(67294),s=a(51995),l=a(61988),i=a(35932),o=a(74069),r=a(4715),d=a(34858),c=a(11965);const u=s.iK.div`
  display: block;
