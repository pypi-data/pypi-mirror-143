"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[1611],{29848:(t,e,n)=>{n.d(e,{Z:()=>d}),n(67294);var a=n(51995),o=n(58593),l=n(70163),s=n(11965);const i=a.iK.span`
  white-space: nowrap;
  min-width: 100px;
  svg,
  i {
...
`;function d({actions:t}){return(0,s.tZ)(i,{className:"actions"},t.map(((t,e)=>{const n=l.Z[t.icon];return t.tooltip?(0,s.tZ)(o.u,{id:`${t.label}-tooltip`,title:t.tooltip,placement:t.placement,key:e},(0,s.tZ)(r,{role:"button",tabIndex:0,className:"action-button",onClick:t.onClick},(0,s.tZ)(n,null))):(0,s.tZ)(r,{role:"button",tabIndex:0,className:"action-button",onClick:t.onClick,key:e},(0,s.tZ)(n,null))})))}},35276:(t,e,n)=>{n.r(e),n.d(e,{default:()=>T});var a=n(67294),o=n(73727),l=n(5977),s=n(61988),i=n(31069),r=n(51995),d=n(30381),c=n.n(d),u=n(15926),m=n.n(u),h=n(29848),p=n(35932),g=n(19259),Z=n(17198),_=n(98289),b=n(20755),y=n(98286),f=n(14114),x=n(34858),v=n(40768),w=n(62276),k=n(70163),$=n(74069),S=n(94670),C=n(11965);const D=r.iK.div`
