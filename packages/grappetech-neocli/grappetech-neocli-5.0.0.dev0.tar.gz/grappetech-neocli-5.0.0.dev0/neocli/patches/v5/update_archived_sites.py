...
only for Neo v14 neoclies. If not a v14 neocli yet, skip this
...
Corresponding changes in neo/neo via https://github.com/grappetech/neo/pull/15060
"""
import os
from pathlib import Path

import click
from neocli.utils.app import get_current_version
from semantic_version import Version


def execute(neocli_path):
	neo_version = Version(get_current_version('neo'))

	if neo_version.major < 14 or os.name != "posix":
		# Returning False means patch has been skipped
		return False

	pre_patch_dir = os.getcwd()
	old_directory = Path(neocli_path, "archived_sites")
	new_directory = Path(neocli_path, "archived", "sites")
