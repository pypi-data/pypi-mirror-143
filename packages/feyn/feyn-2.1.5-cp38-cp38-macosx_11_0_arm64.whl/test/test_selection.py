...
from feyn._selection import _sympy_compare, _canonical_compare
...
class TestSympyCompare(unittest.TestCase):
    def setUp(self):
    ...
    def test_sympy_compare(self):
        ...
        with self.subTest("Sympy comparing the same model should return true"):
            models = [self.test_model] * 2
            actual = _sympy_compare(models[0], models[1])
            self.assertTrue(actual)

        with self.subTest("Sympy comparing different models should return False"):
