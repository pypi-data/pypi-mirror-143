...
class PlotsMixin:
    ...
    @check_types()
    def plot_flow(self, data: DataFrame, sample: Union[DataFrame, Series]) -> "feyn.tools._display.HTML":
    ...
    def plot_response_2d(
        ...
        """
        feyn.plots.plot_model_response_2d(self, data, fixed, ax, resolution, figsize, filename)
    ...
    def plot_response_1d(
        ...
        feyn.plots.plot_model_response_1d(self, data, by, input_constraints, ax, figsize, filename)

    @check_types()
    def plot_signal(self, data: DataFrame, corr_func: Optional[str] = None, filename: Optional[str] = None):
        """
        ...
        """
        return feyn.plots.plot_model_signal(self, data, corr_func=corr_func, filename=filename)
