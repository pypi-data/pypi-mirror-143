...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html)
...
class SnowDeviceManagementClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#can_paginate)
        """
    ...
    async def cancel_task(self, *, taskId: str) -> CancelTaskOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#cancel_task)
        """
    ...
    async def create_task(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#create_task)
        """
    ...
    async def describe_device(self, *, managedDeviceId: str) -> DescribeDeviceOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#describe_device)
        """
    ...
    async def describe_device_ec2_instances(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#describe_device_ec2_instances)
        """
    ...
    async def describe_execution(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#describe_execution)
        """
    ...
    async def describe_task(self, *, taskId: str) -> DescribeTaskOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#describe_task)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#generate_presigned_url)
        """
    ...
    async def list_device_resources(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#list_device_resources)
        """
    ...
    async def list_devices(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#list_devices)
        """
    ...
    async def list_executions(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#list_executions)
        """
    ...
    async def list_tags_for_resource(self, *, resourceArn: str) -> ListTagsForResourceOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#list_tags_for_resource)
        """
    ...
    async def list_tasks(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#list_tasks)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#untag_resource)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_snow_device_management/client.html#get_paginator)
        """
