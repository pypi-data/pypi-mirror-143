...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.SnowDeviceManagement 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore snow-device-management type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
