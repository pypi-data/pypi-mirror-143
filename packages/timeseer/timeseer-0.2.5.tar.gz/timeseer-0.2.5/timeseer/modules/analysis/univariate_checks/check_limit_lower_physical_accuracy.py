...
_CHECK_NAME = "Out-of-bounds (lower, physical, accuracy)"
_EVENT_FRAME_NAME = "Out of bounds (lower, physical, accuracy)"
...
def _get_active_points(df: pd.DataFrame, metadata: timeseer.Metadata):
    limit_low = metadata.get_field(fields.LimitLowPhysical)
