...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html)
...
class SSMContactsClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#exceptions)
        """
    ...
    async def accept_page(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#accept_page)
        """
    ...
    async def activate_contact_channel(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#activate_contact_channel)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#can_paginate)
        """
    ...
    async def create_contact(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#create_contact)
        """
    ...
    async def create_contact_channel(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#create_contact_channel)
        """
    ...
    async def deactivate_contact_channel(self, *, ContactChannelId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#deactivate_contact_channel)
        """
    ...
    async def delete_contact(self, *, ContactId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#delete_contact)
        """
    ...
    async def delete_contact_channel(self, *, ContactChannelId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#delete_contact_channel)
        """
    ...
    async def describe_engagement(self, *, EngagementId: str) -> DescribeEngagementResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#describe_engagement)
        """
    ...
    async def describe_page(self, *, PageId: str) -> DescribePageResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#describe_page)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#generate_presigned_url)
        """
    ...
    async def get_contact(self, *, ContactId: str) -> GetContactResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#get_contact)
        """
    ...
    async def get_contact_channel(self, *, ContactChannelId: str) -> GetContactChannelResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#get_contact_channel)
        """
    ...
    async def get_contact_policy(self, *, ContactArn: str) -> GetContactPolicyResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#get_contact_policy)
        """
    ...
    async def list_contact_channels(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#list_contact_channels)
        """
    ...
    async def list_contacts(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#list_contacts)
        """
    ...
    async def list_engagements(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#list_engagements)
        """
    ...
    async def list_page_receipts(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#list_page_receipts)
        """
    ...
    async def list_pages_by_contact(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#list_pages_by_contact)
        """
    ...
    async def list_pages_by_engagement(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#list_pages_by_engagement)
        """
    ...
    async def list_tags_for_resource(self, *, ResourceARN: str) -> ListTagsForResourceResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#list_tags_for_resource)
        """
    ...
    async def put_contact_policy(self, *, ContactArn: str, Policy: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#put_contact_policy)
        """
    ...
    async def send_activation_code(self, *, ContactChannelId: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#send_activation_code)
        """
    ...
    async def start_engagement(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#start_engagement)
        """
    ...
    async def stop_engagement(self, *, EngagementId: str, Reason: str = ...) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#stop_engagement)
        """
    ...
    async def tag_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceARN: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#untag_resource)
        """
    ...
    async def update_contact(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#update_contact)
        """
    ...
    async def update_contact_channel(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#update_contact_channel)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_contacts/client.html#get_paginator)
        """
