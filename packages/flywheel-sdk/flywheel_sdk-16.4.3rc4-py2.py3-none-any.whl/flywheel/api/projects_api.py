...
class ProjectsApi(object):
    ...
    def add_project_analysis_with_http_info(self, project_id, body, **kwargs):  # noqa: E501
        ...
        all_params = ['project_id','body','job','inputs','description','info','label','job','compute_provider_id',]  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        local_var_files = {}
        if 'inputs' in params:
            form_params.append(('inputs', params['inputs']))  # noqa: E501
            collection_formats['inputs'] = 'multi'  # noqa: E501
        if 'description' in params:
            form_params.append(('description', params['description']))  # noqa: E501
        if 'info' in params:
            form_params.append(('info', params['info']))  # noqa: E501
        if 'label' in params:
        ...
        if 'compute_provider_id' in params:
            form_params.append(('compute_provider_id', params['compute_provider_id']))  # noqa: E501
    ...
    def download_project_analysis_inputs_with_http_info(self, project_id, analysis_id, **kwargs):  # noqa: E501
        ...
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/octet-stream', 'response'])  # noqa: E501
