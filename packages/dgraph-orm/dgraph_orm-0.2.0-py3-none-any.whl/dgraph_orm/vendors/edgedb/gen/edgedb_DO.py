...
class Artist(Node[ArtistInsert]):
    ...
    class GraphORM:
        ...
        exclusive_fields: T.Set[str] = {"beatgig_id", "id", "slug"}
...
class Booking(Node[BookingInsert]):
    ...
    class GraphORM:
        ...
        exclusive_fields: T.Set[str] = {"beatgig_id", "id"}
...
class User(Node[UserInsert]):
    ...
    slug: str = Field(..., allow_mutation=True)
    firebase_id: str = Field(..., allow_mutation=True)
    beatgig_id: str = Field(..., allow_mutation=False)
...
class Animal(Node[AnimalInsert]):
    ...
    class GraphORM:
        ...
        exclusive_fields: T.Set[str] = {"id", "slug", "public_id"}
