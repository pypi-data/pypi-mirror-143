...
for item in json_array_unpack(raw_data) union (
    insert Person {{ first_name := <str>item['first_name'], slug := <str>item['slug'], last_name := <str>item['last_name'] }}
) {{id, slug, last_name, created_at}}
        """
    data = [
        {
    ...
    variables = {"data": json.dumps(data)}
