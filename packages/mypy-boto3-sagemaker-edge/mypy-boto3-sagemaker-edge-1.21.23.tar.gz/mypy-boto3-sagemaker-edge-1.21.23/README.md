...
[boto3.SagemakerEdgeManager 1.21.23](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sagemaker-edge.html#SagemakerEdgeManager)
...
```python
from mypy_boto3_sagemaker_edge.literals import (
    SagemakerEdgeManagerServiceName,
    ServiceName,
    ResourceServiceName,
)

def check_value(value: SagemakerEdgeManagerServiceName) -> bool:
    ...
```
...
[boto3 docs](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_sagemaker_edge/)
