...
def main():
    ...
    home = Path.home()
    user_setting = os.path.join(str(home), ".jupyter", "lab", "user-settings",
                                "jupyterlab_mutableai", "settings-mutableai.jupyterlab-settings")
    setting_file_exists = os.path.exists(user_setting)

    parser = argparse.ArgumentParser()
    parser.add_argument(
        '--api_key', help='Update Jupyterlab MutableAI License Key.')
    parser.add_argument('--auto_complete_domain',
                        help='Update Jupyterlab MutableAI Autocomplete Domain.')
    parser.add_argument('--transform_domain',
                        help='Update Jupyterlab MutableAI Transform Domain.')
