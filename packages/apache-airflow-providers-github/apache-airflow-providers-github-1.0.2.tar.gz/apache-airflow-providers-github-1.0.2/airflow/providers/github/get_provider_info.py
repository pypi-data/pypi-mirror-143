...
def get_provider_info():
    return {
        ...
        'hooks': [
            {'integration-name': 'Github', 'python-modules': ['airflow.providers.github.hooks.github']}
        ],
        'operators': [
            {'integration-name': 'Github', 'python-modules': ['airflow.providers.github.operators.github']}
        ],
        'sensors': [
            {'integration-name': 'Github', 'python-modules': ['airflow.providers.github.sensors.github']}
        ],
        'connection-types': [
            {
