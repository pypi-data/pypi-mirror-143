...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html)
...
class LaunchProfileDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#launchprofiledeletedwaiter)
    """
...
class LaunchProfileReadyWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#launchprofilereadywaiter)
    """
...
class StreamingImageDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#streamingimagedeletedwaiter)
    """
...
class StreamingImageReadyWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#streamingimagereadywaiter)
    """
...
class StreamingSessionDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#streamingsessiondeletedwaiter)
    """
...
class StreamingSessionReadyWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#streamingsessionreadywaiter)
    """
...
class StreamingSessionStoppedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#streamingsessionstoppedwaiter)
    """
...
class StreamingSessionStreamReadyWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#streamingsessionstreamreadywaiter)
    """
...
class StudioComponentDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#studiocomponentdeletedwaiter)
    """
...
class StudioComponentReadyWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#studiocomponentreadywaiter)
    """
...
class StudioDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#studiodeletedwaiter)
    """

    async def wait(self, *, studioId: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
...
class StudioReadyWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_nimble/waiters.html#studioreadywaiter)
    """
