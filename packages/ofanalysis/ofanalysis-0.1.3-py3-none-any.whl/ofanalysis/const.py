...
__rootPath = __curPath[:__curPath.find("inv_mgr") + len("inv_mgr/")]

PROJECT_ROOT = os.path.abspath(__rootPath)

TS_PRO = ts.pro_api('602e5ad960d66ab8b1f3c13b4fd746f5323ff808b0820768b02c6da3')

LIXINGREN_TOKEN = '1364169b-e34f-41ab-95eb-094a10638652'
LIXINGREN_HEADER = {
...
MONGODB_LINK = "mongodb://mongoadmin:secretsecret@mongo:27017/"
