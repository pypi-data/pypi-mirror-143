...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html)
...
class ConnectParticipantClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#can_paginate)
        """
    ...
    async def complete_attachment_upload(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#complete_attachment_upload)
        """
    ...
    async def create_participant_connection(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#create_participant_connection)
        """
    ...
    async def disconnect_participant(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#disconnect_participant)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#generate_presigned_url)
        """
    ...
    async def get_attachment(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#get_attachment)
        """
    ...
    async def get_transcript(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#get_transcript)
        """
    ...
    async def send_event(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#send_event)
        """
    ...
    async def send_message(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#send_message)
        """
    ...
    async def start_attachment_upload(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_connectparticipant/client.html#start_attachment_upload)
        """
