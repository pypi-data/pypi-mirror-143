...
async def _config_data():
    ...
    # [DOC] Check error_reporting_server Config Attr
    if Config.error_reporting_server:
        ...
        sentry_sdk.init(
            ...
            with_locals=True,
            release=f'{Config._app_name}:{Config._app_version}',
