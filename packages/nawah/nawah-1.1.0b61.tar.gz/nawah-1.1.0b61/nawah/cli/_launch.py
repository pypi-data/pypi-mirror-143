...
from ._logging import formatter, handler, logger
...
def launch(
    ...
    try:
        ...
        if (
            not Config._app_name
            or not Config._app_version
            or not Config._app_default_package
        ):
            logger.error(
    ...
    if not custom_launch:
        ...
        async def _():
            from nawah.utils import _generate_ref, _import_modules
        ...
        async def _():
            from nawah.utils import _generate_models, _import_modules
