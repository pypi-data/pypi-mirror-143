...
from typing import (TYPE_CHECKING, Any, Dict, List, Literal, Optional,
                    Protocol, Tuple, TypedDict, Union, cast)
...
if TYPE_CHECKING:
    ...
    from ._types import NAWAH_DOC, NAWAH_ENV, NAWAH_EVENTS, NAWAH_QUERY
...
class PERM:
    ...
    def __validate_obj(self, obj):
        ...
        if type(obj) == list:
            ...
            raise Exception(
                f'Can\'t validate permission obj {obj} of type {type(obj)}.'
            )
        ...
        for j in obj_iter:
            ...
            if type(obj[j]) in [list, dict]:
                ...
                if obj[j]._type != 'TYPE':
                    raise Exception(
                        f'Attr Type \'{j}\' of TYPE \'{obj[j]._type}\' is not allowed.'
                    )
...
class METHOD:
    ...
    reset_cache_channels: Union[None, List[str]] = None
    ...
    def _validate(self):
        ...
        self._callable = BaseMethod(
            ...
            cache=self.cache,
            reset_cache_channels=self.reset_cache_channels,
        )
...
class CACHE:
    ...
    def __repr__(self):
        return f'<CACHE:{self.condition},{self.user_scoped},{self.period}>'
    ...
    def __init__(
        ...
        *,
        ...
        Config._cache_channels.add(channel)
