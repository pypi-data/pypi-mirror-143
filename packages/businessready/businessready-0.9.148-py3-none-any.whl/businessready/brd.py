...
def NXOS_learn_arp(hostname, username, password, ip):
    ...
    # Create Testbed
        filename = hostname
        # create your testbed
        original_testbed = Testbed('manuallyCreatedTestbed',
        ...
        device.testbed = original_testbed
        new_testbed = testbed.load(original_testbed)
        for host_device in new_testbed:
            host_device.connect()

        # Learn ARP to JSON

            learn_arp = host_device.learn("arp").info
