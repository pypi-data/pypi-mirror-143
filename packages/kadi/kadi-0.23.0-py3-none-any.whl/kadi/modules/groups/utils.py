...
def get_user_groups(user=None):
    ...
    inside a group, they are a member of it. Note that inactive groups will be filtered
    out.
    ...
    return Group.query.filter(Group.id.in_(group_ids_query), Group.state == "active")
