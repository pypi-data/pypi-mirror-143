        ...
        <thead class="bg-light" v-if="hasHeader">
          <tr>
            <th v-for="(value, index) in headerRow" :key="index">
              <div class="cursor-pointer" @click="sortRow(index)">
                <span class="mr-2" v-if="sort.index === index">
                  <i class="fa-solid fa-up-long" v-if="sort.direction === 'desc'"></i>
                  <i class="fa-solid fa-down-long" v-if="sort.direction === 'asc'"></i>
                </span>
                <strong>
