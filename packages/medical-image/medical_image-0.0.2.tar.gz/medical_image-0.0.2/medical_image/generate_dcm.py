...
class DicomModule(object):
    def __init__(self, web_json):
        ...
        self.logo = Image.open('package/logo/deepnoid.png')
        self.colorbar = Image.open('package/logo/colorbar.png')
    ...
    def make_sc_array(self, result_json):
        mfont = ImageFont.truetype('package/fonts/NotoSerifCJKkr-hinted/NotoSansCJKkr-Medium.otf', int(result_json['Height'] / 50))
        ...
        if len(heatmaps) != heatmaps.count(None):
            ...
            sfont = ImageFont.truetype('package/fonts/NotoSerifCJKkr-hinted/NotoSansCJKkr-Medium.otf', int(result_json['Height'] / 90))
...
class DicomModule3D(object):
    ...
    def make_sc_array(self, ds, objects):
        ...
        mfont = ImageFont.truetype('package/fonts/NotoSerifCJKkr-hinted/NotoSansCJKkr-Medium.otf', int(height / 50))
