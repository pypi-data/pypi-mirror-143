...
def append_svc_cli(root_sp):
    ...
    p = sp.add_parser('purge',
                      help='purge service (destroy and delete configs)')
    p.add_argument('i', metavar='SVC').completer = ComplSvc()
...
def init_ap():
    ...
    p.add_argument('config',
                   ...
                   choices=[
                       'config/core', 'config/elbus', 'config/logs',
    ...
    try:
        ...
        p.add_argument('--unsafe',
                       action='store_true',
                       help='skip signature verifications')
        p.add_argument('--test',
                       action='store_true',
