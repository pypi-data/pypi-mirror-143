...
class ImagePipeline(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        component_doc_path: builtins.str,
        ...
        :param scope: -
        :param id: -
        :param component_doc_path: Relative path to the Image Builder component document.
        ...
        props = ImagePipelineProps(
            component_doc_path=component_doc_path,
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={
        "component_doc_path": "componentDocPath",
...
class ImagePipelineProps:
    ...
    @builtins.property
    def component_doc_path(self) -> builtins.str:
        '''Relative path to the Image Builder component document.'''
        result = self._values.get("component_doc_path")
        assert result is not None, "Required property 'component_doc_path' is missing"
