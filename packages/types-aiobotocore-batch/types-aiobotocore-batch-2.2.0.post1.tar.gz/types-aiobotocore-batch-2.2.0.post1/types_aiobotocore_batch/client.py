...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html)
...
class BatchClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#can_paginate)
        """
    ...
    async def cancel_job(self, *, jobId: str, reason: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#cancel_job)
        """
    ...
    async def create_compute_environment(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#create_compute_environment)
        """
    ...
    async def create_job_queue(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#create_job_queue)
        """
    ...
    async def create_scheduling_policy(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#create_scheduling_policy)
        """
    ...
    async def delete_compute_environment(self, *, computeEnvironment: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#delete_compute_environment)
        """
    ...
    async def delete_job_queue(self, *, jobQueue: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#delete_job_queue)
        """
    ...
    async def delete_scheduling_policy(self, *, arn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#delete_scheduling_policy)
        """
    ...
    async def deregister_job_definition(self, *, jobDefinition: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#deregister_job_definition)
        """
    ...
    async def describe_compute_environments(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#describe_compute_environments)
        """
    ...
    async def describe_job_definitions(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#describe_job_definitions)
        """
    ...
    async def describe_job_queues(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#describe_job_queues)
        """
    ...
    async def describe_jobs(self, *, jobs: Sequence[str]) -> DescribeJobsResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#describe_jobs)
        """
    ...
    async def describe_scheduling_policies(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#describe_scheduling_policies)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#generate_presigned_url)
        """
    ...
    async def list_jobs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#list_jobs)
        """
    ...
    async def list_scheduling_policies(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#list_scheduling_policies)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#list_tags_for_resource)
        """
    ...
    async def register_job_definition(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#register_job_definition)
        """
    ...
    async def submit_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#submit_job)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#tag_resource)
        """
    ...
    async def terminate_job(self, *, jobId: str, reason: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#terminate_job)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#untag_resource)
        """
    ...
    async def update_compute_environment(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#update_compute_environment)
        """
    ...
    async def update_job_queue(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#update_job_queue)
        """
    ...
    async def update_scheduling_policy(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#update_scheduling_policy)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/client.html#get_paginator)
        """
