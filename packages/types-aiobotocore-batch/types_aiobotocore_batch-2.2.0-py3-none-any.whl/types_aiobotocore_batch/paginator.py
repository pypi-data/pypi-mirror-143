...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/paginators.html)
...
class DescribeComputeEnvironmentsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/paginators.html#describecomputeenvironmentspaginator)
    """
...
class DescribeJobDefinitionsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/paginators.html#describejobdefinitionspaginator)
    """
...
class DescribeJobQueuesPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/paginators.html#describejobqueuespaginator)
    """
...
class ListJobsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/paginators.html#listjobspaginator)
    """
...
class ListSchedulingPoliciesPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_batch/paginators.html#listschedulingpoliciespaginator)
    """
