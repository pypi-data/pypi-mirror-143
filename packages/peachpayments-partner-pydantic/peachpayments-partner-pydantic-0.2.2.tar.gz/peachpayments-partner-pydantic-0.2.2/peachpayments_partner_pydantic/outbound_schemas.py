...
#   timestamp: 2022-03-15T09:12:39+00:00
...
class Browser(BaseModel):
    ...
    acceptHeader: Optional[str] = Field(
        None,
        description="Value of the Accept header sent from the customer's browser.",
    ...
    screenHeight: Optional[str] = Field(
        None, description="Total height of the customer’s screen in pixels.", example="1080", regex="^[\\s\\S]{1,6}$"
    )
    screenWidth: Optional[str] = Field(
        None, description="Total width of the customer’s screen in pixels.", example="1920", regex="^[\\s\\S]{1,6}$"
    )
    timezone: Optional[str] = Field(
        None,
        description="Time-zone offset in minutes between UTC and the customer's browser's local time.",
        example="30",
        regex="^[\\s\\S]{1,5}$",
    )
    ...
    javaEnabled: Optional[str] = Field(
        None,
        description="Boolean that represents the ability of the customer's browser to execute Java.",
        example="false",
        regex="^(true|false)$",
    )
    javascriptEnabled: Optional[str] = Field(
        None,
        description="Boolean that represents the ability of the customer's browser to execute javascript.",
        example="true",
        regex="^(true|false)$",
    )
    ...
    challengeWindow: Optional[str] = Field(
        None,
        description="Dimensions of the challenge window that has been displayed to the customer.",
        example="01",
        regex="^[0-9]{1,2}$",
    )
...
class Customer(BaseModel):
    ...
    status: Optional[str] = Field(
        None,
        description="This is used to determine if this is a new customer or an return customer",
        example="NEW",
        regex="^[\\s\\S]{1,255}$",
    )
    ...
    browser: Optional[Browser] = Field(None, description="Customer's browser details.")
...
class Data(BaseModel):
    ...
    city: Optional[str] = Field(
        None,
        description="The town, district or city linked to billing/shipping.",
        example="Cape Town",
        regex="^[\\s\\S]{1,48}$",
    )
    ...
    country: Optional[str] = Field(
        None, description="The country linked to billing/shippin.", example="ZA", regex="^[A-Z]{2}$"
    )
    houseNumber1: Optional[str] = Field(
        None,
        description="Primary house number of the billing/shipping address.",
        example="25567",
        regex="^[\\s\\S]{1,100}$",
    )
    postcode: Optional[str] = Field(
        None,
        description="The postal code or zip code of the billing/shipping address.",
        example="8001",
        regex="^[\\s\\S]{1,16}$",
    )
    ...
    street1: Optional[str] = Field(
        None,
        description=(
            "The door number, floor, building number, building name, and/or street name of the billing/shipping"
            " address."
        ),
...
class Redirect(BaseModel):
    url: AnyUrl = Field(
        ...,
        description="URL the the shopper must be redirected to in order to proceed.",
...
class NotificationUrl(BaseModel):
    __root__: AnyUrl = Field(
        ...,
        description=(
            "The Peach provided URL at which the Partner is required to send notifications/webhooks when the"
...
class MerchantTransactionId(BaseModel):
    __root__: str = Field(
        ...,
        description="Merchant-provided reference number. This identifier is often used for reconciliation.",
        example="test-12345",
        regex="^[\\s\\S]{1,255}$",
    )
...
class DebitRequestCard(BaseModel):
    ...
    number: str = Field(
        ..., description="The PAN or account number of the card.", example="4242424242424242", regex="^[0-9]{12,19}$"
    )
    cvv: Optional[str] = Field(None, description="The card security code or CVV.", example="123", regex="^[0-9]{3,4}$")
...
class DebitRequest(BaseModel):
    ...
    customParameters: Optional[CustomParameters] = None
    merchantTransactionId: Optional[MerchantTransactionId] = None
    merchantName: str = Field(..., example="Shopping Merchant", regex="^[\\s\\S]{1,255}$")
    merchantInvoiceId: Optional[str] = Field(
        None, example="20170630-4072-00", regex="^[\\w~!@#$%\\^&*()+\\-,./:?\\][\\\\\\{}`;|\\\"']{8,255}$"
    )
    notificationUrl: NotificationUrl
    clearingInstituteSessionId: Optional[ClearingInstituteSessionId] = None
    shopperResultUrl: AnyUrl = Field(
        ...,
        description="This will only be used to redirect back to Peach",
