...
class Iface(object):
    ...
    def prepareStatement(self, query):
        """
        Parameters:
         - query
    ...
    def getNumberOfRows(self, queryId):
        """
        Parameters:
         - queryId
...
class Client(Iface):
    ...
    def setSchema(self, path):
        ...
        """
        self.send_setSchema(path)
        self.recv_setSchema()

    def send_setSchema(self, path):
    ...
    def prepareStatement(self, query):
        ...
        """
        self.send_prepareStatement(query)
        return self.recv_prepareStatement()

    def send_prepareStatement(self, query):
    ...
    def getNumberOfRows(self, queryId):
        ...
        """
        self.send_getNumberOfRows(queryId)
        return self.recv_getNumberOfRows()

    def send_getNumberOfRows(self, queryId):
        self._oprot.writeMessageBegin('getNumberOfRows', TMessageType.CALL, self._seqid)
        args = getNumberOfRows_args()
        args.queryId = queryId
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getNumberOfRows(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.error is not None:
            raise result.error
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getNumberOfRows failed: unknown result")
    ...
    def isSchemaSet(self):
        self.send_isSchemaSet()
        return self.recv_isSchemaSet()

    def send_isSchemaSet(self):
        self._oprot.writeMessageBegin('isSchemaSet', TMessageType.CALL, self._seqid)
        args = isSchemaSet_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_isSchemaSet(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.error is not None:
            raise result.error
        raise TApplicationException(TApplicationException.MISSING_RESULT, "isSchemaSet failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["getNumberOfRows"] = Processor.process_getNumberOfRows
        ...
        self._processMap["isSchemaSet"] = Processor.process_isSchemaSet
    ...
    def process_setSchema(self, seqid, iprot, oprot):
        ...
        result = setSchema_result()
        try:
            self._handler.setSchema(args.path)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except SchemaProcessingException as error:
            msg_type = TMessageType.REPLY
            result.error = error
        ...
        oprot.writeMessageBegin("setSchema", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_prepareStatement(self, seqid, iprot, oprot):
        ...
        result = prepareStatement_result()
        try:
            result.success = self._handler.prepareStatement(args.query)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
    ...
    def process_getNumberOfRows(self, seqid, iprot, oprot):
        args = getNumberOfRows_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getNumberOfRows_result()
        try:
            result.success = self._handler.getNumberOfRows(args.queryId)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except RunTimeException as error:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getNumberOfRows", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_isSchemaSet(self, seqid, iprot, oprot):
        args = isSchemaSet_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = isSchemaSet_result()
        try:
            result.success = self._handler.isSchemaSet()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except RunTimeException as error:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("isSchemaSet", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
all_structs.append(setSchema_args)
setSchema_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'path', 'UTF8', None, ),  # 1
)


class setSchema_result(object):
    """
    Attributes:
     - error
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.error = SchemaProcessingException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setSchema_result)
setSchema_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'error', [SchemaProcessingException, None], None, ),  # 1
)
...
class clear_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.error = RunTimeException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
clear_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'error', [RunTimeException, None], None, ),  # 1
)
...
class getNumberOfRows_args(object):
    """
    Attributes:
     - queryId
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getNumberOfRows_args')
        if self.queryId is not None:
            oprot.writeFieldBegin('queryId', TType.STRING, 1)
            oprot.writeString(self.queryId.encode('utf-8') if sys.version_info[0] == 2 else self.queryId)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getNumberOfRows_args)
getNumberOfRows_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'queryId', 'UTF8', None, ),  # 1
)


class getNumberOfRows_result(object):
    """
    Attributes:
     - success
     - error
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getNumberOfRows_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRING, 0)
            oprot.writeBinary(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getNumberOfRows_result)
getNumberOfRows_result.thrift_spec = (
    (0, TType.STRING, 'success', 'BINARY', None, ),  # 0
    (1, TType.STRUCT, 'error', [RunTimeException, None], None, ),  # 1
)
...
class isSchemaSet_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('isSchemaSet_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(isSchemaSet_args)
isSchemaSet_args.thrift_spec = (
)


class isSchemaSet_result(object):
    """
    Attributes:
     - success
     - error
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('isSchemaSet_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRING, 0)
            oprot.writeBinary(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(isSchemaSet_result)
isSchemaSet_result.thrift_spec = (
    (0, TType.STRING, 'success', 'BINARY', None, ),  # 0
    (1, TType.STRUCT, 'error', [RunTimeException, None], None, ),  # 1
)
