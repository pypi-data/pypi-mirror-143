...
class OpenSearchServiceClient(AioBaseClient):
    ...
    async def describe_domain_change_progress(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_opensearch/client.html#describe_domain_change_progress)
        """
