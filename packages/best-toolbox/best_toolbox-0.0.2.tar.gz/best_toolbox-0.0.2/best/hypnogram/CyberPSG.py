...
class CyberPSG_XML_Writter:
    ...
    standard_UUID = {
        'AWAKE_PiesPro': '00000000-898a-4b80-8ed8-000000000000',
        'N1_PiesPro' : '00000000-898a-4b80-8ed8-111111111111',
        'N2_PiesPro': '00000000-898a-4b80-8ed8-222222222222',
        'N3_PiesPro': '00000000-898a-4b80-8ed8-333333333333',
        'REM_PiesPro': '00000000-898a-4b80-8ed8-444444444444',
        'UNKNOWN_PiesPro': '00000000-898a-4b80-8ed8-555555555555',
        'Arousal_PiesPro': '00000000-898a-4b80-8ed8-666666666666',
        'N_PiesPro': '00000000-898a-4b80-8ed8-777777777777',
        'SLP_PiesPro': '00000000-898a-4b80-8ed8-888888888888',
    }
    ...
    def add_AnnotationType(self, name_string="", groupAssociationId=None, color='#FF6C1FBA', note="", startsWithEpoch=False, stdDurationInSec=0):
        ...
        #     name_string += '_aisc'
        if name_string+'_PiesPro' in list(self.standard_UUID.keys()):
            name_string += '_PiesPro'
    ...
    def add_Annotation(self, start_datetime:datetime, end_datetime:datetime, AnnotationTypeId=0, note='', type='GlobalAnnotation'):
        ...
        if AnnotationTypeId + '_PiesPro' in list(self.standard_UUID.keys()):
            AnnotationTypeId += '_PiesPro'
