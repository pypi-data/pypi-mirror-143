...
# FIXME: runs forever. valid file is in correct BIGDATA_PATH dir as .bin.gz
...
COMPONENT_WORDS = OrderedDict([
    ...
    ('peopleness', 'human Humans homo_sapiens people people individuals humankind people men women'.split()),
    ...
    ('femaleness', 'female female Female females woman girl lady'.split()),
])
...
def nessvector(target, components=COMPONENTS):
    """ Compute your own meaning dimensions (components) for any word """
