...
class Currency(PlisioModel):
    ...
    def from_response(cls, response_dict: 'plisio.RType') -> 'Currency':
        return cls(
            ...
            response_dict.get('precision') and float(response_dict['precision']),
            ...
            response_dict.get('invoice_commission_percentage') and float(response_dict['invoice_commission_percentage']),
        )
...
class Custom(PlisioModel):
    ...
    def from_response(cls, response_dict: Dict[str, Union[str, dict]]) -> 'Custom':
        return cls(
            response_dict.get('min') and float(response_dict['min']),
            response_dict.get('max') and float(response_dict['max']),
            response_dict.get('default') and float(response_dict['default']),
            response_dict.get('borders'),
            response_dict.get('unit'),
        )
...
class Commission(PlisioModel):
    ...
    def __init__(
            ...
            max_amount: float,
            plan: 'plisio.PlanName',
            use_wallet: Optional[float],
            use_wallet_balance: Optional[float],
            plans: 'FeePlan',
            custom: 'Custom',
            errors: Optional[int],
            custom_fee_rate: float
    ):
    ...
    def from_response(cls, response_dict: Dict[str, Union[str, dict]]) -> 'Commission':
        return cls(
            ...
            response_dict.get('plan') and plisio.PlanName[response_dict['plan']],
            response_dict.get('useWallet') and float(response_dict['useWallet']),
            response_dict.get('useWalletBalance') and float(response_dict['useWalletBalance']),
            ...
            response_dict.get('customFeeRate') and float(response_dict['customFeeRate']),
        )
