...
class AssertConcurrentOp(_ods_ir.OpView):
  ...
  def __init__(self, event, clock, property, label, message, operands_, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class AssertOp(_ods_ir.OpView):
  ...
  def __init__(self, expression, defer, label, message, operands_, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class CaseZOp(_ods_ir.OpView):
  OPERATION_NAME = "sv.casez"

  _ODS_REGIONS = (0, False)

  def __init__(self, cond, casePatterns, num_caseRegions, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class FatalOp(_ods_ir.OpView):
  ...
  def __init__(self, verbosity, message, operands_, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class FinishOp(_ods_ir.OpView):
  ...
  def __init__(self, verbosity, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class IfDefOp(_ods_ir.OpView):
  ...
  @builtins.property
  def cond(self):
    return _ods_ir.StringAttr(self.operation.attributes["cond"])
...
class IndexedPartSelectInOutOp(_ods_ir.OpView):
  ...
  def __init__(self, input, base, width, decrement, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class InterfaceInstanceOp(_ods_ir.OpView):
  ...
  def __init__(self, result, name, inner_sym, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class VerbatimExprOp(_ods_ir.OpView):
  ...
  def __init__(self, result, string, operands_, symbols, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class VerbatimOp(_ods_ir.OpView):
  ...
  def __init__(self, string, operands_, symbols, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class XMROp(_ods_ir.OpView):
  ...
  def __init__(self, result, isRooted, path, terminal, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
