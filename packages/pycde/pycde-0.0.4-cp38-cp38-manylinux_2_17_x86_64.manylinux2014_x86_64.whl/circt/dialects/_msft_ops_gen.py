...
class DynamicInstanceOp(_ods_ir.OpView):
  ...
  def __init__(self, appid, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class InstanceOp(_ods_ir.OpView):
  ...
  def __init__(self, result, sym_name, moduleName, inputs, parameters, targetDesignPartition, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class PDPhysLocationOp(_ods_ir.OpView):
  ...
  def __init__(self, loc_, subPath, ref, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class PDPhysRegionOp(_ods_ir.OpView):
  ...
  def __init__(self, physRegionRef, subPath, ref, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
