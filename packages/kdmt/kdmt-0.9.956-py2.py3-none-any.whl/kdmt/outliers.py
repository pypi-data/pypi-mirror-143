...
csv_path='/Users/mohamedmentis/Dropbox/Mac (2)/Documents/Mentis/Development/Python/kolibri/kolibri-ml/projects/Alight/notebooks/data.csv'
...
outlier_mad = z_score_method(df, 'Gross_Total',threshold=4)
print(outlier_mad)