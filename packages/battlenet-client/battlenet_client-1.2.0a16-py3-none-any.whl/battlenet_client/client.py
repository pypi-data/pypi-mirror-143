...
class BattleNetClient(OAuth2Session):
    ...
    def __request(self, method, uri, params, *, retries=5, headers=None):
        ...
        Args:
            ...
            params (dict): parameters such as namespace and locale
        ...
        for _ in range(retries):
            try:
                raw_data = super().request(method, url, headers=headers, params=params)
    ...
    def get(self, uri, locale, namespace, **kwargs):
        ...
        if namespace and not self.tag == 'cn':
            namespace = getattr(self, f"{namespace}")

        params = {'locale': localize(locale), 'namespace': namespace}
        ...
        return self.__request("GET", uri, params, **kwargs)
    ...
    def post(self, uri, locale, namespace, **kwargs):
        ...
        kwargs['headers']['Battlenet-Namespace'] = namespace

        return self.__request("POST", uri, params, **kwargs)
