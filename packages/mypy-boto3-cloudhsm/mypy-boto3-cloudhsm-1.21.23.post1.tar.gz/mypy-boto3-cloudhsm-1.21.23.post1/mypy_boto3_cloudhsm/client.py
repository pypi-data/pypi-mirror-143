...
class CloudHSMClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_cloudhsm/client.html#exceptions)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_hapgs"]) -> ListHapgsPaginator:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_cloudhsm/client.html#get_paginator)
        """
