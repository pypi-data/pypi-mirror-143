...
def addInventory(request):
	...
	if request.method == "POST":
		newid = getlastid_kinos(Inventory,str(userAddress.employee.village.id))
...
def addUsedInventory(request):
	...
	if request.method == "POST":
		newid1 = getlastid_kinos(UsedInventory,str(userAddress.employee.village.id))
		newid2 = getlastid_kinos(UsedInventoryDetail,str(userAddress.employee.village.id))
