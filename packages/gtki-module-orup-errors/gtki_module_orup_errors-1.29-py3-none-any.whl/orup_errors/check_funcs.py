...
def check_car_has_rfid(have_rfid, choose_mode, comment, *args, **kwargs):
...
def check_carrier_debtor(carrier_name:str, debtors_list: list, comment, *args, **kwargs):
    if len(comment) < 1 and check_type_correctness(carrier_name, debtors_list):
        return True
