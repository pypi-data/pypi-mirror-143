...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.MarketplaceMetering 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore meteringmarketplace type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
