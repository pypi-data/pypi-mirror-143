...
"""
def read_gsheet(spreadsheetId = None, url = None, credentials = None, sheet = None):
    

    if url and credentials != True:
        ...
        cred = ServiceAccountCredentials.from_json_keyfile_name(credentials, scope)
        
        service = build('sheets', 'v4', credentials=cred)
    
        sheet = service.spreadsheets()
        
        result_input = sheet.values().get(spreadsheetId = spreadsheetId,
                                          range='A1:WWW500000').execute()
