...
class GasExchange(RateConstant):
    ...
    def __with_isotopes__(self, i: int) -> None:
        ...
        # eco2_at_12 = eco2_aq - eco2_at_13
        # gd = get_delta_i(eco2_at_12, eco2_at_13, self.gas.species.r)
        # print(f"gas eq delta {gd:.2f}")
        ...
        # debug
        # eco2_aq_12 = eco2_aq - eco2_aq_13
        # print(f"{eco2_aq}, {eco2_aq_12}, {eco2_aq_13}")
        # adelta = get_delta_i(eco2_aq_12, eco2_aq_13, self.rvalue)
        # print(f"water eq delta {adelta}")
        ...
        # debug
        # ed = get_delta_i(abs(f12), abs(f13), self.gas.species.r)
        # print(f"exchange flux delta {ed}")
