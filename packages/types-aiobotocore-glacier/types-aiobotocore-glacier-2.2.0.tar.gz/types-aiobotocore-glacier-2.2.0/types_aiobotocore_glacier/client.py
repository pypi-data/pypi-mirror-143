...
class GlacierClient(AioBaseClient):
    ...
    async def abort_vault_lock(self, *, vaultName: str, accountId: str = "-") -> None:
        """
    ...
    async def delete_archive(self, *, vaultName: str, archiveId: str, accountId: str = "-") -> None:
        """
    ...
    async def delete_vault(self, *, vaultName: str, accountId: str = "-") -> None:
        """
    ...
    async def delete_vault_access_policy(self, *, vaultName: str, accountId: str = "-") -> None:
        """
    ...
    async def delete_vault_notifications(self, *, vaultName: str, accountId: str = "-") -> None:
        """
