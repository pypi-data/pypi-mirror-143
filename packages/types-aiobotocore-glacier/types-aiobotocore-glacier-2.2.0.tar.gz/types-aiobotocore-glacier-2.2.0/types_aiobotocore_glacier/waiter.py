...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/waiters.html)
...
class VaultExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/waiters.html#vaultexistswaiter)
    """
...
class VaultNotExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_glacier/waiters.html#vaultnotexistswaiter)
    """
