...
# Django OTP
# ------------------------------------------------------------------------------
# OTP_FORCE_CODE will reuse a fixed code if set; will not send outgoing Messages
OTP_FORCE_CODE = os.environ.get("OTP_FORCE_CODE", None)
OTP_PROVIDER = os.environ.get("OTP_PROVIDER", "twilio")
OTP_TWILIO_SERVICE = os.getenv("OTP_TWILIO_SERVICE", None)
OTP_RETURN_USAGE = os.getenv("OTP_RETURN_USAGE", False)
OTP_TIMEOUT = os.environ.get("OTP_TIMEOUT", 3 * 60)
OTP_AUTH_USAGE_ONLY = os.getenv("OTP_AUTH_USAGE_ONLY", False)
OTP_EMAIL_AS_PRIMARY_FIELD = os.getenv("OTP_EMAIL_AS_PRIMARY_FIELD", False)
OTP_PHONE_NUMBER_AS_PRIMARY_FIELD = os.getenv(
    "OTP_PHONE_NUMBER_AS_PRIMARY_FIELD", False
)
TWILIO_MESSAGING_SERVICE_ID = os.getenv("TWILIO_MESSAGING_SERVICE_ID", None)
TWILIO_SENDER_ID = os.getenv("TWILIO_SENDER_ID", None)
