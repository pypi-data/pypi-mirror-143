...
async def get_nh(id: int = choose().nhentai):
    ...
    ## remove all " or ' in neat_dir
    neat_dir = re.sub(r'[\'"]', '', neat_dir)
    ...
    for i in img:
        ...
        with open(neat_dir + '/' + img_name, 'wb') as f:
            ...
            if len(img) == len(os.listdir(neat_dir)):
                ...
                with open(neat_dir + '/tomoe.phtml', 'x') as f:
                    ...
                    print(f'Static gallery saved to {neat_dir}/tomoe.phtml')
                    print(f'Directory: {os.path.abspath(neat_dir)}')
                ...
                try:
                    ...
                    if to_pdf == 'y':
                        try:
                            source = open(f"{neat_dir}/tomoe.phtml")
                        ...
                        print("Okay")
                        os.remove(neat_dir + '/tomoe.phtml')
                        return
