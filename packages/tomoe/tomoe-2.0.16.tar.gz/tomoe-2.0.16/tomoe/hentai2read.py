...
print(choose().hentai2read)
async def get_h2r(id: str = choose().hentai2read[0], chapter: int = 1):
    initial = time.time()
    ## if chapter is not specified, assign it to 1
    if chapter == 1:
        chapter = choose().hentai2read[1]
    ...
    ## get value in the second last slash of set_name
