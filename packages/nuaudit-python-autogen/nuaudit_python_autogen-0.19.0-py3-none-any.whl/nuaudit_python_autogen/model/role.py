...
class Role(ModelNormal):
    ...
    attribute_map = {
        'name': 'name',  # noqa: E501
        'id': 'id',  # noqa: E501
        'is_system_role': 'is_system_role',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, id, is_system_role, permissions, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, id, is_system_role, permissions, *args, **kwargs):  # noqa: E501
        """Role - a model defined in OpenAPI
