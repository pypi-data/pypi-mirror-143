...
class UsersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_roles_for_user_endpoint = _Endpoint(
            settings={
                'response_type': ([Role],),
                'auth': [
                    'APIKeyHeader'
                ],
                'endpoint_path': '/{organization_id}/users/{user_id}/roles',
                'operation_id': 'list_roles_for_user',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_users_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{organization_id}/users',
    ...
    def list_roles_for_user(
        ...
        **kwargs
        ...
        >>> thread = api.list_roles_for_user(organization_id, user_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['user_id'] = \
            user_id
        return self.list_roles_for_user_endpoint.call_with_http_info(**kwargs)
