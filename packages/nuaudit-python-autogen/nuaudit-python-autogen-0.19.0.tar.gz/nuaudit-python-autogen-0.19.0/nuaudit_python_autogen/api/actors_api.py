...
class ActorsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_actor_endpoint = _Endpoint(
            settings={
                'response_type': (Actor,),
                'auth': [
                    'APIKeyHeader'
                ],
                'endpoint_path': '/{organization_id}/actors/{actor_id}',
        ...
        self.list_actors_endpoint = _Endpoint(
            settings={
                'response_type': ([Actor],),
                'auth': [
                    'APIKeyHeader'
                ],
                'endpoint_path': '/{organization_id}/actors',
                'operation_id': 'list_actors',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_actor(
        ...
        **kwargs
        ...
        >>> thread = api.get_actor(organization_id, actor_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['actor_id'] = \
            actor_id
        return self.get_actor_endpoint.call_with_http_info(**kwargs)
    ...
    def list_actors(
        ...
        **kwargs
        ...
        >>> thread = api.list_actors(organization_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['organization_id'] = \
            organization_id
        return self.list_actors_endpoint.call_with_http_info(**kwargs)
