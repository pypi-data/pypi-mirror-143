...
class ResourcesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_resource_endpoint = _Endpoint(
            settings={
                'response_type': (Resource,),
                'auth': [
                    'APIKeyHeader'
                ],
                'endpoint_path': '/{organization_id}/resources/{resource_id}',
        ...
        self.list_resources_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/{organization_id}/resources',
    ...
    def get_resource(
        ...
        **kwargs
        ...
        >>> thread = api.get_resource(organization_id, resource_id, async_req=True)
        >>> result = thread.get()
    ...
    def list_resources(
        ...
        **kwargs
        ...
        >>> thread = api.list_resources(organization_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['organization_id'] = \
            organization_id
        return self.list_resources_endpoint.call_with_http_info(**kwargs)
