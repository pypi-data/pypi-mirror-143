...
class Indexes(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'actor_type': ([str],),  # noqa: E501
            'actor_id': ([str],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource_type, resource_id, actor_type, actor_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource_type, resource_id, actor_type, actor_id, *args, **kwargs):  # noqa: E501
        """Indexes - a model defined in OpenAPI
