...
[boto3.Mobile 1.21.23](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mobile.html#Mobile)
...
Install `boto3-stubs-lite[mobile]` in your environment:
...
- Install `boto3-stubs[mobile]` with services you use in your environment:
...
[boto3 docs](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mobile/)
