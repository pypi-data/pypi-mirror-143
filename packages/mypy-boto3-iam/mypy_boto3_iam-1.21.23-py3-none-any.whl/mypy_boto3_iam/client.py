...
class IAMClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_iam/client.html#exceptions)
        """
    ...
    def tag_mfa_device(self, *, SerialNumber: str, Tags: Sequence["TagTypeDef"]) -> None:
        """
    ...
    def tag_policy(self, *, PolicyArn: str, Tags: Sequence["TagTypeDef"]) -> None:
        """
    ...
    def tag_role(self, *, RoleName: str, Tags: Sequence["TagTypeDef"]) -> None:
        """
    ...
    def tag_saml_provider(self, *, SAMLProviderArn: str, Tags: Sequence["TagTypeDef"]) -> None:
        """
    ...
    def tag_user(self, *, UserName: str, Tags: Sequence["TagTypeDef"]) -> None:
        """
    ...
    def untag_instance_profile(self, *, InstanceProfileName: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def untag_mfa_device(self, *, SerialNumber: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def untag_policy(self, *, PolicyArn: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def untag_role(self, *, RoleName: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def untag_saml_provider(self, *, SAMLProviderArn: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def untag_user(self, *, UserName: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def update_group(self, *, GroupName: str, NewPath: str = ..., NewGroupName: str = ...) -> None:
        """
    ...
    def update_user(self, *, UserName: str, NewPath: str = ..., NewUserName: str = ...) -> None:
        """
    ...
    def get_paginator(
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_iam/client.html#get_paginator)
        """
    ...
    def get_waiter(
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_iam/client.html#get_waiter)
        """
