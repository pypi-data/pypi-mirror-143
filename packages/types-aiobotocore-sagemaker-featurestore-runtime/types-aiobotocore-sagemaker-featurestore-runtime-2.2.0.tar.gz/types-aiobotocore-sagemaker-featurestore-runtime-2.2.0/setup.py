...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.SageMakerFeatureStoreRuntime 2.2.0 service generated with"
        " mypy-boto3-builder 7.4.0"
    ),
    classifiers=[
    ...
    keywords=(
        "aiobotocore sagemaker-featurestore-runtime type-annotations boto3-stubs mypy typeshed"
        " autocomplete"
    ),
