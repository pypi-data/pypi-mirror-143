...
def _init():
    ...
    _configs_dir = os.path.join(_current_dir, 'configs')
    ...
    if _config['use_log_file'] or _config['use_log_json']:
        ...
        if os.getenv('LOGS_DIR') and os.getenv('LOGS_DIR').strip():
            ...
            if ('logs_dir' in _config) and _config['logs_dir'].strip():
                ...
                logger.debug(f"Not found 'LOGS_DIR' environment variable, changed to '{_LOGS_DIR}' local directory.")
