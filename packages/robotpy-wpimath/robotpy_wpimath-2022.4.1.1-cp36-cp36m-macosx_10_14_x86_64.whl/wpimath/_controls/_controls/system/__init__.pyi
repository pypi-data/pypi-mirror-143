...
class LinearSystemId():
    @staticmethod
    def DCMotorSystem(motor: wpimath._controls._controls.plant.DCMotor, J: kilogram_square_meters, G: float) -> LinearSystem_2_1_2: 
        """
    ...
    @staticmethod
    @typing.overload
    def identifyDrivetrainSystem(kVlinear: volt_seconds_per_meter, kAlinear: volt_seconds_squared_per_meter, kVangular: volt_seconds_per_meter, kAangular: volt_seconds_squared_per_meter) -> LinearSystem_2_2_2: 
        """
    ...
    @staticmethod
    @typing.overload
    def identifyDrivetrainSystem(kVlinear: volt_seconds_per_meter, kAlinear: volt_seconds_squared_per_meter, kVangular: volt_seconds_per_radian, kAangular: volt_seconds_squared_per_radian, trackwidth: meters) -> LinearSystem_2_2_2: ...
    @staticmethod
    def identifyPositionSystemMeters(kV: volt_seconds_per_meter, kA: volt_seconds_squared_per_meter) -> LinearSystem_2_1_1: 
        """
        ...
        """
    @staticmethod
    def identifyPositionSystemRadians(kV: volt_seconds_per_radian, kA: volt_seconds_squared_per_radian) -> LinearSystem_2_1_1: ...
    @staticmethod
    def identifyVelocitySystemMeters(kV: volt_seconds_per_meter, kA: volt_seconds_squared_per_meter) -> LinearSystem_1_1_1: 
        """
        ...
        """
    @staticmethod
    def identifyVelocitySystemRadians(kV: volt_seconds_per_radian, kA: volt_seconds_squared_per_radian) -> LinearSystem_2_1_1: ...
    @staticmethod
