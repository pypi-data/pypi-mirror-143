...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.PersonalizeEvents 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore personalize-events type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
