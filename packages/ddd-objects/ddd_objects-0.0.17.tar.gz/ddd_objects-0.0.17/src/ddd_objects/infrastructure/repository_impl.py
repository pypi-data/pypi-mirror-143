...
class SqlalchemyRepositoryImpl(RepositoryImpl):
    ...
    @exception_class_dec()
    def find_all_helper(self, do_cls) -> List[BaseDO]:
        raise NULLError('null')
...
def return_single(log_func=None):
