...
class _youtube:
    ...
    def get_results(vid):
        ...
        video_ext = re.findall(r"watch\?v=.{11}", html.read().decode())
        latest = video_ext[0]
        first = video_ext[-1]
...
class vids:
    ...
    def get_videos_all(self):
        ...
        for i in self.videos:
            main_list.append(Downloader("https://www.youtube.com/"+i))
        return main_list
    def get_video_first(self):
        return Downloader("https://www.youtube.com/"+self.first)
    def get_video_latest(self):
        return Downloader("https://www.youtube.com/"+self.latest)
