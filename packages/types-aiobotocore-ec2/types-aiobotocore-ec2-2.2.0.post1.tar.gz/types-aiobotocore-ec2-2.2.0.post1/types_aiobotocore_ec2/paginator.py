...
class DescribeFastLaunchImagesPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ec2/paginators.html#describefastlaunchimagespaginator)
    """
...
class ListImagesInRecycleBinPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ec2/paginators.html#listimagesinrecyclebinpaginator)
    """
