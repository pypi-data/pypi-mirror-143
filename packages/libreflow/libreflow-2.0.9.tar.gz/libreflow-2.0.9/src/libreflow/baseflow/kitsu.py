...
class KitsuAPIWrapper(flow.Object):
    ...
    def get_shot_task(self, sequence_name, shot_name, task_type_name):
        task = None
        shot = self.get_shot_data(shot_name, sequence_name)
    ...
    def set_shot_task_status(self, sequence_name, shot_name, task_type_name, task_status_name, comment=''):
        task = self.get_shot_task(sequence_name, shot_name, task_type_name)
