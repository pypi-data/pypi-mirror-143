...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html)
...
class CodeStarClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#exceptions)
        """
    ...
    async def associate_team_member(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#associate_team_member)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#can_paginate)
        """
    ...
    async def create_project(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#create_project)
        """
    ...
    async def create_user_profile(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#create_user_profile)
        """
    ...
    async def delete_project(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#delete_project)
        """
    ...
    async def delete_user_profile(self, *, userArn: str) -> DeleteUserProfileResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#delete_user_profile)
        """
    ...
    async def describe_project(self, *, id: str) -> DescribeProjectResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#describe_project)
        """
    ...
    async def describe_user_profile(self, *, userArn: str) -> DescribeUserProfileResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#describe_user_profile)
        """
    ...
    async def disassociate_team_member(self, *, projectId: str, userArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#disassociate_team_member)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#generate_presigned_url)
        """
    ...
    async def list_projects(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#list_projects)
        """
    ...
    async def list_resources(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#list_resources)
        """
    ...
    async def list_tags_for_project(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#list_tags_for_project)
        """
    ...
    async def list_team_members(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#list_team_members)
        """
    ...
    async def list_user_profiles(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#list_user_profiles)
        """
    ...
    async def tag_project(self, *, id: str, tags: Mapping[str, str]) -> TagProjectResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#tag_project)
        """
    ...
    async def untag_project(self, *, id: str, tags: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#untag_project)
        """
    ...
    async def update_project(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#update_project)
        """
    ...
    async def update_team_member(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#update_team_member)
        """
    ...
    async def update_user_profile(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#update_user_profile)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_projects"]) -> ListProjectsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_codestar/client.html#get_paginator)
        """
