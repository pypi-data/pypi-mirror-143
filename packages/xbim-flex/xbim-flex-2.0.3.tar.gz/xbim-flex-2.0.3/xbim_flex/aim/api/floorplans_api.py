...
from xbim_flex.aim.model.unknownbasetype import UNKNOWNBASETYPE
...
class FloorplansApi(object):
    ...
    def floorplans_get_floor_plan(
        ...
        **kwargs
        ...
        """Gets floor plan as SVG image. Element of SVG have encoded identity allowing to implement custom interactions  where more data can be retrieved from Flex API  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Gets floor plan as SVG image. Element of SVG have encoded identity allowing to implement custom interactions  where more data can be retrieved from Flex API.<br/>Return Type: <b>string</b><br/><br/>  # noqa: E501
    ...
    def floorplans_get_space_floor_plan(
        ...
        **kwargs
        ...
        """Gets space floor plan as SVG image. Element of SVG have encoded identity allowing to implement custom interactions  where more data can be retrieved from Flex API  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Gets space floor plan as SVG image. Element of SVG have encoded identity allowing to implement custom interactions  where more data can be retrieved from Flex API.<br/>Return Type: <b>string</b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
