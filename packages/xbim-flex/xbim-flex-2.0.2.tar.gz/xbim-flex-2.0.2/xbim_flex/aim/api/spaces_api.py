...
class SpacesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.spaces_patch_by_tenantid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': "/{region}/aim/2.0/{tenantId}/Spaces(AssetModelId={AssetModelId}, EntityId={EntityId})",
                'operation_id': 'spaces_patch_by_tenantid',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def spaces_patch_by_tenantid(
        ...
        **kwargs
        ...
        >>> thread = api.spaces_patch_by_tenantid(asset_model_id, entity_id, tenant_id, patch, region="UK", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['patch'] = \
            patch
        return self.spaces_patch_by_tenantid_endpoint.call_with_http_info(**kwargs)
