...
setup(
    ...
    entry_points="""
    [console_scripts]
    databutton=databutton.cli:cli
    """,
    python_requires=">=0.0.1",
    license='Apache Software License 2.0',  # noqa
    author='Databutton',
    author_email='support@databutton.com',
    # Use the URL to the github repo.
    url='https://github.com/databutton/databutton-cli',
    download_url=(
        f'https://github.com/databutton/'
        f'databutton-cli/archive/{version}.tar.gz'
    ),
    keywords=[
