...
def get_provider_info():
    return {
        ...
        'versions': ['2.0.3', '2.0.2', '2.0.1', '2.0.0', '1.0.1', '1.0.0'],
        ...
        'operators': [
            {
                'integration-name': 'Segment',
                'python-modules': ['airflow.providers.segment.operators.segment_track_event'],
            }
        ],
        'hooks': [
            {'integration-name': 'Segment', 'python-modules': ['airflow.providers.segment.hooks.segment']}
        ],
        'hook-class-names': ['airflow.providers.segment.hooks.segment.SegmentHook'],
        'connection-types': [
            {
