...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/paginators.html)
...
class ListJobRunsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/paginators.html#listjobrunspaginator)
    """
...
class ListManagedEndpointsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/paginators.html#listmanagedendpointspaginator)
    """
...
class ListVirtualClustersPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/paginators.html#listvirtualclusterspaginator)
    """
