...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html)
...
class EMRContainersClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#can_paginate)
        """
    ...
    async def cancel_job_run(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#cancel_job_run)
        """
    ...
    async def create_managed_endpoint(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#create_managed_endpoint)
        """
    ...
    async def create_virtual_cluster(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#create_virtual_cluster)
        """
    ...
    async def delete_managed_endpoint(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#delete_managed_endpoint)
        """
    ...
    async def delete_virtual_cluster(self, *, id: str) -> DeleteVirtualClusterResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#delete_virtual_cluster)
        """
    ...
    async def describe_job_run(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#describe_job_run)
        """
    ...
    async def describe_managed_endpoint(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#describe_managed_endpoint)
        """
    ...
    async def describe_virtual_cluster(self, *, id: str) -> DescribeVirtualClusterResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#describe_virtual_cluster)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#generate_presigned_url)
        """
    ...
    async def list_job_runs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#list_job_runs)
        """
    ...
    async def list_managed_endpoints(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#list_managed_endpoints)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#list_tags_for_resource)
        """
    ...
    async def list_virtual_clusters(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#list_virtual_clusters)
        """
    ...
    async def start_job_run(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#start_job_run)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#untag_resource)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_job_runs"]) -> ListJobRunsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_emr_containers/client.html#get_paginator)
        """
