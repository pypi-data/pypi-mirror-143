...
['renku',
 ...
 'renku.core',
 'renku.core.commands',
 'renku.core.commands.checks',
 'renku.core.commands.format',
 'renku.core.commands.schema',
 'renku.core.commands.view_model',
 'renku.core.incubation',
 'renku.core.management',
 'renku.core.management.command_builder',
 'renku.core.management.dataset',
 'renku.core.management.dataset.providers',
 'renku.core.management.interface',
 'renku.core.management.migrations',
 'renku.core.management.migrations.models',
 'renku.core.management.migrations.utils',
 'renku.core.management.template',
 'renku.core.management.workflow',
 'renku.core.management.workflow.converters',
 'renku.core.management.workflow.providers',
 'renku.core.metadata',
 'renku.core.metadata.gateway',
 'renku.core.models',
 'renku.core.models.provenance',
 'renku.core.models.workflow',
 'renku.core.models.workflow.converters',
 'renku.core.plugins',
 'renku.core.plugins.implementations',
 'renku.core.utils',
 'renku.data',
 'renku.service',
 'renku.service.cache',
 ...
 'renku.service.controllers',
 'renku.service.controllers.api',
 'renku.service.controllers.utils',
 'renku.service.gateways',
 'renku.service.interfaces',
 'renku.service.jobs',
 'renku.service.serializers',
 'renku.service.serializers.v0_9',
 'renku.service.serializers.v1_0',
 'renku.service.utils',
 'renku.service.views',
 'renku.service.views.v0_9',
 'renku.service.views.v1_0']
...
{':python_full_version < "3.8.0"': ['importlib-metadata>=4.8.1,<4.12.0'],
 ':python_full_version < "3.9.0"': ['importlib-resources>=5.4.0,<5.5.0'],
 'all': ['apispec>=4.0.0,<5.2.0',
         ...
         'responses>=0.7.0,<0.19.0',
         'rq==1.10.1',
         'rq-scheduler==0.11.0',
         'sentry-sdk[flask]>=1.0.0,<1.5.6',
         'sphinxcontrib-spelling>=7.0.0,<8.0.0',
         'sphinx-rtd-theme>=0.5.0,<1.1',
         'sphinx-tabs==3.2.0',
         'toil==5.6.0',
         'walrus>=0.8.2,<0.10.0'],
 'docs': ['renku-sphinx-theme>=0.2.0',
          'sphinxcontrib-spelling>=7.0.0,<8.0.0',
          'sphinx-rtd-theme>=0.5.0,<1.1',
          'sphinx-tabs==3.2.0'],
