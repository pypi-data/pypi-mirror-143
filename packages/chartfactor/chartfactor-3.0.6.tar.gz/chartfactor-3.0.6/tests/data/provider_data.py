...
class ProviderData(object):
    ...
    TS_HISTOGRAM_DEFAULT_RESULT = {
        'data': [
            ...
            {'group': [[12604.0, 12604.0]], 'current': {'count': 1.0}}
        ],
        'visualization': 'Bars'
    }
