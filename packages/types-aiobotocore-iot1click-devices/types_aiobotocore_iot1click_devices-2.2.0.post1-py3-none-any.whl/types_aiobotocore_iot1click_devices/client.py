...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html)
...
class IoT1ClickDevicesServiceClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#can_paginate)
        """
    ...
    async def claim_devices_by_claim_code(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#claim_devices_by_claim_code)
        """
    ...
    async def describe_device(self, *, DeviceId: str) -> DescribeDeviceResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#describe_device)
        """
    ...
    async def finalize_device_claim(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#finalize_device_claim)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#generate_presigned_url)
        """
    ...
    async def get_device_methods(self, *, DeviceId: str) -> GetDeviceMethodsResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#get_device_methods)
        """
    ...
    async def initiate_device_claim(self, *, DeviceId: str) -> InitiateDeviceClaimResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#initiate_device_claim)
        """
    ...
    async def invoke_device_method(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#invoke_device_method)
        """
    ...
    async def list_device_events(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#list_device_events)
        """
    ...
    async def list_devices(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#list_devices)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#list_tags_for_resource)
        """
    ...
    async def tag_resource(self, *, ResourceArn: str, Tags: Mapping[str, str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#tag_resource)
        """
    ...
    async def unclaim_device(self, *, DeviceId: str) -> UnclaimDeviceResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#unclaim_device)
        """
    ...
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#untag_resource)
        """
    ...
    async def update_device_state(self, *, DeviceId: str, Enabled: bool = ...) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#update_device_state)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot1click_devices/client.html#get_paginator)
        """
