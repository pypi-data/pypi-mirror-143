...
setup(
    ...
    # https://packaging.python.org/specifications/core-metadata/#home-page-optional
     url='https://github.com/dhchenx/quick-topic',  # Optional
    ...
    # larger catalog.
    keywords="topic modeling, text analysis",  # Optional
    ...
    install_requires=[
        "jieba","quick-csv","gensim","numpy","pandas","matplotlib","correlation-kit","strsimpy","PyQt5","pyqtgraph","spacy","wordcloud","seaborn","sklearn","bokeh","pyLDAvis"
    ],  # Optional
