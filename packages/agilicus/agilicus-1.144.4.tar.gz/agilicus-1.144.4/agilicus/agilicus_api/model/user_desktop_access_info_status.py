"""
    ...
    The version of the OpenAPI document: 2022.03.22
...
class UserDesktopAccessInfoStatus(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_id, org_id, org_name, resource_id, resource_name, desktop_type, access_level, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_id, org_id, org_name, resource_id, resource_name, desktop_type, access_level, *args, **kwargs):  # noqa: E501
        """UserDesktopAccessInfoStatus - a model defined in OpenAPI
