...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_machinelearning/waiters.html)
...
class BatchPredictionAvailableWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_machinelearning/waiters.html#batchpredictionavailablewaiter)
    """
...
class DataSourceAvailableWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_machinelearning/waiters.html#datasourceavailablewaiter)
    """
...
class EvaluationAvailableWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_machinelearning/waiters.html#evaluationavailablewaiter)
    """
...
class MLModelAvailableWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_machinelearning/waiters.html#mlmodelavailablewaiter)
    """
