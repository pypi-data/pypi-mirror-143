...
from ..exceptions import HeaderDeprecationWarning
...
def deprecated(use_instead=None):
    ...
    def deco(func):
        ...
        def wrapped(*args, **kwargs):
            ...
            warnings.warn(message, category=HeaderDeprecationWarning, stacklevel=2)
...
class MutableChain:
    ...
    @deprecated("anti_header.utils.python.MutableChain.__next__")
    def next(self):
