...
class PatchTracking(object):
    ...
    def __init__(self, opens=None, clicks_html=None, clicks_text=None, additional_params=None, local_vars_configuration=None):  # noqa: E501
        """PatchTracking - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def opens(self):
        """Gets the opens of this PatchTracking.  # noqa: E501

        Enable the tracking of opens (only available for the HTML version)  # noqa: E501

        :return: The opens of this PatchTracking.  # noqa: E501
        :rtype: bool
        """
        return self._opens
    ...
    def opens(self, opens):
        """Sets the opens of this PatchTracking.

        Enable the tracking of opens (only available for the HTML version)  # noqa: E501

        :param opens: The opens of this PatchTracking.  # noqa: E501
        :type: bool
        """
    ...
    def clicks_html(self):
        """Gets the clicks_html of this PatchTracking.  # noqa: E501

        Enable the tracking of link clicks in the HTML version  # noqa: E501

        :return: The clicks_html of this PatchTracking.  # noqa: E501
        :rtype: bool
        """
    ...
    def clicks_html(self, clicks_html):
        """Sets the clicks_html of this PatchTracking.

        Enable the tracking of link clicks in the HTML version  # noqa: E501

        :param clicks_html: The clicks_html of this PatchTracking.  # noqa: E501
        :type: bool
        """
    ...
    def clicks_text(self):
        """Gets the clicks_text of this PatchTracking.  # noqa: E501

        Enable the tracking of link clicks in the text version  # noqa: E501

        :return: The clicks_text of this PatchTracking.  # noqa: E501
        :rtype: bool
        """
    ...
    def clicks_text(self, clicks_text):
        """Sets the clicks_text of this PatchTracking.

        Enable the tracking of link clicks in the text version  # noqa: E501

        :param clicks_text: The clicks_text of this PatchTracking.  # noqa: E501
        :type: bool
        """
    ...
    def additional_params(self):
        """Gets the additional_params of this PatchTracking.  # noqa: E501

        Append additional tracking parameters on all link (should be URL encoded)  # noqa: E501

        :return: The additional_params of this PatchTracking.  # noqa: E501
        :rtype: str
        """
    ...
    def additional_params(self, additional_params):
        """Sets the additional_params of this PatchTracking.

        Append additional tracking parameters on all link (should be URL encoded)  # noqa: E501

        :param additional_params: The additional_params of this PatchTracking.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchTracking):
            return False
