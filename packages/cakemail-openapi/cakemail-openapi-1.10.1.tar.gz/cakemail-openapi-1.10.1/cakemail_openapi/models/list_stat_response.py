...
class ListStatResponse(object):
    ...
    def __init__(self, active_contacts=None, pending_contacts=None, invalid_contacts=None, unsubscribed_contacts=None, flagged_contacts=None, deleted_contacts=None, sent_emails=None, open_rate=None, bounce_rate=None, click_rate=None, clickthru_rate=None, unsubscribe_rate=None, spam_rate=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.clickthru_rate = clickthru_rate
    ...
    @property
    def clickthru_rate(self):
        """Gets the clickthru_rate of this ListStatResponse.  # noqa: E501


        :return: The clickthru_rate of this ListStatResponse.  # noqa: E501
        :rtype: float
        """
        return self._clickthru_rate

    @clickthru_rate.setter
    def clickthru_rate(self, clickthru_rate):
        """Sets the clickthru_rate of this ListStatResponse.


        :param clickthru_rate: The clickthru_rate of this ListStatResponse.  # noqa: E501
        :type: float
        """
        if self.local_vars_configuration.client_side_validation and clickthru_rate is None:  # noqa: E501
            raise ValueError("Invalid value for `clickthru_rate`, must not be `None`")  # noqa: E501

        self._clickthru_rate = clickthru_rate
