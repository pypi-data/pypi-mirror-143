...
class AccountFullResponse(object):
    ...
    def __init__(self, id=None, lineage=None, status=None, name=None, address=None, account_owner=None, fax=None, phone=None, website=None, logo=None, usage_limits=None, last_activity_on=None, created_on=None, partner=None, overrides=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def overrides(self):
        """Gets the overrides of this AccountFullResponse.  # noqa: E501


        :return: The overrides of this AccountFullResponse.  # noqa: E501
        :rtype: AccountOverrides
        """
        return self._overrides

    @overrides.setter
    def overrides(self, overrides):
        """Sets the overrides of this AccountFullResponse.


        :param overrides: The overrides of this AccountFullResponse.  # noqa: E501
        :type: AccountOverrides
        """
        if self.local_vars_configuration.client_side_validation and overrides is None:  # noqa: E501
