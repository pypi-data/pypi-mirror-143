...
class PatchUser(object):
    ...
    def __init__(self, first_name=None, last_name=None, title=None, office_phone=None, mobile_phone=None, language=None, timezone=None, password=None, local_vars_configuration=None):  # noqa: E501
