...
class EmailLogResponse(object):
    ...
    def __init__(self, id=None, sent_id=None, group_id=None, email=None, type=None, timestamp=None, user_agent=None, clickthru_url=None, dsn_message=None, sender_name=None, sender_email=None, source_ip=None, envelope_from=None, additional_headers=None, local_vars_configuration=None):  # noqa: E501
    ...
    def sent_id(self, sent_id):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and sent_id is None:  # noqa: E501
            raise ValueError("Invalid value for `sent_id`, must not be `None`")  # noqa: E501
