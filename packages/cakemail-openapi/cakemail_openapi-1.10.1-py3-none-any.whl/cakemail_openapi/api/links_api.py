...
class LinksApi(object):
    ...
    def get_link(self, link_id, **kwargs):  # noqa: E501
        """Show a link information  # noqa: E501
    ...
    def get_link_with_http_info(self, link_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(LinkInfoResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('link_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `link_id` when calling `get_link`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='LinkInfoResponse',  # noqa: E501
