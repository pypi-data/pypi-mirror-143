...
class SubAccountApi(object):
    ...
    def create_account_with_http_info(self, create_account, **kwargs):  # noqa: E501
        ...
        if 'skip_verification' in local_var_params and local_var_params['skip_verification'] is not None:  # noqa: E501
            query_params.append(('skip_verification', local_var_params['skip_verification']))  # noqa: E501
