...
class DatasetUsageHistory:
    ...
    def from_dict(obj: Any) -> 'DatasetUsageHistory':
        ...
        return DatasetUsageHistory(id, entity_id, field_query_counts, history_date, history_type, dataset_usage_history_id, query_count)
...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, dataset_created_at, deleted_at, documentation, entity_type, field_statistics, dataset_id, last_modified_at, logical_id, properties, query_history, schema, soda_data_quality, source_info, statistics, support_info, upstream, usage, usage_history)
...
class KnowledgeCardDetail:
    ...
    def from_dict(obj: Any) -> 'KnowledgeCardDetail':
        ...
        return KnowledgeCardDetail(asset_description, business_critical, business_term, column_description, deprecation, incident, type, usage)
...
class PowerBIDataset:
    ...
    def from_dict(obj: Any) -> 'PowerBIDataset':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        return PowerBIDataset(id, aspect_type, created_at, entity_id, power_bi_dataset_id, latest, name, source_datasets, tables, url)
...
class VirtualView:
    ...
    def from_dict(obj: Any) -> 'VirtualView':
        ...
        return VirtualView(created_at, id, virtual_view_created_at, dbt_model, deleted_at, entity_type, virtual_view_id, last_modified_at, logical_id, looker_explore, looker_view, power_bi_dataset)
