...
print(crayons.blue(f'\n Mathyslolbots by Cousin & Mathyslol. USE CODE XBX #ad'))
...
def is_admin():
        async def predicate(ctx):
            return ctx.author.display_name in info['FullAccess'] or ctx.author.display_name in adminsss
...
#///////////////////////////////////////////////////////////////////////////////////////////////////////////// PARTY/FRIENDS/ADMIN //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    async def credits(self, ctx: fortnitepy.ext.commands.Context) -> None:
