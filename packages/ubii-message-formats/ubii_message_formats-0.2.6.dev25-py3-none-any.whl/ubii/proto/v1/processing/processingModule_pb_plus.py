...
class ProcessingMode(Message):
    ...
    class Frequency(Message):
        """Processing Callback is executed at a fixed time interval, with target
            frequency
    ...
    class Lockstep(Message):
        """Processing Callback is executed when the master node sends a lockstep
            processing request
    ...
    class TriggerOnInput(Message):
        """Processing Callback is executed when all or any of the input data
            changes
