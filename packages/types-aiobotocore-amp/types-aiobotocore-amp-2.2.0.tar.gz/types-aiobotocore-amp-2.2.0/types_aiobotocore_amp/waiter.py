...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_amp/waiters.html)
...
class WorkspaceActiveWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_amp/waiters.html#workspaceactivewaiter)
    """
...
class WorkspaceDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_amp/waiters.html#workspacedeletedwaiter)
    """
