...
extras_require = \
{'interactive': ['ipython>=7.29.0,<8.0.0'],
 'legacy': ['httpx>=0.18.2,<0.19.0'],
 'postgresql': ['psycopg2>=2.9.2,<3.0.0', 'asyncpg>=0.25.0,<0.26.0'],
 'tasks': ['ansible>=5.2.0,<6.0.0',
           'ansible-core>=2.12.1,<3.0.0',
