'''
ENG
    pysaur.math module, beta 0.3.

    What's new in beta 0.3: implementation of polynomials of variable x with coefficients - rational (integer) fractions, stable version
...
UKR
    Модуль pysaur.math бета-версії 0.3.

    Що нового в версії 0.3: реалізація поліномів змінної х з коефіцієнтами - раціональними (цілочисельними) дробами, стабільна версія
