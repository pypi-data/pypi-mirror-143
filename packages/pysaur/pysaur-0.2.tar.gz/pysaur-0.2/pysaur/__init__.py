'''
ENG
    pysaur.math module, beta 0.1.

    What's new in beta 0.1: implementation of polynomials of variable x with coefficients - rational (integer) fractions
...
UKR
    Модуль pysaur.math бета-версії 0.1.

    Що нового в версії 0.1: реалізація поліномів змінної х з коефіцієнтами - раціональними (цілочисельними) дробами
    ...
    Функції:
        polynom(expression):  Перетворення виразу expression у поліноми
