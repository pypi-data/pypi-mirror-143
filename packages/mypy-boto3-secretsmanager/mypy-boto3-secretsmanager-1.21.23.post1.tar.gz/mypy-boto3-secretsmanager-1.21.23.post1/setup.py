...
setup(
    ...
    description=(
        "Type annotations for boto3.SecretsManager 1.21.23 service generated with"
    ...
    keywords="boto3 secretsmanager type-annotations boto3-stubs mypy typeshed autocomplete",
