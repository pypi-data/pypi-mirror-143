...
release_notes = {
    '1.65.1': """
    When shutting down, kill all processes by default instead of opt-in. - tarehart
    Improvement to Epic launch. - VirxEC
    Fix Linux launch. - VirxEC
    Make RLBot's python virtual enviroment system more efficient. - VirxEC
    """,
    '1.64.0': """
    Warning in performance readout when processes are fighting over a bot index. - tarehart
    """,
    '1.63.2': """
    Killing processes more effectively at the end of matches. - tarehart
    Preventing bot startup commands from leaking into the next match. - tarehart
    Processing agent metadata regularly during training exercises. - tarehart
    """,
    '1.62.6': """
    ...
    Fix continue and spawn bug. - VirxEC
    Fixing NoneType error in Epic launcher. - SavageSnowgoose
    """,
    '1.61.1': """
