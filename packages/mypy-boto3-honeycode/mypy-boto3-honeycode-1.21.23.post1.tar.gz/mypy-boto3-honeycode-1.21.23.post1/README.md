...
[boto3.Honeycode 1.21.23](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/honeycode.html#Honeycode)
...
- Install `boto3-stubs[honeycode]` in your environment:
...
Install `boto3-stubs-lite[honeycode]` in your environment:
...
- Install `boto3-stubs[honeycode]` with services you use in your environment:
...
[boto3 docs](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_honeycode/)
