...
class SuitePrice():
  def __init__(self, case_name, node_id, env = ENV.LOCAL_TEST.value):
  ...
  def get_obj(self):
    ...
    self.obj = cls(self.case_name, self.node_id, self.env)
    return self.obj


if __name__ == '__main__':
  cls_name = 'USEP_SHORT'
  cls = get_forecast_subclass(cls_name)
  obj = cls('usep-short', '', 'localtest')
  print(cls)