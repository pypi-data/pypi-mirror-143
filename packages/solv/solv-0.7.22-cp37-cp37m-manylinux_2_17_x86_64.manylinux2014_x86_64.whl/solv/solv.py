...
class Ruleinfo(object):
    ...
    def __init__(self, r, type, source, target, dep_id):
        _solv.Ruleinfo_swiginit(self, _solv.new_Ruleinfo(r, type, source, target, dep_id))
...
class Solver(object):
    ...
    def alternative(self, aid):
        return _solv.Solver_alternative(self, aid)

    def all_alternatives(self):
        return _solv.Solver_all_alternatives(self)
...
class Solutionelement(object):
    ...
    id = property(_solv.Solutionelement_id_get)
    type = property(_solv.Solutionelement_type_get)

    def __init__(self, solv, problemid, solutionid, id, type, p, rp):
        _solv.Solutionelement_swiginit(self, _solv.new_Solutionelement(solv, problemid, solutionid, id, type, p, rp))
...
class Alternative(object):
    ...
    rid = property(_solv.Alternative_rid_get)
    from_id = property(_solv.Alternative_from_id_get)
    dep_id = property(_solv.Alternative_dep_id_get)
    chosen_id = property(_solv.Alternative_chosen_id_get)
    level = property(_solv.Alternative_level_get, _solv.Alternative_level_set)
