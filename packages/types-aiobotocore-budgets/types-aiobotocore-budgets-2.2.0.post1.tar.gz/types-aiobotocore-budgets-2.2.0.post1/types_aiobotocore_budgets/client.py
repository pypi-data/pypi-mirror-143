...
class BudgetsClient(AioBaseClient):
    ...
    async def describe_budget_notifications_for_account(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_budgets/client.html#describe_budget_notifications_for_account)
        """
