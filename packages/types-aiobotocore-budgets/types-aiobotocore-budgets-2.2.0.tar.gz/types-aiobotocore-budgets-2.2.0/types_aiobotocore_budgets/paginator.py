...
class DescribeBudgetNotificationsForAccountPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_budgets/paginators.html#describebudgetnotificationsforaccountpaginator)
    """
