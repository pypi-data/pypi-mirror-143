...
class SageMakerFeatureStoreRuntimeClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_sagemaker_featurestore_runtime/client.html#exceptions)
        """
    ...
    def put_record(self, *, FeatureGroupName: str, Record: Sequence["FeatureValueTypeDef"]) -> None:
        """
