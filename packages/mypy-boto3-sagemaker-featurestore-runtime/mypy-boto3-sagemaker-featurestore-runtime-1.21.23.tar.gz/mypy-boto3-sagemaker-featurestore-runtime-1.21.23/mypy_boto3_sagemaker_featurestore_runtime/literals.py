...
Usage::
    ...
    data: SageMakerFeatureStoreRuntimeServiceName = "sagemaker-featurestore-runtime"
    ```
"""
import sys
...
__all__ = ("SageMakerFeatureStoreRuntimeServiceName", "ServiceName", "ResourceServiceName")
