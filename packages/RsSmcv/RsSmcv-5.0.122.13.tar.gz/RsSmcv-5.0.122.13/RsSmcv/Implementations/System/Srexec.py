...
class Srexec:
	...
	def __init__(self, core: Core, parent):
		self._core = core
		self._cmd_group = CommandsGroup("srexec", core, parent)

	def set(self) -> None:
		"""SCPI: SYSTem:SREXec \n
		Snippet: driver.system.srexec.set() \n
		No command help available \n
		"""
		self._core.io.write(f'SYSTem:SREXec')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SYSTem:SREXec \n
		Snippet: driver.system.srexec.set_with_opc() \n
		No command help available \n
		...
		self._core.io.write_with_opc(f'SYSTem:SREXec', opc_timeout_ms)
