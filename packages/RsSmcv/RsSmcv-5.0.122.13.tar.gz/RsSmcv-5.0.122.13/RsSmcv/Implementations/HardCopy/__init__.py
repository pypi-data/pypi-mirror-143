...
class HardCopy:
	...
	def image(self):
		...
		if not hasattr(self, '_image'):
			...
			self._image = Image(self._core, self._cmd_group)
		return self._image
	...
	def get_region(self) -> enums.HardCopyRegion:
		"""SCPI: HCOPy:REGion \n
	...
	def set_region(self, region: enums.HardCopyRegion) -> None:
		"""SCPI: HCOPy:REGion \n
	...
	def clone(self) -> 'HardCopy':
		...
		new_group = HardCopy(self._core, self._cmd_group.parent)
