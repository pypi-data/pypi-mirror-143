...
class Execute:
	...
	def set(self) -> None:
		...
		Snippet: driver.source.bb.dab.trigger.execute.set() \n
		No command help available \n
		"""
		self._core.io.write(f'SOURce<HwInstance>:BB:DAB:TRIGger:EXECute')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: [SOURce<HW>]:BB:DAB:TRIGger:EXECute \n
		Snippet: driver.source.bb.dab.trigger.execute.set_with_opc() \n
		No command help available \n
		...
		self._core.io.write_with_opc(f'SOURce<HwInstance>:BB:DAB:TRIGger:EXECute', opc_timeout_ms)
