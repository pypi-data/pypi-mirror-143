...
class Apply:
	...
	def set(self) -> None:
		...
		Snippet: driver.source.bb.radio.fm.rds.tmc.apply.set() \n
		No command help available \n
		"""
		self._core.io.write(f'SOURce<HwInstance>:BB:RADio:FM:RDS:TMC:APPLy')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: [SOURce<HW>]:BB:RADio:FM:RDS:TMC:APPLy \n
		Snippet: driver.source.bb.radio.fm.rds.tmc.apply.set_with_opc() \n
		No command help available \n
		...
		self._core.io.write_with_opc(f'SOURce<HwInstance>:BB:RADio:FM:RDS:TMC:APPLy', opc_timeout_ms)
