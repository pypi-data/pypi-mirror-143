...
class Execute:
	...
	def set(self) -> None:
		...
		Snippet: driver.source.bb.arbitrary.trigger.arm.execute.set() \n
		Stops (arms) waveform output. \n
		"""
		self._core.io.write(f'SOURce<HwInstance>:BB:ARBitrary:TRIGger:ARM:EXECute')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: [SOURce<HW>]:BB:ARBitrary:TRIGger:ARM:EXECute \n
		Snippet: driver.source.bb.arbitrary.trigger.arm.execute.set_with_opc() \n
		Stops (arms) waveform output. \n
		...
		self._core.io.write_with_opc(f'SOURce<HwInstance>:BB:ARBitrary:TRIGger:ARM:EXECute', opc_timeout_ms)
