...
class Identification:
	...
	def get_value(self) -> enums.AutoUser:
		...
		RsSmcv.System.language. Note: While working in an emulation mode, the R&S SMCV100B specific command set is disabled, that
		is, the SCPI command method RsSmcv.System.Identification.value is discarded. \n
