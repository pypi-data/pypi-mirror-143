...
class System:
	"""System commands group definition. 177 total commands, 31 Subgroups, 30 group commands"""
	...
	def get_iresponse(self) -> str:
		...
		specific command set is disabled, i.e. the SCPI command method RsSmcv.System.iresponse is discarded. \n
	...
	def get_oresponse(self) -> str:
		...
		command set is disabled, i.e. the SCPI command method RsSmcv.System.oresponse is discarded. \n
	...
	def recall(self, path_name: str) -> None:
		...
		Loads a file with previously saved R&S SMCV100B settings. Loads the selected file with previously saved R&S SMCV100B
	...
	def save(self, path_name: str) -> None:
		...
		Saves the current R&S SMCV100B settings into a file with defined filename and into a specified directory.
