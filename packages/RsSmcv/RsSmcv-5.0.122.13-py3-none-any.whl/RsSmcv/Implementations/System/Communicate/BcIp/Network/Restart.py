...
class Restart:
	...
	def set(self) -> None:
		...
		Snippet: driver.system.communicate.bcIp.network.restart.set() \n
		Triggers a restart of the network. \n
		"""
		self._core.io.write(f'SYSTem:COMMunicate:BCIP:NETWork:RESTart')

	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		"""SCPI: SYSTem:COMMunicate:BCIP:NETWork:RESTart \n
		Snippet: driver.system.communicate.bcIp.network.restart.set_with_opc() \n
		Triggers a restart of the network. \n
		...
		self._core.io.write_with_opc(f'SYSTem:COMMunicate:BCIP:NETWork:RESTart', opc_timeout_ms)
