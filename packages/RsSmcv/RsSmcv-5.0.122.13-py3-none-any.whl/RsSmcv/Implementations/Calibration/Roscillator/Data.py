...
class Data:
	...
	def get_value(self) -> int:
		...
		Sets a user-defined calibration value for the internal reference frequency. \n
			:return: data: integer 0 = the factory value is used (i.e. user-defined calibration is disabled) Value 0: positive calibration values are used Value 0: negative calibration values are used Range: depends on other values
		"""
	...
	def set_value(self, data: int) -> None:
		...
		Sets a user-defined calibration value for the internal reference frequency. \n
			:param data: integer 0 = the factory value is used (i.e. user-defined calibration is disabled) Value 0: positive calibration values are used Value 0: negative calibration values are used Range: depends on other values
		"""
