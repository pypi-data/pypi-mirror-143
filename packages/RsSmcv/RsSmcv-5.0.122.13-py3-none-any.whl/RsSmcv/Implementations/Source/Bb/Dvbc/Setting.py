...
class Setting:
	...
	def get_catalog(self) -> List[str]:
		...
		Snippet: value: List[str] = driver.source.bb.dvbc.setting.get_catalog() \n
		Queries the files with settings in the default directory. Listed are files with the file extension *.dvbc.
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:DVBC:SETTing:CATalog?')
		return Conversions.str_to_str_list(response)

	def delete(self, delete: str) -> None:
		"""SCPI: [SOURce<HW>]:BB:DVBC:SETTing:DELete \n
		Snippet: driver.source.bb.dvbc.setting.delete(delete = '1') \n
		Deletes the selected file from the default or the specified directory. Deleted are files with extension *.dvbc. Refer to
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:DVBC:SETTing:DELete {param}')

	def get_load(self) -> str:
		"""SCPI: [SOURce<HW>]:BB:DVBC:SETTing:LOAD \n
		Snippet: value: str = driver.source.bb.dvbc.setting.get_load() \n
		Loads the selected file from the default or the specified directory. Loaded are files with extension *.dvbc. Refer to
		'Accessing Files in the Default or Specified Directory' for general information on file handling in the default and in a
		specific directory. \n
			:return: recall: 'filename' Filename or complete file path; file extension can be omitted.
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:DVBC:SETTing:LOAD?')
		return trim_str_response(response)

	def set_load(self, recall: str) -> None:
		"""SCPI: [SOURce<HW>]:BB:DVBC:SETTing:LOAD \n
		Snippet: driver.source.bb.dvbc.setting.set_load(recall = '1') \n
		Loads the selected file from the default or the specified directory. Loaded are files with extension *.dvbc. Refer to
		'Accessing Files in the Default or Specified Directory' for general information on file handling in the default and in a
		specific directory. \n
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:DVBC:SETTing:LOAD {param}')

	def get_store(self) -> str:
		"""SCPI: [SOURce<HW>]:BB:DVBC:SETTing:STORe \n
		Snippet: value: str = driver.source.bb.dvbc.setting.get_store() \n
		Saves the current settings into the selected file; the file extension (*.dvbc) is assigned automatically.
		Refer to 'Accessing Files in the Default or Specified Directory' for general information on file handling in the default
		and in a specific directory. \n
			:return: save: 'filename' Filename or complete file path
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:DVBC:SETTing:STORe?')
		return trim_str_response(response)

	def set_store(self, save: str) -> None:
		"""SCPI: [SOURce<HW>]:BB:DVBC:SETTing:STORe \n
		Snippet: driver.source.bb.dvbc.setting.set_store(save = '1') \n
		Saves the current settings into the selected file; the file extension (*.dvbc) is assigned automatically.
		Refer to 'Accessing Files in the Default or Specified Directory' for general information on file handling in the default
		and in a specific directory. \n
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:DVBC:SETTing:STORe {param}')
