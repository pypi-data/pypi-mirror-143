...
class Trigger:
	...
	@property
	def external(self):
		"""external commands group. 2 Sub-classes, 1 commands."""
	...
	def get_source(self) -> enums.TriggerSourceB:
		...
		Snippet: value: enums.TriggerSourceB = driver.source.bb.mccw.trigger.get_source() \n
		No command help available \n
	...
	def set_source(self, source: enums.TriggerSourceB) -> None:
		"""SCPI: [SOURce<HW>]:BB:MCCW:TRIGger:SOURce \n
		Snippet: driver.source.bb.mccw.trigger.set_source(source = enums.TriggerSourceB.BEXTernal) \n
		No command help available \n
