...
class Level:
	...
	def get(self, iqConnector=repcap.IqConnector.Default, channelNull=repcap.ChannelNull.Default) -> float:
		...
		Sets the RMS level of the channel of the HS digital I/Q output signal. The level is relative to full scale of 0.5 V (in
		terms of dB full scale) . \n
			...
			:return: bbout_hs_level: float Range: -60 to 0"""
