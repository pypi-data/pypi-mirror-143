...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.GlobalAccelerator 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore globalaccelerator type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
