...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html)
...
class MarketplaceCatalogClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html#can_paginate)
        """
    ...
    async def cancel_change_set(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html#cancel_change_set)
        """
    ...
    async def describe_change_set(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html#describe_change_set)
        """

    async def describe_entity(
        self, *, Catalog: str, EntityId: str
    ) -> DescribeEntityResponseTypeDef:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html#describe_entity)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html#generate_presigned_url)
        """
    ...
    async def list_change_sets(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html#list_change_sets)
        """
    ...
    async def list_entities(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html#list_entities)
        """
    ...
    async def start_change_set(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_marketplace_catalog/client.html#start_change_set)
        """
