...
setup(
    ...
    description="Type annotations for boto3 1.21.26 generated with mypy-boto3-builder 7.4.1",
    classifiers=[
    ...
    extras_require={
        "all": [
            ...
            "mypy-boto3-billingconductor>=1.21.0",
        ...
        "gamesparks": ["mypy-boto3-gamesparks>=1.21.0"],
