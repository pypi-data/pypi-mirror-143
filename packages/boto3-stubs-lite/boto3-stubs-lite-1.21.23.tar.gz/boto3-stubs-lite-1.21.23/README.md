...
[boto3 1.21.23](https://boto3.amazonaws.com/v1/documentation/api/1.21.23/index.html)
...
Generated by
[mypy-boto3-builder 7.3.0](https://github.com/vemel/mypy_boto3_builder).
...
- `boto3-stubs-lite[all]` - Type annotations for all 301 services.
