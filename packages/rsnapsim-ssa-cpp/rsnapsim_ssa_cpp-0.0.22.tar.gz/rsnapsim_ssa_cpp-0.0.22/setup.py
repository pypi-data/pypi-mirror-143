...
sources = ['ssa_translation_c_w_full.cpp','ssa_translation_lowmem.pyx','ssa_translation_c_w_lowmem.cpp', 'ssa_trna_lowmem_c_w.cpp', 'ssa_trna_c_w.cpp', 'ssa_translation_c_w_replicon.cpp' ]
