...
#=====================================================================    
def make_stock_sample(dfprice,dfindex,n_nextdays=10, \
...
if __name__=='__main__':
    ...
    X,y,ndfeature=make_stock_sample(dfprice,dfindex,120,480,120,'AR')
    #m,n=ndfeature.shape
    X1,y1,ndfeature1=make_stock_sample(dfprice,dfindex,5,240,20,'JG')
    ...
    dfprice=get_price(ticker,'4/12/2019','1/1/2015')
    len(dfprice)
    X,y,ndfeature=make_stock_sample(dfprice,dfindex,30,120,30,'AR')
    
    ticker='BILI'
    dfprice=get_price(ticker,'4/12/2019','1/1/2015')
    len(dfprice)
    X,y,ndfeature=make_stock_sample(dfprice,dfindex,20,120,40,'AR')
#=====================================================================
def bestLRL1(X,y):
    """
...
if __name__=='__main__':
    ...
    X,y,ndfeature=make_stock_sample(dfprice,dfindex,5,240,20,'AR')
...
def bestMODEL(dfprice,dfindex,n_nextdays=5, \
    ...
    #构造样本：AR, JG
    X,y,ndfeature=make_stock_sample(dfprice,dfindex,n_nextdays, \
                              n_samples,n_features,'AR',n_shares)    
    X1,y1,ndfeature1=make_stock_sample(dfprice,dfindex,n_nextdays, \
...
if __name__=='__main__':
    ...
    X,y,ndfeature=make_stock_sample(dfprice,dfindex,n_days, \
