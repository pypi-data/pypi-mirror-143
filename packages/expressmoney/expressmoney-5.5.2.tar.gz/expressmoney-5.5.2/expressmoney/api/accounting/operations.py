...
accounting_operations_loan_issue = ID(SERVICE, 'operations', 'loan_issue')
accounting_operations_loan_payment_body = ID(SERVICE, 'operations', 'loan_payment_body')
accounting_operations_loan_interests_charge = ID(SERVICE, 'operations', 'loan_interests_charge')
accounting_operations_loan_payment_interests = ID(SERVICE, 'operations', 'loan_payment_interests')
