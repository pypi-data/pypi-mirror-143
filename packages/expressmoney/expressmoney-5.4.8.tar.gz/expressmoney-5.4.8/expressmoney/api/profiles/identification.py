...
viewsets = 'russian_identification_process'
profiles_identification_russian_identification_process = ID(SERVICE, 'identification', viewsets)


class RussianIdentificationProcessPoint(ListPointMixin, ContractPoint):
    _point_id = profiles_identification_russian_identification_process
