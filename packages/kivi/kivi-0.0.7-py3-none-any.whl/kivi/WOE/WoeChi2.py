...
class Chi2Merge(WOE):
    ...
    描述：
    """
    def __init__(self, variables, target, init_bins=20, min_bins=3, max_bins=5, m=2, fill_pos=False, confidence_level=0.9):
        """
        ...
        super(Chi2Merge, self).__init__(variables, target, bins=self.max_bins, fill_pos=fill_pos)
