...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/waiters.html)
...
class ChangeSetCreateCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/waiters.html#changesetcreatecompletewaiter)
    """
...
class StackCreateCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/waiters.html#stackcreatecompletewaiter)
    """
...
class StackDeleteCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/waiters.html#stackdeletecompletewaiter)
    """
...
class StackExistsWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/waiters.html#stackexistswaiter)
    """
...
class StackImportCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/waiters.html#stackimportcompletewaiter)
    """
...
class StackRollbackCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/waiters.html#stackrollbackcompletewaiter)
    """
...
class StackUpdateCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/waiters.html#stackupdatecompletewaiter)
    """
...
class TypeRegistrationCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/waiters.html#typeregistrationcompletewaiter)
    """

    async def wait(
        self, *, RegistrationToken: str, WaiterConfig: WaiterConfigTypeDef = ...
    ) -> None:
        """
