...
class CloudFormationClient(AioBaseClient):
    ...
    async def describe_change_set_hooks(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_cloudformation/client.html#describe_change_set_hooks)
        """
