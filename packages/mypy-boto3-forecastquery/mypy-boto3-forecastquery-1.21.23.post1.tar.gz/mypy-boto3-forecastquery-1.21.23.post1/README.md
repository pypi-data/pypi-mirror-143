...
[boto3.ForecastQueryService 1.21.23](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/forecastquery.html#ForecastQueryService)
...
```python
from mypy_boto3_forecastquery.literals import (
...
[boto3 docs](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_forecastquery/)
