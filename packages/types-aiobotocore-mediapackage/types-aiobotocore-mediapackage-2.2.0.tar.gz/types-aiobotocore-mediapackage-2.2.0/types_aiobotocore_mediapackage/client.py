...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html)
...
class MediaPackageClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#can_paginate)
        """
    ...
    async def configure_logs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#configure_logs)
        """
    ...
    async def create_channel(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#create_channel)
        """
    ...
    async def create_harvest_job(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#create_harvest_job)
        """
    ...
    async def create_origin_endpoint(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#create_origin_endpoint)
        """
    ...
    async def delete_channel(self, *, Id: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#delete_channel)
        """
    ...
    async def delete_origin_endpoint(self, *, Id: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#delete_origin_endpoint)
        """
    ...
    async def describe_channel(self, *, Id: str) -> DescribeChannelResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#describe_channel)
        """
    ...
    async def describe_harvest_job(self, *, Id: str) -> DescribeHarvestJobResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#describe_harvest_job)
        """
    ...
    async def describe_origin_endpoint(self, *, Id: str) -> DescribeOriginEndpointResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#describe_origin_endpoint)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#generate_presigned_url)
        """
    ...
    async def list_channels(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#list_channels)
        """
    ...
    async def list_harvest_jobs(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#list_harvest_jobs)
        """
    ...
    async def list_origin_endpoints(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#list_origin_endpoints)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#list_tags_for_resource)
        """
    ...
    async def rotate_channel_credentials(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#rotate_channel_credentials)
        """
    ...
    async def rotate_ingest_endpoint_credentials(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#rotate_ingest_endpoint_credentials)
        """
    ...
    async def tag_resource(self, *, ResourceArn: str, Tags: Mapping[str, str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceArn: str, TagKeys: Sequence[str]) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#untag_resource)
        """
    ...
    async def update_channel(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#update_channel)
        """
    ...
    async def update_origin_endpoint(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#update_origin_endpoint)
        """
    ...
    def get_paginator(self, operation_name: Literal["list_channels"]) -> ListChannelsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackage/client.html#get_paginator)
        """
