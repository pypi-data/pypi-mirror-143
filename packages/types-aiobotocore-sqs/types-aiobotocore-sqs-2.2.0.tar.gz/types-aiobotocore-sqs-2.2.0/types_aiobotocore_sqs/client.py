...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html)
...
class SQSClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#exceptions)
        """
    ...
    async def add_permission(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#add_permission)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#can_paginate)
        """
    ...
    async def change_message_visibility(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#change_message_visibility)
        """
    ...
    async def change_message_visibility_batch(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#change_message_visibility_batch)
        """
    ...
    async def create_queue(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#create_queue)
        """
    ...
    async def delete_message(self, *, QueueUrl: str, ReceiptHandle: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#delete_message)
        """
    ...
    async def delete_message_batch(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#delete_message_batch)
        """
    ...
    async def delete_queue(self, *, QueueUrl: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#delete_queue)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#generate_presigned_url)
        """
    ...
    async def get_queue_attributes(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#get_queue_attributes)
        """
    ...
    async def get_queue_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#get_queue_url)
        """
    ...
    async def list_dead_letter_source_queues(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#list_dead_letter_source_queues)
        """
    ...
    async def list_queue_tags(self, *, QueueUrl: str) -> ListQueueTagsResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#list_queue_tags)
        """
    ...
    async def list_queues(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#list_queues)
        """
    ...
    async def purge_queue(self, *, QueueUrl: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#purge_queue)
        """
    ...
    async def receive_message(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#receive_message)
        """
    ...
    async def remove_permission(self, *, QueueUrl: str, Label: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#remove_permission)
        """
    ...
    async def send_message(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#send_message)
        """
    ...
    async def send_message_batch(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#send_message_batch)
        """
    ...
    async def set_queue_attributes(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#set_queue_attributes)
        """

    async def tag_queue(self, *, QueueUrl: str, Tags: Mapping[str, str]) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#tag_queue)
        """

    async def untag_queue(self, *, QueueUrl: str, TagKeys: Sequence[str]) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#untag_queue)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_sqs/client.html#get_paginator)
        """
