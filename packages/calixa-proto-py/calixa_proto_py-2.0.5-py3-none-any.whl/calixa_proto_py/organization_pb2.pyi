...
EnrichmentProviderStatusValue = typing___NewType('EnrichmentProviderStatusValue', builtin___int)
type___EnrichmentProviderStatusValue = EnrichmentProviderStatusValue
EnrichmentProviderStatus: _EnrichmentProviderStatus
class _EnrichmentProviderStatus(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[EnrichmentProviderStatusValue]):
    DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
    ENRICHMENT_PROVIDER_STATUS_UNSPECIFIED = typing___cast(EnrichmentProviderStatusValue, 0)
    ENRICHMENT_PROVIDER_STATUS_ENABLED = typing___cast(EnrichmentProviderStatusValue, 1)
    ENRICHMENT_PROVIDER_STATUS_DISABLED = typing___cast(EnrichmentProviderStatusValue, 2)
ENRICHMENT_PROVIDER_STATUS_UNSPECIFIED = typing___cast(EnrichmentProviderStatusValue, 0)
ENRICHMENT_PROVIDER_STATUS_ENABLED = typing___cast(EnrichmentProviderStatusValue, 1)
ENRICHMENT_PROVIDER_STATUS_DISABLED = typing___cast(EnrichmentProviderStatusValue, 2)
type___EnrichmentProviderStatus = EnrichmentProviderStatus
...
class Settings(google___protobuf___message___Message):
    ...
    @property
    def enrichment_provider(self) -> type___EnrichmentProvider: ...
    ...
    def __init__(self,
        *,
        ...
        enrichment_provider : typing___Optional[type___EnrichmentProvider] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"enrichment_provider",b"enrichment_provider",u"new_user_experience_calixa_api_selected_at",b"new_user_experience_calixa_api_selected_at",u"new_user_experience_completed_at",b"new_user_experience_completed_at",u"new_user_experience_data_warehouse_selected_at",b"new_user_experience_data_warehouse_selected_at"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"enrichment_provider",b"enrichment_provider",u"journeys",b"journeys",u"new_user_experience_calixa_api_selected_at",b"new_user_experience_calixa_api_selected_at",u"new_user_experience_completed_at",b"new_user_experience_completed_at",u"new_user_experience_data_warehouse_selected_at",b"new_user_experience_data_warehouse_selected_at",u"ownership_source",b"ownership_source",u"preferred_account_sources",b"preferred_account_sources",u"property_definitions",b"property_definitions",u"scoring_functions",b"scoring_functions"]) -> None: ...
type___Settings = Settings

class EnrichmentProvider(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    status: type___EnrichmentProviderStatusValue = ...

    @property
    def clearbit_key(self) -> type___ClearbitKey: ...

    def __init__(self,
        *,
        status : typing___Optional[type___EnrichmentProviderStatusValue] = None,
        clearbit_key : typing___Optional[type___ClearbitKey] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"clearbit_key",b"clearbit_key",u"keys",b"keys"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"clearbit_key",b"clearbit_key",u"keys",b"keys",u"status",b"status"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"keys",b"keys"]) -> typing_extensions___Literal["clearbit_key"]: ...
type___EnrichmentProvider = EnrichmentProvider

class ClearbitKey(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
...
type___ClearbitKey = ClearbitKey
...
class TrendSearch(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"columns",b"columns",u"created_by_organization_user_id",b"created_by_organization_user_id",u"entity_type",b"entity_type",u"filters",b"filters",u"is_public",b"is_public",u"name",b"name",u"rank_metrics",b"rank_metrics",u"sort_field",b"sort_field",u"sort_order",b"sort_order"]) -> None: ...
