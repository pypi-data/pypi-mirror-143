...
class Journey(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"entity_type",b"entity_type",u"id",b"id",u"milestones",b"milestones",u"name",b"name"]) -> None: ...
...
class ScoringFunction(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"entity_type",b"entity_type",u"id",b"id",u"levels",b"levels",u"name",b"name"]) -> None: ...
...
class ScoringFunctionCondition(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"operator",b"operator",u"scoring_function_id",b"scoring_function_id",u"values",b"values"]) -> None: ...
