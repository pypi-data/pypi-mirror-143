...
from channelengine_channel_api_client import rest
from channelengine_channel_api_client.configuration import Configuration
from channelengine_channel_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from channelengine_channel_api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.cancellation_index  # this is an instance of the class Endpoint
        api_instance.cancellation_index()  # this invokes api_instance.cancellation_index.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancellation_index.callable or self.callable in this class
