...
def lazy_import():
    ...
    globals()['ChannelProductExtraDataItemResponse'] = ChannelProductExtraDataItemResponse
    globals()['VatRateType'] = VatRateType


class ChannelProductResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'id': (int,),  # noqa: E501
            'parent_channel_product_no': (str, none_type,),  # noqa: E501
            'grandparent_channel_product_no': (str, none_type,),  # noqa: E501
            'mapped_fields': ({str: (str,)}, none_type,),  # noqa: E501
            'extra_data': ([ChannelProductExtraDataItemResponse], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'id': 'Id',  # noqa: E501
        'parent_channel_product_no': 'ParentChannelProductNo',  # noqa: E501
        'grandparent_channel_product_no': 'GrandparentChannelProductNo',  # noqa: E501
        'mapped_fields': 'MappedFields',  # noqa: E501
    ...
    def __init__(self, merchant_product_no, *args, **kwargs):  # noqa: E501
        """ChannelProductResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            id (int): An unique identifier which ChannelEngine uses to identify the product.  Needed in the call 'POST /v2/products/data'.. [optional]  # noqa: E501
            parent_channel_product_no (str, none_type): The unique product reference used by the Channel for the parent product.. [optional]  # noqa: E501
            grandparent_channel_product_no (str, none_type): The unique product reference used by the Channel for the grandparent product.. [optional]  # noqa: E501
            mapped_fields ({str: (str,)}, none_type): A channel can require certain fields to be available. The channel  can provide ChannelEngine with this fields after which the merchants  will be able to fill in this field using custom conditions in ChannelEngine.. [optional]  # noqa: E501
            extra_data ([ChannelProductExtraDataItemResponse], none_type): An optional list of key-value pairs containing  extra data about this product. This data can be  sent to channels or used for filtering products.. [optional]  # noqa: E501
