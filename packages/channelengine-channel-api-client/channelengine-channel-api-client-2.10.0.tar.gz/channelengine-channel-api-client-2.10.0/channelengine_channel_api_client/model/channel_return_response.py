...
def lazy_import():
    ...
    globals()['ChannelReturnLineResponse'] = ChannelReturnLineResponse
    globals()['ReturnReason'] = ReturnReason


class ChannelReturnResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'channel_return_no': (str,),  # noqa: E501
            'channel_order_no': (str,),  # noqa: E501
            'lines': ([ChannelReturnLineResponse],),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, channel_return_no, channel_order_no, lines, *args, **kwargs):  # noqa: E501
        """ChannelReturnResponse - a model defined in OpenAPI

        Args:
            channel_return_no (str): The unique return reference used by the Channel.
            channel_order_no (str): The unique order reference used by the Channel.
            lines ([ChannelReturnLineResponse]):
