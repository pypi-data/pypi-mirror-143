...
class CancellationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __cancellation_index(
            self,
            **kwargs
        ):
            """Get Cancellations.  # noqa: E501

            Gets all cancellations created since the supplied date.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.cancellation_index(async_req=True)
            >>> result = thread.get()


            Keyword Args:
                created_since (datetime): The date from which you will get all created cancellations. [optional]
        ...
        self.cancellation_index = _Endpoint(
            settings={
                'response_type': (CollectionOfChannelCancellationResponse,),
                'auth': [
                    'apiKey'
                ],
                'endpoint_path': '/v2/cancellations',
                'operation_id': 'cancellation_index',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
