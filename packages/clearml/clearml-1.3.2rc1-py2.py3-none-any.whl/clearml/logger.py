...
class Logger(object):
    ...
    **PLOTS**, and **DEBUG SAMPLES** sub-tabs. When you compare experiments, ``Logger`` output appears in the
    ...
    @classmethod
    def set_reporting_nan_value(cls, value):
        MetricsEventAdapter.default_nan_value = value
        MetricsEventAdapter.should_report_nan_warning = False

    @classmethod
    def set_reporting_inf_value(cls, value):
        MetricsEventAdapter.default_inf_value = value
        MetricsEventAdapter.should_report_inf_warning = False
