...
setuptools.setup(
    ...
    install_requires=['attrs==19.2.0', 'boto3', 'dill==0.3.0', 'googleapis-common-protos==1.52.0', 'grpcio', 'jinja2', 'numpy~=1.16', 'pathspec', 'pendulum==2.1.2', 'protobuf==3.13.0', 'pyarrow~=6.0.0', 'pytimeparse', 'pandas~=1.0', 'texttable', 'requests', 'colorama==0.4.3', 'tqdm==4.41.1', 'yaspin==0.16.0', 'typing-extensions~=3.7', 'pygments>=2.7.4', 'pytest', 'click~=8.0', 'typeguard', 'sqlparse'],
