...
from mediciasafely import check, codelists, jupyter, pull, upgrade
from mediciasafely._vendor.jobrunner.cli import local_run
...
def main():
    ...
    parser.add_argument(
        "--version", action="version", version=f"mediciasafely {__version__}"
    )
    ...
    # following recent documentation but has an old mediciasafely installed,
