...
DESCRIPTION = "Run a jupyter lab notebook using the MediciaSAFELY environment"
...
def main(directory, name, port, no_browser, unknown_args):
    ...
    print(f"Running following jupyter cmd in MediciaSAFELY docker container {name}...")
