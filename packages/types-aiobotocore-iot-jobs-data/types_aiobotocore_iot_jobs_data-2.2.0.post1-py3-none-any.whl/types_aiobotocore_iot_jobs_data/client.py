...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot_jobs_data/client.html)
...
class IoTJobsDataPlaneClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot_jobs_data/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot_jobs_data/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot_jobs_data/client.html#can_paginate)
        """
    ...
    async def describe_job_execution(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot_jobs_data/client.html#describe_job_execution)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot_jobs_data/client.html#generate_presigned_url)
        """
    ...
    async def get_pending_job_executions(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot_jobs_data/client.html#get_pending_job_executions)
        """
    ...
    async def start_next_pending_job_execution(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot_jobs_data/client.html#start_next_pending_job_execution)
        """
    ...
    async def update_job_execution(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_iot_jobs_data/client.html#update_job_execution)
        """
