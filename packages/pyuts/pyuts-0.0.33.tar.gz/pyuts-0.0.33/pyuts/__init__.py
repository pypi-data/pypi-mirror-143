...
try:
    from pyuts.py_recg.imgU import ImgU

    def imgU(key=None) -> ImgU:
        '''
        
        图片相关工具
        
        '''
        return ImgU.produce(key)
except ImportError as e:
    pass
...
try:
    from pyuts.py_phone.phoneAutoU import PhoneAutoU

    def phoneAutoU(key=None) -> PhoneAutoU:
        '''
        
        手机自动化相关工具
        
        '''
        return PhoneAutoU.produce(key)
except ImportError as e:
    pass
