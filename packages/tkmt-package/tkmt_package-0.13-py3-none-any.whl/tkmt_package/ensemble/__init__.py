class Averaging:
    def __init__(self):
        """
        Average_weight_Ensemble:
        
        This package contains ensemble learning techniques which include Averaging,
        Rank Weighted and Weighted Averaging along with important data preprocessing techniques including
        data preparation, data normalisation, train test split, performance evaluation and its graphical representation.
        """
        import pandas as pd
        import numpy as np
...
class weighted_Averaging:
    def __init__(self):
          ...
          Multiple predictions are made for each data point and the average of predictions from all the models
...
class Rank_weighted:
    def __init__(self):
          ...
          and then predictions are made for each data point and the average of predictions from all the models are used to make the
          final prediction.
          """
          pass
...
class votingClassifer:
      def __init__(self,estimator):
          """
          Voting Classifier multiple models are used to make predictions for each data point. 
          ...
          Initializer 
          Initialises the base estimators for voting.

          Parameters
          —-------------
          Estimator: base models for voting operation
          ...
          Example
          ----------      
            >>>   from Ensemble_Learning import votingClassifer
            >>> vc = votingClassifer()            
