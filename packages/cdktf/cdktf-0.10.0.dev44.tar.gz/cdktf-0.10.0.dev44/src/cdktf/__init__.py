...
class GcsBackendProps:
    def __init__(
        ...
        *,
        ...
        :param impersonate_service_account_delegates: 
        :param prefix: 
...
@jsii.implements(IInterpolatingParent)
...
class ComplexObject(metaclass=jsii.JSIIMeta, jsii_type="cdktf.ComplexObject"):
    ...
    def _complex_object_index(self) -> jsii.Number:
        '''(experimental) the index of the complex object in a list.

        :stability: experimental
        '''
        return typing.cast(jsii.Number, jsii.get(self, "complexObjectIndex"))

    @_complex_object_index.setter
    def _complex_object_index(self, value: jsii.Number) -> None:
