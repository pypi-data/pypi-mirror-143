...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html)
...
class XRayClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#exceptions)
        """
    ...
    async def batch_get_traces(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#batch_get_traces)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#can_paginate)
        """
    ...
    async def create_group(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#create_group)
        """
    ...
    async def create_sampling_rule(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#create_sampling_rule)
        """
    ...
    async def delete_group(self, *, GroupName: str = ..., GroupARN: str = ...) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#delete_group)
        """
    ...
    async def delete_sampling_rule(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#delete_sampling_rule)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#generate_presigned_url)
        """
    ...
    async def get_encryption_config(self) -> GetEncryptionConfigResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_encryption_config)
        """
    ...
    async def get_group(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_group)
        """
    ...
    async def get_groups(self, *, NextToken: str = ...) -> GetGroupsResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_groups)
        """
    ...
    async def get_insight(self, *, InsightId: str) -> GetInsightResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_insight)
        """
    ...
    async def get_insight_events(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_insight_events)
        """
    ...
    async def get_insight_impact_graph(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_insight_impact_graph)
        """
    ...
    async def get_insight_summaries(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_insight_summaries)
        """
    ...
    async def get_sampling_rules(self, *, NextToken: str = ...) -> GetSamplingRulesResultTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_sampling_rules)
        """
    ...
    async def get_sampling_statistic_summaries(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_sampling_statistic_summaries)
        """
    ...
    async def get_sampling_targets(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_sampling_targets)
        """
    ...
    async def get_service_graph(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_service_graph)
        """
    ...
    async def get_time_series_service_statistics(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_time_series_service_statistics)
        """
    ...
    async def get_trace_graph(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_trace_graph)
        """
    ...
    async def get_trace_summaries(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_trace_summaries)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#list_tags_for_resource)
        """
    ...
    async def put_encryption_config(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#put_encryption_config)
        """
    ...
    async def put_telemetry_records(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#put_telemetry_records)
        """
    ...
    async def put_trace_segments(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#put_trace_segments)
        """
    ...
    async def tag_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, ResourceARN: str, TagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#untag_resource)
        """
    ...
    async def update_group(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#update_group)
        """
    ...
    async def update_sampling_rule(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#update_sampling_rule)
        """
    ...
    def get_paginator(self, operation_name: Literal["batch_get_traces"]) -> BatchGetTracesPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_xray/client.html#get_paginator)
        """
