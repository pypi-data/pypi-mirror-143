...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ecr/waiters.html)
...
class ImageScanCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ecr/waiters.html#imagescancompletewaiter)
    """
...
class LifecyclePolicyPreviewCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_ecr/waiters.html#lifecyclepolicypreviewcompletewaiter)
    """
