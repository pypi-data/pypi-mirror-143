...
from client.add_contact_dialog import AddContact
...
class ClientMainWindow(QMainWindow):
    ...
    def history_list_update(self):
        '''
        Заполнение соответствующий QListView
    ...
    def select_active_user(self):
        '''Обработкасобытия двойного клика по списку контактов.'''
    ...
    def add_contact_window(self):
        '''Создание окна - диалога добавления контакта'''
    ...
    def add_contact_action(self, item):
        '''Обрабортка нажатия кнопки "Добавить"'''
    ...
    def add_contact(self, new_contact):
        '''
        Добавление контакта в серверную и клиентскую Базы Данных.
    ...
    def delete_contact_window(self):
        '''Создание окна удаления контакта.'''
    ...
    def delete_contact(self, item):
        '''
        Удаление контакта из серверной и клиентской БД.
        После обновления баз данных обновляет и содержимое окна.
        '''
    ...
    def send_message(self):
        '''Отправка сообщения текущему собеседнику.
