...
class ConfigWindow(QDialog):
    ...
    def save_server_config(self):
        '''
        Сохранение настроек. Проверяет корректность введенных данных
        сохраняет проверенные данные в ini файл
        '''
        ...
        try:
            ...
            if 1023 < port < 65536:
                ...
                with open(f'{dir_path}/{"server.ini"}', 'w') as conf:
                    ...
                    message.information(self, 'OK', 'Настройки сохранены успешно')
            else:
