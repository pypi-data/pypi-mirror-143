...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.CustomerProfiles 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore customer-profiles type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
