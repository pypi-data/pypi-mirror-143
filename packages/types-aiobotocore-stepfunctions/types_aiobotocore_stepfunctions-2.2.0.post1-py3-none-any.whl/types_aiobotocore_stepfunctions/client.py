...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html)
...
class SFNClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#can_paginate)
        """
    ...
    async def create_activity(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#create_activity)
        """
    ...
    async def create_state_machine(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#create_state_machine)
        """
    ...
    async def delete_activity(self, *, activityArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#delete_activity)
        """
    ...
    async def delete_state_machine(self, *, stateMachineArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#delete_state_machine)
        """
    ...
    async def describe_activity(self, *, activityArn: str) -> DescribeActivityOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#describe_activity)
        """
    ...
    async def describe_execution(self, *, executionArn: str) -> DescribeExecutionOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#describe_execution)
        """
    ...
    async def describe_state_machine(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#describe_state_machine)
        """
    ...
    async def describe_state_machine_for_execution(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#describe_state_machine_for_execution)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#generate_presigned_url)
        """
    ...
    async def get_activity_task(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#get_activity_task)
        """
    ...
    async def get_execution_history(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#get_execution_history)
        """
    ...
    async def list_activities(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#list_activities)
        """
    ...
    async def list_executions(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#list_executions)
        """
    ...
    async def list_state_machines(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#list_state_machines)
        """
    ...
    async def list_tags_for_resource(self, *, resourceArn: str) -> ListTagsForResourceOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#list_tags_for_resource)
        """
    ...
    async def send_task_failure(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#send_task_failure)
        """
    ...
    async def send_task_heartbeat(self, *, taskToken: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#send_task_heartbeat)
        """
    ...
    async def send_task_success(self, *, taskToken: str, output: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#send_task_success)
        """
    ...
    async def start_execution(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#start_execution)
        """
    ...
    async def start_sync_execution(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#start_sync_execution)
        """
    ...
    async def stop_execution(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#stop_execution)
        """
    ...
    async def tag_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#untag_resource)
        """
    ...
    async def update_state_machine(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#update_state_machine)
        """
    ...
    def get_paginator(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_stepfunctions/client.html#get_paginator)
        """
