    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.remoteUrl = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.STRING:
                    self.trackingBranch = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class ReportFilter(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i152 in range(_size148):
                        ...
                        self.cleanupPlanNames.append(_elem153)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.checkerMsg is not None:
            ...
            for iter155 in self.checkerMsg:
        ...
        if self.checkerName is not None:
            ...
            for iter156 in self.checkerName:
        ...
        if self.reportHash is not None:
            ...
            for iter157 in self.reportHash:
        ...
        if self.reviewStatus is not None:
            ...
            for iter159 in self.reviewStatus:
        ...
        if self.detectionStatus is not None:
            ...
            for iter160 in self.detectionStatus:
        ...
        if self.runHistoryTag is not None:
            ...
            for iter161 in self.runHistoryTag:
        ...
        if self.componentNames is not None:
            ...
            for iter164 in self.componentNames:
        ...
        if self.analyzerNames is not None:
            ...
            for iter165 in self.analyzerNames:
        ...
        if self.cleanupPlanNames is not None:
            ...
            for iter166 in self.cleanupPlanNames:
...
class ExportData(object):
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i206 in range(_size202):
                        ...
                        for _i213 in range(_size209):
                            _elem214 = CommentData()
                            _elem214.read(iprot)
                            _val208.append(_elem214)
                        iprot.readListEnd()
                        self.comments[_key207] = _val208
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i219 in range(_size215):
                        ...
                        _val221 = ReviewData()
                        _val221.read(iprot)
                        self.reviewData[_key220] = _val221
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.comments is not None:
            ...
            for kiter222, viter223 in self.comments.items():
                oprot.writeString(kiter222.encode('utf-8') if sys.version_info[0] == 2 else kiter222)
                oprot.writeListBegin(TType.STRUCT, len(viter223))
                for iter224 in viter223:
                    iter224.write(oprot)
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.reviewData is not None:
            ...
            for kiter225, viter226 in self.reviewData.items():
...
class AnalysisInfo(object):
    ...
    def __init__(self, analyzerCommand=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.analyzerCommand = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.commitHash = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.committedDateTime = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class BlameInfo(object):
    ...
    def write(self, oprot):
        ...
        if self.commits is not None:
            ...
            for kiter240, viter241 in self.commits.items():
...
class CleanupPlan(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i247 in range(_size243):
                        _elem248 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.reportHashes.append(_elem248)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter249 in self.reportHashes:
