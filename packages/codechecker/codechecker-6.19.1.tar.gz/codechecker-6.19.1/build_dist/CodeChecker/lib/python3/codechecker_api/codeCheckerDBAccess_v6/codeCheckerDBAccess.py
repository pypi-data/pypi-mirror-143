...
class getRunHistoryCount_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter298 in self.runIds:
                oprot.writeI64(iter298)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.runHistoryFilter is not None:
...
class getDiffResultsHash_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i309 in range(_size305):
                        ...
                        self.reportHashes.append(_elem310)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i315 in range(_size311):
                        ...
                        self.skipDetectionStatuses.append(_elem316)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            ...
            for iter324 in self.reportHashes:
        ...
        if self.skipDetectionStatuses is not None:
            ...
            for iter325 in self.skipDetectionStatuses:
...
class getLinesInSourceFileContents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i410 in range(_size406):
                        _elem411 = LinesInFilesRequested()
                        _elem411.read(iprot)
                        self.linesInFilesRequested.append(_elem411)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.linesInFilesRequested is not None:
            ...
            for iter412 in self.linesInFilesRequested:
                iter412.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.encoding is not None:
...
class getLinesInSourceFileContents_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter427, viter428 in self.success.items():
                oprot.writeI64(kiter427)
                oprot.writeMapBegin(TType.I64, TType.STRING, len(viter428))
                for kiter429, viter430 in viter428.items():
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter457 in self.success:
                oprot.writeListBegin(TType.STRING, len(iter457))
                for iter458 in iter457:
...
class getSeverityCounts_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter487, viter488 in self.success.items():
                oprot.writeI32(kiter487)
                oprot.writeI64(viter488)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getCheckerMsgCounts_args(object):
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter495 in self.runIds:
                oprot.writeI64(iter495)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i500 in range(_size496):
                        _key501 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
class getReviewStatusCounts_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i509 in range(_size505):
                        _elem510 = iprot.readI64()
                        self.runIds.append(_elem510)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.runIds is not None:
            oprot.writeFieldBegin('runIds', TType.LIST, 1)
            oprot.writeListBegin(TType.I64, len(self.runIds))
            for iter511 in self.runIds:
                oprot.writeI64(iter511)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.reportFilter is not None:
            oprot.writeFieldBegin('reportFilter', TType.STRUCT, 2)
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i525 in range(_size521):
                        _elem526 = iprot.readI64()
                        self.runIds.append(_elem526)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i532 in range(_size528):
                        ...
                        _val534 = iprot.readI64()
                        self.success[_key533] = _val534
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getFileCounts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i548 in range(_size544):
                        _key549 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val550 = iprot.readI64()
                        self.success[_key549] = _val550
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.I64, len(self.success))
            for kiter551, viter552 in self.success.items():
                oprot.writeString(kiter551.encode('utf-8') if sys.version_info[0] == 2 else kiter551)
                oprot.writeI64(viter552)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getAnalyzerNameCounts_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i592 in range(_size588):
                        _key593 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val594 = iprot.readI64()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.I64, len(self.success))
            for kiter595, viter596 in self.success.items():
                oprot.writeString(kiter595.encode('utf-8') if sys.version_info[0] == 2 else kiter595)
                oprot.writeI64(viter596)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getSourceComponents_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i601 in range(_size597):
                        ...
                        self.sourceComponentFilter.append(_elem602)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.sourceComponentFilter is not None:
            ...
            for iter603 in self.sourceComponentFilter:
...
class getMissingContentHashes_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i615 in range(_size611):
                        _elem616 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.fileHashes.append(_elem616)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            ...
            for iter617 in self.fileHashes:
                oprot.writeString(iter617.encode('utf-8') if sys.version_info[0] == 2 else iter617)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i622 in range(_size618):
                        _elem623 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter624 in self.success:
                oprot.writeString(iter624.encode('utf-8') if sys.version_info[0] == 2 else iter624)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class getMissingContentHashesForBlameInfo_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i629 in range(_size625):
                        _elem630 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.fileHashes.append(_elem630)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.fileHashes is not None:
            oprot.writeFieldBegin('fileHashes', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.fileHashes))
            for iter631 in self.fileHashes:
                oprot.writeString(iter631.encode('utf-8') if sys.version_info[0] == 2 else iter631)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i636 in range(_size632):
                        _elem637 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter638 in self.success:
                oprot.writeString(iter638.encode('utf-8') if sys.version_info[0] == 2 else iter638)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.requestError is not None:
            oprot.writeFieldBegin('requestError', TType.STRUCT, 1)
...
class massStoreRun_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i643 in range(_size639):
                        _elem644 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.trimPathPrefixes.append(_elem644)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.trimPathPrefixes is not None:
            ...
            for iter645 in self.trimPathPrefixes:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i659 in range(_size655):
                        _key660 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val661 = AnalyzerStatistics()
                        _val661.read(iprot)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter662, viter663 in self.success.items():
                oprot.writeString(kiter662.encode('utf-8') if sys.version_info[0] == 2 else kiter662)
...
class setCleanupPlan_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i675 in range(_size671):
                        _elem676 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.reportHashes.append(_elem676)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            oprot.writeFieldBegin('reportHashes', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter677 in self.reportHashes:
...
class unsetCleanupPlan_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i682 in range(_size678):
                        ...
                        self.reportHashes.append(_elem683)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.reportHashes is not None:
            oprot.writeFieldBegin('reportHashes', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.reportHashes))
            for iter684 in self.reportHashes:
