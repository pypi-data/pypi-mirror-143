...
class NumberTypePropInfo(TypePropInfo):
    ...
    def __eq__(self, __o: NumberTypePropInfo):
        cb = CombinePropInfo('==', self, __o)
        return BoolTypePropInfo(cb)

    def __ne__(self, __o: NumberTypePropInfo):
        cb = CombinePropInfo('!=', self, __o)
        return BoolTypePropInfo(cb)

    def __lt__(self, __o: NumberTypePropInfo):
        cb = CombinePropInfo('<', self, __o)
        return BoolTypePropInfo(cb)

    def __le__(self, __o: NumberTypePropInfo):
        cb = CombinePropInfo('<=', self, __o)
        return BoolTypePropInfo(cb)

    def __gt__(self, __o: NumberTypePropInfo):
        cb = CombinePropInfo('>', self, __o)
        return BoolTypePropInfo(cb)

    def __ge__(self, __o: NumberTypePropInfo):
        cb = CombinePropInfo('>=', self, __o)
        return BoolTypePropInfo(cb)
    ...
    def __combine(self, logic: str,
        ...
        cb = CombinePropInfo(logic, self, val)
