...
当选项过多时，使用下拉菜单展示并选择内容
    ...
    def values(self):
        ...
        p = self.get_prop('values')
        return SubscriptableTypePropInfo[int,NumberTypePropInfo](p)

        


    @values.setter
    def values(self, value: Union[SubscriptableTypePropInfo[int,NumberTypePropInfo],List[int]]):
        '''
        可选值：— \n
        选中项绑定值
        '''
        self.set_prop('values', value)
