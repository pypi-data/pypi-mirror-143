...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html)
...
class AppIntegrationsServiceClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#can_paginate)
        """
    ...
    async def create_data_integration(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#create_data_integration)
        """
    ...
    async def create_event_integration(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#create_event_integration)
        """
    ...
    async def delete_data_integration(self, *, DataIntegrationIdentifier: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#delete_data_integration)
        """
    ...
    async def delete_event_integration(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#delete_event_integration)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#generate_presigned_url)
        """
    ...
    async def get_data_integration(self, *, Identifier: str) -> GetDataIntegrationResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#get_data_integration)
        """
    ...
    async def get_event_integration(self, *, Name: str) -> GetEventIntegrationResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#get_event_integration)
        """
    ...
    async def list_data_integration_associations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#list_data_integration_associations)
        """
    ...
    async def list_data_integrations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#list_data_integrations)
        """
    ...
    async def list_event_integration_associations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#list_event_integration_associations)
        """
    ...
    async def list_event_integrations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#list_event_integrations)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#list_tags_for_resource)
        """
    ...
    async def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#tag_resource)
        """
    ...
    async def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#untag_resource)
        """
    ...
    async def update_data_integration(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#update_data_integration)
        """
    ...
    async def update_event_integration(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_appintegrations/client.html#update_event_integration)
        """
