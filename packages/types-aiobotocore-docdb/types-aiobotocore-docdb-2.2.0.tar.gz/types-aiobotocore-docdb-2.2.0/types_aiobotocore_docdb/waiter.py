...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_docdb/waiters.html)
...
class DBInstanceAvailableWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_docdb/waiters.html#dbinstanceavailablewaiter)
    """
...
class DBInstanceDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_docdb/waiters.html#dbinstancedeletedwaiter)
    """
