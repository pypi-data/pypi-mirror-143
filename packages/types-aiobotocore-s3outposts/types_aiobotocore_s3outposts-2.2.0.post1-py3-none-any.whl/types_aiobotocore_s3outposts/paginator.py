...
class ListSharedEndpointsPaginator(AioPaginator):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_s3outposts/paginators.html#listsharedendpointspaginator)
    """
