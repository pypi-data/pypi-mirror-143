...
class dCorrProvCfgSelectOne:
    ...
    async def exec(self, irec: tCorrProvCfgKey = None) -> "dCorrProvCfgSelectOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("CorrProvCfgSelectOne", self._dbcon.STMNT_TYPE_READ)
