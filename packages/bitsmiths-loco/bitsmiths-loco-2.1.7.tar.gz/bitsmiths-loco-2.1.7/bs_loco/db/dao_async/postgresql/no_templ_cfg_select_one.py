...
class dNoTemplCfgSelectOne:
    ...
    async def exec(self, irec: tNoTemplCfgKey = None) -> "dNoTemplCfgSelectOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("NoTemplCfgSelectOne", self._dbcon.STMNT_TYPE_READ)
