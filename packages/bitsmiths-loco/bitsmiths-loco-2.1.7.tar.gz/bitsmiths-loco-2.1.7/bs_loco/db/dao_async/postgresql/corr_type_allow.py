...
class dCorrTypeAllow:
    ...
    async def lock_one_with(self, _rec: tCorrTypeAllow, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tCorrTypeAllowKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_with(self, _rec: tCorrTypeAllow) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tCorrTypeAllowKey) -> bool:
        """
    ...
    async def select_one(self) -> "dCorrTypeAllow":
        """
    ...
    async def select_one_with(self, _rec: tCorrTypeAllow) -> "dCorrTypeAllow":
        """
    ...
    async def select_one_by_key(self, _key: tCorrTypeAllowKey) -> "dCorrTypeAllow":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tCorrTypeAllow = None):
        """
    ...
    async def insert(self, irec: tCorrTypeAllow = None):
        """
    ...
    async def delete_one(self, irec: tCorrTypeAllowKey = None):
        """
