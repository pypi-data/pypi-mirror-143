...
class dNoTemplCfgInsert:
    ...
    async def exec(self, irec: tNoTemplCfg = None) -> "dNoTemplCfgInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("NoTemplCfgInsert", self._dbcon.STMNT_TYPE_CUD)
  ...
  :tm_stamp
        ...
        self.irec.id = await self._dbcon.post_get_sequence(self._dbstmnt, "loco.NoTemplCfg", "id", 8)
