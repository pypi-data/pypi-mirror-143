...
class dCorrTypeInsert:
    ...
    async def exec_deft(self,
                        ...
                        templ_schema: dict,
                        modified_by: str,
                        tm_stamp: datetime.datetime) -> "dCorrTypeInsert":
        """
    ...
    async def exec(self, irec: tCorrType = None) -> "dCorrTypeInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("CorrTypeInsert", self._dbcon.STMNT_TYPE_CUD)

        self._dbstmnt.sql("""insert into loco.CorrType (
  id,
  descr,
  status,
  templ_schema,
