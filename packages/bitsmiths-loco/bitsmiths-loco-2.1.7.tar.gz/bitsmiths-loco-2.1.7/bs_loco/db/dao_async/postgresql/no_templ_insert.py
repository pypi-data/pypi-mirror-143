...
class dNoTemplInsert:
    ...
    async def exec_deft(self,
                        ...
                        res_list: dict,
                        modified_by: str,
                        tm_stamp: datetime.datetime) -> "dNoTemplInsert":
        """
    ...
    async def exec(self, irec: tNoTempl = None) -> "dNoTemplInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("NoTemplInsert", self._dbcon.STMNT_TYPE_CUD)

        self._dbstmnt.sql("""insert into loco.NoTempl (
  notype_id,
  corrtype_id,
  status,
  lastcfg_id,
