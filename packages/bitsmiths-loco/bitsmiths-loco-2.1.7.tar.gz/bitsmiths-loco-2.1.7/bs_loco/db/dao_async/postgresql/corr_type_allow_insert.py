...
class dCorrTypeAllowInsert:
    ...
    async def exec(self, irec: tCorrTypeAllow = None) -> "dCorrTypeAllowInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("CorrTypeAllowInsert", self._dbcon.STMNT_TYPE_CUD)
