...
class dCorrProvCfgInsert:
    ...
    async def exec(self, irec: tCorrProvCfg = None) -> "dCorrProvCfgInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("CorrProvCfgInsert", self._dbcon.STMNT_TYPE_CUD)
  ...
  :tm_stamp
        ...
        self.irec.id = await self._dbcon.post_get_sequence(self._dbstmnt, "loco.CorrProvCfg", "id", 8)
