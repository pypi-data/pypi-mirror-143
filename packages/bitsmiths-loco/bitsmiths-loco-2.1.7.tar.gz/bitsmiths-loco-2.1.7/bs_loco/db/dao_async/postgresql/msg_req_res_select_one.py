...
class dMsgReqResSelectOne:
    ...
    async def exec(self, irec: tMsgReqResKey = None) -> "dMsgReqResSelectOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("MsgReqResSelectOne", self._dbcon.STMNT_TYPE_READ)
