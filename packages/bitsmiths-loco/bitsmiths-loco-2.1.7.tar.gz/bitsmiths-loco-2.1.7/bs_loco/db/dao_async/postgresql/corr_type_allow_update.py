...
class dCorrTypeAllowUpdate:
    ...
    async def exec(self, irec: tCorrTypeAllow = None) -> "dCorrTypeAllowUpdate":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("CorrTypeAllowUpdate", self._dbcon.STMNT_TYPE_CUD)
