...
class dMsgHistSelectOne:
    ...
    async def exec(self, irec: tMsgHistKey = None) -> "dMsgHistSelectOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("MsgHistSelectOne", self._dbcon.STMNT_TYPE_READ)
