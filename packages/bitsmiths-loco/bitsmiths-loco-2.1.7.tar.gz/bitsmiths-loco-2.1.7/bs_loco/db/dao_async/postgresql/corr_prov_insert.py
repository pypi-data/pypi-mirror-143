...
class dCorrProvInsert:
    ...
    async def exec_deft(self,
                        ...
                        lastcfg_id: int,
                        modified_by: str,
                        tm_stamp: datetime.datetime) -> "dCorrProvInsert":
        """
    ...
    async def exec(self, irec: tCorrProv = None) -> "dCorrProvInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("CorrProvInsert", self._dbcon.STMNT_TYPE_CUD)

        self._dbstmnt.sql("""insert into loco.CorrProv (
  id,
  corrtype_id,
  descr,
  status,
