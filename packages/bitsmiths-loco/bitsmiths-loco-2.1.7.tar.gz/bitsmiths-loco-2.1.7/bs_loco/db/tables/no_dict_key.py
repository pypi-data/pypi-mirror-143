...
class tNoDictKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tNoDictKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tNoDictKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tNoDictKey._cache_davs(dvc)
