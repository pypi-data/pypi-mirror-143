...
class tCorrProvCfgKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tCorrProvCfgKey"):
        """
    ...
    def _get_davs(self, dvc=None):
        tCorrProvCfgKey._cache_davs(dvc)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tCorrProvCfgKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tCorrProvCfgKey._cache_davs(dvc)
