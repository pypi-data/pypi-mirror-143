...
class tMsgKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tMsgKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tMsgKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tMsgKey._cache_davs(dvc)
