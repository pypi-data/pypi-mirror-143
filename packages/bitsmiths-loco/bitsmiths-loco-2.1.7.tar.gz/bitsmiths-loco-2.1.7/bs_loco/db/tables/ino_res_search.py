...
class iNoResSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iNoResSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iNoResSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<NoRes [criteria:%.32s]>' % (
            self.criteria)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iNoResSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iNoResSearch._cache_davs(dvc)
