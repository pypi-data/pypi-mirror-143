...
class tMsgReqResKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tMsgReqResKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tMsgReqResKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tMsgReqResKey._cache_davs(dvc)
