...
class tNoTypeKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tNoTypeKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tNoTypeKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tNoTypeKey._cache_davs(dvc)
