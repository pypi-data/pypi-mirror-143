...
class tMsgReqKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tMsgReqKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tMsgReqKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tMsgReqKey._cache_davs(dvc)
