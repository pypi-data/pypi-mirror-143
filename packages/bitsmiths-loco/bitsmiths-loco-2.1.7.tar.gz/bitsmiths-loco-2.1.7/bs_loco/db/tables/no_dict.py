...
class tNoDict(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    def _copy_from(self, rec: "tNoDict"):
        """
    ...
    def _write_pk(self, _key: "tNoDict"):
        """
    ...
    def _read_pk(self, _key: "tNoDict"):
        """
    ...
    def _cache_davs(dvc=None, for_ins: bool = False, key_only: bool = False):
        ...
        dvc.add_targ("value", mettle.lib.Dav(mettle.lib.Dav.eDavType.Max, 256))
    ...
    def _get_davs(self, dvc=None, for_ins: bool = False, key_only: bool = False):
        tNoDict._cache_davs(dvc, for_ins, key_only)

    def _write_key(self, _key: tNoDictKey):
        """
    ...
    def _read_key(self, _key: tNoDictKey):
        """
    ...
    def __repr__(self) -> str:
        return '<NoDict [id:%.32s, value:%.32s, modified_by:%.32s, tm_stamp:%s]>' % (
            self.id, self.value, self.modified_by, self.tm_stamp)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tNoDict.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None, for_ins: bool = False, key_only: bool = False):
            return tNoDict._cache_davs(dvc, for_ins, key_only)
