...
class dNoResLockOne:
    ...
    def exec(self, irec: tNoResKey = None) -> "dNoResLockOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("NoResLockOne", self._dbcon.STMNT_TYPE_READ)
...
where
  id = :id for update nowait""")
    ...
    def fetch_all(self, outList: tNoRes.List, clearList: bool = True) -> int:
        """
