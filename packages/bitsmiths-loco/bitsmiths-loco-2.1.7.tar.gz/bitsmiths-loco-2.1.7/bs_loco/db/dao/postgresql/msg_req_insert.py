...
class dMsgReqInsert:
    ...
    def exec(self, irec: tMsgReq = None) -> "dMsgReqInsert":
        """
        ...
        self._dbstmnt = self._dbcon.statement("MsgReqInsert", self._dbcon.STMNT_TYPE_CUD)
  ...
  :tm_stamp
        ...
        self.irec.id = self._dbcon.post_get_sequence(self._dbstmnt, "loco.MsgReq", "id", 8)
