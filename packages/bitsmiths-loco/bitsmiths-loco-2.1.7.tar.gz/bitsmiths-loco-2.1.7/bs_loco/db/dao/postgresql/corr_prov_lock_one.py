...
class dCorrProvLockOne:
    ...
    def exec_deft(self,
                  id: str,
                  corrtype_id: str) -> "dCorrProvLockOne":
        """
    ...
    def exec(self, irec: tCorrProvKey = None) -> "dCorrProvLockOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("CorrProvLockOne", self._dbcon.STMNT_TYPE_READ)
