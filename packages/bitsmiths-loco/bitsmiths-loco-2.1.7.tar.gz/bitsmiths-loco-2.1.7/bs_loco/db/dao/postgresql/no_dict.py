...
class dNoDict:
    ...
    def lock_one_with(self, _rec: tNoDict, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tNoDictKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tNoDict) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tNoDictKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tNoDict) -> "dNoDict":
        """
    ...
    def select_one_by_key(self, _key: tNoDictKey) -> "dNoDict":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tNoDict = None):
        """
    ...
    def insert(self, irec: tNoDict = None):
        """
    ...
    def delete_one(self, irec: tNoDictKey = None):
        """
