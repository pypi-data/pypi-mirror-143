...
class dCorrTypeAllowSelectOne:
    ...
    def exec(self, irec: tCorrTypeAllowKey = None) -> "dCorrTypeAllowSelectOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("CorrTypeAllowSelectOne", self._dbcon.STMNT_TYPE_READ)
...
where
  ...
  allow_id = :allow_id""")
    ...
    def fetch_all(self, outList: tCorrTypeAllow.List, clearList: bool = True) -> int:
        """
