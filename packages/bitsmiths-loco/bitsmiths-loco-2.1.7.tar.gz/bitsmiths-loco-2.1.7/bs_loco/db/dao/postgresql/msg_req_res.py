...
class dMsgReqRes:
    ...
    def lock_one_with(self, _rec: tMsgReqRes, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tMsgReqResKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tMsgReqRes) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tMsgReqResKey) -> bool:
        """
    ...
    def select_one(self) -> "dMsgReqRes":
        """
    ...
    def select_one_with(self, _rec: tMsgReqRes) -> "dMsgReqRes":
        """
    ...
    def select_one_by_key(self, _key: tMsgReqResKey) -> "dMsgReqRes":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tMsgReqRes = None):
        """
    ...
    def insert(self, irec: tMsgReqRes = None):
        """
    ...
    def delete_one(self, irec: tMsgReqResKey = None):
        """
