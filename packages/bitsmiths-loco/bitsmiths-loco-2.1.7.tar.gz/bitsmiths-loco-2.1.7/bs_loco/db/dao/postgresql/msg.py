...
class dMsg:
    ...
    def lock_one_with(self, _rec: tMsg, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tMsgKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tMsg) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tMsgKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tMsg) -> "dMsg":
        """
    ...
    def select_one_by_key(self, _key: tMsgKey) -> "dMsg":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tMsg = None):
        """
    ...
    def insert(self, irec: tMsg = None):
        """
    ...
    def delete_one(self, irec: tMsgKey = None):
        """
