...
class dNoDictSelectOne:
    ...
    def exec(self, irec: tNoDictKey = None) -> "dNoDictSelectOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("NoDictSelectOne", self._dbcon.STMNT_TYPE_READ)
...
where
  id = :id""")
    ...
    def fetch_all(self, outList: tNoDict.List, clearList: bool = True) -> int:
        """
