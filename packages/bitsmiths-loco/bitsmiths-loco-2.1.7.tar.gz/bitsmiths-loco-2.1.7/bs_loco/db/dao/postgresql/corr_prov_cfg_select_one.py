...
class dCorrProvCfgSelectOne:
    ...
    def exec(self, irec: tCorrProvCfgKey = None) -> "dCorrProvCfgSelectOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("CorrProvCfgSelectOne", self._dbcon.STMNT_TYPE_READ)
...
where
  id = :id""")
    ...
    def fetch_all(self, outList: tCorrProvCfg.List, clearList: bool = True) -> int:
        """
