...
class dNoRes:
    ...
    def lock_one_with(self, _rec: tNoRes, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tNoResKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tNoRes) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tNoResKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tNoRes) -> "dNoRes":
        """
    ...
    def select_one_by_key(self, _key: tNoResKey) -> "dNoRes":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tNoRes = None):
        """
    ...
    def insert(self, irec: tNoRes = None):
        """
    ...
    def delete_one(self, irec: tNoResKey = None):
        """
