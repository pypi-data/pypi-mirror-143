...
class iMsgReqPendingChanged(mettle.io.ISerializable):
    ...
    def _serialize(self, _w: mettle.io.IWriter, _oname: str = None):
        ...
        _w.write_string("limit_crit", self.limit_crit)
        _w.write_end(_oname)
    ...
    def _deserialize(self, _r: mettle.io.IReader, _oname: str = None):
        ...
        self.limit_crit = _r.read_string("limit_crit")
        _r.read_end(_oname)

    def _copy_from(self, rec: "iMsgReqPendingChanged"):
        """
        Copies the column from the rec into this record.

        :param rec: The source record.
        """
        self.limit_crit = rec.limit_crit
    ...
    def _cache_davs(dvc=None):
        ...
        dvc.add_targ("limitCrit", mettle.lib.Dav(mettle.lib.Dav.eDavType.NotNull))

        return dvc

    def _get_davs(self, dvc=None):
        iMsgReqPendingChanged._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<MsgReq [limit_crit:%.32s]>' % (
            self.limit_crit)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iMsgReqPendingChanged.List'
        ...
        def __repr__(self) -> str:
            return '<iMsgReqPendingChanged.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iMsgReqPendingChanged._cache_davs(dvc)
