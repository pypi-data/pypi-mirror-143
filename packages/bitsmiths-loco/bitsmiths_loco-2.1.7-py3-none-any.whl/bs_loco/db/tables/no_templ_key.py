...
class tNoTemplKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tNoTemplKey"):
        """
    ...
    def __repr__(self) -> str:
        return '<NoTempl [notype_id:%.32s, corrtype_id:%.32s]>' % (
            self.notype_id, self.corrtype_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tNoTemplKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tNoTemplKey._cache_davs(dvc)
