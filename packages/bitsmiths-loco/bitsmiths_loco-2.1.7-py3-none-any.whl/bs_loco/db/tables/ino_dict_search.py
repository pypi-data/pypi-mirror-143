...
class iNoDictSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iNoDictSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iNoDictSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<NoDict [criteria:%.32s]>' % (
            self.criteria)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iNoDictSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iNoDictSearch._cache_davs(dvc)
