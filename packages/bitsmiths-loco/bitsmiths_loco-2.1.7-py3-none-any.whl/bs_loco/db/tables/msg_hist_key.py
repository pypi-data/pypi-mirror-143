...
class tMsgHistKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tMsgHistKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tMsgHistKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tMsgHistKey._cache_davs(dvc)
