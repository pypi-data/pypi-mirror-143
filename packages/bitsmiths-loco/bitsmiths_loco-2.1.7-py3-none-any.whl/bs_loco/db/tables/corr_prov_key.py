...
class tCorrProvKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tCorrProvKey"):
        """
    ...
    def __repr__(self) -> str:
        return '<CorrProv [id:%.32s, corrtype_id:%.32s]>' % (
            self.id, self.corrtype_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tCorrProvKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tCorrProvKey._cache_davs(dvc)
