...
class tNoTemplCfgKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tNoTemplCfgKey"):
        """
    ...
    def _get_davs(self, dvc=None):
        tNoTemplCfgKey._cache_davs(dvc)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tNoTemplCfgKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tNoTemplCfgKey._cache_davs(dvc)
