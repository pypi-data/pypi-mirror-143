...
class iMsgByMsgReq(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iMsgByMsgReq"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iMsgByMsgReq.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iMsgByMsgReq._cache_davs(dvc)
