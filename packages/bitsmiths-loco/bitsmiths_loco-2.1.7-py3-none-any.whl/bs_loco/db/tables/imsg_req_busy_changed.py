...
class iMsgReqBusyChanged(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iMsgReqBusyChanged"):
        """
    ...
    def _get_davs(self, dvc=None):
        iMsgReqBusyChanged._cache_davs(dvc)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iMsgReqBusyChanged.List'
        ...
        def __repr__(self) -> str:
            return '<iMsgReqBusyChanged.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iMsgReqBusyChanged._cache_davs(dvc)
