...
class tCorrTypeKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tCorrTypeKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tCorrTypeKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tCorrTypeKey._cache_davs(dvc)
