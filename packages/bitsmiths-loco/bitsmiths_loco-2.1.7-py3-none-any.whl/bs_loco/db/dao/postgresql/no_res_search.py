...
class dNoResSearch:
    ...
    def exec(self, irec: iNoResSearch = None) -> "dNoResSearch":
        """
        ...
        self._dbstmnt = self._dbcon.statement("NoResSearch", self._dbcon.STMNT_TYPE_READ)
...
order by
  nr.id""")
    ...
    def fetch_all(self, outList: oNoResSearch.List, clearList: bool = True) -> int:
        """
