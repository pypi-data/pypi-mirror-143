...
class dMsgReqPendingChanged:
    ...
    def exec(self, irec: iMsgReqPendingChanged = None) -> "dMsgReqPendingChanged":
        """
        ...
        self._dbstmnt = self._dbcon.statement("MsgReqPendingChanged", self._dbcon.STMNT_TYPE_READ)
...
[limitCrit]""")
    ...
    def fetch_all(self, outList: oMsgReqPendingChanged.List, clearList: bool = True) -> int:
        """
