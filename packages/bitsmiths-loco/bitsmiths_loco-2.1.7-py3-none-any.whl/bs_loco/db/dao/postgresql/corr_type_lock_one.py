...
class dCorrTypeLockOne:
    ...
    def exec(self, irec: tCorrTypeKey = None) -> "dCorrTypeLockOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("CorrTypeLockOne", self._dbcon.STMNT_TYPE_READ)
...
where
  id = :id for update nowait""")
    ...
    def fetch_all(self, outList: tCorrType.List, clearList: bool = True) -> int:
        """
