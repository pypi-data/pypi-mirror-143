...
class dCorrProvSelectOne:
    ...
    def exec_deft(self,
                  id: str,
                  corrtype_id: str) -> "dCorrProvSelectOne":
        """
    ...
    def exec(self, irec: tCorrProvKey = None) -> "dCorrProvSelectOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("CorrProvSelectOne", self._dbcon.STMNT_TYPE_READ)
...
where
  ...
  corrtype_id = :corrtype_id""")
        ...
        self._dbstmnt.bind_out("cfg_schema", dict)
    ...
    def fetch_all(self, outList: tCorrProv.List, clearList: bool = True) -> int:
        """
