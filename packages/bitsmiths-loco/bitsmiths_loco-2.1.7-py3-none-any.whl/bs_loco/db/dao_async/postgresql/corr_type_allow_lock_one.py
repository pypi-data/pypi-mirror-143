...
class dCorrTypeAllowLockOne:
    ...
    async def exec(self, irec: tCorrTypeAllowKey = None) -> "dCorrTypeAllowLockOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("CorrTypeAllowLockOne", self._dbcon.STMNT_TYPE_READ)
