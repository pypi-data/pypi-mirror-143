...
class dNoTempl:
    ...
    async def lock_one_with(self, _rec: tNoTempl, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tNoTemplKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_with(self, _rec: tNoTempl) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tNoTemplKey) -> bool:
        """
    ...
    async def select_one(self) -> "dNoTempl":
        """
    ...
    async def select_one_with(self, _rec: tNoTempl) -> "dNoTempl":
        """
    ...
    async def select_one_by_key(self, _key: tNoTemplKey) -> "dNoTempl":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tNoTempl = None):
        """
    ...
    async def insert(self, irec: tNoTempl = None):
        """
