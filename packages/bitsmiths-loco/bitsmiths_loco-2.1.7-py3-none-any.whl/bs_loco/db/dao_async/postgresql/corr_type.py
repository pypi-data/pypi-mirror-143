...
class dCorrType:
    ...
    async def lock_one_with(self, _rec: tCorrType, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tCorrTypeKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_with(self, _rec: tCorrType) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tCorrTypeKey) -> bool:
        """
    ...
    async def select_one(self) -> "dCorrType":
        """
    ...
    async def select_one_with(self, _rec: tCorrType) -> "dCorrType":
        """
    ...
    async def select_one_by_key(self, _key: tCorrTypeKey) -> "dCorrType":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tCorrType = None):
        """
    ...
    async def insert(self, irec: tCorrType = None):
        """
