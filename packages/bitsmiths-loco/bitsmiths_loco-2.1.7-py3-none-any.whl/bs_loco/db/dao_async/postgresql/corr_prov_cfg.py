...
class dCorrProvCfg:
    ...
    async def lock_one_with(self, _rec: tCorrProvCfg, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tCorrProvCfgKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_with(self, _rec: tCorrProvCfg) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tCorrProvCfgKey) -> bool:
        """
    ...
    async def select_one(self) -> "dCorrProvCfg":
        """
    ...
    async def select_one_with(self, _rec: tCorrProvCfg) -> "dCorrProvCfg":
        """
    ...
    async def select_one_by_key(self, _key: tCorrProvCfgKey) -> "dCorrProvCfg":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tCorrProvCfg = None):
        """
    ...
    async def insert(self, irec: tCorrProvCfg = None):
        """
    ...
    async def delete_one(self, irec: tCorrProvCfgKey = None):
        """
