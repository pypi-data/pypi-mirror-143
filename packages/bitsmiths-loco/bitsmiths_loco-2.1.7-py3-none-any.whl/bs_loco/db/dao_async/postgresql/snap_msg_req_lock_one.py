...
class dSnapMsgReqLockOne:
    ...
    async def exec(self, irec: tSnapMsgReqKey = None) -> "dSnapMsgReqLockOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("SnapMsgReqLockOne", self._dbcon.STMNT_TYPE_READ)
...
where
  ...
  notype_id = :notype_id for update nowait""")
    ...
    async def fetch_all(self, outList: tSnapMsgReq.List, clearList: bool = True) -> int:
        """
