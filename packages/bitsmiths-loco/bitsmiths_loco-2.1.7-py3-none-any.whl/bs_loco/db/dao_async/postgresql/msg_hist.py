...
class dMsgHist:
    ...
    async def try_select_one_with(self, _rec: tMsgHist) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tMsgHistKey) -> bool:
        """
    ...
    async def select_one(self) -> "dMsgHist":
        """
    ...
    async def select_one_with(self, _rec: tMsgHist) -> "dMsgHist":
        """
    ...
    async def select_one_by_key(self, _key: tMsgHistKey) -> "dMsgHist":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tMsgHist = None):
        """
    ...
    async def insert(self, irec: tMsgHist = None):
        """
