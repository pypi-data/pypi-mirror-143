...
class dSnapMsgReqDeleteOne:
    ...
    async def exec(self, irec: tSnapMsgReqKey = None) -> "dSnapMsgReqDeleteOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("SnapMsgReqDeleteOne", self._dbcon.STMNT_TYPE_CUD)
