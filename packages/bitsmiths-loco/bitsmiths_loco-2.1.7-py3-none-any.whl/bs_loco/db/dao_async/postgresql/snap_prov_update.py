...
class dSnapProvUpdate:
    ...
    async def exec_deft(self,
                        ...
                        msg_retry: int,
                        avg_msg_time: float,
                        tot_msg_time: float) -> "dSnapProvUpdate":
        """
    ...
    async def exec(self, irec: tSnapProv = None) -> "dSnapProvUpdate":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("SnapProvUpdate", self._dbcon.STMNT_TYPE_CUD)
...
set
  ...
  msg_retry = :msg_retry,
  avg_msgTime = :avg_msgTime,
  tot_msgTime = :tot_msgTime
where
