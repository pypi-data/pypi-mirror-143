...
class dNoTemplCfg:
    ...
    async def lock_one_with(self, _rec: tNoTemplCfg, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tNoTemplCfgKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_with(self, _rec: tNoTemplCfg) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tNoTemplCfgKey) -> bool:
        """
    ...
    async def select_one(self) -> "dNoTemplCfg":
        """
    ...
    async def select_one_with(self, _rec: tNoTemplCfg) -> "dNoTemplCfg":
        """
    ...
    async def select_one_by_key(self, _key: tNoTemplCfgKey) -> "dNoTemplCfg":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tNoTemplCfg = None):
        """
    ...
    async def insert(self, irec: tNoTemplCfg = None):
        """
