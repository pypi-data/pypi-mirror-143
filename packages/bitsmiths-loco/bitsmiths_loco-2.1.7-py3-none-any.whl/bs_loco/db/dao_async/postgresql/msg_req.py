...
class dMsgReq:
    ...
    async def lock_one_with(self, _rec: tMsgReq, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tMsgReqKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_with(self, _rec: tMsgReq) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tMsgReqKey) -> bool:
        """
    ...
    async def select_one(self) -> "dMsgReq":
        """
    ...
    async def select_one_with(self, _rec: tMsgReq) -> "dMsgReq":
        """
    ...
    async def select_one_by_key(self, _key: tMsgReqKey) -> "dMsgReq":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tMsgReq = None):
        """
    ...
    async def insert(self, irec: tMsgReq = None):
        """
    ...
    async def delete_one(self, irec: tMsgReqKey = None):
        """
