...
class dNoTypeLockOne:
    ...
    async def exec(self, irec: tNoTypeKey = None) -> "dNoTypeLockOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("NoTypeLockOne", self._dbcon.STMNT_TYPE_READ)
