...
class dMsgReqResLockOne:
    ...
    async def exec(self, irec: tMsgReqResKey = None) -> "dMsgReqResLockOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("MsgReqResLockOne", self._dbcon.STMNT_TYPE_READ)
