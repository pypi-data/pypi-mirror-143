...
setup(
    ...
    description=(
        "Type annotations for boto3.Account 1.21.23 service generated with mypy-boto3-builder 7.4.1"
    ),
    classifiers=[
    ...
    keywords="boto3 account type-annotations boto3-stubs mypy typeshed autocomplete",
