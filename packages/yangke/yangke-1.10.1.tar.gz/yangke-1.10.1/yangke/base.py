...
def save_as_xlsx(file, engine="WPS", ext="xlsx", visible=False):
    ...
    # SaveAs("D:\Users\2021\陕投商洛\8111320.csv", xlCSV, undefined, undefined, undefined, undefined, xlNoChange, 1, -1, undefined, undefined);
    excel_app.Quit()
...
def update_options_para(origin_para, new_para):
    ...
    opt.update(get_settings('aiTrain.opt'))
