...
class MemorydbClusterShards(
    ...
    def nodes(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "nodes"))
...
class MemorydbClusterShardsNodes(
    ...
    def endpoint(self) -> cdktf.IResolvable:
        return typing.cast(cdktf.IResolvable, jsii.get(self, "endpoint"))
...
class MemorydbSnapshot(
    ...
    def cluster_configuration(
        ...
        :param index: -
        '''
        return typing.cast("MemorydbSnapshotClusterConfiguration", jsii.invoke(self, "clusterConfiguration", [index]))
