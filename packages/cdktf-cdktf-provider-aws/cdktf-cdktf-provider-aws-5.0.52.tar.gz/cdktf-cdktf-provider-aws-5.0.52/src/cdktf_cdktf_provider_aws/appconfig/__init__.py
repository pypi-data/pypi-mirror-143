...
class AppconfigConfigurationProfile(
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        tags_all: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        validator: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence["AppconfigConfigurationProfileValidator"]]] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
        lifecycle: typing.Optional[cdktf.TerraformResourceLifecycle] = None,
        provider: typing.Optional[cdktf.TerraformProvider] = None,
    ...
    def validator(
        self,
    ) -> typing.Union[cdktf.IResolvable, typing.List["AppconfigConfigurationProfileValidator"]]:
        return typing.cast(typing.Union[cdktf.IResolvable, typing.List["AppconfigConfigurationProfileValidator"]], jsii.get(self, "validator"))

    @validator.setter
    def validator(
        self,
        value: typing.Union[cdktf.IResolvable, typing.List["AppconfigConfigurationProfileValidator"]],
    ) -> None:
...
class AppconfigEnvironment(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        description: typing.Optional[builtins.str] = None,
        monitor: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence["AppconfigEnvironmentMonitor"]]] = None,
        tags: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        tags_all: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
    ...
    def monitor(
        self,
    ) -> typing.Union[cdktf.IResolvable, typing.List["AppconfigEnvironmentMonitor"]]:
        return typing.cast(typing.Union[cdktf.IResolvable, typing.List["AppconfigEnvironmentMonitor"]], jsii.get(self, "monitor"))

    @monitor.setter
    def monitor(
        self,
        value: typing.Union[cdktf.IResolvable, typing.List["AppconfigEnvironmentMonitor"]],
    ) -> None:
