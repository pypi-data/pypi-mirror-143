...
class ElasticacheParameterGroup(
    ...
    def __init__(
        ...
        *,
        ...
        parameter: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence["ElasticacheParameterGroupParameter"]]] = None,
        tags: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        tags_all: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        count: typing.Optional[jsii.Number] = None,
        depends_on: typing.Optional[typing.Sequence[cdktf.ITerraformDependable]] = None,
    ...
    def parameter(
        self,
    ) -> typing.Union[cdktf.IResolvable, typing.List["ElasticacheParameterGroupParameter"]]:
        return typing.cast(typing.Union[cdktf.IResolvable, typing.List["ElasticacheParameterGroupParameter"]], jsii.get(self, "parameter"))

    @parameter.setter
    def parameter(
        self,
        value: typing.Union[cdktf.IResolvable, typing.List["ElasticacheParameterGroupParameter"]],
    ) -> None:
