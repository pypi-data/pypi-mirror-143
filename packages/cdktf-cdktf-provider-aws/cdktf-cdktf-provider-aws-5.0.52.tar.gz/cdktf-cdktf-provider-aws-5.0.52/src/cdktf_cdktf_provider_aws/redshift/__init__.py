...
class RedshiftParameterGroup(
    ...
    def parameter(
        self,
    ) -> typing.Union[cdktf.IResolvable, typing.List["RedshiftParameterGroupParameter"]]:
        return typing.cast(typing.Union[cdktf.IResolvable, typing.List["RedshiftParameterGroupParameter"]], jsii.get(self, "parameter"))

    @parameter.setter
    def parameter(
        self,
        value: typing.Union[cdktf.IResolvable, typing.List["RedshiftParameterGroupParameter"]],
    ) -> None:
...
class RedshiftSecurityGroup(
    ...
    def ingress(
        ...
        return typing.cast(typing.Union[cdktf.IResolvable, typing.List["RedshiftSecurityGroupIngress"]], jsii.get(self, "ingress"))

    @ingress.setter
    def ingress(
        self,
        value: typing.Union[cdktf.IResolvable, typing.List["RedshiftSecurityGroupIngress"]],
    ) -> None:
