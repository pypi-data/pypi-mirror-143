...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html)
...
class PollyClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#can_paginate)
        """
    ...
    async def delete_lexicon(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#delete_lexicon)
        """
    ...
    async def describe_voices(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#describe_voices)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#generate_presigned_url)
        """
    ...
    async def get_lexicon(self, *, Name: str) -> GetLexiconOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#get_lexicon)
        """
    ...
    async def get_speech_synthesis_task(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#get_speech_synthesis_task)
        """
    ...
    async def list_lexicons(self, *, NextToken: str = ...) -> ListLexiconsOutputTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#list_lexicons)
        """
    ...
    async def list_speech_synthesis_tasks(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#list_speech_synthesis_tasks)
        """
    ...
    async def put_lexicon(self, *, Name: str, Content: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#put_lexicon)
        """
    ...
    async def start_speech_synthesis_task(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#start_speech_synthesis_task)
        """
    ...
    async def synthesize_speech(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#synthesize_speech)
        """
    ...
    def get_paginator(self, operation_name: Literal["describe_voices"]) -> DescribeVoicesPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_polly/client.html#get_paginator)
        """
