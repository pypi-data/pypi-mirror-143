...
class InstallerApi(object):
    ...
    def transform_cluster_to_day2(self, cluster_id, **kwargs):  # noqa: E501
        ...
        Transforming cluster to day2 and allowing adding hosts  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str cluster_id: The cluster to transform to day2 and to allow adding hosts by this. (required)
        :return: Cluster
                 If the method is called asynchronously,
                 returns the request thread.
        """
