...
setup(
    ...
    description=(
        "Type annotations for aiobotocore.PinpointSMSVoice 2.2.0 service generated with"
    ...
    keywords=(
        "aiobotocore pinpoint-sms-voice type-annotations boto3-stubs mypy typeshed autocomplete"
    ),
