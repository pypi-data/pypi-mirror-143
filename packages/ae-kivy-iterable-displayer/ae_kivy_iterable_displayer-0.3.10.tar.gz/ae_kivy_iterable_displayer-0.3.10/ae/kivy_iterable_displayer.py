...
The popup widget provided by this ae namespace portion displays items and sub-items of any type of iterables,
...
class IterableDisplayerPopup(FlowPopup):
    ...
    def compile_data_maps(data: Union[dict, list, set, tuple]):
        ...
        for key, val in items:
            text = (str(key) + KEY_VAL_SEPARATOR + str(val))[:369]  # cut long text preventing black texture kivy/gl bug
