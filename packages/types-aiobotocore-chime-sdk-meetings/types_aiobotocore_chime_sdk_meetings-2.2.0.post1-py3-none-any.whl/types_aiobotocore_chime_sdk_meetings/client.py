...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html)
...
class ChimeSDKMeetingsClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#exceptions)
        """
    ...
    async def batch_create_attendee(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#batch_create_attendee)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#can_paginate)
        """
    ...
    async def create_attendee(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#create_attendee)
        """
    ...
    async def create_meeting(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#create_meeting)
        """
    ...
    async def create_meeting_with_attendees(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#create_meeting_with_attendees)
        """
    ...
    async def delete_attendee(self, *, MeetingId: str, AttendeeId: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#delete_attendee)
        """
    ...
    async def delete_meeting(self, *, MeetingId: str) -> None:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#delete_meeting)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#generate_presigned_url)
        """
    ...
    async def get_attendee(self, *, MeetingId: str, AttendeeId: str) -> GetAttendeeResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#get_attendee)
        """
    ...
    async def get_meeting(self, *, MeetingId: str) -> GetMeetingResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#get_meeting)
        """
    ...
    async def list_attendees(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#list_attendees)
        """
    ...
    async def start_meeting_transcription(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#start_meeting_transcription)
        """

    async def stop_meeting_transcription(self, *, MeetingId: str) -> None:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_chime_sdk_meetings/client.html#stop_meeting_transcription)
        """
