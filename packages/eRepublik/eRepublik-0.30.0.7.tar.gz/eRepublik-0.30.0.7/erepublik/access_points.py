...
class SlowRequests(Client):
    ...
    def __init__(self, *, proxies: str = None, user_agent: str = None):
        ...
        super().__init__(http2=True, follow_redirects=True, proxies={"all://": proxies})
    ...
    def _cookies_as_dict(self) -> List[Dict[str, Any]]:
        ...
        return [{attr: getattr(c, attr, None) for attr in cookie_attrs if hasattr(c, attr)} for c in self.cookies.jar]
