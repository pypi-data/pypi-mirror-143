...
class LookoutMetricsClient(AioBaseClient):
    ...
    async def deactivate_anomaly_detector(self, *, AnomalyDetectorArn: str) -> Dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#deactivate_anomaly_detector)
        """
    ...
    async def list_anomaly_group_related_metrics(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_lookoutmetrics/client.html#list_anomaly_group_related_metrics)
        """
