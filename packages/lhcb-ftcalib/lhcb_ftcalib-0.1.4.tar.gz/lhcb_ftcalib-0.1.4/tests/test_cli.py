...
def parse_args(argv):
    ...
    parser.add_argument("-fun",  type=str, dest="fun", nargs=2, default=["POLY", 1])
...
def test_prepare_cli_tests():
    ...
    if not os.path.exists("tests/cli/toy_data.root"):
        ...
        File = uproot.recreate("tests/cli/toy_data.root")
        File["BU_TOY"] = toydata
...
def test_read_file():
    ...
    args = parse_args(f"{F} -t TOY0 -id TOY_DECAY -mode Bu -op calibrate")
...
def test_validate_ops():
    args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op calibrate")
    validate_ops(args)
    args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op calibrate combine")
    validate_ops(args)
    args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op calibrate combine calibrate")
    validate_ops(args)
    args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op apply")
    validate_ops(args)
    args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op apply combine")
    validate_ops(args)

    with pytest.raises(FTCalibException):
        args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op apply apply")
        validate_ops(args)
    with pytest.raises(FTCalibException):
        args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op calibrate calibrate")
        validate_ops(args)
    with pytest.raises(FTCalibException):
        args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op apply calibrate")
        validate_ops(args)
    with pytest.raises(FTCalibException):
        args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op calibrate apply")
        validate_ops(args)
    with pytest.raises(FTCalibException):
        validate_ops(args)
        args = parse_args("FILE -t TOY0 -id TOY_DECAY -mode Bu -op calibrate combine calibrate calibrate")
...
def test_run_calibrate_Bu():
    ...
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BU_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bu -op calibrate -write {testfile} -plot")
...
def test_run_calibrate_combine_Bu():
    ...
    delete_file(testfile + ".root")
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BU_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bu -op calibrate combine -write {testfile}")
...
def test_run_calibrate_combine_calibrate_Bu():
    ...
    delete_file(testfile + ".root")
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BU_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bu -op calibrate combine calibrate -write {testfile}")
...
def test_run_calibrate_Bd():
    ...
    delete_file(testfile + ".root")
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BD_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bd -op calibrate -tau TAU -timeunit ps -write {testfile}")
...
def test_run_calibrate_Bd_selection_vartype1():
    ...
    delete_file(testfile + ".root")
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BD_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bd -op calibrate -tau TAU -timeunit ps -write {testfile} -selection \"TAU>0.5\"")
...
def test_run_calibrate_Bd_selection_vartype2():
    ...
    delete_file(testfile + ".root")
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BD_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bd -op calibrate -tau TAU -timeunit ps -write {testfile} -selection \"eventNumber%2==0\"")
...
def test_run_calibrate_combine_Bd():
    ...
    delete_file(testfile + ".root")
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BD_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bd -op calibrate combine -tau TAU -timeunit ps -write {testfile}")
...
def test_run_calibrate_combine_calibrate_Bd():
    ...
    delete_file(testfile + ".root")
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BD_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bd -op calibrate combine calibrate -tau TAU -timeunit ps -write {testfile}")
...
def test_run_calibrate_combine_calibrate_Bd_selection():
    ...
    delete_file(testfile + ".root")
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BD_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bd -op calibrate combine calibrate -tau TAU -timeunit ps -selection eventNumber%2==0 -write {testfile}")
...
def test_run_calibrate_combine_calibrate_Bd_double_selection():
    ...
    delete_file(testfile + ".root")
    F = "tests/cli/toy_data.root"
    args = parse_args(f"{F}:BD_TOY -t TOY0 TOY1 TOY2 -id TOY_DECAY -mode Bd -op calibrate combine calibrate -tau TAU -timeunit ps -selection eventNumber%2==0;eventNumber%3==2 -write {testfile}")
