...
[Open documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html)
...
class ApplicationDiscoveryServiceClient(AioBaseClient):
    ...
    [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#exceptions)
        """
    ...
    async def associate_configuration_items_to_application(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#associate_configuration_items_to_application)
        """
    ...
    async def batch_delete_import_data(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#batch_delete_import_data)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#can_paginate)
        """
    ...
    async def create_application(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#create_application)
        """
    ...
    async def create_tags(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#create_tags)
        """

    async def delete_applications(self, *, configurationIds: Sequence[str]) -> Dict[str, Any]:
        """
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#delete_applications)
        """
    ...
    async def delete_tags(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#delete_tags)
        """
    ...
    async def describe_agents(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#describe_agents)
        """
    ...
    async def describe_configurations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#describe_configurations)
        """
    ...
    async def describe_continuous_exports(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#describe_continuous_exports)
        """
    ...
    async def describe_export_configurations(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#describe_export_configurations)
        """
    ...
    async def describe_export_tasks(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#describe_export_tasks)
        """
    ...
    async def describe_import_tasks(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#describe_import_tasks)
        """
    ...
    async def describe_tags(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#describe_tags)
        """
    ...
    async def disassociate_configuration_items_from_application(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#disassociate_configuration_items_from_application)
        """
    ...
    async def export_configurations(self) -> ExportConfigurationsResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#export_configurations)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#generate_presigned_url)
        """
    ...
    async def get_discovery_summary(self) -> GetDiscoverySummaryResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#get_discovery_summary)
        """
    ...
    async def list_configurations(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#list_configurations)
        """
    ...
    async def list_server_neighbors(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#list_server_neighbors)
        """
    ...
    async def start_continuous_export(self) -> StartContinuousExportResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#start_continuous_export)
        """
    ...
    async def start_data_collection_by_agent_ids(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#start_data_collection_by_agent_ids)
        """
    ...
    async def start_export_task(
        ...
        *,
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#start_export_task)
        """
    ...
    async def start_import_task(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#start_import_task)
        """
    ...
    async def stop_continuous_export(self, *, exportId: str) -> StopContinuousExportResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#stop_continuous_export)
        """
    ...
    async def stop_data_collection_by_agent_ids(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#stop_data_collection_by_agent_ids)
        """
    ...
    async def update_application(
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#update_application)
        """
    ...
    def get_paginator(self, operation_name: Literal["describe_agents"]) -> DescribeAgentsPaginator:
        ...
        [Show types-aiobotocore documentation](https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_discovery/client.html#get_paginator)
        """
