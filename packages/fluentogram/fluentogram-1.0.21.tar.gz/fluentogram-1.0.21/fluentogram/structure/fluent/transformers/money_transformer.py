...
from fluentogram.structure.abstract import AbstractDataTransformer
...
class MoneyTransformer(AbstractDataTransformer):
    ...
    def __new__(cls,
                amount: Decimal,
                currency: str,
                currency_display: Union[Literal['code'], Literal['symbol'],
                                        Literal['name']] = "code",
                ...
                **kwargs) -> Union[FluentNumber, FluentNone]:
