...
class StrategyDTO:
    ...
    def __init__(self, campaign_id, name, status,
                 use_campaign_start_date, use_campaign_end_date,
                 start_date, end_date,
                 input_type, pacing_amount, pacing_interval, pacing_type,
                 impression_pacing_amount, impression_pacing_type,
                 impression_pacing_interval, min_bid, max_bid,
    ...
    def fromDict(user_data: dict):
        ...
        return StrategyDTO(campaign_id=user_data.get("campaign_id"),
                           ...
                           input_type=InputTypeEnum.set(user_data.get("input_type")),
                           ...
                           frequency_type=FrequencyTypeEnum(user_data.get("frequency_type")),
