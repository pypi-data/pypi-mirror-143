...
from ts_t1_validator.validators.rules.amount_ranges import T1AmountRanges, StrategyFrequencyRanges, StrategyRanges, StrategyImpressionRanges, StrategyGoalRanges, StrategyRoiTargetRanges
...
from .rules.input_type_required_put import InputTypeRequiredPutRule
...
class StrategyPostValidator(AbstractValidator):
    ...
    def build_rules_set(self, *args, **kwargs):
        ...
        self.rules.append(InputTypeRequiredPutRule(pacing_amount=dto.pacing_amount,
        ...
        # rule for roi_target field
        self.rules.append(T1AmountRanges(
            input_type=dto.input_type,
            type_ranges=StrategyRoiTargetRanges,
            amount=dto.roi_target,
            amount_field="roi_target"))
