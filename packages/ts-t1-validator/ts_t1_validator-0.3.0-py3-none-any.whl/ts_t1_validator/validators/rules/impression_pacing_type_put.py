...
class ImpressionPacingTypePutRule(ValidationRule):
    def __init__(self, impression_pacing_type: ImpressionPacingTypeEnum,
        ...
        assert type(input_type) is InputTypeEnum, "input_type should be InputTypeEnum type"
    ...
    def put(self, pacing_amount: int or float or None, pacing_interval: PacingIntervalEnum):
        ...
        if self.input_type is InputTypeEnum.PERCENTAGE and is_number(pacing_amount):
    ...
    def execute(self):
        ...
        postValidator = ImpressionPacingTypeRule(
