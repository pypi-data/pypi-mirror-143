...
def print_info() -> None:
    ...
    """
    print(
        "Type annotations for aiobotocore.ResourceGroupsTaggingAPI 2.2.0\nVersion:        "
        " 2.2.0.post1\nBuilder version: 7.4.1\nDocs:           "
        " https://vemel.github.io/types_aiobotocore_docs/types_aiobotocore_resourcegroupstaggingapi//\nBoto3"
        " docs:     "
