...
class QsciScintillaBase(QtWidgets.QAbstractScrollArea):
    ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: typing.Any = ..., lParam: int = ...) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: int, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> int: ...
    @typing.overload
    def SendScintilla(self, msg: int, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> int: ...
    @typing.overload
...
class QsciScintilla(QsciScintillaBase):
    ...
    def marginRightClicked(self, margin: int, line: int, state: QtCore.Qt.KeyboardModifier) -> None: ...
    def marginClicked(self, margin: int, line: int, state: QtCore.Qt.KeyboardModifier) -> None: ...
    def linesChanged(self) -> None: ...
    def indicatorReleased(self, line: int, index: int, state: QtCore.Qt.KeyboardModifier) -> None: ...
    def indicatorClicked(self, line: int, index: int, state: QtCore.Qt.KeyboardModifier) -> None: ...
    ...
    def setSelectionForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setSelectionBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setSelection(self, lineFrom: int, indexFrom: int, lineTo: int, indexTo: int) -> None: ...
    def setReadOnly(self, ro: bool) -> None: ...
    def setPaper(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setMarginsForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setMarginsFont(self, f: QtGui.QFont) -> None: ...
    def setMarginsBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setIndentationGuidesForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setIndentationGuidesBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setCaretLineBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setCaretForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setWhitespaceForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setWhitespaceBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setUnmatchedBraceForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setUnmatchedBraceBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def resetMatchedBraceIndicator(self) -> None: ...
    def setMatchedBraceIndicator(self, indicatorNumber: int) -> None: ...
    def setMatchedBraceForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setMatchedBraceBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setMarkerForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], markerNumber: int = ...) -> None: ...
    def setMarkerBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], markerNumber: int = ...) -> None: ...
    ...
    def setMarginBackgroundColor(self, margin: int, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setIndicatorOutlineColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], indicatorNumber: int = ...) -> None: ...
    def setIndicatorHoverStyle(self, style: 'QsciScintilla.IndicatorStyle', indicatorNumber: int = ...) -> None: ...
    def setIndicatorHoverForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], indicatorNumber: int = ...) -> None: ...
    def setIndicatorForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], indicatorNumber: int = ...) -> None: ...
    ...
    def setHotspotForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setHotspotBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setEdgeColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def clearEdgeColumns(self) -> None: ...
    def addEdgeColumn(self, colnr: int, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setCallTipsHighlightColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setCallTipsForegroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setCallTipsBackgroundColor(self, col: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    ...
    def setFoldMarginColors(self, fore: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], back: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QsciLexer(QtCore.QObject):
    ...
    def paperChanged(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], style: int) -> None: ...
    def fontChanged(self, f: QtGui.QFont, style: int) -> None: ...
    def eolFillChanged(self, eolfilled: bool, style: int) -> None: ...
    def colorChanged(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], style: int) -> None: ...
    def setPaper(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], style: int = ...) -> None: ...
    def setFont(self, f: QtGui.QFont, style: int = ...) -> None: ...
    def setEolFill(self, eolfill: bool, style: int = ...) -> None: ...
    def setColor(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], style: int = ...) -> None: ...
    def setAutoIndentStyle(self, autoindentstyle: int) -> None: ...
    def writeSettings(self, qs: QtCore.QSettings, prefix: typing.Optional[str] = ...) -> bool: ...
    def readSettings(self, qs: QtCore.QSettings, prefix: typing.Optional[str] = ...) -> bool: ...
    def wordCharacters(self) -> str: ...
    def styleBitsNeeded(self) -> int: ...
    def setDefaultPaper(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def setDefaultFont(self, f: QtGui.QFont) -> None: ...
    def setDefaultColor(self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QsciPrinter(QtPrintSupport.QPrinter):
    ...
    def wrapMode(self) -> QsciScintilla.WrapMode: ...
    @typing.overload
    def printRange(self, qsb: QsciScintillaBase, painter: QtGui.QPainter, from_: int = ..., to: int = ...) -> int: ...
    @typing.overload
...
class QsciStyle(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def __init__(self, style: int, description: str, color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], paper: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int], font: QtGui.QFont, eolFill: bool = ...) -> None: ...
    @typing.overload
    ...
    def paper(self) -> QtGui.QColor: ...
    def setPaper(self, paper: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int]) -> None: ...
    def color(self) -> QtGui.QColor: ...
