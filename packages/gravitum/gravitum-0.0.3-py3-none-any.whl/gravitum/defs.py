"""Implemented functions which are used in the code decompiled by IDA."""
...
def bswap32(value: IntVar, byteorder: str = 'little') -> IntVar:
    """Implementation for `bswap32`."""
    data = value.to_bytes(byteorder=byteorder)
    return type(value).from_bytes(data[::-1], byteorder=byteorder)
