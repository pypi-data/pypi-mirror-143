...
setup(
    ...
    description="A complete web automation framework for end-to-end Application testing.",
    ...
    author="manish Saini",
    author_email="manishsaini74.ms@gmail.com",
    ...
    entry_points={
        "console_scripts": [
            "appiumbase = appiumbase.console_scripts.run:main",
            "sbase = appiumbase.console_scripts.run:main",  # Simplified name
        ],
        "pytest11": ["appiumbase = appiumbase.plugins.pytest_plugin"],
    },
)

print("\n*** AppiumBase Installation Complete! ***\n")