...
class ChimeClient(BaseClient):
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_chime/client.html#exceptions)
        """
    ...
    def tag_meeting(self, *, MeetingId: str, Tags: Sequence["TagTypeDef"]) -> None:
        """
    ...
    def untag_attendee(self, *, MeetingId: str, AttendeeId: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def untag_meeting(self, *, MeetingId: str, TagKeys: Sequence[str]) -> None:
        """
    ...
    def get_paginator(self, operation_name: Literal["list_accounts"]) -> ListAccountsPaginator:
        ...
        [Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_chime/client.html#get_paginator)
        """
